...
!              1              2           3   4            5           6        7            8     
write(901,*)PSNOWSWE(:,1),PSNOWHEAT(:,1),PTV,PTG(:,1),PSNOWTEMP(:,1),PPSN(:),PSWNET_G(:),PLWNET_G(:)
...
!write(902,*)PSNOWSWE(:,1),PSNOWHEAT(:,1),PTV,PTG(:,1),PSNOWTEMP(:,1),PPSN(:),PSWNET_G(:),PLWNET_G(:),PH_G_C(:),PLE_G_C(:)
!write(902,*)PH_G_C(:),PLE_G_C(:)
