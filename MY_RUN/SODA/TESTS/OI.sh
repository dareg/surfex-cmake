...
# Copy namelists
cp $SRC_SURFEX/MY_RUN/SODA/NAMELISTS/OPTIONS.nam_soda_OI OPTIONS.nam
...
cp  $SRC_SURFEX/MY_RUN/SODA/OUTPUT/PREP_OFFLINE.lfi .
...
# Save output
mv PREP_OFFLINE.lfi $SRC_SURFEX/MY_RUN/SODA/OUTPUT/PREP_SODA_OI.lfi
