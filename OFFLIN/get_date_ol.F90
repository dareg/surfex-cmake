...
ISEC=MAX(0,NINT(TPTIME%TIME-(PTSTEP-FLOOR(PTSTEP/86400)*86400)))
...
ENDIF
!
CALL WRITE_TIME(TPTIME%TDATE%YEAR,1,"-",HDATE)
CALL WRITE_TIME(TPTIME%TDATE%MONTH,0,"-",HDATE)
CALL WRITE_TIME(TPTIME%TDATE%DAY,0,"",HDATE)
