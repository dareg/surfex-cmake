...
!!!!
CHARACTER(LEN=2)                      :: CDIF     ! type of soil function
...
CALL READ_SURF(CSURF_FILETYPE,'THETA_PSI',CDIF,IRESP)
CALL READ_SURF(CSURF_FILETYPE,'PEDOTF',CPEDOTF,IRESP)
IF (CDIF=='VG') THEN
  WRITE(ILUOUT,*) '*****************************************************'
  WRITE(ILUOUT,*) '* Van Genuchten not yet implemented                 *'
  WRITE(ILUOUT,*) '*****************************************************'
  CALL ABOR1_SFX('MAIN_CARB_SPINUP: Van Genuchten not yet implemented')
ENDIF
