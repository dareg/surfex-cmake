...
USE MODD_IO_SURF_FA, ONLY : CFILEIN_FA, CFILEOUT_FA
USE MODD_IO_SURF_LFI,ONLY : CLUOUT_LFI, CFILEIN_LFI, CFILEOUT_LFI
...
YRECFM='TAU_WOOD'
CALL READ_SURF(CSURF_FILETYPE,YRECFM,ZTAU_WOOD(:,:),IRESP)
