...
USE MODD_SURFEX_MPI, ONLY : NRANK, NPIO, XTIME_NPIO_READ, NPROC, NCOMM, &
                                 XTIME_NPIO_READ, XTIME_COMM_READ, NREQ, LSFX_MPI
!
...
IF (NRANK==NPIO) THEN
  ...
  IF (NID_NC.NE.0) THEN
    ...
    IF ( INDIMS>0 ) THEN
      !
      !PRINT*, "MODE_READ_SURF_NC", NID_NC,IVAR_ID,IDIMIDS
      IRET(4)=NF90_INQUIRE_VARIABLE(NID_NC,IVAR_ID,DIMIDS=IDIMIDS(1:INDIMS))
      !PRINT*, "MODE_READ_SURF_NC"
      !
      IDIMLEN(:) = 1.
      DO JDIM=1,INDIMS
...
!
USE MODD_SURFEX_MPI, ONLY: NRANK, NPROC, NCOMM, NPIO, XTIME_NPIO_READ, XTIME_COMM_READ, NREQ, LSFX_MPI
!
USE MODD_IO_SURF_NC, ONLY: LMASK,NMASK,NID_NC
!
USE MODD_SURF_PAR,   ONLY: XUNDEF
...
!
USE MODD_SURFEX_MPI, ONLY : NRANK, NPIO, XTIME_NPIO_READ, NPROC, NCOMM, &
                                 XTIME_NPIO_READ, XTIME_COMM_READ, LSFX_MPI
!
USE MODD_IO_SURF_NC, ONLY: LMASK,NMASK,NID_NC
!
USE MODD_SURF_PAR,   ONLY: NUNDEF
...
!!****  *READN0* - routine to read an integer
!
USE MODD_SURFEX_MPI, ONLY: NRANK, NPROC, NCOMM, NPIO, XTIME_NPIO_READ, XTIME_COMM_READ, LSFX_MPI
!
USE MODD_IO_SURF_NC, ONLY: LMASK,NMASK,NID_NC
!
USE MODD_SURF_PAR,   ONLY: NUNDEF
