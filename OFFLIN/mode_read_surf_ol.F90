...
!            print *,'RX1, use START, ISTART=',ISTART
!            print *,'RX1, use START, ICOUNT=',ICOUNT
!            print *,'RX1, use START, ISTRIDE=',ISTRIDE
  ...
  IF (IFILE_ID.NE.0) THEN
    ...
    IF (LPARTR) THEN
            ...
            DO  JDIM=1,INDIMS
                ...
                ENDIF
            ENDDO
!           print *,'RX2, use START, ISTART=',ISTART
!           print *,'RX2, use START, ICOUNT=',ICOUNT
!           print *,'RX2, use START, ISTRIDE=',ISTRIDE

            ALLOCATE(ZTAB_2D(ICOUNT(1),ICOUNT(2)))
      ...
      ELSE
           ALLOCATE(ZTAB_2D(IDIMLEN(1),IDIMLEN(2)))
           IRET(2)=NF_GET_VAR_DOUBLE(IFILE_ID,IVAR_ID,ZTAB_2D)
    ENDIF

!    print *,'RX2 ',HREC,ZTAB_2D
   ! print *,'MINVAL=',MINVAL(ZTAB_2D),'IRET=',IRET
...
!
 ...
 ELSE
   ...
   IF (LMASK) THEN
!       print *,'RX2 LMASK',LMASK,HREC,ZTAB_2D,PFIELD
        CALL PACK_SAME_RANK(NMASK,TRANSPOSE(ZTAB_2D),PFIELD)
    ELSE 
        PFIELD(:,:)=TRANSPOSE(ZTAB_2D(:,:))
!       print *,'RX2 sans Mask ',HREC,ZTAB_2D,PFIELD
   ENDIF
 END IF
!  
...
!    print *,'RX3 ',HREC,ZTAB_3D
   ! print *,'MINVAL=',MINVAL(ZTAB_3D),'IRET=',IRET
...
!
 ...
 ELSE
   ...
   IF (LMASK) THEN
!       print *,'RX2 LMASK',LMASK,HREC,ZTAB_3D,PFIELD
        CALL PACK_SAME_RANK(NMASK,ZTAB_3D,PFIELD)
    ELSE 
        PFIELD(:,:,:)=ZTAB_3D(:,:,:) 
!       print *,'RX3 sans Mask ',HREC,ZTAB_3D,PFIELD
   ENDIF
 END IF
!  
