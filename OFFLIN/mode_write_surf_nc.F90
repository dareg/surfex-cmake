...
!
!
IF (LHOOK) CALL DR_HOOK('MODE_WRITE_SURF_NC:WRITE_SURFX3_NC',1,ZHOOK_HANDLE)
!
CONTAINS
!
...
REAL(KIND=JPHOOK) :: ZHOOK_HANDLE
!
IF (LHOOK) CALL DR_HOOK('MODE_WRITE_SURF_NC:WRITE_SURFX2_NC:WRITE_DATAX3_NC',0,ZHOOK_HANDLE)
!
ZTAB3D = XUNDEF
!
IF (HDIR=='-') THEN
...
ENDIF
!
IF (LHOOK) CALL DR_HOOK('MODE_WRITE_SURF_NC:WRITE_SURFX2_NC:WRITE_DATAX3_NC',1,ZHOOK_HANDLE)
!
