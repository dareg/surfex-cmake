...
!     #######################################################
!
!!****  *OPEN_NAMELIST_NC* - opens namelists files for surface (OFFLINE universe)
!!
!!    PURPOSE
!!    -------
!!
...
!  -------------------
!
IF (LHOOK) CALL DR_HOOK('OPEN_NAMELIST_NC',0,ZHOOK_HANDLE)
...
END IF
!
 CALL OPEN_FILE_NC(KLUNAM,YNAM,"FORMATTED  ","READ     ","      ",IRESP)
IF (LHOOK) CALL DR_HOOK('OPEN_NAMELIST_NC',1,ZHOOK_HANDLE)
!-------------------------------------------------------------------------------
!
