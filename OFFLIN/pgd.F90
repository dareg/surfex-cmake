...
USE MODD_SURFEX_MPI, ONLY : NCOMM, NPROC, NRANK, NPIO, WLOG_MPI, PREP_LOG_MPI,   &
                            END_LOG_MPI, NINDEX, NNUM, NSIZE_TASK, LSFX_MPI
...
!
#ifdef SFX_MPI
 IF (LSFX_MPI) CALL MPI_INIT_THREAD(MPI_THREAD_MULTIPLE,ILEVEL,INFOMPI)
#endif
!
...
!            ----------------------
!
    WRITE(*,*)      CSURF_FILETYPE
    WRITE(*,*)      NRANK,NPIO
    WRITE(*,*)      CSURF_FILETYPE=='FA    ',NRANK==NPIO
!
  WRITE(ILUOUT,*) ' '
  WRITE(ILUOUT,*) '    ----------------------'
