...
cp -f OPTIONS.nam OPTIONS.nam_save
sed -e "s/XUNIF_ALB_WALL = 1.0E+20/XUNIF_ALB_WALL = 0.40/g" OPTIONS.nam_save > OPTIONS.nam
cp -f OPTIONS.nam OPTIONS.nam_save
sed -e "s/XUNIF_EMIS_WALL = 1.0E+20/XUNIF_EMIS_WALL = 0.90/g" OPTIONS.nam_save > OPTIONS.nam
cp -f OPTIONS.nam OPTIONS.nam_save
sed -e "s/XUNIF_HC_WALL(1) = 1.0E+20/XUNIF_HC_WALL(1) = 1800000./g" OPTIONS.nam_save > OPTIONS.nam
cp -f OPTIONS.nam OPTIONS.nam_save
sed -e "s/XUNIF_HC_WALL(2) = 1.0E+20/XUNIF_HC_WALL(2) = 2200000./g" OPTIONS.nam_save > OPTIONS.nam
cp -f OPTIONS.nam OPTIONS.nam_save
sed -e "s/XUNIF_HC_WALL(3) = 1.0E+20/XUNIF_HC_WALL(3) = 2200000./g" OPTIONS.nam_save > OPTIONS.nam
cp -f OPTIONS.nam OPTIONS.nam_save
sed -e "s/XUNIF_HC_WALL(4) = 1.0E+20/XUNIF_HC_WALL(4) = 700000./g" OPTIONS.nam_save > OPTIONS.nam
cp -f OPTIONS.nam OPTIONS.nam_save
sed -e "s/XUNIF_TC_WALL(1) = 1.0E+20/XUNIF_TC_WALL(1) = 1.0/g" OPTIONS.nam_save > OPTIONS.nam
cp -f OPTIONS.nam OPTIONS.nam_save
sed -e "s/XUNIF_TC_WALL(2) = 1.0E+20/XUNIF_TC_WALL(2) = 1.65/g" OPTIONS.nam_save > OPTIONS.nam
cp -f OPTIONS.nam OPTIONS.nam_save
sed -e "s/XUNIF_TC_WALL(3) = 1.0E+20/XUNIF_TC_WALL(3) = 1.75/g" OPTIONS.nam_save > OPTIONS.nam
cp -f OPTIONS.nam OPTIONS.nam_save
sed -e "s/XUNIF_TC_WALL(4) = 1.0E+20/XUNIF_TC_WALL(4) = 0.2/g" OPTIONS.nam_save > OPTIONS.nam
cp -f OPTIONS.nam OPTIONS.nam_save
sed -e "s/XUNIF_D_WALL(1) = 1.0E+20/XUNIF_D_WALL(1) = 0.04/g" OPTIONS.nam_save > OPTIONS.nam
cp -f OPTIONS.nam OPTIONS.nam_save
sed -e "s/XUNIF_D_WALL(2) = 1.0E+20/XUNIF_D_WALL(2) = 0.15/g" OPTIONS.nam_save > OPTIONS.nam
cp -f OPTIONS.nam OPTIONS.nam_save
sed -e "s/XUNIF_D_WALL(3) = 1.0E+20/XUNIF_D_WALL(3) = 0.035/g" OPTIONS.nam_save > OPTIONS.nam
cp -f OPTIONS.nam OPTIONS.nam_save
sed -e "s/XUNIF_D_WALL(4) = 1.0E+20/XUNIF_D_WALL(4) = 0.03/g" OPTIONS.nam_save > OPTIONS.nam


cp -f OPTIONS.nam OPTIONS.nam_save
sed -e "s/XUNIF_BLD = 1.0E+20/XUNIF_BLD = 0.689/g" OPTIONS.nam_save > OPTIONS.nam
cp -f OPTIONS.nam OPTIONS.nam_save
sed -e "s/XUNIF_BLD_HEIGHT = 1.0E+20/XUNIF_BLD_HEIGHT = 4.70/g" OPTIONS.nam_save > OPTIONS.nam
cp -f OPTIONS.nam OPTIONS.nam_save
sed -e "s/XUNIF_WALL_O_HOR = 1.0E+20/XUNIF_WALL_O_HOR = 0.75/g" OPTIONS.nam_save > OPTIONS.nam
cp -f OPTIONS.nam OPTIONS.nam_save
sed -e "s/XUNIF_Z0_TOWN = 1.0E+20/XUNIF_Z0_TOWN = 1.90/g" OPTIONS.nam_save > OPTIONS.nam
