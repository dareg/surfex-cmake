...
./script_isba_neige_dif.sh "OPTIONS.nam" "$2" $3 $4 $5
...
./script_isba_neige_dif.sh "OPTIONS.nam" "$2_NIT" $3 $4 $5
...
echo "############# $2_NIT__NITRO_DILUPRM_AGRIP"
mv -f OPTIONS.nam OPTIONS.nam_save
...
echo "############# $2_NCB_PRM_TR_ML_NITRO_DILU "
mv -f OPTIONS.nam OPTIONS.nam_save
sed -e "s/LNITRO\_DILU\ =\ F/LNITRO\_DILU\ =\ T/g" OPTIONS.nam_save > OPTIONS.nam
cp -f OPTIONS.nam OPTIONS.nam_"$2_NCB_PRM_TR_ML_NITRO_DILU"
./script_exec.sh "$2_NCB_PRM_TR_ML_NITRO_DILU" $3 $4 $5
#crepsl = CNT
echo "############# $2_NCB_CNT "
cp -f OPTIONS.nam_ncb OPTIONS.nam_save
...
echo "############# $2_NCB_CNT_TR_ML_SPINUPCARBS "
mv -f OPTIONS.nam OPTIONS.nam_save
...
cp -f OPTIONS.nam OPTIONS.nam_"$2_NCB_CNT_TR_ML_SPINUPCARBS"
./script_isba_canopy_parall.sh "OPTIONS.nam" "$2_NCB_CNT_TR_ML_SPINUPCARBS" $3 $4 $5
#lagrip = t
echo "############# $2_NCB_AGRIP "
cp -f OPTIONS.nam_ncb OPTIONS.nam_save
sed -e "s/LAGRIP\ =\ F/LAGRIP\ =\ T/g" OPTIONS.nam_save > OPTIONS.nam
