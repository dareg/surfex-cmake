...
!              ------------
!
USE MODD_AGRI_GARDEN_n,   ONLY : AGRI_GARDEN_ALLOC
...
CALL DIAG_MISC_TEB_ALLOC(KMODEL)
...
CALL TEB_GARDEN_ALLOC(KMODEL)
CALL TEB_GRID_ALLOC(KMODEL)
CALL TEB_ALLOC(KMODEL)
