!     #########
      SUBROUTINE CONVERT_PATCH_ISBA(HISBA,KDECADE,PCOVER,HPHOTO,HSFTYPE, &
                                  PVEG,PLAI,PRSMIN,PGAMMA,               &
                                  PWRMAX_CF,PRGL,PCV,PDG,PZ0,PZ0_O_Z0H,  &
...
!
USE MODD_ISBA_n,         ONLY : NPATCH, NGROUND_LAYER, CALBEDO,           &
...
IF (PRESENT(PVEG)) THEN
  IF (LDATA_VEG) THEN
    CALL AV_PGD_PARAM(PVEG,XPAR_VEGTYPE,XPAR_VEG(:,KDECADE,:),YNAT,'ARI')
  ELSE
...
IF (PRESENT(PLAI)) THEN
  IF (LDATA_LAI) THEN
    CALL AV_PGD_PARAM(PLAI,XPAR_VEGTYPE,XPAR_LAI(:,KDECADE,:),YVEG,'ARI',KDECADE=KDECADE)
  ELSE
...
IF (PRESENT(PEMIS_ECO)) THEN    
  IF (LDATA_EMIS) THEN
    CALL AV_PGD_PARAM(PEMIS_ECO,XPAR_VEGTYPE,XPAR_EMIS(:,KDECADE,:),YNAT,'ARI')
  ELSE
...
IF (PRESENT(PZ0)) THEN
  IF (LDATA_Z0) THEN
    CALL AV_PGD_PARAM(PZ0,XPAR_VEGTYPE,XPAR_Z0(:,KDECADE,:),YNAT,'CDN')
  ELSE
...
IF (PRESENT(PROOTFRAC)) THEN
  DO JLAYER=1,IGROUND
    IF (LDATA_ROOTFRAC) THEN
      CALL AV_PGD_PARAM(PROOTFRAC(:,JLAYER,:),XPAR_VEGTYPE,XPAR_ROOTFRAC(:,JLAYER,:),YNAT,'ARI')
    ELSE
      CALL AV_PGD (PROOTFRAC(:,JLAYER,:),PCOVER,XDATA_CUM_ROOT_FRAC(:,JLAYER,:),YNAT,'ARI')
    ENDIF
  ENDDO
ENDIF
!
...
IF (PRESENT(PRSMIN)) THEN
  IF( SIZE(PRSMIN)>0) THEN
    IF (LDATA_RSMIN) THEN
      CALL AV_PGD_PARAM(PRSMIN,XPAR_VEGTYPE,XPAR_RSMIN,YLAI,'INV',KDECADE=KDECADE)
    ELSE
...
IF (PRESENT(PGAMMA)) THEN
  IF (LDATA_GAMMA) THEN
    CALL AV_PGD_PARAM(PGAMMA,XPAR_VEGTYPE,XPAR_GAMMA,YVEG,'ARI',KDECADE=KDECADE)
  ELSE
...
IF (PRESENT(PWRMAX_CF)) THEN
  IF (LDATA_WRMAX_CF) THEN
    CALL AV_PGD_PARAM(PWRMAX_CF,XPAR_VEGTYPE,XPAR_WRMAX_CF,YVEG,'ARI',KDECADE=KDECADE)
  ELSE
...
IF (PRESENT(PRGL)) THEN
  IF (LDATA_RGL) THEN
    CALL AV_PGD_PARAM(PRGL,XPAR_VEGTYPE,XPAR_RGL,YVEG,'ARI',KDECADE=KDECADE)
  ELSE
...
IF (PRESENT(PCV)) THEN
  IF (LDATA_CV) THEN
    CALL AV_PGD_PARAM(PCV,XPAR_VEGTYPE,XPAR_CV,YVEG,'INV',KDECADE=KDECADE)
  ELSE
...
IF (PRESENT(PALBNIR_VEG)) THEN
  IF (LDATA_ALBNIR_VEG) THEN
    CALL AV_PGD_PARAM(PALBNIR_VEG,XPAR_VEGTYPE,XPAR_ALBNIR_VEG,YVEG,'ARI',KDECADE=KDECADE)
  ELSE
...
IF (PRESENT(PALBVIS_VEG)) THEN
  IF (LDATA_ALBVIS_VEG) THEN
    CALL AV_PGD_PARAM(PALBVIS_VEG,XPAR_VEGTYPE,XPAR_ALBVIS_VEG,YVEG,'ARI',KDECADE=KDECADE)
  ELSE
...
IF (PRESENT(PALBUV_VEG)) THEN
  IF (LDATA_ALBUV_VEG) THEN
    CALL AV_PGD_PARAM(PALBUV_VEG,XPAR_VEGTYPE,XPAR_ALBUV_VEG,YVEG,'ARI',KDECADE=KDECADE)
  ELSE
...
IF (PRESENT(PGMES)) THEN
  IF ( SIZE(PGMES)>0) THEN
    IF (LDATA_GMES) THEN
      CALL AV_PGD_PARAM(PGMES,XPAR_VEGTYPE,XPAR_GMES,YVEG,'ARI',KDECADE=KDECADE)
    ELSE
...
IF (PRESENT(PBSLAI)) THEN
  IF( SIZE(PBSLAI)>0) THEN
    IF (LDATA_BSLAI) THEN
      CALL AV_PGD_PARAM(PBSLAI,XPAR_VEGTYPE,XPAR_BSLAI,YVEG,'ARI',KDECADE=KDECADE)
    ELSE
      IF (HPHOTO == 'AST' .OR. HPHOTO == 'LST' .OR. HPHOTO == 'NIT' .OR. HPHOTO == 'NCB') THEN
...
IF (PRESENT(PSEFOLD)) THEN
  IF (SIZE(PSEFOLD)>0) THEN
    IF (LDATA_SEFOLD) THEN
      CALL AV_PGD_PARAM(PSEFOLD,XPAR_VEGTYPE,XPAR_SEFOLD,YVEG,'ARI',KDECADE=KDECADE)
    ELSE
      IF (HPHOTO == 'AST' .OR. HPHOTO == 'LST' .OR. HPHOTO == 'NIT' .OR. HPHOTO == 'NCB') THEN
...
IF (PRESENT(PGC)) THEN
  IF ( SIZE(PGC)>0) THEN
    IF (LDATA_GC) THEN
      CALL AV_PGD_PARAM(PGC,XPAR_VEGTYPE,XPAR_GC,YVEG,'ARI',KDECADE=KDECADE)
    ELSE
      IF (HPHOTO == 'AST' .OR. HPHOTO == 'LST' .OR. HPHOTO == 'NIT' .OR. HPHOTO == 'NCB') THEN
...
IF (PRESENT(PLAIMIN)) THEN
  IF (SIZE(PLAIMIN)>0) THEN
    IF (LDATA_LAIMIN) THEN
      CALL AV_PGD_PARAM(PLAIMIN,XPAR_VEGTYPE,XPAR_LAIMIN,YVEG,'ARI',KDECADE=KDECADE)
    ELSE
...
IF (PRESENT(PF2I)) THEN
  IF (SIZE(PF2I)>0) THEN
    IF (LDATA_F2I) THEN
      CALL AV_PGD_PARAM(PF2I,XPAR_VEGTYPE,XPAR_F2I,YVEG,'ARI',KDECADE=KDECADE)
    ELSE
...
IF (PRESENT(PCE_NITRO)) THEN
  IF (SIZE(PCE_NITRO)>0) THEN
    IF (LDATA_CE_NITRO) THEN
      CALL AV_PGD_PARAM(PCE_NITRO,XPAR_VEGTYPE,XPAR_CE_NITRO,YVEG,'ARI',KDECADE=KDECADE)
    ELSE
...
IF (PRESENT(PCF_NITRO)) THEN
  IF (SIZE(PCF_NITRO)>0) THEN
    IF (LDATA_CF_NITRO) THEN
      CALL AV_PGD_PARAM(PCF_NITRO,XPAR_VEGTYPE,XPAR_CF_NITRO,YVEG,'ARI',KDECADE=KDECADE)
    ELSE
...
IF (PRESENT(PCNA_NITRO)) THEN
  IF (SIZE(PCNA_NITRO)>0) THEN
    IF (LDATA_CNA_NITRO) THEN
      CALL AV_PGD_PARAM(PCNA_NITRO,XPAR_VEGTYPE,XPAR_CNA_NITRO,YVEG,'ARI',KDECADE=KDECADE)
    ELSE
...
IF (HPHOTO == 'LAI' .OR. HPHOTO == 'LST' .OR. HPHOTO == 'NIT')  THEN
  ...
  IF (PRESENT(PIRRIG)) THEN 
    IF (SIZE(PIRRIG)>0) THEN
      IF (LDATA_IRRIG) THEN
        CALL AV_PGD_PARAM(PIRRIG,XPAR_VEGTYPE,XPAR_IRRIG(:,KDECADE,:),YVEG,'ARI',KDECADE=KDECADE)
      ELSE
  ...
  IF (PRESENT(PWATSUP)) THEN  
    IF (SIZE(PWATSUP)>0) THEN
      IF (LDATA_WATSUP) THEN
        CALL AV_PGD_PARAM(PWATSUP,XPAR_VEGTYPE,XPAR_WATSUP(:,KDECADE,:),YVEG,'ARI',KDECADE=KDECADE)
      ELSE
...
IF (PRESENT(PALBNIR_SOIL)) THEN
  IF (LDATA_ALBNIR_SOIL) THEN
    CALL AV_PGD_PARAM(PALBNIR_SOIL,XPAR_VEGTYPE,XPAR_ALBNIR_SOIL,YNAT,'ARI',KDECADE=KDECADE)
  ELSE
...
IF (PRESENT(PALBVIS_SOIL)) THEN
  IF (LDATA_ALBVIS_SOIL) THEN
    CALL AV_PGD_PARAM(PALBVIS_SOIL,XPAR_VEGTYPE,XPAR_ALBVIS_SOIL,YNAT,'ARI',KDECADE=KDECADE)
  ELSE
...
IF (PRESENT(PALBUV_SOIL)) THEN
  IF (LDATA_ALBUV_SOIL) THEN
    CALL AV_PGD_PARAM(PALBUV_SOIL,XPAR_VEGTYPE,XPAR_ALBUV_SOIL,YNAT,'ARI',KDECADE=KDECADE)
  ELSE
...
IF (LDATA_STRESS) THEN
  ...
  ENDDO
  CALL AV_PGD_PARAM(ZWORK,XPAR_VEGTYPE,ZSTRESS,YVEG,'ARI',KDECADE=KDECADE)
ELSE
