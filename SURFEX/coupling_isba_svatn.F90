...
ENDIF
!
!*      2.     initialization of implicit coefficients
!              ---------------------------------------
!
IF (HCOUPLING=='I' .AND. TSNOW%SCHEME /= 'D95' .AND. TSNOW%SCHEME /= 'EBA') THEN
   CALL ABOR1_SFX('COUPLING_ISBA_SVATN: IMPLICIT COUPLING ALLOWD ONLY WITH D95 OR EBA OPTION')
ENDIF
!
