...
USE MODD_ISBA_n,       ONLY : NSIZE_NATURE_P, NR_NATURE_P, CROUGH, NPATCH, LGLACIER,     &
                                ...
                                CSCOND, CC1DRY, CRUNOFF, CPHOTO, CISBA, XPATCH, TTIME,   &
                                CALBEDO, XCOVER, XLAI, XVEG, XZ0, XEMIS,                 &
                                ...
                                XRSMIN, XGAMMA, XWRMAX_CF, XRGL, XCV, XDG, XZ0_O_Z0H,    &
                                ...
                                CKSAT, CRAIN, CHORT, XMUF, XFSAT, LTRIP, CDIF,           &
                                LFLOOD, XFFLOOD, XPIFLOOD, LTEMP_ARP, XSODELX,           &
                                LVEGUPD  
!
USE MODD_SURF_ATM, ONLY : LNOSOF
!
USE MODD_DST_n,       ONLY: XSFDST,XSFDSTM,XEMISRADIUS,XEMISSIG
USE MODD_DST_SURF,    ONLY: CDSTYN, NDSTMDE, NDST_MDEBEG
USE MODE_DST_SURF
USE MODD_SLT_n,       ONLY: XSFSLT,XEMISRADIUS_SLT,XEMISSIG_SLT
USE MODD_SLT_SURF,    ONLY: CSLTYN, NSLTMDE, NSLT_MDEBEG
USE MODE_SLT_SURF
!
USE MODD_PACK_ISBA,   ONLY : XP_VEGTYPE_PATCH, XP_SSO_SLOPE, XP_Z0_O_Z0H,       &
                               XP_ALBNIR, XP_ALBVIS, XP_ALBUV,                  &
                               XP_EMIS, XP_Z0, XP_VEG,                          &
                               XP_WRMAX_CF, XP_RSMIN , XP_GAMMA, XP_CV, XP_RGL, &
                               XP_ROOTFRAC, XP_BSLAI, XP_LAIMIN, XP_SEFOLD,     &
                               XP_H_TREE, XP_ANF, XP_ANMAX, XP_FZERO, XP_EPSO,  &
                               XP_GAMM, XP_QDGAMM, XP_RE25, XP_QDGMES,          &
                               XP_T1GMES, XP_T2GMES, XP_AMAX, XP_QDAMAX,        &
                               XP_T1AMAX, XP_T2AMAX, LP_STRESS, XP_F2I, XP_GC,  &
                               XP_AH, XP_BH, XP_TAU_WOOD, XP_DMAX, XP_RUNOFFB,  &
                               XP_WDRAIN, XP_TAUICE, XP_Z0REL, XP_GAMMAT,       &
                               XP_DG, XP_RUNOFFD, XP_C1SAT,                     &
                               XP_C2REF, XP_C3, XP_C4B, XP_C4REF, XP_ACOEF,     &
                               XP_PCOEF, XP_WFC, XP_WWILT, XP_WSAT, XP_BCOEF,   &
                               XP_CONDSAT, XP_MPOTSAT, XP_CGSAT, XP_HCAPSOIL,   &
                               XP_CONDDRY, XP_CONDSLD, XP_TDEEP,                &
                               XP_SNOWSWE, XP_SNOWHEAT, XP_SNOWRHO, XP_SNOWALB, &
                               XP_SNOWGRAN1,XP_SNOWGRAN2,XP_SNOWHIST,XP_SNOWAGE,&
                               XP_WR, XP_TG, XP_WG, XP_WGI, XP_RESA, XP_LAI,    &
                               XP_AN, XP_ANFM, XP_ANDAY, XP_LE,                 &
                               XP_Z0EFFIP,XP_Z0EFFIM,XP_Z0EFFJP,XP_Z0EFFJM,     &
                               XP_AOSIP,XP_AOSIM,XP_AOSJP,XP_AOSJM,             &
                               XP_HO2IP,XP_HO2IM,XP_HO2JP,XP_HO2JM, XP_SNOWEMIS,&
                               ...
                               XP_BSLAI_NITRO, XP_GMES, XP_LAT, XP_LON,         &
                               XP_BIOMASS, XP_RESP_BIOMASS,                     &
                               XP_LITTER, XP_SOILCARB, XP_LIGNIN_STRUC,         &
                               XP_LIRRIDAY, TP_SEED, TP_REAP, XP_IRRIG,         &
                               XP_WATSUP, XP_THRESHOLD, XP_LIRRIGATE,           &
                               XP_MUF, XP_FSAT, XP_KSAT_ICE, XP_D_ICE,          &
                               XP_FFLOOD, XP_Z0FLOOD, XP_PIFLOOD,               &
                               XP_CPS,XP_LVTT, XP_LSTT,XP_INCREASE, XP_TURNOVER,&
                               XP_PSN, XP_PSNG, XP_PSNV, XP_PSNV_A,             &
                               XP_FFG, XP_FFV, XP_FF, XP_DIR_ALB_WITH_SNOW,     &
                               XP_SCA_ALB_WITH_SNOW, XP_ALBF, XP_EMISF,         &
                               XP_ICE_STO, XP_FFROZEN, XP_CONDSAT_EXP,          &
                               XP_EXP_DIF, XP_ALPHA, XP_NVG, XP_MVG, XP_LVG,    &
                               XP_WRES  
...
USE MODD_PACK_DIAG_ISBA, ONLY : XP_RNSNOW, XP_HSNOW, XP_HPSNOW, XP_SMELTFLUX,   &
                                  ...
                                  XP_USTAR_ISBA, XP_LER_ISBA, XP_LE_ISBA,       &
                                  XP_LEI_ISBA, XP_GFLUX_ISBA, XP_MELTADV,       &
                                  XP_IACAN, XP_LEI,                             &
                                  ...
                                  XP_HV, XP_SNOWFREE_ALB_VEG, XP_QS,            &
                                  XP_SNOWFREE_ALB_SOIL, XP_HORT, XP_DRIP,       &
                                  XP_ALBT, XP_IFLOOD, XP_PFLOOD, XP_LE_FLOOD,   &
                                  XP_LEI_FLOOD, XP_ICEFLUX, XP_RRVEG, XP_GPP,   &
                                  XP_TS, XP_TSRAD, XP_RESP_AUTO, XP_RESP_ECO  
         
                                
USE MODD_PACK_CH_ISBA,   ONLY : XP_SOILRC_SO2, XP_SOILRC_O3, XP_DEP

USE MODD_CH_ISBA_n,      ONLY : CSV, CCH_DRY_DEP, LCH_BIO_FLUX, XDEP,           &
                                  NBEQ, NSV_CHSBEG, NSV_CHSEND, NBEQ,             &
...
! Patch outputs:
!
REAL, DIMENSION(SIZE(PTA),NPATCH) :: ZSFTH_TILE     ! surface heat flux (Km/s)
REAL, DIMENSION(SIZE(PTA),NPATCH) :: ZSFTQ_TILE     ! surface vapor flux (kgm/kg/s)
REAL, DIMENSION(SIZE(PTA),NPATCH) :: ZSFCO2_TILE    ! surface CO2 flux
...
!
REAL, DIMENSION(KSIZE) :: ZP_SUNTIME ! solar time                    (s from midnight)
...
REAL, DIMENSION(KSIZE) :: ZP_SFTQ    ! flux of water vapor <w'q'>            (mkg/kg/s)
REAL, DIMENSION(KSIZE) :: ZP_SFTH    ! flux of temperature <w'T'>            (Km/s)
REAL, DIMENSION(KSIZE,SIZE(PSV,2)) :: ZP_SFTS    ! flux of scalar      <w'sv'>           (mkg/kg/s)
REAL, DIMENSION(KSIZE) :: ZP_SFCO2   ! flux of CO2         <w'CO2'>          (m/s*kg/kg)
...
!
REAL, DIMENSION(KSIZE,ISWB) :: ZP_DIR_ALB_WITHOUT_SNOW      ! snow-free direct albedo
REAL, DIMENSION(KSIZE,ISWB) :: ZP_SCA_ALB_WITHOUT_SNOW      ! snow-free diffuse albedo
REAL, DIMENSION(KSIZE,ISWB) :: ZP_DIR_ALB_VEG_WITHOUT_SNOW  ! snow-free direct albedo from vegetation
REAL, DIMENSION(KSIZE,ISWB) :: ZP_SCA_ALB_VEG_WITHOUT_SNOW  ! snow-free diffuse albedo from vegetation
REAL, DIMENSION(KSIZE,ISWB) :: ZP_DIR_ALB_SOIL_WITHOUT_SNOW ! snow-free direct albedo from soil
REAL, DIMENSION(KSIZE,ISWB) :: ZP_SCA_ALB_SOIL_WITHOUT_SNOW ! snow-free diffuse albedo from soil
REAL, DIMENSION(KSIZE) :: ZP_EMIS                      ! emissivity
REAL, DIMENSION(KSIZE) :: ZP_GLOBAL_SW                 ! global incoming SW rad.
REAL, DIMENSION(KSIZE) :: ZP_SW_UP                     ! outgoing SW rad.
...
!
CALL PACK_DIAG_PATCH_n(KMASK,KSIZE,NPATCH,JPATCH,ISWB)     
!
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
!
CALL ISBA_ALBEDO(TSNOW%SCHEME,                                           &
                   ZP_DIR_SW, ZP_SCA_SW, PSW_BANDS,ISWB,                 &
                   XP_ALBNIR, XP_ALBVIS, XP_ALBUV,                       &
                   XP_ALBNIR_VEG, XP_ALBVIS_VEG, XP_ALBUV_VEG,           &
                   XP_ALBNIR_SOIL, XP_ALBVIS_SOIL, XP_ALBUV_SOIL,        &
                   ZP_GLOBAL_SW, XP_SNOWFREE_ALB,                        &
...
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
!
CALL ISBA( CISBA, CPHOTO, CRUNOFF, CC1DRY, CSCOND, CSOILFRZ,                              &
          CDIFSFCOND, TSNOW%SCHEME, CSNOWRES, CCPSURF, CDIF,                              &
          TTIME, LFLOOD, LTEMP_ARP, LGLACIER,                                             &
          ZP_PEW_A_COEF, ZP_PEW_B_COEF,                                                   &
          ZP_PET_A_COEF, ZP_PEQ_A_COEF, ZP_PET_B_COEF, ZP_PEQ_B_COEF,                     &
          PTSTEP, ZP_ZREF, ZP_UREF, ZP_SLOPE_COS,                                         &
          ZP_TA, ZP_QA, ZP_EXNA,  ZP_RHOA, ZP_PS, ZP_EXNS,                                &
          ZP_RAIN, ZP_SNOW, ZP_ZENITH, ZP_GLOBAL_SW, ZP_LW,                               &
          ZP_WIND,                                                                        &
          XP_VEG, XP_LAI, XP_WRMAX_CF, XP_RSMIN, XP_GAMMA, XP_CV, XP_RGL,                 &
          XP_RUNOFFD, XP_EMIS, XP_SNOWFREE_ALB, XP_Z0_WITH_SNOW,                          &
          XP_Z0H_WITH_SNOW, XP_Z0EFF,                                                     &
          XP_RUNOFFB, XP_WDRAIN, XP_CGSAT, XP_C1SAT, XP_C2REF, XP_C3, XP_C4B, XP_C4REF,   &
          XP_ACOEF, XP_PCOEF, XP_TAUICE, XP_CG, XP_C1, XP_C2, XP_WGEQ, XP_CT, XP_RS,      &
          XP_TDEEP, XP_GAMMAT,                                                            &
          XP_WR,                                                                          &
          XP_RESA, XP_CH, XP_CD,                                                          &
          XP_CDN, XP_RI, XP_HU, XP_HUG,                                                   &
          XP_PSN, XP_PSNG, XP_PSNV,                                                       &
          XP_RN, XP_H, XP_LE, XP_LEI,                                                     &
          XP_LEG, XP_LEGI, XP_LEV, XP_LES, XP_LER, XP_LETR,                               &
          XP_EVAP,XP_GFLUX, XP_RESTORE,                                                   &
          ZP_USTAR,                                                                       &
          XP_DRAIN, XP_RUNOFF, XP_MELT,                                                   &
          XP_VEGTYPE_PATCH, XP_AN, XP_ANF,                                                &
          XP_ANFM, XP_ANDAY, ZP_RESP_BIOMASS_INST, XP_RESP_BIOMASS,                       &
          XABC, XPOI, ZP_CO2,                                                             &
          XP_FZERO, XP_EPSO, XP_GAMM, XP_QDGAMM,                                          &
          XP_GMES, XP_QDGMES,                                                             &
          XP_T1GMES, XP_T2GMES, XP_AMAX, XP_QDAMAX,                                       &
          XP_T1AMAX, XP_T2AMAX,                                                           &
          LP_STRESS, XP_F2I, XP_GC, XP_AH, XP_BH, XP_DMAX,                                &
          XP_SNOWSWE, XP_SNOWHEAT, XP_SNOWRHO,                                            &
          XP_SNOWALB,                                                                     &
          XP_SNOWGRAN1, XP_SNOWGRAN2, XP_SNOWHIST,XP_SNOWAGE,                             &
          XP_RNSNOW, XP_HSNOW,  XP_HPSNOW, XP_SMELTFLUX,                                  &
          XP_GFLUXSNOW, XP_USTARSNOW,                                                     &
          XP_GRNDFLUX, XP_SRSFC, XP_RRSFC, XP_LESL,                                       &
          XP_SNOWEMIS, XP_CDSNOW, XP_CHSNOW,                                              &
          XP_SNOWTEMP, XP_SNOWLIQ, XP_SNOWDZ, XP_TSRAD, XP_TS, XP_SNOWHMASS,              &
          XP_RN_ISBA, XP_H_ISBA, XP_LEG_ISBA, XP_LEGI_ISBA, XP_LEV_ISBA,                  &
          XP_LETR_ISBA, XP_USTAR_ISBA, XP_LER_ISBA, XP_LE_ISBA, XP_LEI_ISBA,              &
          XP_GFLUX_ISBA, XP_MELTADV,                                                      &
          XP_DG, XP_ROOTFRAC,                                                             &
          XP_TG, XP_WG, XP_WGI,                                                           &
          XP_CPS, XP_LVTT, XP_LSTT,                                                       &
          XP_WFC, XP_WWILT, XP_WSAT,                                                      &
          XP_BCOEF, XP_CONDSAT, XP_MPOTSAT,                                               &
          XP_HCAPSOIL, XP_CONDDRY, XP_CONDSLD, ZP_EMIS, XP_ALBT, XP_IACAN, XP_HV,         &
          XP_SNOWFREE_ALB_VEG, XP_SNOWFREE_ALB_SOIL, XP_PSNV_A, XP_QS,                    &
          XP_IRRIG, XP_WATSUP, XP_THRESHOLD, XP_LIRRIGATE, XP_LIRRIDAY, XCGMAX,           &
          CKSAT, CRAIN, CHORT, XP_MUF, XP_FSAT, XP_KSAT_ICE, XP_D_ICE, XP_HORT,           &
          XP_DRIP, XP_GPP, XP_FFLOOD, XP_PIFLOOD, XP_IFLOOD, XP_PFLOOD,                   &
          XP_LE_FLOOD, XP_LEI_FLOOD, XP_FFG, XP_FFV, XP_FF, XP_ALBF, XP_EMISF, ZP_FFGNOS, &
          ZP_FFVNOS, XP_FFROZEN, XP_RRVEG, XP_CONDSAT_EXP, XP_EXP_DIF, XP_ALPHA, XP_NVG,  &
          XP_MVG, XP_LVG, XP_WRES, ZP_AC_AGG, ZP_HU_AGG, XSODELX, XP_LAT, XP_LON          )  
!
ZP_TRAD=XP_TSRAD
!
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
IF (CPHOTO=='LAI' .OR. CPHOTO=='LST' .OR. CPHOTO=='NIT' .OR. CPHOTO=='NCB') THEN
  CALL VEGETATION_EVOL(ZP_RHOA, ZP_SUNTIME,PTSTEP, CRESPSL,                  &
                         XP_LAI,XP_VEG,XP_Z0,                                &
                         XP_ALBNIR,XP_ALBVIS,XP_ALBUV,XP_EMIS,               &
                         XP_H_TREE,XP_BSLAI,XP_LAIMIN,XP_SEFOLD,             &
                         CPHOTO, XP_ANFM, XP_ANDAY, XP_ANMAX,                &
                         CALBEDO, XP_ALBNIR_VEG, XP_ALBVIS_VEG, XP_ALBUV_VEG,&
                         XP_ALBNIR_SOIL, XP_ALBVIS_SOIL, XP_ALBUV_SOIL,      &
                         XP_AOSIP,XP_AOSIM,XP_AOSJP,XP_AOSJM,                &
                         XP_HO2IP,XP_HO2IM,XP_HO2JP,XP_HO2JM,                &
                         XP_Z0EFFIP,XP_Z0EFFIM,XP_Z0EFFJP,XP_Z0EFFJM,        &
                         XP_VEGTYPE_PATCH,                                   &
                         XP_CE_NITRO, XP_CF_NITRO, XP_CNA_NITRO,             &
                         XP_BSLAI_NITRO, XP_GMES, XP_LAT, XP_TG, PTIME,      &
                         XP_BIOMASS, XP_RESP_BIOMASS, ZP_RESP_BIOMASS_INST,  &
                         XP_INCREASE, XP_TURNOVER,                           &
                         XP_TAU_WOOD,TP_SEED,TP_REAP, LAGRIP, KMONTH, KDAY   )  
END IF
!
!
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
!Modify fluxes due to dry deposition, we introduce a negative flux where dust is lost
  CALL DST_DEP(ZP_SV(:,NSV_DSTBEG:NSV_DSTEND),&
             ZP_SFTS(:,NSV_DSTBEG:NSV_DSTEND),&
            ZP_USTAR, XP_RESA,ZP_TA,ZP_RHOA)  
...
IF(CSLTYN=='Y')THEN
  ...
  !Modify fluxes due to dry deposition, we introduce a negative flux where sea salt is lost
  CALL SLT_DEP(ZP_SV(:,NSV_SLTBEG:NSV_SLTEND),&
             ZP_SFTS(:,NSV_SLTBEG:NSV_SLTEND),&
             ZP_USTAR, XP_RESA,ZP_TA,ZP_RHOA)  
...
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
!
CALL DIAG_MISC_ISBA_n(XP_WG, XP_WGI, XP_WFC, XP_WWILT, XP_THRESHOLD,            &
                      XP_SNOWSWE, XP_SNOWRHO, LAGRIP,                           &
                      KMASK,KSIZE,JPATCH,                                       &
                      CPHOTO, ZP_RHOA, XP_PSN, XP_PSNG, XP_PSNV, XP_FF,         &
                      XP_FFG, XP_FFV, TSNOW%SCHEME, PTSTEP                      )  
!
