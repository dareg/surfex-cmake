...
!
USE MODD_FLAKE_n,      ONLY : LCOVER, XCOVER, XZS, &
                                XEMIS         , &
                                XWATER_DEPTH  , &
                                XWATER_FETCH  , &
                                XT_BS         , &
...
IF (ASSOCIATED(XALB_WATER    ))  DEALLOCATE(XALB_WATER    )
IF (ASSOCIATED(XALB_ICE      ))  DEALLOCATE(XALB_ICE      )
IF (ASSOCIATED(XALB_SNOW     ))  DEALLOCATE(XALB_SNOW     )
