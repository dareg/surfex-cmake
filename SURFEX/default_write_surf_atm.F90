!     #########
      SUBROUTINE DEFAULT_WRITE_SURF_ATM(ONOWRITE_COVERS, ONOWRITE_CANOPY, ONOWRITE_TEXFILE)
!     ########################################################################
!
...
!
!
LOGICAL,           INTENT(OUT) :: ONOWRITE_COVERS  ! flag to desactivate writing of covers fields
