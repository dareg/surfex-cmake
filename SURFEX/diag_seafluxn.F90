...
SUBROUTINE DIAG_SEAFLUX_n(HPROGRAM,                                           &
                            PRN, PH, PLE, PLEI, PGFLUX, PRI, PCD, PCH, PCE, PZ0,&
                            PZ0H, PT2M, PTS, PQ2M, PHU2M, PZON10M, PMER10M,     &
...
USE MODD_DIAG_SEAFLUX_n, ONLY : N2M, LSURF_BUDGET, LCOEF, LSURF_BUDGETC,            &
                                  XRN, XH, XLE, XLEI, XGFLUX, XRI, XT2M, XQ2M, XHU2M, &
                                  XZON10M, XMER10M, XCD, XCH, XCE, XZ0, XZ0H,         &
