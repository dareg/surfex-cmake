...
USE MODD_DIAG_SURF_ATM_n,ONLY : N2M, L2M_MIN_ZS, LSURF_BUDGET, LCOEF,          &
                                  ...
                                  XZ0_TILE, XZ0H_TILE, XT2M_MIN_TILE,            &
                                  XT2M_MAX_TILE,                                 &
...
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
!
CALL AVERAGE_DIAG(N2M, LSURF_BUDGET, LSURF_BUDGETC, LCOEF, ZFRAC_TILE, &
                    XRN_TILE, XH_TILE, XLE_TILE, XLEI_TILE , XGFLUX_TILE,&
                    XRI_TILE, XCD_TILE, XCH_TILE, XCE_TILE,              &
                    XT2M_TILE, XTS_TILE, XQ2M_TILE, XHU2M_TILE,          &
...
IMPLICIT NONE
!
INTEGER, DIMENSION(4), INTENT(OUT) :: KFACT
REAL(KIND=JPRB) :: ZHOOK_HANDLE
!
...
INTEGER, DIMENSION(4), INTENT(IN) :: KFACT
!
