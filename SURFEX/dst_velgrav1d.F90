!     #########
SUBROUTINE DST_VELGRAV1D(PSIG, PRG, PTA, PRHODREF, PRHOP, PMU, PVGK,PDPK, PVGG, PDPG)
!!   #######################################
!!
!!   PURPOSE
!!   -------
...
IF (LHOOK) CALL DR_HOOK('DST_VELGRAV1D',0,ZHOOK_HANDLE)
ZPI = 2.*ASIN(1.)
...
ENDDO
IF (LHOOK) CALL DR_HOOK('DST_VELGRAV1D',1,ZHOOK_HANDLE)
 

END SUBROUTINE DST_VELGRAV1D
