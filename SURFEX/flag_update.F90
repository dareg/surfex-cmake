!     #########
      SUBROUTINE FLAG_UPDATE(ONOWRITE_COVERS,ONOWRITE_CANOPY,OPGD,OPROVAR_TO_DIAG,OSELECT)
!     ############################################################
!
...
!
!
LOGICAL, INTENT(IN) :: ONOWRITE_COVERS ! flag to (des)activate writing of covers fields
...
LNOWRITE_COVERS = ONOWRITE_COVERS
