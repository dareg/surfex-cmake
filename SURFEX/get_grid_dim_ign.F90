...
!     ##############################################################
!
!!**** *GET_GRID_DIM_IGN* get the grid mesh dimensions
!!
!!    PURPOSE
!!    -------
!!
...
!----------------------------------------------------------------------------
!
IF (LHOOK) CALL DR_HOOK('GET_GRID_DIM_IGN',0,ZHOOK_HANDLE)
ORECT = .FALSE.
!
 CALL GET_GRIDTYPE_IGN(PGRID_PAR,KDIMX=KDIM1,KDIMY=KDIM2)
!
IF (LHOOK) CALL DR_HOOK('GET_GRID_DIM_IGN',1,ZHOOK_HANDLE)
!
!-------------------------------------------------------------------------------
!
