...
INTEGER,                          INTENT(IN) :: KSV      ! number of scalars
 ...
 CHARACTER(LEN=16), DIMENSION(:), POINTER :: HCH_NAMES
 CHARACTER(LEN=16), DIMENSION(:), POINTER :: HAER_NAMES     

 CHARACTER(LEN=16), DIMENSION(:), POINTER, OPTIONAL :: HDSTNAMES
 CHARACTER(LEN=16), DIMENSION(:), POINTER, OPTIONAL :: HSLTNAMES
!
