...
!
!
IF (PRESENT(PH_TREE)) PH_TREE = XDATA_H_TREE
!
...
!
IF (PRESENT(PROOTFRAC)) PROOTFRAC = XDATA_ROOTFRAC
!
!* soil ice for runoff
!
...
IF (PRESENT(PALBNIR_SOIL)) PALBNIR_SOIL(:,1) = XDATA_ALBNIR_SOIL
IF (PRESENT(PALBVIS_SOIL)) PALBVIS_SOIL(:,1) = XDATA_ALBVIS_SOIL
IF (PRESENT(PALBUV_SOIL)) PALBUV_SOIL(:,1) = XDATA_ALBUV_SOIL
