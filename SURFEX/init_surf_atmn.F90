...
USE MODD_DST_SURF,       ONLY : NDSTMDE, NDST_MDEBEG, LVARSIG, LRGFIX_DST
...
USE MODD_DATA_COVER,     ONLY : LCLIM_LAI, NYEAR, XDATA_LAI_ALL_YEARS, XDATA_LAI, &
...
IF (LNAM_READ) THEN
 ...
 CALL DEFAULT_DIAG_SURF_ATM(N2M,L2M_MIN_ZS,LSURF_BUDGET,LRAD_BUDGET, &
                              ...
                              LDIAG_GRID,LSURF_BUDGETC,LRESET_BUDGETC, &
                              LPROVAR_TO_DIAG, LSELECT       )                       
 !
ENDIF
!
...
!
IF (KSV /= 0) THEN
  CALL DST_INIT_NAMES(ILUOUT,HSV,NDSTEQ,NSV_DSTBEG,NSV_DSTEND,LVARSIG,LRGFIX_DST)
  CALL SLT_INIT_NAMES(ILUOUT,HSV,NSLTEQ,NSV_SLTBEG,NSV_SLTEND,LVARSIG_SLT,LRGFIX_SLT)        
END IF
!
...
!
!print*,'surf_atm ',CROUGH
IF (CROUGH=='BE04') CALL READ_SSO_CANOPY_n(HPROGRAM)
!
!
!*       2.7 Dummy fields
!
...
!
!*       2.8 Precip fields (for ARPEGE/ALADIN run)
!
CALL READ_PRECIP_n(HPROGRAM,HINIT)
!
!*       2.9 Allocations and Initialization of diagnostics
!
