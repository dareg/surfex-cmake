!     #########
      SUBROUTINE ISBA_PROPERTIES(HISBA, TPSNOW, KPATCH,                        &
...
REAL, DIMENSION(:)  , INTENT(IN)   :: PTG                ! ISBA prognostic surf.  temp
REAL, DIMENSION(:)  , INTENT(OUT):: PPSN
REAL, DIMENSION(:)  , INTENT(OUT):: PPSNG
REAL, DIMENSION(:)  , INTENT(OUT):: PPSNV
...
!
CALL ISBA_ALBEDO(TPSNOW%SCHEME,                                          &
                   PDIR_SW, PSCA_SW, PSW_BANDS, KSW,                       &
                   PALBNIR, PALBVIS, PALBUV,                                &
                   PALBNIR_VEG, PALBVIS_VEG, PALBUV_VEG,                    &
