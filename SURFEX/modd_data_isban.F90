...
!!      J. Masek       08/2023  Use of NVEGTYPE_MAX
!
!*       0.   DECLARATIONS
!             ------------
!
USE MODD_DATA_COVER_PAR, ONLY : NVEGTYPE_ECOSG, NVEGTYPE_OLD, NVEGTYPE_MAX
!
...
!
  ...
  !
  LOGICAL, DIMENSION(NVEGTYPE_MAX)   :: LDATA_DG
  LOGICAL, DIMENSION(NVEGTYPE_MAX)   :: LDATA_ROOTFRAC
  LOGICAL, DIMENSION(NVEGTYPE_MAX)   :: LDATA_H_TREE
  LOGICAL, DIMENSION(NVEGTYPE_MAX)   :: LDATA_DICE  
  LOGICAL, DIMENSION(NVEGTYPE_MAX)   :: LDATA_GROUND_DEPTH
  LOGICAL, DIMENSION(NVEGTYPE_MAX)   :: LDATA_ROOT_DEPTH
  LOGICAL, DIMENSION(NVEGTYPE_MAX)   :: LDATA_ROOT_EXTINCTION
  LOGICAL, DIMENSION(NVEGTYPE_MAX)   :: LDATA_ROOT_LIN
  LOGICAL, DIMENSION(NVEGTYPE_MAX)   :: LDATA_RSMIN
  LOGICAL, DIMENSION(NVEGTYPE_MAX)   :: LDATA_GAMMA
  LOGICAL, DIMENSION(NVEGTYPE_MAX)   :: LDATA_WRMAX_CF
  LOGICAL, DIMENSION(NVEGTYPE_MAX)   :: LDATA_CV
  LOGICAL, DIMENSION(NVEGTYPE_MAX)   :: LDATA_Z0_O_Z0H
  LOGICAL, DIMENSION(NVEGTYPE_MAX)   :: LDATA_RGL
  LOGICAL, DIMENSION(NVEGTYPE_MAX)   :: LDATA_BSLAI
  LOGICAL, DIMENSION(NVEGTYPE_MAX)   :: LDATA_LAIMIN
  LOGICAL, DIMENSION(NVEGTYPE_MAX)   :: LDATA_SEFOLD
  LOGICAL, DIMENSION(NVEGTYPE_MAX)   :: LDATA_GMES
  LOGICAL, DIMENSION(NVEGTYPE_MAX)   :: LDATA_RE25
  LOGICAL, DIMENSION(NVEGTYPE_MAX)   :: LDATA_STRESS
  LOGICAL, DIMENSION(NVEGTYPE_MAX)   :: LDATA_F2I
  LOGICAL, DIMENSION(NVEGTYPE_MAX)   :: LDATA_GC
  LOGICAL, DIMENSION(NVEGTYPE_MAX)   :: LDATA_DMAX
  LOGICAL, DIMENSION(NVEGTYPE_MAX)   :: LDATA_CE_NITRO
  LOGICAL, DIMENSION(NVEGTYPE_MAX)   :: LDATA_CF_NITRO
  LOGICAL, DIMENSION(NVEGTYPE_MAX)   :: LDATA_CNA_NITRO
  LOGICAL, DIMENSION(NVEGTYPE_MAX)   :: LDATA_SEED_M
  LOGICAL, DIMENSION(NVEGTYPE_MAX)   :: LDATA_SEED_D
  LOGICAL, DIMENSION(NVEGTYPE_MAX)   :: LDATA_REAP_M
  LOGICAL, DIMENSION(NVEGTYPE_MAX)   :: LDATA_REAP_D
!
