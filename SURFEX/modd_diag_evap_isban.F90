...
!
  ...
  REAL, POINTER, DIMENSION(:)   :: XAVG_LES      ! latent heat of evaporation over the snow     (W/m2)
...
!
  ...
  REAL, POINTER, DIMENSION(:,:) :: XLESC         ! latent heat of evaporation over the snow     (J/m2)
  ...
  REAL, POINTER, DIMENSION(:,:) :: XICEFLUXC
...
!
  ...
  REAL, POINTER, DIMENSION(:)   :: XAVG_LESC      ! latent heat of evaporation over the snow     (J/m2)
  ...
  REAL, POINTER, DIMENSION(:)   :: XAVG_ICEFLUXC  
