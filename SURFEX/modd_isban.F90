...
!                                          ! '3-L'
!                                          ! 'DIF'
  CHARACTER(LEN=2)               :: CDIF   ! NOTE: Only used when HISBA = DIF
!                                          ! 'BC' = Brook and Corey 1964 (default)
...
!
  ...
  REAL, POINTER, DIMENSION(:,:)    :: XORGMAT        ! % of soil organic matter                (%)
  REAL, POINTER, DIMENSION(:,:)    :: XDENSITY       ! soil density                            (kg/m3)
...
!
  REAL, POINTER, DIMENSION(:,:,:)  :: XCONDSAT_EXP   ! exponential hydraulic conductivity at saturation    (m/s)
  REAL, POINTER, DIMENSION(:,:,:)  :: XEXP_DIF       ! interfacial exponential profile coeff
  REAL, POINTER, DIMENSION(:,:)    :: XALPHA         ! Van Genuchten parameter
  REAL, POINTER, DIMENSION(:,:)    :: XNVG           ! Van Genuchten parameter
  REAL, POINTER, DIMENSION(:,:)    :: XMVG           ! Van Genuchten parameter
  REAL, POINTER, DIMENSION(:,:)    :: XLVG           ! Van Genuchten parameter
  REAL, POINTER, DIMENSION(:,:)    :: XWRES          ! Van Genuchten parameter  
!
!-------------------------------------------------------------------------------
!
...
!                                            
  ...
  REAL, POINTER, DIMENSION(:)    :: XFSAT ! Topmodel saturated fraction
!-------------------------------------------------------------------------------
!
...
CHARACTER(LEN=2), POINTER :: CDIF=>NULL()
!$OMP THREADPRIVATE(CDIF)
...
REAL, POINTER, DIMENSION(:,:)    :: XORGMAT=>NULL()
!$OMP THREADPRIVATE(XORGMAT)
REAL, POINTER, DIMENSION(:,:)    :: XDENSITY=>NULL()
!$OMP THREADPRIVATE(XDENSITY)
...
!Dif scheme
!
REAL, POINTER, DIMENSION(:,:,:)  :: XCONDSAT_EXP=>NULL()
!$OMP THREADPRIVATE(XCONDSAT_EXP)
REAL, POINTER, DIMENSION(:,:,:)  :: XEXP_DIF=>NULL()
!$OMP THREADPRIVATE(XEXP_DIF)
REAL, POINTER, DIMENSION(:,:)    :: XALPHA=>NULL()
!$OMP THREADPRIVATE(XALPHA)
REAL, POINTER, DIMENSION(:,:)    :: XNVG=>NULL()
!$OMP THREADPRIVATE(XNVG)
REAL, POINTER, DIMENSION(:,:)    :: XMVG=>NULL()
!$OMP THREADPRIVATE(XMVG)
REAL, POINTER, DIMENSION(:,:)    :: XLVG=>NULL()
!$OMP THREADPRIVATE(XLVG)
REAL, POINTER, DIMENSION(:,:)    :: XWRES=>NULL()
!$OMP THREADPRIVATE(XWRES)
!
!
!SGH scheme
!
...
ISBA_MODEL(KFROM)%XORGMAT=>XORGMAT
ISBA_MODEL(KFROM)%XDENSITY=>XDENSITY
...
!DIF scheme
!
ISBA_MODEL(KFROM)%XCONDSAT_EXP=>XCONDSAT_EXP
ISBA_MODEL(KFROM)%XEXP_DIF=>XEXP_DIF
ISBA_MODEL(KFROM)%XALPHA=>XALPHA
ISBA_MODEL(KFROM)%XNVG=>XNVG
ISBA_MODEL(KFROM)%XMVG=>XMVG
ISBA_MODEL(KFROM)%XLVG=>XLVG
ISBA_MODEL(KFROM)%XWRES=>XWRES
!
!SGH scheme
!
...
XORGMAT=>ISBA_MODEL(KTO)%XORGMAT
XDENSITY=>ISBA_MODEL(KTO)%XDENSITY
...
!DIF scheme
!
XCONDSAT_EXP=>ISBA_MODEL(KTO)%XCONDSAT_EXP
XEXP_DIF=>ISBA_MODEL(KTO)%XEXP_DIF
XALPHA=>ISBA_MODEL(KTO)%XALPHA
XNVG=>ISBA_MODEL(KTO)%XNVG
XMVG=>ISBA_MODEL(KTO)%XMVG
XLVG=>ISBA_MODEL(KTO)%XLVG
XWRES=>ISBA_MODEL(KTO)%XWRES
!
!SGH scheme
!
...
DO J=1,KMODEL
  ...
  NULLIFY(ISBA_MODEL(J)%XORGMAT)
  NULLIFY(ISBA_MODEL(J)%XDENSITY)
  ...
  NULLIFY(ISBA_MODEL(J)%XCONDSAT_EXP)
  NULLIFY(ISBA_MODEL(J)%XEXP_DIF)
  NULLIFY(ISBA_MODEL(J)%XALPHA)
  NULLIFY(ISBA_MODEL(J)%XNVG)
  NULLIFY(ISBA_MODEL(J)%XMVG)
  NULLIFY(ISBA_MODEL(J)%XLVG)
  NULLIFY(ISBA_MODEL(J)%XWRES)
