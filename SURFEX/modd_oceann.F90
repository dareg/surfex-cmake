...
REAL, POINTER, DIMENSION(:) ::   XHMOKMEL! mixing coef at the CMO base
!
END TYPE OCEAN_t
!
...
REAL, POINTER, DIMENSION(:)   :: XHMOKMEL=>NULL()
!$OMP THREADPRIVATE(XHMOKMEL)
...
OCEAN_MODEL(KFROM)%XHMOKMEL=>XHMOKMEL
ENDIF
!
...
XHMOKMEL=>OCEAN_MODEL(KTO)%XHMOKMEL
...
DO J=1,KMODEL
  ...
  NULLIFY(OCEAN_MODEL(J)%XHMOKMEL)
ENDDO
