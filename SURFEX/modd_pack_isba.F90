...
REAL, POINTER, DIMENSION(:,:)  :: XP_DG            ! soil layer thicknesses                  (m)
...
!
REAL, POINTER, DIMENSION(:,:)  :: XP_CONDSAT_EXP ! exponential hydraulic conductivity at saturation    (m/s)
!$OMP THREADPRIVATE(XP_CONDSAT_EXP)
REAL, POINTER, DIMENSION(:,:)  :: XP_EXP_DIF     ! exponential coef for interfacial hydraulic conductivity
!$OMP THREADPRIVATE(XP_EXP_DIF)
REAL, POINTER, DIMENSION(:,:)  :: XP_ALPHA       ! Van Genuchten parameters
!$OMP THREADPRIVATE(XP_ALPHA)
REAL, POINTER, DIMENSION(:,:)  :: XP_NVG         ! Van Genuchten parameters
!$OMP THREADPRIVATE(XP_NVG)
REAL, POINTER, DIMENSION(:,:)  :: XP_MVG         ! Van Genuchten parameters
!$OMP THREADPRIVATE(XP_MVG)
REAL, POINTER, DIMENSION(:,:)  :: XP_LVG         ! Van Genuchten parameters
!$OMP THREADPRIVATE(XP_LVG)
REAL, POINTER, DIMENSION(:,:)  :: XP_WRES        ! Van Genuchten parameters
!$OMP THREADPRIVATE(XP_WRES)
!
