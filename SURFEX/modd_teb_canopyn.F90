...
!
  ...
  REAL, POINTER, DIMENSION(:)   :: XQ0  ! Canyon temperature flux               (Km/s)  
!
...
REAL, POINTER, DIMENSION(:)   :: XQ0=>NULL()
!$OMP THREADPRIVATE(XQ0)
...
TEB_CANOPY_MODEL(KFROM)%XQ0=>XQ0
...
DO J=1,KMODEL
  ...
  NULLIFY(TEB_CANOPY_MODEL(J)%XQ0)  
