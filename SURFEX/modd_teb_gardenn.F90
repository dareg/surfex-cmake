...
!                                                      ! profile                                 (m3/m3)
  ...
  REAL, POINTER, DIMENSION(:,:,:)  :: XEXP_DIF       ! interfacial exponential ksat coefficient     
...
TEB_GARDEN_MODEL(KFROM)%XCONDSAT_EXP=>XCONDSAT_EXP
TEB_GARDEN_MODEL(KFROM)%XEXP_DIF=>XEXP_DIF
...
CDIF=>TEB_GARDEN_MODEL(KTO)%CDIF
...
XCONDSAT_EXP=>TEB_GARDEN_MODEL(KTO)%XCONDSAT_EXP
XEXP_DIF=>TEB_GARDEN_MODEL(KTO)%XEXP_DIF
...
DO J=1,KMODEL
  ...
  NULLIFY(TEB_GARDEN_MODEL(J)%XCONDSAT_EXP)
  NULLIFY(TEB_GARDEN_MODEL(J)%XEXP_DIF)  
...
TEB_GARDEN_MODEL(:)%XABC(1)=0.
TEB_GARDEN_MODEL(:)%XABC(2)=0.
TEB_GARDEN_MODEL(:)%XABC(3)=0.
TEB_GARDEN_MODEL(:)%XPOI(1)=0.
TEB_GARDEN_MODEL(:)%XPOI(2)=0.
TEB_GARDEN_MODEL(:)%XPOI(3)=0.
