...
NAMELIST/NAM_ISBAn/CC1DRY,CSCOND,CSOILFRZ,CDIFSFCOND,CSNOWRES,CCPSURF, &
                     XTSTEP,XCVHEATF,XCGMAX,XCSMAX,XCDRAG,LGLACIER,LCANOPY_DRAG,LVEGUPD, &
...
!
  ...
  XPERT_LOW = IO%XPERT_LOW
  XPERT_HIGH = IO%XPERT_HIGH
...
!
  ...
  IO%XPERT_LOW = XPERT_LOW
  IO%XPERT_HIGH = XPERT_HIGH
