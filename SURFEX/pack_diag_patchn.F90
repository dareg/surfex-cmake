!     #########
SUBROUTINE PACK_DIAG_PATCH_n(KMASK,KSIZE,KNPATCH,KPATCH,KSW)
!##############################################
!
...
!
!
USE MODD_ISBA_n,            ONLY : TSNOW, CPHOTO, NGROUND_LAYER, LGLACIER
...
USE MODD_PACK_DIAG_ISBA, ONLY :   XP_RNSNOW, XP_HSNOW, XP_HPSNOW, XP_SMELTFLUX, &
                                  ...
                                  NSIZE_KSW, NSIZE_3, NSIZE_0, NSIZE_00
...
IMPLICIT NONE
!
INTEGER, INTENT(IN)               :: KSIZE, KPATCH, KNPATCH, KSW
!
INTEGER, DIMENSION(:), INTENT(IN) :: KMASK
!
INTEGER :: ISIZE_SIMPLE, ISIZE_GROUND, ISIZE_SNOW, ISIZE_KSW, &
           ISIZE_3, ISIZE_0, ISIZE_00
INTEGER :: JJ, JI
...
ALLOCATE(XBLOCK_3(KSIZE,3,NSIZE_3))
