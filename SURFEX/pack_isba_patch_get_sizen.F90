...
!
USE MODD_ISBA_n,      ONLY : TSNOW, LGLACIER, CSCOND, CISBA, CDIF, CPHOTO, CRESPSL, CRUNOFF, CRAIN         
...
USE MODD_PACK_ISBA,  ONLY :    LBLOCK_SIMPLE, LBLOCK_0, TBLOCK_SIMPLE, TBLOCK_0, XBLOCK_SIMPLE,  &
                               ...
                               NSIZE_LSIMPLE, NSIZE_L0, NSIZE_TSIMPLE, NSIZE_T0, NSIZE_SIMPLE,   &
...
!
IF (CISBA=='DIF') THEN
  NSIZE_GROUND=NSIZE_GROUND+3
  IF (CDIF=='VG') THEN
    NSIZE_GROUND=NSIZE_GROUND+5
  ELSE
    NSIZE_01=NSIZE_01+5
  ENDIF
ELSE
