...
USE MODD_CH_EMIS_FIELD_n,    ONLY : JPEMISMAX, NEMIS_NBR, CEMIS_AREA, CEMIS_NAME, &
...
CHARACTER(LEN=40), DIMENSION(JPEMISMAX):: CEMIS_PGD_COMMENT
INTEGER,           DIMENSION(JPEMISMAX):: NEMIS_PGD_TIME
CHARACTER(LEN=3),  DIMENSION(JPEMISMAX):: CEMIS_PGD_AREA
CHARACTER(LEN=3),  DIMENSION(JPEMISMAX):: CEMIS_PGD_ATYPE
CHARACTER(LEN=28), DIMENSION(JPEMISMAX):: CEMIS_PGD_FILE
CHARACTER(LEN=6),  DIMENSION(JPEMISMAX):: CEMIS_PGD_FILETYPE
