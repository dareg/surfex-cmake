!     #########
SUBROUTINE PREP_FLAKE(HPROGRAM,HATMFILE,HATMFILETYPE)
!     #################################################################################
!
...
!
CALL PREP_HOR_FLAKE_FIELD(HPROGRAM,'ZS     ',HATMFILE,HATMFILETYPE)
!
!*      2.1    FLake variables
!
GNOVALUE = .FALSE.
...
IF (.NOT.LCLIM_LAKE) THEN
  !
  CALL PREP_HOR_FLAKE_FIELD(HPROGRAM,'TS     ',HATMFILE,HATMFILETYPE,GNOVALUE)
  IF (GNOVALUE) CALL ABOR1_SFX('PREP_FLAKE: AT LEAST TS SHOULD BE GIVEN!')
  !
  CALL PREP_HOR_FLAKE_FIELD(HPROGRAM,'T_SNOW ',HATMFILE,HATMFILETYPE,GNOVALUE)
  !
  IF (.NOT.GNOVALUE) CALL PREP_HOR_FLAKE_FIELD(HPROGRAM,'T_ICE  ',HATMFILE,HATMFILETYPE,GNOVALUE)
  !
  IF (.NOT.GNOVALUE) CALL PREP_HOR_FLAKE_FIELD(HPROGRAM,'T_WML  ',HATMFILE,HATMFILETYPE,GNOVALUE)
  !
  ALLOCATE(XT_MNW(SIZE(XLAT)))
  !
  IF (.NOT.GNOVALUE) CALL PREP_HOR_FLAKE_FIELD(HPROGRAM,'T_BOT  ',HATMFILE,HATMFILETYPE,GNOVALUE)
  !
  IF (.NOT.GNOVALUE) CALL PREP_HOR_FLAKE_FIELD(HPROGRAM,'T_B1   ',HATMFILE,HATMFILETYPE,GNOVALUE)
  !
  IF (.NOT.GNOVALUE) CALL PREP_HOR_FLAKE_FIELD(HPROGRAM,'CT     ',HATMFILE,HATMFILETYPE,GNOVALUE)
  !
  IF (.NOT.GNOVALUE) CALL PREP_HOR_FLAKE_FIELD(HPROGRAM,'H_SNOW ',HATMFILE,HATMFILETYPE,GNOVALUE)
  !
  IF (.NOT.GNOVALUE) CALL PREP_HOR_FLAKE_FIELD(HPROGRAM,'H_ICE  ',HATMFILE,HATMFILETYPE,GNOVALUE)
  !
  IF (.NOT.GNOVALUE) CALL PREP_HOR_FLAKE_FIELD(HPROGRAM,'H_ML   ',HATMFILE,HATMFILETYPE,GNOVALUE)
  !
  IF (.NOT.GNOVALUE) CALL PREP_HOR_FLAKE_FIELD(HPROGRAM,'H_B1   ',HATMFILE,HATMFILETYPE,GNOVALUE)
  !
ENDIF
!
