!     #########
SUBROUTINE PREP_FLAKE_EXTERN(HPROGRAM,HSURF,HFILE,HFILETYPE,KLUOUT,PFIELD)
!     #################################################################################
!
...
!
CALL READ_SURF(HFILETYPE,'WATER',YWATER,IRESP)
!-------------------------------------------------------------------------------------
!
!*      2.     Reading of grid
!              ---------------
...
!
CALL READ_SURF(HFILETYPE,'DIM_WATER',IDIM_WATER,IRESP)
