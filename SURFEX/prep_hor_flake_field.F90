!     #########
SUBROUTINE PREP_HOR_FLAKE_FIELD(HPROGRAM,HSURF,HATMFILE,HATMFILETYPE,ONOVALUE)
!     #################################################################################
!
...
!
CALL READ_PREP_FLAKE_CONF(HPROGRAM,HSURF,YFILE,YFILETYPE,HATMFILE,HATMFILETYPE,ILUOUT,GUNIF)
!
CMASK = 'WATER'
!
...
!
  ...
  ELSE IF (YFILETYPE=='MESONH' .OR. YFILETYPE=='ASCII ' .OR. YFILETYPE=='LFI   ') THEN
    CALL PREP_FLAKE_EXTERN(HPROGRAM,HSURF,YFILE,YFILETYPE,ILUOUT,ZFIELDIN)
