!     #########
SUBROUTINE PREP_HOR_SEAFLUX_FIELD(HPROGRAM,HSURF,HATMFILE,HATMFILETYPE)
!     #################################################################################
!
...
!
CALL READ_PREP_SEAFLUX_CONF(HPROGRAM,HSURF,YFILE,YFILETYPE,HATMFILE,HATMFILETYPE,ILUOUT,GUNIF)
!
CMASK = 'SEA'
!-------------------------------------------------------------------------------------
!
...
ELSE IF (YFILETYPE=='MESONH' .OR. YFILETYPE=='ASCII ' .OR. YFILETYPE=='LFI   ') THEN        
   CALL PREP_SEAFLUX_EXTERN(HPROGRAM,HSURF,YFILE,YFILETYPE,ILUOUT,ZFIELDIN)
