!     #########
SUBROUTINE PREP_HOR_WATFLUX_FIELD(HPROGRAM,HSURF,HATMFILE,HATMFILETYPE)
!     #################################################################################
!
...
!
CALL READ_PREP_WATFLUX_CONF(HPROGRAM,HSURF,YFILE,YFILETYPE,HATMFILE,HATMFILETYPE,ILUOUT,GUNIF)
!
CMASK = 'WATER'
!
!-------------------------------------------------------------------------------------
...
ELSE IF (YFILETYPE=='MESONH' .OR. YFILETYPE=='ASCII ' .OR. YFILETYPE=='LFI   ') THEN
   CALL PREP_WATFLUX_EXTERN(HPROGRAM,HSURF,YFILE,YFILETYPE,ILUOUT,ZFIELDIN)
