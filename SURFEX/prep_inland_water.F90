!     #########
SUBROUTINE PREP_INLAND_WATER(HPROGRAM,HATMFILE,HATMFILETYPE)
!     #################################################################################
!
...
IF (CWATER=='WATFLX') THEN
  CALL PREP_WATFLUX(HPROGRAM,HATMFILE,HATMFILETYPE)
ELSE IF (CWATER=='FLAKE ') THEN
  CALL PREP_FLAKE(HPROGRAM,HATMFILE,HATMFILETYPE)
END IF
