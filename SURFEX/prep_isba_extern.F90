!     #########
SUBROUTINE PREP_ISBA_EXTERN(HPROGRAM,HSURF,HFILE,HFILETYPE,KLUOUT,PFIELD)
!     #################################################################################
!
...
!
  CASE('ZS     ')
    ...
    YRECFM='ZS'
    CALL READ_SURF(HFILETYPE,YRECFM,PFIELD(:,1,1),IRESP,HDIR='A')
!
!--------------------------------------------------------------------------
!
!
...
!* reading of the profile and its depth definition
     CALL READ_EXTERN_ISBA(HFILETYPE,KLUOUT,INI,HSURF,ZFIELD,ZD)
! 
