!     #########
SUBROUTINE PREP_SEAFLUX(HPROGRAM,HATMFILE,HATMFILETYPE)
!     #################################################################################
!
...
!
CALL PREP_HOR_SEAFLUX_FIELD(HPROGRAM,'ZS     ',HATMFILE,HATMFILETYPE)
!
!*      2.1    Temperature
!
CALL PREP_HOR_SEAFLUX_FIELD(HPROGRAM,'SST    ',HATMFILE,HATMFILETYPE)
!
!
!*      2.2    Roughness
!
