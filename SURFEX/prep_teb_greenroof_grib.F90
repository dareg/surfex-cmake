...
!     #################################################################################
!
!!****  *PREP_TEB_GREENROOF_GRIB* - initializes ISBA fields from operational GRIB
!!
!!    PURPOSE
!!    -------
!
...
!              ---------------
!
IF (LHOOK) CALL DR_HOOK('PREP_TEB_GREENROOF_GRIB',0,ZHOOK_HANDLE)
!
...
!
  ...
  CASE DEFAULT
     CALL ABOR1_SFX('PREP_TEB_GREENROOF_GRIB: OPTION NOT SUPPORTED - '//HSURF)
