!     #########
SUBROUTINE PREP_WATFLUX(HPROGRAM,HATMFILE,HATMFILETYPE)
!     #################################################################################
!
...
!
CALL PREP_HOR_WATFLUX_FIELD(HPROGRAM,'ZS     ',HATMFILE,HATMFILETYPE)
!
!*      2.1    Temperature
!
CALL PREP_HOR_WATFLUX_FIELD(HPROGRAM,'TSWATER',HATMFILE,HATMFILETYPE)
!
!*      2.2    Roughness
!
