SUBROUTINE PUT_IN_TIME(NTIME1,NTIME2,PDATA)
...
ELSEIF (NTIME1==2) THEN !2 values: winter and summer
  IF (NTIME2.NE.36) CALL ABOR1_SFX("PUT_IN_TIME: WITH NTIME1=2, NTIME2 MUST BE =36 (WINTER AND SUMMER VALUES)")
  ZDATA=PDATA(:,1:2,:)
  DO JJ=1,8
...
ELSE
  I1=NTIME2/NTIME1
  I2=NTIME2/I1  
  IF (I2.NE.NTIME1) CALL ABOR1_SFX("PUT_INT_TIME: NTIME2 MUST BE A MULTIPLE OF NTIME1")
