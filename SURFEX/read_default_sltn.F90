!     #########
      SUBROUTINE READ_DEFAULT_SLT_n(HPROGRAM)
!     #######################################################
!
...
!-------------------------------------------------------------------------------
!
IF (LHOOK) CALL DR_HOOK('READ_DEFAULT_SLT_N',0,ZHOOK_HANDLE)
CALL GET_LUOUT(HPROGRAM,ILUOUT)
!
CALL GET_DEFAULT_NAM_n(HPROGRAM,'READ ',ILUDES)
!
IF (ILUDES==0 .AND. LHOOK) CALL DR_HOOK('READ_DEFAULT_SLT_N',1,ZHOOK_HANDLE)
IF (ILUDES==0) RETURN
!
...
IF (LHOOK) CALL DR_HOOK('READ_DEFAULT_SLT_N',1,ZHOOK_HANDLE)
!
!-------------------------------------------------------------------------------
!
END SUBROUTINE READ_DEFAULT_SLT_n
