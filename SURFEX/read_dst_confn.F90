!     #########
      SUBROUTINE READ_DST_CONF_n(HPROGRAM)
!     #######################################################
!
...
!
IF (LHOOK) CALL DR_HOOK('READ_DST_CONF_N',0,ZHOOK_HANDLE)
...
IF (LHOOK) CALL DR_HOOK('READ_DST_CONF_N',1,ZHOOK_HANDLE)
!
!-------------------------------------------------------------------------------
!
END SUBROUTINE READ_DST_CONF_n
