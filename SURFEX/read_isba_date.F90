!     #########
      SUBROUTINE READ_ISBA_DATE(HPROGRAM,HINIT,KLUOUT,HATMFILE,HATMFILETYPE,&
...
!
IF (TPTIME%TDATE%YEAR==XUNDEF.OR.TPTIME%TDATE%MONTH==XUNDEF &
...
IF (TPTIME%TDATE%YEAR==XUNDEF.OR.TPTIME%TDATE%MONTH==XUNDEF &
      .OR.TPTIME%TDATE%DAY==XUNDEF.OR.TPTIME%TIME==XUNDEF) THEN  
  !
  CALL READ_PREP_ISBA_CONF(HPROGRAM,'DATE   ',YFILE,YFILETYPE,HATMFILE,HATMFILETYPE,KLUOUT,GUNIF)
  !
