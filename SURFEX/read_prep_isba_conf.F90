!     #########
      SUBROUTINE READ_PREP_ISBA_CONF(HPROGRAM,HVAR,HFILE,HFILETYPE,HATMFILE,HATMFILETYPE,KLUOUT,OUNIF)
!     #######################################################
!
...
!
USE MODN_PREP_ISBA
USE MODD_PREP_ISBA,  ONLY : CFILE_ISBA, CTYPE, CFILE_HUG, CTYPE_HUG,           &
