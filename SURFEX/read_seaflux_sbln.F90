...
USE MODD_SEAFLUX_SBL_n,   ONLY : NLVL, XZ, XU, XT, XQ, XTKE, XLMO, XDZ, XZF, XDZF, XP
!
USE MODI_READ_SURF
!
!
...
!
IF (.NOT. LSBL .AND. LHOOK) CALL DR_HOOK('READ_SEAFLUX_SBL_N',1,ZHOOK_HANDLE)
IF (.NOT. LSBL) RETURN
!
...
!
DO JLAYER=1,NLVL
  WRITE(YRECFM,'(A9,I2.2,A4)') 'SEA_SBL_Z',JLAYER,'    '
...
!
DO JLAYER=1,NLVL
  WRITE(YRECFM,'(A9,I2.2,A4)') 'SEA_SBL_U',JLAYER,'    '
...
!
DO JLAYER=1,NLVL
  WRITE(YRECFM,'(A9,I2.2,A4)') 'SEA_SBL_T',JLAYER,'    '
...
!
DO JLAYER=1,NLVL
  WRITE(YRECFM,'(A9,I2.2,A4)') 'SEA_SBL_Q',JLAYER,'    '
...
!
DO JLAYER=1,NLVL
  WRITE(YRECFM,'(A9,I2.2,A4)') 'SEA_SBL_E',JLAYER,'    '
...
!
DO JLAYER=1,NLVL
  WRITE(YRECFM,'(A9,I2.2,A4)') 'SEA_SBL_P',JLAYER,'    '
