...
!
USE MODD_SURFEX_MPI, ONLY : NRANK, NPIO, NCOMM, NPROC, XTIME_NPIO_READ, XTIME_COMM_READ, LSFX_MPI
!
#ifdef SFX_OL
...
IF (HPROGRAM=='AROME ') THEN
  CALL YRSURFEX_HOST%READ_SURFX0 (YREC,PFIELD,KRESP,YCOMMENT)
ENDIF
!
...
!
IF (HPROGRAM=='AROME ') THEN
  CALL YRSURFEX_HOST%READ_SURFX1 (YREC,IL,PFIELD,KRESP,YCOMMENT,YDIR)
ENDIF
!
IF (HPROGRAM=='OFFLIN') THEN
#ifdef SFX_OL
...
!
IF (HPROGRAM=='AROME ') THEN
  CALL YRSURFEX_HOST%READ_SURFX2 (YREC,IL1,IL2,PFIELD,KRESP,YCOMMENT,YDIR)
ENDIF
!
IF (HPROGRAM=='OFFLIN') THEN
#ifdef SFX_OL
...
!
IF (HPROGRAM=='AROME ') THEN
  CALL YRSURFEX_HOST%READ_SURFN0 (YREC,KFIELD,KRESP,YCOMMENT)
ENDIF
!
IF (HPROGRAM=='OFFLIN' .OR. HPROGRAM=='ASCII ' .OR. &
    HPROGRAM=='FA    ' .OR. HPROGRAM=='LFI   ' .OR. &
...
!
IF (HPROGRAM=='AROME ') THEN
  CALL YRSURFEX_HOST%READ_SURFN1 (YREC,IL,KFIELD,KRESP,YCOMMENT,YDIR)
ENDIF
!
IF (HPROGRAM=='OFFLIN') THEN
#ifdef SFX_OL
...
ELSE IF (HPROGRAM=='AROME ') THEN
  CALL YRSURFEX_HOST%READ_SURFC0 (YREC,YFIELD,KRESP,YCOMMENT)
  HFIELD = YFIELD
...
#endif
ELSE IF (HPROGRAM=='AROME ') THEN
  CALL YRSURFEX_HOST%READ_SURFL0 (YREC,OFIELD,KRESP,YCOMMENT)
ELSEIF (HPROGRAM=='OFFLIN' .OR. HPROGRAM=='ASCII ' .OR. &
    HPROGRAM=='FA    ' .OR. HPROGRAM=='LFI   ' .OR. &
    HPROGRAM=='NC    ' ) THEN 
  !  
...
#endif
ELSE IF (HPROGRAM=='AROME ') THEN
  CALL YRSURFEX_HOST%READ_SURFL1 (YREC,IL,OFIELD,KRESP,YCOMMENT,YDIR)
...
#endif
ELSE IF (HPROGRAM=='AROME ') THEN
  CALL YRSURFEX_HOST%READ_SURFT0 (YREC,IWORK(1),IWORK(2),IWORK(3),ZWORK,KRESP,YCOMMENT)
ELSEIF (HPROGRAM=='OFFLIN' .OR. HPROGRAM=='ASCII ' .OR. &
    HPROGRAM=='FA    ' .OR. HPROGRAM=='LFI   ' .OR. &
    HPROGRAM=='NC    ' ) THEN 
  !  
...
#endif
ELSE IF (HPROGRAM=='AROME ') THEN
  CALL YRSURFEX_HOST%READ_SURFT1 (YREC,IL1,IWORK2(:,1),IWORK2(:,2),IWORK2(:,3),ZWORK2,KRESP,YCOMMENT)
ELSEIF (HPROGRAM=='OFFLIN' .OR. HPROGRAM=='ASCII ' .OR. &
    HPROGRAM=='FA    ' .OR. HPROGRAM=='LFI   ' .OR. &
    HPROGRAM=='NC    ') THEN 
  !
  IF (NRANK==NPIO) THEN
    ...
    ELSE IF (HPROGRAM=='FA    ') THEN
#ifdef SFX_FA
      CALL READ_SURFT_FA(YREC,IWORK2(:,1),IWORK2(:,2),IWORK2(:,3),ZWORK2,KRESP,YCOMMENT)
#endif
    ELSE IF (HPROGRAM=='ASCII ') THEN
#ifdef SFX_ASC
      CALL READ_SURFT_ASC(&
