...
!
!
SUBROUTINE SNOW3LALB_OLD(PALBEDOSC,PTSTEP,PSNOWLIQ,PSNOWDZ,     &
...
! --------------------------------------------
!
ZPCPALB(:) = (PSR(:)*PTSTEP/XWNEW)*(ZANSMAX(:) - ZANSMIN(:))
!
