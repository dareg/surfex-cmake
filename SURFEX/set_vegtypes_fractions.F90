...
ENDIF
!
IF (CFTYP_VEGTYPE.EQ.'FA    ' .OR. CFTYP_VEGTYPE.EQ.'ASCII ' .OR. CFTYP_VEGTYPE.EQ.'LFI   ' &
    .OR. CFTYP_VEGTYPE.EQ.'OFFLIN') THEN
  LDATA_VEGTYPE=.TRUE.
...
ENDIF
!
IF (LDATA_VEGTYPE) CALL EXTRAPOL_FIELDS(HPROGRAM,'NAT',ILUOUT)
!
