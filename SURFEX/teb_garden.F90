...
!     #########
    SUBROUTINE TEB_GARDEN (DTCO, G, TOP, T, BOP, B, TPN, TIR, DMT, AT, GDM, GRM, KTEB_P,              &
...
IF (TOP%LGARDEN) THEN
!
  CALL GARDEN(DTCO, G, T, TOP, TIR, AT, GDM%DTV, GDM%GB, GDDK, GDDEK, GDDMK,                &
...
IF (TOP%LGREENROOF) THEN
  !
  CALL GREENROOF(DTCO, G, T, TOP, TIR, AT, GRM%DTV, GRM%GB, GRDK, GRDEK,                 &
...
!
  CALL TEB  (TOP, T, BOP, B, TIR, DMT, HIMPLICIT_WIND,                             &
             ...
             PPEW_B_COEF_LOWCAN, AT, PPS, PPA, PEXNS, PEXNA, PTA, PQA, PRHOA, PLW_RAD, &
