...
USE MODD_PACK_ISBA, ONLY :   LBLOCK_SIMPLE, LBLOCK_0, TBLOCK_SIMPLE, TBLOCK_0, XBLOCK_SIMPLE,  &
                             ...
                             XP_WFC, XP_WWILT, XP_WSAT, XP_BCOEF, XP_WR, XP_TG, XP_WG, XP_WGI, &
                             XP_LAI, XP_RESA, XP_VEG, XP_TDEEP, XP_ROOTFRAC,                   &
                             ...
                             XP_CONDSAT_EXP, XP_EXP_DIF, XP_ALPHA, XP_NVG, XP_MVG, XP_LVG,     &
                             XP_WRES  
...
USE MODD_ISBA_n,   ONLY : TSNOW, XWR, XTG, XWG, XWGI, XRESA, XLAI, XAN, XANFM,        &
                            ...
                            XALBNIR_VEG, XALBVIS_VEG, XALBUV_VEG, LGLACIER,             &
                            ...
                            XBIOMASS, XRESP_BIOMASS, XINCREASE, XTURNOVER,              &
                            CRESPSL, XLITTER, XSOILCARB, XLIGNIN_STRUC,                 &
