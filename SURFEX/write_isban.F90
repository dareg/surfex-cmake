!     #########
      SUBROUTINE WRITE_ISBA_n(HPROGRAM,HWRITE)
!     ####################################
!
...
IF (HWRITE/='PGD') THEN
   ...
   CALL WRITESURF_ISBA_n(HPROGRAM)
   !
   IF ((.NOT.LNOWRITE_CANOPY).OR.LSELECT) CALL WRITESURF_ISBA_CANOPY_n(HPROGRAM)
   !
ENDIF
!
IF ((.NOT.LNOWRITE_COVERS).OR.LSELECT) CALL WRITESURF_PGD_ISBA_n(HPROGRAM,HWRITE)
!
!-------------------------------------------------------------------------------
!
!         End of IO
