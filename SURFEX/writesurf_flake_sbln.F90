!     #########
      SUBROUTINE WRITESURF_FLAKE_SBL_n(HPROGRAM)
!     ####################################
!
...
USE MODD_FLAKE_SBL_n,   ONLY : NLVL, XZ, XU, XT, XQ, XTKE, XLMO, XP
!
USE MODI_WRITE_SURF
!
!
...
!
IF (.NOT. LSBL .AND. LHOOK) CALL DR_HOOK('WRITESURF_FLAKE_SBL_N',1,ZHOOK_HANDLE)
IF (.NOT. LSBL) RETURN
!
!* number of levels
!
