!     #########
      SUBROUTINE WRITESURF_ISBA_n(HPROGRAM)
!     #####################################
!
...
!              ------------
!
USE MODD_ISBA_n, ONLY : NPATCH, NGROUND_LAYER, CPHOTO, CRESPSL,      &
...
!
INTEGER :: JLAYER, JNBIOMASS, JNLITTER, JNSOILCARB, JNLITTLEVS  ! loop counter on levels
...
!* snow mantel
!
CALL WRITESURF_GR_SNOW(HPROGRAM,'VEG',NPATCH,TSNOW)
!
!-------------------------------------------------------------------------------
!
