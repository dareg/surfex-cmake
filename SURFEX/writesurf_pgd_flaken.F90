!     #########
      SUBROUTINE WRITESURF_PGD_FLAKE_n(HPROGRAM,HWRITE)
!     ###################################################
!
...
!
! The following variables are not yet writen 
! XCOR XALB_WATER XALB_ICE XALB_SNOW XEXTCOEF_ICE XEXTCOEF_SNOW 
!-------------------------------------------------------------------------------
!
