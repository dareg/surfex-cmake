!     #########
      SUBROUTINE WRITESURF_TEB_CANOPY_n(HPROGRAM)
!     ####################################
!
...
USE MODD_TEB_CANOPY_n,   ONLY : NLVL, XZ, XU, XT, XQ, XTKE, XLMO, XLM, XLEPS, XP, XQ0
...
INTEGER :: JI, JJ  ! loop counter on grid point
...
!* Canyon heat flux
!
YCOMMENT='Canyon heat flux (mK/s)'
CALL WRITE_SURF(HPROGRAM,'TEB_CAN_Q0',XQ0(:),IRESP,HCOMMENT=YCOMMENT)
