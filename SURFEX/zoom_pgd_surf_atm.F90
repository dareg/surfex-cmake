...
CALL READ_SURF(HFILETYPE,'SEA',   CSEA,   IRESP)
CALL READ_SURF(HFILETYPE,'NATURE',CNATURE,IRESP)
CALL READ_SURF(HFILETYPE,'WATER', CWATER, IRESP)
CALL READ_SURF(HFILETYPE,'TOWN',  CTOWN,  IRESP)
CALL READ_SURF(HFILETYPE,'GARDEN',LGARDEN,IRESP)
