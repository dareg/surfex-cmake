...
!       
      YVNAME = 'WTDRIV'
      ZWRITE = TPDG%TDIAG%XWTDRIV / PTSTEP_DIAG
      CALL WRITE_TRIP(KLISTING,YFILE,YVNAME,LMASK_GW,ZWRITE,ITNUM,ITVAL)    
      CALL CUM_DIAG(TPDG%TDIAG%XWTDRIV,TPDG%TDIAG_RUN%XWTDRIV)
!       
      YVNAME = 'WTDELEV'
      ZWRITE = TPDG%TDIAG%XWTDELEV / PTSTEP_DIAG
      CALL WRITE_TRIP(KLISTING,YFILE,YVNAME,LMASK_GW,ZWRITE,ITNUM,ITVAL)    
      CALL CUM_DIAG(TPDG%TDIAG%XWTDELEV,TPDG%TDIAG_RUN%XWTDELEV)
!      
      YVNAME = 'QGCELL'
...
!
    YVNAME = 'FSOURCE'
    ZWRITE = TPDG%TDIAG%XSOURCE / PTSTEP_DIAG
    CALL WRITE_TRIP(KLISTING,YFILE,YVNAME,LMASK,ZWRITE,ITNUM,ITVAL) 
