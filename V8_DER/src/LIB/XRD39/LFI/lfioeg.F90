...
IF (LHOOK) CALL DR_HOOK('LFIOEG_MT',0,ZHOOK_HANDLE)
CLACTI=''
...
ENDIF
!
IF (LHOOK) CALL DR_HOOK('LFIOEG_MT',1,ZHOOK_HANDLE)
END SUBROUTINE



! Oct-2012 P. Marguinaud 64b LFI
SUBROUTINE LFIOEG_BB          &
&           (KNIVAU)
