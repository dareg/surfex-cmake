...
IF (LHOOK) CALL DR_HOOK('LFIOSG_MT',0,ZHOOK_HANDLE)
CLACTI=''
...
ENDIF
!
IF (LHOOK) CALL DR_HOOK('LFIOSG_MT',1,ZHOOK_HANDLE)
END SUBROUTINE



! Oct-2012 P. Marguinaud 64b LFI
SUBROUTINE LFIOSG_BB          &
&           (KNIVAU)
