...
SUBROUTINE ELLIPS64 (KSMAX,KMSMAX,KNTMP,KMTMP)
...
!
!
INTEGER (KIND=JPLIKB) KSMAX, KMSMAX
INTEGER (KIND=JPLIKB) KNTMP(0:KMSMAX),KMTMP(0:KSMAX)
!
INTEGER (KIND=JPLIKB) JM, JN
!
...
!
!
INTEGER (KIND=JPLIKM) KSMAX, KMSMAX
INTEGER (KIND=JPLIKM) KNTMP(0:KMSMAX),KMTMP(0:KSMAX)
!
INTEGER (KIND=JPLIKM) JM, JN
!
REAL (KIND=JPDBLR) ZEPS, ZKN, ZKM, ZAUXIL
!
REAL(KIND=JPRB) :: ZHOOK_HANDLE
