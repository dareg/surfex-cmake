...
!
TYPE(LFICOM) :: LFI
INTEGER (KIND=JPDBLE) IDESCR (LFI%JPLARX)
...
IF (LHOOK) CALL DR_HOOK('LFIMOE_MT64',0,ZHOOK_HANDLE)
CLACTI=''
IRETOU=0
!
...
ENDIF
!
IF (LHOOK) CALL DR_HOOK('LFIMOE_MT64',1,ZHOOK_HANDLE)
