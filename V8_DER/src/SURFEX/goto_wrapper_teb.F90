...
USE MODD_DIAG_MISC_TEB_OPTION_n
...
USE MODD_TEB_GRID_n
USE MODD_TEB_n
USE MODD_TEB_OPTION_n
USE MODD_TEB_VEG_n
USE MODD_BEM_n
USE MODD_BEM_OPTION_n
USE MODD_DATA_BEM_n
USE MODD_DATA_TEB_n
...
!
 CALL DIAG_CUMUL_TEB_GOTO_MODEL(KFROM, KTO, LKFROM)
 CALL DIAG_MISC_TEB_GOTO_MODEL(KFROM, KTO, LKFROM)
 CALL TEB_GOTO_MODEL(KFROM, KTO, LKFROM)
 CALL BEM_GOTO_MODEL(KFROM, KTO, LKFROM)
 CALL TEB_GARDEN_PGD_EVOL_GOTO_MODEL(KFROM, KTO, LKFROM)
 CALL TEB_GREENROOF_PGD_EVOL_GOTO_MODEL(KFROM, KTO, LKFROM)
 CALL TEB_GARDEN_GOTO_MODEL(KFROM, KTO, LKFROM)
 CALL TEB_GREENROOF_GOTO_MODEL(KFROM, KTO, LKFROM)
!
...
!
 ...
 CALL DIAG_TEB_GREENROOF_GOTO_MODEL(KFROM, KTO, LKFROM)
 ...
 CALL TEB_IRRIG_GOTO_MODEL(KFROM, KTO, LKFROM)
 CALL TEB_PANEL_GOTO_MODEL(KFROM, KTO, LKFROM)
 ...
 CALL GR_BIOG_GREENROOF_GOTO_MODEL(KFROM, KTO, LKFROM)
!
