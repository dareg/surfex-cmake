...
!
SUBROUTINE INI_VAR_FROM_DATA_1D (BOP, BDD, CHE, CHI, CHS, CHN, CHU, CHT, CHW, DTS, DTT, &
...
!
!
      SUBROUTINE INI_VAR_FROM_DATA_2D (BOP, BDD, CHE, CHI, CHS, CHN, CHU, CHT, CHW, DTS, DTT, &
                                        DTZ, DGEI, DGF, DGI, DGMI, DGMTO, DGO, DGS, DGSI, DGU, DGT, &
                                        DGUT, DGW, F, FSB, GB, ICP, I, O, S, SSB, SV, &
                                        TCP, TGD, TGDO, TGR, TGRO, T, TOP, TVG, W, WSB, &
                                        DTCO, IOB, UG, U, USS, &
