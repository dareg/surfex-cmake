!#############################################################
SUBROUTINE INIT_TEB_GARDEN_PGD_n (CHI, CHT, DTCO, DTI, DTGD, DST, GBGD, IOB, I, SLT, U, TGDO, TGDPE, TGDP, TG, T, TOP, TVG, &
...
!
IF (OREAD_PGD) &
 CALL READ_PGD_TEB_GARDEN_n(CHT, DTCO, DTGD, GBGD, IOB, U, TGDO, TGDP, TG, TOP, &
...
IF (.NOT. TGDO%LPAR_GARDEN) THEN
  CALL CONVERT_PATCH_GARDEN(DTCO, DTI, I, TGDO, TGDPE, TGDP, TOP, TVG, &
                            KI,IDECADE)
ELSE
...
!
 CALL INIT_VEG_PGD_GARDEN_n(CHI, DTCO, DST, I, SLT, U, &
                            HPROGRAM, ILUOUT, KI, TGDO%NGROUND_LAYER, TOP%TTIME%TDATE%MONTH,    &
