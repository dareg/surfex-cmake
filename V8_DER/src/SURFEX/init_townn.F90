!     #############################################################
      SUBROUTINE INIT_TOWN_n (B, BOP, BDD, CHE, CHI, CHS, CHN, CHU, CHT, CHW, DTB, &
...
ELSE IF (U%CTOWN=='TEB   ') THEN
  CALL INIT_TEB_n(B, BOP, BDD, CHE, CHI, CHS, CHN, CHU, CHT, CHW, DTB, &
                                  DTCO, DTI, DTS, DTGD, DTGR, DTT, DTZ, DGCT, DGEI, DGF, DGI, &
                                  DGMI, DGMT, DGMTO, DGO, DGS, DGSI, DGU, DGT, DGUT, DGW, DST, &
                                  F, FSB, GBGD, GBGR, GB, IOB, ICP, I, O, S, SSB, &
                                  SLT, UG, U, SV, TCP, TGD, TGDO, TGDPE, TGDP, TGR, TGRO, &
                                  TGRPE, TGRP, TG, TIR, T, TOP, TPN, TVG, W, WSB, &
                  HPROGRAM,HINIT,                               &
