...
TYPE(BEM_OPTIONS_t), POINTER :: BEM_OPTIONS => NULL()
!$OMP THREADPRIVATE(BEM_OPTIONS)
...
BEM_OPTIONS => BEM_OPTIONS_MODEL(KTO)
...
BEM_OPTIONS => BEM_OPTIONS_MODEL(KMODEL)
...
IF (ASSOCIATED(BEM_OPTIONS)) NULLIFY(BEM_OPTIONS)
