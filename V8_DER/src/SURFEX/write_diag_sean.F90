!     #########
SUBROUTINE WRITE_DIAG_SEA_n (BOP, BDD, CHE, CHI, CHN, CHU, CHT, CHW, DTCO, DTS, DTT, &
...
IF (U%CSEA=='SEAFLX') THEN
  CALL WRITE_DIAG_SEAFLUX_n(BOP, BDD, CHE, CHI, CHN, CHU, CHT, CHW, DTCO, DTS, DTT, &
                                  DTZ, DGEI, DGF, DGI, DGMI, DGMTO, DGT, DGUT, DGW, F, FSB, &
                                  GB, IOB, ICP, I, O, SSB, UG, U, SV, TCP, TGD, &
                                  TGDO, TGR, TGRO, T, TOP, TVG, W, WSB, &
                            CHS, DGO, DGS, DGSI, DGU, S, &
                            HPROGRAM,HWRITE)
END IF
