...
#ifdef SFX_ARO
  CALL ARO_GET_SIZE_GLOBAL(SIZE(PFIELD_IN),ISIZE)
#else
...
!      ENDIf
  ...
  ELSE
    IF ( PRESENT(PALT) ) THEN
      CALL OI_HOR_EXTRAPOL_SURF(ISIZE0,ZLAT0,ZLON0,ZFIELD0,ZLAT0,ZLON0,ZFIELD_EP,GINTERP,ZALT0)
    ELSE
      CALL OI_HOR_EXTRAPOL_SURF(ISIZE0,ZLAT0,ZLON0,ZFIELD0,ZLAT0,ZLON0,ZFIELD_EP,GINTERP)
    ENDIF
  ENDIF
...
CALL ASSIM_DIST_FIELD(HPROGRAM,ZFIELD,PFIELD_OUT)
