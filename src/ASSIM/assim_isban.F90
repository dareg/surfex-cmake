...
!-------------------------------------------------------------------------------------
!
LOGICAL, DIMENSION(KI) :: GINTERP_NATURE
LOGICAL, DIMENSION(KI) :: GINTERP_SN
REAL,    DIMENSION(KI) :: ZTS_EP,ZTS_EP0
REAL,    DIMENSION(KI) :: ZTP_EP,ZTP_EP0
REAL,    DIMENSION(KI) :: ZT3_EP,ZT3_EP0
REAL,    DIMENSION(KI) :: ZWS_EP,ZWS_EP0
REAL,    DIMENSION(KI) :: ZWP_EP,ZWP_EP0
REAL,    DIMENSION(KI) :: ZTL_EP,ZTL_EP0
REAL,    DIMENSION(KI) :: ZSWE_EP,ZSWE_EP0
REAL,    DIMENSION(KI) :: ZSNR_EP,ZSNR_EP0
REAL,    DIMENSION(KI) :: ZSNA_EP,ZSNA_EP0
