...
USE MODD_ASSIM, ONLY:  LASSIM,CASSIM,CASSIM_ISBA,NPRINTLEV,LAROME,LECSST,LAESST,LAESNM,LWATERTG2,&
                       ...
                       LPRT,LBEV,LBFIXED,NOBSTYPE,YERROBS,INCO,IVAR,NVAR,XVAR_M,         &
                       XSIGMA_M, TPRT_M, INCV, SCALE_Q,PTSTEP_OUTPUT,NBOUTPUT 
!
IMPLICIT NONE
!
...
NAMELIST/NAM_VAR/IVAR, NVAR, XVAR_M, XSIGMA_M, TPRT_M, INCV, SCALE_Q
!
