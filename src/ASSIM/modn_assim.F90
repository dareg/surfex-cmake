...
USE MODD_ASSIM, ONLY:  LASSIM,CASSIM,CASSIM_ISBA,NPRINTLEV,LAROME,LECSST,LAESST,LAESNM,LWATERTG2, &
                       ...
                       CBIO,LPRT,LBEV,LBFIXED,NOBSTYPE,COBS_M,XERROBS_M,NNCO,NIVAR,NVAR,CVAR_M,LSIM, &
                       ...
                       CASSIM_WATER,LEXTRAP_SNOW,LSWEPSINI, XSWEPSINI, LSWEPSMIN, XSWEPSMIN 
!
IMPLICIT NONE
!
NAMELIST/NAM_ASSIM/LASSIM,CASSIM,CASSIM_SEA,CASSIM_WATER,CASSIM_ISBA,CASSIM_TEB,NPRINTLEV,&
