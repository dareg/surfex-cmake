...
ALLOCATE(U%XSEA   (ISIZE))
ALLOCATE(U%XNATURE(ISIZE))
...
CALL GET_1D_MASK( U%NSIZE_SEA,    ISIZE, U%XSEA   , U%NR_SEA   )
CALL GET_1D_MASK( U%NSIZE_WATER,  ISIZE, U%XWATER , U%NR_WATER )
CALL GET_1D_MASK( U%NSIZE_TOWN,   ISIZE, U%XTOWN  , U%NR_TOWN  )
CALL GET_1D_MASK( U%NSIZE_NATURE, ISIZE, U%XNATURE, U%NR_NATURE)
...
IF (U%NSIZE_WATER>0 .AND. U%CWATER/='NONE') THEN
  CALL READ_SURF(IOB, &
               YPROGRAM,'TS_WATER',  PLST,  IRESP)
ENDIF

IF (U%NSIZE_TOWN>0 .AND. U%CTOWN/='NONE' .AND. LAROME) THEN
  CALL READ_SURF(IOB, &
               YPROGRAM,'VERSION',IVERSION,IRESP)
  CALL READ_SURF(IOB, &
               YPROGRAM,'BUG',IBUGFIX,IRESP)
...
PRINT *,'           '
PRINT *,'Mean T2m increments  ',SUM(ZT2INC)/U%NDIM_FULL
PRINT *,'Mean HU2m increments ',SUM(ZH2INC)/U%NDIM_FULL
PRINT *,'           '
...
PRINT *,'---------------------------------------------------------------'
PRINT *,'Mean WS increments over NATURE ',SUM(ZWSINC,U%XNATURE > 0.)/U%NDIM_NATURE
PRINT *,'Mean WP increments over NATURE ',SUM(ZWPINC,U%XNATURE > 0.)/U%NDIM_NATURE
PRINT *,'Mean TS increments over NATURE ',SUM(ZTSINC,U%XNATURE > 0.)/U%NDIM_NATURE
PRINT *,'Mean TP increments over NATURE ',SUM(ZTPINC,U%XNATURE > 0.)/U%NDIM_NATURE
PRINT *,'Mean TL increments over NATURE ',SUM(ZTLINC,U%XNATURE > 0.)/U%NDIM_NATURE
PRINT *,'Mean SN increments over NATURE ',SUM(ZSNINC,U%XNATURE > 0.)/U%NDIM_NATURE
PRINT *,'---------------------------------------------------------------'
PRINT *,'Mean WS increments over SEA    ',SUM(ZWSINC,U%XSEA > 0.)/U%NDIM_SEA
PRINT *,'Mean WP increments over SEA    ',SUM(ZWPINC,U%XSEA > 0.)/U%NDIM_SEA
PRINT *,'Mean TS increments over SEA    ',SUM(ZTSINC,U%XSEA > 0.)/U%NDIM_SEA
PRINT *,'Mean TP increments over SEA    ',SUM(ZTPINC,U%XSEA > 0.)/U%NDIM_SEA
PRINT *,'Mean TL increments over SEA    ',SUM(ZTLINC,U%XSEA > 0.)/U%NDIM_SEA
PRINT *,'Mean SN increments over SEA    ',SUM(ZSNINC,U%XSEA > 0.)/U%NDIM_SEA
PRINT *,'---------------------------------------------------------------'
...
IF (U%NSIZE_TOWN > 0 .AND. LAROME) THEN
