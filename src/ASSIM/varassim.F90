...
INTEGER :: ILEVEL, INFOMPI, INKPROMA, JBLOCK, ISIZE_FULL
...
!
 ALLOCATE(YSC%U%XSEA(YSC%U%NDIM_FULL))
 ALLOCATE(YSC%U%XNATURE(YSC%U%NDIM_FULL))
 ALLOCATE(YSC%U%XWATER(YSC%U%NDIM_FULL))
 ALLOCATE(YSC%U%XTOWN(YSC%U%NDIM_FULL))
!
 CALL CONVERT_COVER_FRAC(YSC%DTCO, &
                         YSC%U%XCOVER,YSC%U%LCOVER,YSC%U%XSEA,&
                         YSC%U%XNATURE,YSC%U%XTOWN,YSC%U%XWATER)
!
...
!
 ALLOCATE(ZSAND(YSC%U%NSIZE_NATURE))
 ALLOCATE(ZCLAY(YSC%U%NSIZE_NATURE))
!
...
!
 ...
 ENDDO
!
 ALLOCATE(XI(YSC%U%NSIZE_NATURE,PATCH_NUMBER,NVAR))
 ALLOCATE(VECT(YSC%U%NSIZE_NATURE,PATCH_NUMBER))
 ALLOCATE(LAI_PASS(YSC%U%NSIZE_NATURE,PATCH_NUMBER))
 ALLOCATE(ZBIO_PASS(YSC%U%NSIZE_NATURE,PATCH_NUMBER))
 ALLOCATE(ZBIO_OUT(YSC%U%NSIZE_NATURE,PATCH_NUMBER))
!
...
!
ALLOCATE(XPATCH(YSC%U%NSIZE_NATURE,PATCH_NUMBER))
ALLOCATE(LPATCH(YSC%U%NSIZE_NATURE,PATCH_NUMBER))
!
...
!
   ...
   ENDDO
!
 ALLOCATE(COFSWI(YSC%U%NSIZE_NATURE))
 ALLOCATE(WILT(YSC%U%NSIZE_NATURE))
 ALLOCATE(SMSAT(YSC%U%NSIZE_NATURE)) 
 ALLOCATE(B(YSC%U%NSIZE_NATURE,PATCH_NUMBER*NVAR,PATCH_NUMBER*NVAR))
!
 DO JI=1,YSC%U%NSIZE_NATURE
...
CALL INIT_IO_SURF_n(YSC%DTCO, YSC%U, &
                        YPROGRAM,'NATURE','ISBA  ','READ ')     
!
   ALLOCATE(SIMOBS(YSC%U%NSIZE_NATURE,PATCH_NUMBER,NOBSTYPE))
   ALLOCATE(SIMMOD(YSC%U%NSIZE_NATURE,PATCH_NUMBER,NVAR))
!
   ...
   DO K = 1,NOBSTYPE
     ...
     IF( XOBS(K) == 'SWI2' ) THEN
       ...
       ALLOCATE(MWG2(YSC%U%NSIZE_NATURE,PATCH_NUMBER))
       ALLOCATE(XWG2(YSC%U%NSIZE_NATURE,PATCH_NUMBER))
...
!
   ...
   ALLOCATE(LTM( YSC%U%NSIZE_NATURE,PATCH_NUMBER*NVAR,PATCH_NUMBER*NVAR))
   ALLOCATE(ZEPS( YSC%U%NSIZE_NATURE,PATCH_NUMBER,NVAR))
   ALLOCATE(XF( YSC%U%NSIZE_NATURE,PATCH_NUMBER,NVAR+1,NVAR))
...
!
 ALLOCATE(YF( YSC%U%NSIZE_NATURE,NVAR+1,NOBS))
 ALLOCATE(YF_PATCH( YSC%U%NSIZE_NATURE,PATCH_NUMBER,NVAR+1,NOBS))
 ALLOCATE(ZEPS( YSC%U%NSIZE_NATURE,PATCH_NUMBER,NVAR))
 ALLOCATE(XF( YSC%U%NSIZE_NATURE,PATCH_NUMBER,NVAR+1,NVAR))
!
! Read fraction of each patch (=> LPGD=T in OPTIONS.nam)
...
!   Observations
!
 ALLOCATE(YO(YSC%U%NSIZE_NATURE,NOBS))
 ALLOCATE(YOWR(YSC%U%NDIM_FULL,NOBS))
!
!   Temporary vectors used by the EKF approach
!
 ALLOCATE(HO(YSC%U%NSIZE_NATURE,NOBS,PATCH_NUMBER*NVAR))
 ALLOCATE(HOWR(YSC%U%NSIZE_NATURE,NOBS,PATCH_NUMBER*NVAR))
 ALLOCATE(HOT(YSC%U%NSIZE_NATURE,PATCH_NUMBER*NVAR,NOBS))
 ALLOCATE(R(YSC%U%NSIZE_NATURE,NOBS,NOBS))
 ALLOCATE(IDENT(PATCH_NUMBER*NVAR,PATCH_NUMBER*NVAR))
 ALLOCATE(GAIN(YSC%U%NSIZE_NATURE,PATCH_NUMBER*NVAR,NOBS))
 ALLOCATE(ZB(YSC%U%NSIZE_NATURE,NOBS))
 ALLOCATE(ZX(YSC%U%NSIZE_NATURE,NOBS))
 ALLOCATE(ZP(YSC%U%NSIZE_NATURE,NOBS))
 ALLOCATE(XINCR(YSC%U%NSIZE_NATURE,PATCH_NUMBER*NVAR))
 ALLOCATE(K1(YSC%U%NSIZE_NATURE,NOBS,NOBS))
 ALLOCATE(KH(YSC%U%NSIZE_NATURE,PATCH_NUMBER*NVAR,PATCH_NUMBER*NVAR))
 ALLOCATE(KRK(YSC%U%NSIZE_NATURE,PATCH_NUMBER*NVAR,PATCH_NUMBER*NVAR))
 ALLOCATE(IdKH(YSC%U%NSIZE_NATURE,PATCH_NUMBER*NVAR,PATCH_NUMBER*NVAR))
 ALLOCATE(FROZ(YSC%U%NSIZE_NATURE,PATCH_NUMBER))
!
!   Initialisations
!
...
!
 ...
 WRITE (111,*) (R(JI,:,:), JI=1,YSC%U%NSIZE_NATURE)
 CLOSE(111)
 OPEN (unit=111,file='OBSout',status='unknown',IOSTAT=istat)
 WRITE (111,*) (YO(JI,:), JI=1,YSC%U%NSIZE_NATURE)
 CLOSE(111)
!--------------------------------------------------------------------
!
...
ALLOCATE(Q(YSC%U%NSIZE_NATURE,PATCH_NUMBER*NVAR,PATCH_NUMBER*NVAR))
   Q(:,:,:) = 0.0
   DO L=1,NVAR
     DO JI=1,YSC%U%NSIZE_NATURE
       DO J=1,PATCH_NUMBER
