...
!
 ...
 CALL READ_SURF(IOB, &
                YPROGRAM,'WATER ',U%CWATER ,IRESP)
 CALL READ_SURF(IOB, &
                YPROGRAM,'NATURE',U%CNATURE,IRESP)
 CALL READ_SURF(IOB, &
                YPROGRAM,'TOWN  ',U%CTOWN  ,IRESP)
...
!
 ...
 CALL READ_SURF(IOB, &
                YPROGRAM,'DIM_NATURE',U%NDIM_NATURE,IRESP)
 CALL READ_SURF(IOB, &
                YPROGRAM,'DIM_WATER ',U%NDIM_WATER, IRESP)
 CALL READ_SURF(IOB, &
                YPROGRAM,'DIM_TOWN  ',U%NDIM_TOWN,  IRESP)
