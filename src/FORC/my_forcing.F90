...
INTERFACE
!===================================================================================
        SUBROUTINE MY_FORC(HEXPER,KNI,KNPTS,PTSTEP_FORC,           &
...
!
        CASE ('MA01        ')
                CALL MY_FORC_MA01(HEXPER,KNI,KNPTS,PTSTEP_FORC,              &
                                  KYEAR,KMONTH,KDAY,PTIME,                   &
                                  PLON, PLAT, PZS, PZREF, PUREF,             &
                                  PTA, PQA, PPS, PWINDSPEED, PWINDDIR,       &
                                  PDIR_SW, PSCA_SW, PLW, PRAIN, PSNOW, PCO2  )
        CASE ('HAPEX       ')
                CALL MY_FORC_HAPEX(HEXPER,KNI,KNPTS,PTSTEP_FORC,             &
                                  KYEAR,KMONTH,KDAY,PTIME,                   &
                                  PLON, PLAT, PZS, PZREF, PUREF,             &
                                  PTA, PQA, PPS, PWINDSPEED, PWINDDIR,       &
                                  PDIR_SW, PSCA_SW, PLW, PRAIN, PSNOW, PCO2  )
        CASE ('PLM         ')
                CALL MY_FORC_PLM  (HEXPER,KNI,KNPTS,PTSTEP_FORC,             &
                                  KYEAR,KMONTH,KDAY,PTIME,                   &
                                  PLON, PLAT, PZS, PZREF, PUREF,             &
                                  PTA, PQA, PPS, PWINDSPEED, PWINDDIR,       &
                                  PDIR_SW, PSCA_SW, PLW, PRAIN, PSNOW, PCO2  )
        CASE ('ALQUEVA0206 ')
                CALL MY_FORC_ALQUEVA0206(HEXPER,KNI,KNPTS,PTSTEP_FORC,       &
                                  KYEAR,KMONTH,KDAY,PTIME,                   &
                                  PLON, PLAT, PZS, PZREF, PUREF,             &
                                  PTA, PQA, PPS, PWINDSPEED, PWINDDIR,       &
                                  PDIR_SW, PSCA_SW, PLW, PRAIN, PSNOW, PCO2  )
        CASE ('ALP_FOR_0203')
                CALL MY_FORC_ALP_FOR_0203(HEXPER,KNI,KNPTS,PTSTEP_FORC,      &
                                  KYEAR,KMONTH,KDAY,PTIME,                   &
                                  PLON, PLAT, PZS, PZREF, PUREF,             &
                                  PTA, PQA, PPS, PWINDSPEED, PWINDDIR,       &
                                  PDIR_SW, PSCA_SW, PLW, PRAIN, PSNOW, PCO2  )
        CASE ('ME93        ')
                CALL MY_FORC_ME93(HEXPER,KNI,KNPTS,PTSTEP_FORC,              &
                                  KYEAR,KMONTH,KDAY,PTIME,                   &
                                  PLON, PLAT, PZS, PZREF, PUREF,             &
                                  PTA, PQA, PPS, PWINDSPEED, PWINDDIR,       &
                                  PDIR_SW, PSCA_SW, PLW, PRAIN, PSNOW, PCO2  )
        CASE ('VL92        ')
                CALL MY_FORC_VL92(HEXPER,KNI,KNPTS,PTSTEP_FORC,              &
                                  KYEAR,KMONTH,KDAY,PTIME,                   &
                                  PLON, PLAT, PZS, PZREF, PUREF,             &
                                  PTA, PQA, PPS, PWINDSPEED, PWINDDIR,       &
                                  PDIR_SW, PSCA_SW, PLW, PRAIN, PSNOW, PCO2  )
        CASE ('cdp9697     ')
                CALL MY_FORC_CDP9697(HEXPER,KNI,KNPTS,PTSTEP_FORC,           &
                                  KYEAR,KMONTH,KDAY,PTIME,                   &
                                  PLON, PLAT, PZS, PZREF, PUREF,             &
                                  PTA, PQA, PPS, PWINDSPEED, PWINDDIR,       &
                                  PDIR_SW, PSCA_SW, PLW, PRAIN, PSNOW, PCO2  )
