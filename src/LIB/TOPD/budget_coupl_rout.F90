...
!     ##########################
      SUBROUTINE BUDGET_COUPL_ROUT (DGEI, DGEIC, DGIC, DGMI, &
                                   IO, IMX, IP, IR, U, KNI, KFORC_STEP)
!     ##########################
!
!!
!!    PURPOSE
...
INTEGER                       :: JMESH,JCAT
REAL, DIMENSION(SIZE(IR%XWG,1),3)  :: ZWG_3L,ZWGI_3L,ZDG_3L          
...
!
CALL UNPACK_SAME_RANK(U%NR_NATURE,DGEI%XDWR, ZB_DWR)
CALL UNPACK_SAME_RANK(U%NR_NATURE,DGIC%XEVAP, XB_EVAP)        
!
CALL UNPACK_SAME_RANK(U%NR_NATURE,DGEIC%XRUNOFF,XB_RUNOFF_ISBA)
CALL UNPACK_SAME_RANK(U%NR_NATURE,DGEIC%XHORT,XB_HORTON)
CALL UNPACK_SAME_RANK(U%NR_NATURE,DGEI%XWATBUD, ZB_WATBUD)
XB_RUNOFF_TOPD = XB_RUNOFF_ISBA
CALL UNPACK_SAME_RANK(U%NR_NATURE,DGEIC%XDRAIN, XB_DRAIN)
!
...
ENDWHERE
!
CALL UNPACK_SAME_RANK(U%NR_NATURE,IR%TSNOW%WSNOW(:,1,1),XB_SWE1)
CALL UNPACK_SAME_RANK(U%NR_NATURE,IR%TSNOW%WSNOW(:,2,1),XB_SWE2)
CALL UNPACK_SAME_RANK(U%NR_NATURE,IR%TSNOW%WSNOW(:,3,1),XB_SWE3)
