...
USE MODD_COUPLING_TOPD, ONLY : XRUNOFF_TOP, XRUN_TOROUT, XDR_TOROUT, XATOP
!
USE MODD_SURF_PAR
USE MODD_CSTS,            ONLY : XRHOLW
!
USE MODD_ISBA_n,          ONLY : XWG, XDG, XWR, CRUNOFF, XWGI, TSNOW, CISBA
USE MODD_DIAG_EVAP_ISBA_n,ONLY : XAVG_EVAPC, XAVG_LEGC, XAVG_RUNOFFC, XAVG_DRAINC,&
                                 XAVG_HORTC,XRAINFALL,XSNOWFALL,&
                                 XAVG_DWG,XAVG_DWGI,XAVG_DSWE,XAVG_DWR,XAVG_WATBUD
...
ENDIF
!
CALL UNPACK_SAME_RANK(NR_NATURE,XRAINFALL(:), XB_RAIN)
CALL UNPACK_SAME_RANK(NR_NATURE,XSNOWFALL(:), XB_SNOW)
!
CALL UNPACK_SAME_RANK(NR_NATURE,XAVG_DWR, ZB_DWR)
CALL UNPACK_SAME_RANK(NR_NATURE,XAVG_EVAPC, XB_EVAP)        
!
CALL UNPACK_SAME_RANK(NR_NATURE,XAVG_RUNOFFC,XB_RUNOFF_ISBA)
CALL UNPACK_SAME_RANK(NR_NATURE,XAVG_HORTC,XB_HORTON)
CALL UNPACK_SAME_RANK(NR_NATURE,XAVG_WATBUD, ZB_WATBUD)
XB_RUNOFF_TOPD = XB_RUNOFF_ISBA
CALL UNPACK_SAME_RANK(NR_NATURE,XAVG_DRAINC, XB_DRAIN)
!
CALL UNPACK_SAME_RANK(NR_NATURE,ZWG_3L(:,2)  ,XB_WG2)
CALL UNPACK_SAME_RANK(NR_NATURE,ZWG_3L(:,3)  ,XB_WG3)
...
ENDWHERE
!
CALL UNPACK_SAME_RANK(NR_NATURE,ZWGI_3L(:,2) ,XB_WGI2)
CALL UNPACK_SAME_RANK(NR_NATURE,ZWGI_3L(:,3) ,XB_WGI3)
