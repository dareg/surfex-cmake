...
!     ##########################
      SUBROUTINE BUDGET_COUPL_ROUT (DGEI, DGEIC, DGIC, DGMI, I, U, &
                                    KNI,KFORC_STEP)
!     ##########################
!
!!
...
ENDWHERE
!
CALL UNPACK_SAME_RANK(U%NR_NATURE,I%R%TSNOW%WSNOW(:,1,1),XB_SWE1)
CALL UNPACK_SAME_RANK(U%NR_NATURE,I%R%TSNOW%WSNOW(:,2,1),XB_SWE2)
CALL UNPACK_SAME_RANK(U%NR_NATURE,I%R%TSNOW%WSNOW(:,3,1),XB_SWE3)
