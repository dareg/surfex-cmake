...
XRUNOFF_TOP=XB_RUNOFF_ISBAM 
CALL UNPACK_SAME_RANK(NR_NATURE,XAVG_HORTC,XB_HORTONM)
CALL UNPACK_SAME_RANK(NR_NATURE,XAVG_DRAINC,XB_DRAINM)
CALL UNPACK_SAME_RANK(NR_NATURE,ZWG_3L(:,2),XB_WG2M)
CALL UNPACK_SAME_RANK(NR_NATURE,ZWG_3L(:,3),XB_WG3M)
CALL UNPACK_SAME_RANK(NR_NATURE,ZDG_3L(:,2),XB_DG2)
CALL UNPACK_SAME_RANK(NR_NATURE,ZDG_3L(:,3),XB_DG3)
!
...
ENDWHERE
!
CALL UNPACK_SAME_RANK(NR_NATURE,ZWGI_3L(:,2),XB_WGI2M)
CALL UNPACK_SAME_RANK(NR_NATURE,ZWGI_3L(:,3),XB_WGI3M)
