!     ##########################
      SUBROUTINE INIT_BUDGET_COUPL_ROUT (DGEIC, DGIC, DGMI, IG, I, U, &
                                         KNI)
!     ##########################
!
!!
...
!
!init var tot
CALL UNPACK_SAME_RANK(U%NR_NATURE,I%R%XWR(:,1),XB_WRM)
...
ENDWHERE
!
CALL UNPACK_SAME_RANK(U%NR_NATURE,I%R%TSNOW%WSNOW(:,1,1),XB_SWE1M)
CALL UNPACK_SAME_RANK(U%NR_NATURE,I%R%TSNOW%WSNOW(:,2,1),XB_SWE2M)
CALL UNPACK_SAME_RANK(U%NR_NATURE,I%R%TSNOW%WSNOW(:,3,1),XB_SWE3M)
