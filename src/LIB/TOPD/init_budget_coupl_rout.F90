!     ##########################
      SUBROUTINE INIT_BUDGET_COUPL_ROUT (DGEIC, DGIC, DGMI, PMESH_SIZE, IO, IP, IMX, IR, U, KNI)
!     ##########################
!
!!
!!    PURPOSE
...
!
!init var tot
CALL UNPACK_SAME_RANK(U%NR_NATURE,IR%XWR(:,1),XB_WRM)
CALL UNPACK_SAME_RANK(U%NR_NATURE,DGIC%XEVAP,XB_EVAPM)
CALL UNPACK_SAME_RANK(U%NR_NATURE,DGEIC%XRUNOFF,XB_RUNOFF_ISBAM)
CALL UNPACK_SAME_RANK(U%NR_NATURE,DGEIC%XHORT,XB_HORTONM)
CALL UNPACK_SAME_RANK(U%NR_NATURE,DGEIC%XDRAIN,XB_DRAINM)
...
ENDWHERE
!
CALL UNPACK_SAME_RANK(U%NR_NATURE,IR%TSNOW%WSNOW(:,1,1),XB_SWE1M)
CALL UNPACK_SAME_RANK(U%NR_NATURE,IR%TSNOW%WSNOW(:,2,1),XB_SWE2M)
CALL UNPACK_SAME_RANK(U%NR_NATURE,IR%TSNOW%WSNOW(:,3,1),XB_SWE3M)
