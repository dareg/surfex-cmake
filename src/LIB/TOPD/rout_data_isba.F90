!-----------------------------------------------------------------
!     #####################
      SUBROUTINE ROUT_DATA_ISBA (DGEIC, DGIC, DGMI, PMESH_SIZE, IO, IP, IMX, IR, &
                                 UG, U, HPROGRAM,KI,KSTEP)
!     #####################
!
!!****  *ROUT_DATA_ISBA*  
!!
...
ZDRAIN_ISBA   (:) = 0.
ZDRAIN_TOPD (:,:) = 0.
IF (KSTEP==1 .AND. LBUDGET_TOPD) CALL INIT_BUDGET_COUPL_ROUT(DGEIC, DGIC, DGMI, PMESH_SIZE, &
                                                             IO, IP, IMX, IR, U, KI)
!
