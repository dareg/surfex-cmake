...
SUBROUTINE TRIP_GRID_INIT(YTRIP_GRID)
TYPE(TRIP_GRID_t), INTENT(INOUT) :: YTRIP_GRID
REAL(KIND=JPRB) :: ZHOOK_HANDLE
IF (LHOOK) CALL DR_HOOK("MODD_TRIP_GRID:TRIP_GRID_INIT",0,ZHOOK_HANDLE)
...
IF (LHOOK) CALL DR_HOOK("MODD_TRIP_GRID:TRIP_GRID_INIT",1,ZHOOK_HANDLE)
END SUBROUTINE TRIP_GRID_INIT
