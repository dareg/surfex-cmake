...
!
!######################################################################
SUBROUTINE WRITE_TRIP_XY(KLISTING,HFILE,HVNAME,OMASK,PWRITE,KTNUM,KTVAL,ODOUBLE)
!######################################################################
!
!!    PURPOSE
!!    -------
...
!
!#######################################################################
SUBROUTINE WRITE_TRIP_XYZ(KLISTING,HFILE,HVNAME,OMASK,PWRITE,KTNUM,KTVAL,ODOUBLE)
!#######################################################################
!
!!    PURPOSE
!!    -------
...
DO JZ=1,IZLEN
   ...
   ENDWHERE
   IF(PRESENT(KTNUM).AND.PRESENT(KTVAL).AND.PRESENT(ODOUBLE))THEN
     CALL NCSTORE(KLISTING,INCID,YVNAME,ZWRITE,LNCPRINT,KTNUM,KTVAL,JZ,LZW,ODOUBLE=ODOUBLE)
   ELSEIF(PRESENT(KTNUM).AND.PRESENT(KTVAL))THEN
     CALL NCSTORE(KLISTING,INCID,YVNAME,ZWRITE,LNCPRINT,KTNUM,KTVAL,JZ,LZW)
   ELSEIF(PRESENT(ODOUBLE))THEN
     CALL NCSTORE(KLISTING,INCID,YVNAME,ZWRITE,LNCPRINT,KLEVEL=JZ,OVARZDIM=LZW,ODOUBLE=ODOUBLE)
   ELSE
     CALL NCSTORE(KLISTING,INCID,YVNAME,ZWRITE,LNCPRINT,KLEVEL=JZ,OVARZDIM=LZW)
   ENDIF
ENDDO
CALL NCCLOSE(KLISTING,LNCPRINT,YFILE,INCID)
!
