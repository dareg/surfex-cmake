...
!!    -------------
!!      Original    25/04/08
!!      B. Decharme 07/07/16 Compressed Netcdf4 files
!--------------------------------------------------------------------------------
!
!*       0.    DECLARATIONS
!              ------------
...
!
IMODE = OR(NF90_HDF5,NF90_CLASSIC_MODEL)
!
IC = NF90_CREATE(YWORK,IMODE,KNCID)
IF(IC/=NF90_NOERR)THEN
...
!Variable attributs
!
IC = NF90_DEF_VAR(KNCID,'longitude',NF90_FLOAT,ILONDIM,ILON_ID,SHUFFLE=.TRUE.,DEFLATE_LEVEL=6)
IC = NF90_DEF_VAR(KNCID,'latitude' ,NF90_FLOAT,ILATDIM,ILAT_ID,SHUFFLE=.TRUE.,DEFLATE_LEVEL=6)
YWORK = 'degrees_east'
     ...
     IF(OTIME)THEN
       IF(OVARZDIM(JVAR))THEN
         IF(LDOUBLE(JVAR))THEN
           IC = NF90_DEF_VAR(KNCID,YWORK,NF90_DOUBLE,(/ILONDIM,ILATDIM,ILEVDIM,ITIMEDIM/),VAR_ID,SHUFFLE=.TRUE.,DEFLATE_LEVEL=6)
         ELSE
           IC = NF90_DEF_VAR(KNCID,YWORK,NF90_FLOAT,(/ILONDIM,ILATDIM,ILEVDIM,ITIMEDIM/),VAR_ID,SHUFFLE=.TRUE.,DEFLATE_LEVEL=6)
         ENDIF
       ELSE
         IF(LDOUBLE(JVAR))THEN
           IC = NF90_DEF_VAR(KNCID,YWORK,NF90_DOUBLE,(/ILONDIM,ILATDIM,ITIMEDIM/),VAR_ID,SHUFFLE=.TRUE.,DEFLATE_LEVEL=6)
         ELSE
           IC = NF90_DEF_VAR(KNCID,YWORK,NF90_FLOAT,(/ILONDIM,ILATDIM,ITIMEDIM/),VAR_ID,SHUFFLE=.TRUE.,DEFLATE_LEVEL=6)
         ENDIF
       ENDIF
     ELSE
       IF(OVARZDIM(JVAR))THEN
         IF(LDOUBLE(JVAR))THEN
           IC = NF90_DEF_VAR(KNCID,YWORK,NF90_DOUBLE,(/ILONDIM,ILATDIM,ILEVDIM/),VAR_ID,SHUFFLE=.TRUE.,DEFLATE_LEVEL=6)
         ELSE
           IC = NF90_DEF_VAR(KNCID,YWORK,NF90_FLOAT,(/ILONDIM,ILATDIM,ILEVDIM/),VAR_ID,SHUFFLE=.TRUE.,DEFLATE_LEVEL=6)
         ENDIF
       ELSE
         IF(LDOUBLE(JVAR))THEN
           IC = NF90_DEF_VAR(KNCID,YWORK,NF90_DOUBLE,(/ILONDIM,ILATDIM/),VAR_ID,SHUFFLE=.TRUE.,DEFLATE_LEVEL=6)
         ELSE
           IC = NF90_DEF_VAR(KNCID,YWORK,NF90_FLOAT,(/ILONDIM,ILATDIM/),VAR_ID,SHUFFLE=.TRUE.,DEFLATE_LEVEL=6)
         ENDIF
       ENDIF
     ENDIF
   ELSE
