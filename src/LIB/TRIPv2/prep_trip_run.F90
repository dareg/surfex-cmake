...
!
  YVAR ='ELEV'  
  CALL READ_TRIP(NLISTING,YFILE_READ,YVAR,ZREAD)  
  TP%XELEV = ZREAD(ILON_DEB:ILON_END,ILAT_DEB:ILAT_END)
  CALL WRITE_TRIP(NLISTING,YFILE_PARAM,YVAR,TPG%GMASK_GW,TP%XELEV)  
!
  YVAR ='TOPO_RIV'  
  CALL READ_TRIP(NLISTING,YFILE_READ,YVAR,ZREAD)  
...
!
  YVAR ='TAUG'
  CALL READ_TRIP(NLISTING,YFILE_READ,YVAR,ZREAD)
  TP%XTAUG(:,:) = ZREAD(ILON_DEB:ILON_END,ILAT_DEB:ILAT_END)
  CALL WRITE_TRIP(NLISTING,YFILE_PARAM,YVAR,TPG%GMASK_GW,TP%XTAUG)
!
  YVAR ='HGROUND'   
  CALL READ_TRIP(NLISTING,YFILE_READ_INIT,YVAR,ZREAD)   
