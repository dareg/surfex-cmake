!#########
SUBROUTINE TRIP_RESTART(KLISTING,KYEAR,KMONTH,KDAY,PTIME,KLON,KLAT)
!############################################
!
!!****  *TRIP_RESTART*  
!!
...
!
YVNAME = 'SURF_STO'
CALL WRITE_TRIP(KLISTING,YFILE,YVNAME,LMASK,TTRIP%XSURF_STO,ODOUBLE=LDOUBLE)
!
IF(CGROUNDW=='CST')THEN
  YVNAME = 'GROUND_STO'
  CALL WRITE_TRIP(KLISTING,YFILE,YVNAME,LMASK_GW,TTRIP%XGROUND_STO,ODOUBLE=LDOUBLE)
  ELSEIF(CGROUNDW=='DIF')THEN
  YVNAME = 'HGROUND'   
  CALL WRITE_TRIP(KLISTING,YFILE,YVNAME,LMASK_GW,TTRIP%XHGROUND,ODOUBLE=LDOUBLE)
ENDIF
!
IF(LFLOOD)THEN
  YVNAME = 'FLOOD_STO'
  CALL WRITE_TRIP(KLISTING,YFILE,YVNAME,LMASK,TTRIP%XFLOOD_STO,ODOUBLE=LDOUBLE)           
  YVNAME = 'FFLOOD'
  CALL WRITE_TRIP(KLISTING,YFILE,YVNAME,LMASK,TTRIP%XFFLOOD,ODOUBLE=LDOUBLE)        
  YVNAME = 'HFLOOD'
  CALL WRITE_TRIP(KLISTING,YFILE,YVNAME,LMASK,TTRIP%XHFLOOD,ODOUBLE=LDOUBLE)        
ENDIF
!
