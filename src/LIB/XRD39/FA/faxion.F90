...
REAL (KIND=JPDBLR)     PCHAME     (KLCHAM)                    ! IN   
INTEGER (KIND=JPLIKB)  KPUISS                                 ! IN   
INTEGER (KIND=JPLIKB)  KDIMNC                                 ! IN   
REAL (KIND=JPDBLR)     PMIN                                   ! IN   
REAL (KIND=JPDBLR)     PMAX                                   ! IN   
INTEGER (KIND=JPLIKB)  KNBITS                                 ! IN   
LOGICAL                LDARPE                                 ! IN   
...
REAL (KIND=JPDBLR)     PCHAME     (KLCHAM)                    ! IN   
INTEGER (KIND=JPLIKM)  KPUISS                                 ! IN   
INTEGER (KIND=JPLIKM)  KDIMNC                                 ! IN   
REAL (KIND=JPDBLR)     PMIN                                   ! IN   
REAL (KIND=JPDBLR)     PMAX                                   ! IN   
INTEGER (KIND=JPLIKM)  KNBITS                                 ! IN   
LOGICAL                LDARPE                                 ! IN   
REAL (KIND=JPDBLR)     PECART                                 !   OUT
LOGICAL                LDMLAM                                 ! IN   
...
INTEGER (KIND=JPLIKM)  KXLOPA                                 ! IN   
! Local integers
INTEGER (KIND=JPLIKB)  IPUISS                                 ! IN   
INTEGER (KIND=JPLIKB)  IDIMNC                                 ! IN   
INTEGER (KIND=JPLIKB)  ILCHAM                                 ! IN   
INTEGER (KIND=JPLIKB)  INBITS                                 ! IN   
INTEGER (KIND=JPLIKB)  INOZPA     (FA%JPXIND)                 ! IN   
INTEGER (KIND=JPLIKB)  ISTROF                                 ! IN   
INTEGER (KIND=JPLIKB)  ITRONC                                 ! IN   
INTEGER (KIND=JPLIKB)  IXLOPA                                 ! IN   
! Convert arguments

IPUISS     = INT (    KPUISS, JPLIKB)
IDIMNC     = INT (    KDIMNC, JPLIKB)
ILCHAM     = INT (    KLCHAM, JPLIKB)
INBITS     = INT (    KNBITS, JPLIKB)
INOZPA     = INT (    KNOZPA, JPLIKB)
ISTROF     = INT (    KSTROF, JPLIKB)
