...
&                    LFI%NBWRIT(KRANG),IFACTM,IRETIN)
!
    IF (IRETIN.EQ.1) THEN
      GOTO 903
...
INTEGER (KIND=JPLIKM)  KRANG                                  ! IN   
INTEGER (KIND=JPLIKM)  KREC                                   ! IN   
INTEGER (KIND=JPDBLE)  KZONE      (LFI%JPLARX)                ! IN   
LOGICAL                LDADON                                 ! IN   
INTEGER (KIND=JPLIKM)  KRETIN                                 !   OUT
! Local integers
...
!INTF KRANG         IN                                                                 
!INTF KREC          IN                                                                 
!INTF KZONE         IN    DIMS=LFI%JPLARX                KIND=JPDBLE                   
!INTF LDADON        IN                                                                 
!INTF KRETIN          OUT                                                              
