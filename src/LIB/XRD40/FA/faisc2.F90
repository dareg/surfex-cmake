...
IF (FA%CADRE(KRANGC)%NSEC2LL(5).GT.180000)                &
&  FA%CADRE(KRANGC)%NSEC2LL(5)=FA%CADRE(KRANGC)%NSEC2LL(5)-360000
...
IF (FA%CADRE(KRANGC)%NSEC2LL(8).GT.180000)                &
&  FA%CADRE(KRANGC)%NSEC2LL(8)=FA%CADRE(KRANGC)%NSEC2LL(8)-360000
! Increment zonal (1/1000 degre)
...
IF (FA%CADRE(KRANGC)%NSEC2LA(5).GT.180000)               &
& FA%CADRE(KRANGC)%NSEC2LA(5)=FA%CADRE(KRANGC)%NSEC2LA(5)-360000
!
...
&                          KIND=JPLIKB)
IF (FA%CADRE(KRANGC)%NSEC2LA(7).GT.180000)               &
& FA%CADRE(KRANGC)%NSEC2LA(7)=FA%CADRE(KRANGC)%NSEC2LA(7)-360000
