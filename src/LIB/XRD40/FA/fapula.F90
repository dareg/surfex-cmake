...
INTEGER (KIND=JPLIKB) IKMAX, IDEB, IFIN, JN, JM, JK, IK, IN
...
REAL (KIND=JPDBLR)     PSPEC      (*)                         ! IN   
INTEGER (KIND=JPLIKB)  KPULAP                                 !   OUT
...
REAL (KIND=JPDBLR)     PSPEC      (*)                         ! IN   
INTEGER (KIND=JPLIKM)  KPULAP                                 !   OUT
...
INTEGER (KIND=JPLIKB)  IPULAP                                 !   OUT
! Convert arguments
