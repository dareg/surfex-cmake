     ...
     &                   KROUND,KCPACK,KSCALP,KERR,PMIN,PMAX,LDARPE)
      ...
      USE LFI_PRECISION, ONLY : JPDBLR, JPDBLE
!
!
!********************************************************************
!*
...
!
      IMPLICIT NONE
!
      INTEGER(KIND=JPIM) :: KLENF
      INTEGER(KIND=JPIM) :: KBITS
      INTEGER(KIND=JPIM) :: KNBIT
      INTEGER(KIND=JPIM) :: KLENG
      INTEGER(KIND=JPIM) :: KWORD
      INTEGER(KIND=JPIM) :: KROUND
      INTEGER(KIND=JPIM) :: KCPACK
      INTEGER(KIND=JPIM) :: KSCALP
      INTEGER(KIND=JPIM) :: KERR
      INTEGER(KIND=JPIM) :: KLENV
!
      REAL (KIND=JPDBLR) :: PFDATA(*)
      REAL (KIND=JPDBLR) :: PVERT(KLENV)
!
...
!
      ...
      INTEGER(KIND=JPIM) :: KB1PAR(19)
      INTEGER(KIND=JPIM) :: KB2PAR(17)
!
      INTEGER(KIND=JPIM) :: IMAX, ILENF, IMISS
      INTEGER(KIND=JPIM) :: J, IBYTE, INVAL, IOFF, ITEMP, IERR
      INTEGER(KIND=JPIM) :: IERY, IERD, IERM, IERH, IERN
      INTEGER(KIND=JPIM) :: I, IEXP, IMANT, IPW, IPB
      INTEGER(KIND=JPIM) :: IREP, IFLAG, ICPACK, ILEN
      INTEGER(KIND=JPIM) :: ISCALE, ISCALX, ISTPA, IRESTE
      INTEGER(KIND=JPIM) :: ISCALP, IAUXIL, ILENFM, ILBIN
      INTEGER(KIND=JPIM) :: IL, ILNIL, IBITS, INUMBI
      INTEGER (KIND=JPDBLE) :: IL8, ILEXP, ILMANT, ILFLAG, ILSCALX
      INTEGER (KIND=JPDBLE) :: ILAUXIL, ILLBIN, ILBITS, ILSTPA, ILSCALP
!
      INTEGER(KIND=JPIM) :: IBLOCK(24)
      INTEGER(KIND=JPIM) :: ILAT(2)
...
!
             DO 50 J=1,ILENF
!
                IF (PFDATA(J).NE.0.0_JPDBLR) THEN
                       KERR = -4
                       WRITE (*,9012)
...
!
        ZS = (PMAX-ZREFER)/REAL(2**(KBITS+1)-1,KIND=JPDBLR)
        ZAUXIL=1.0_JPDBLR
        ZAUXI2=2.0_JPDBLR
!
