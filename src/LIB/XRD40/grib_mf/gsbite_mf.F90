...
!
      ...
      INTEGER (KIND=JPDBLE) :: KMASK(*)
      INTEGER (KIND=JPDBLE) :: IS , ISHFT, ISH, IMASK
      INTEGER(KIND=JPIM) :: KSKST
      INTEGER(KIND=JPIM) :: KSIZE
      INTEGER(KIND=JPIM) :: KSKBTW
      INTEGER(KIND=JPIM) :: K
      INTEGER(KIND=JPIM) :: KBPW
      INTEGER(KIND=JPIM) :: IBDL
      INTEGER(KIND=JPIM) :: IBS,IENBS,IEND,ILCF,ILL,IOD,IOS
      INTEGER(KIND=JPIM) :: ISHF,ISKB,ISKW,ISKWS,ISTA,ISTD,ISTEP,ISTS
      INTEGER(KIND=JPIM) :: J,JBD,JI
