...
USE PARKIND1 , ONLY : JPRD, JPIM, JPIB, JPRB, JPRM
...
PUBLIC IGRIB_GET_VALUE, IGRIB_SET_VALUE, IGRIB_OPEN_FILE, IGRIB_CLOSE_FILE,&
 ...
 & IGRIB_READ_BYTES, IGRIB_WRITE_BYTES, IGRIB_IS_DEFINED
...
ELSEIF(IRET /= JPGRIB_SUCCESS) THEN
  WRITE(0,*) 'GRIB_GET_LONG',KHANDLE,' ',CDKEY,' FAILED',IRET
  CALL ERR_MSG(IRET)
#ifdef SFX_MPI
...
IF(PRESENT(KRET)) THEN
  KRET = IRET
ELSEIF(IRET /= JPGRIB_SUCCESS) THEN
  WRITE(0,*) 'GRIB_GET_INT',KHANDLE,' ',CDKEY,' FAILED',IRET
  CALL ERR_MSG(IRET)
#ifdef SFX_MPI
  CALL MPL_ABORT('GRIB_GET_VALUE FAILED')
#endif
...
IF(PRESENT(KRET)) THEN
  KRET = IRET
ELSEIF(IRET /= JPGRIB_SUCCESS) THEN
  WRITE(0,*) 'GRIB_GET_REAL4',KHANDLE,' ',CDKEY,' FAILED',IRET
  CALL ERR_MSG(IRET)
#ifdef SFX_MPI
  CALL MPL_ABORT('GRIB_GET_VALUE FAILED')
#endif
...
IF(PRESENT(KRET)) THEN
  KRET = IRET
ELSEIF(IRET /= JPGRIB_SUCCESS) THEN
  WRITE(0,*) 'GRIB_GET_REAL8',KHANDLE,' ',CDKEY,' FAILED',IRET
  CALL ERR_MSG(IRET)
#ifdef SFX_MPI
  CALL MPL_ABORT('GRIB_GET_VALUE FAILED')
#endif
...
IF(PRESENT(KRET)) THEN
  KRET = IRET
ELSEIF(IRET /= JPGRIB_SUCCESS) THEN
  WRITE(0,*) 'GRIB_GET_STRING',KHANDLE,' ',CDKEY,' FAILED',IRET
  CALL ERR_MSG(IRET)
#ifdef SFX_MPI
  CALL MPL_ABORT('GRIB_GET_VALUE FAILED')
#endif
...
IF(PRESENT(KRET)) THEN
  KRET = IRET
ELSEIF(IRET /= JPGRIB_SUCCESS) THEN
  WRITE(0,*) 'GRIB_GET_REAL4_ARRAY',KHANDLE,' ',CDKEY,' FAILED',IRET
  CALL ERR_MSG(IRET)
#ifdef SFX_MPI
  CALL MPL_ABORT('GRIB_GET_VALUE FAILED')
#endif
...
IF(PRESENT(KRET)) THEN
  KRET = IRET
ELSEIF(IRET /= JPGRIB_SUCCESS) THEN
  WRITE(0,*) 'GRIB_GET_REAL8_ARRAY',KHANDLE,' ',CDKEY,' FAILED',IRET
  CALL ERR_MSG(IRET)
#ifdef SFX_MPI
  CALL MPL_ABORT('GRIB_GET_VALUE FAILED')
#endif
...
IF(PRESENT(KRET)) THEN
  KRET = IRET
ELSEIF(IRET /= JPGRIB_SUCCESS) THEN
  WRITE(0,*) 'GRIB_SET_LONG',KHANDLE,' ',CDKEY,' ',KVAL,' FAILED',IRET
  CALL ERR_MSG(IRET)
#ifdef SFX_MPI
...
IF(PRESENT(KRET)) THEN
  KRET = IRET
ELSEIF(IRET /= JPGRIB_SUCCESS) THEN
  WRITE(0,*) 'GRIB_SET_INT',KHANDLE,' ',CDKEY,' ',KVAL,' FAILED',IRET
  CALL ERR_MSG(IRET)
#ifdef SFX_MPI
  CALL MPL_ABORT('GRIB_SET_VALUE FAILED')
#endif
...
IF(PRESENT(KRET)) THEN
  KRET = IRET
ELSEIF(IRET /= JPGRIB_SUCCESS) THEN
  WRITE(0,*) 'GRIB_SET_REAL4',KHANDLE,' ',CDKEY,' ',PVAL,' FAILED',IRET
  CALL ERR_MSG(IRET)
#ifdef SFX_MPI
  CALL MPL_ABORT('GRIB_SET_VALUE FAILED')
#endif
...
IF(PRESENT(KRET)) THEN
  KRET = IRET
ELSEIF(IRET /= JPGRIB_SUCCESS) THEN
  WRITE(0,*) 'GRIB_SET_REAL8',KHANDLE,' ',CDKEY,' ',PVAL,' FAILED',IRET
  CALL ERR_MSG(IRET)
#ifdef SFX_MPI
  CALL MPL_ABORT('GRIB_SET_VALUE FAILED')
#endif
...
IF(PRESENT(KRET)) THEN
  KRET = IRET
ELSEIF(IRET /= JPGRIB_SUCCESS) THEN
  WRITE(0,*) 'GRIB_SET_STRING',KHANDLE,' ',CDKEY,' ',CDVAL,' FAILED',IRET
  CALL ERR_MSG(IRET)
#ifdef SFX_MPI
  CALL MPL_ABORT('GRIB_SET_VALUE FAILED')
#endif
...
IF(PRESENT(KRET)) THEN
  KRET = IRET
ELSEIF(IRET /= JPGRIB_SUCCESS) THEN
  WRITE(0,*) 'GRIB_SET_LONG_ARRAY',KHANDLE,' ',CDKEY,' FAILED',IRET
  CALL ERR_MSG(IRET)
#ifdef SFX_MPI
  CALL MPL_ABORT('GRIB_SET_VALUE FAILED')
#endif
...
IF(PRESENT(KRET)) THEN
  KRET = IRET
ELSEIF(IRET /= JPGRIB_SUCCESS) THEN
  WRITE(0,*) 'GRIB_SET_INT_ARRAY',KHANDLE,' ',CDKEY,' FAILED',IRET
  CALL ERR_MSG(IRET)
#ifdef SFX_MPI
  CALL MPL_ABORT('GRIB_SET_VALUE FAILED')
#endif
...
IF(PRESENT(KRET)) THEN
  KRET = IRET
ELSEIF(IRET /= JPGRIB_SUCCESS) THEN
  WRITE(0,*) 'GRIB_SET_REAL4_ARRAY',KHANDLE,' ',CDKEY,' FAILED',IRET
  CALL ERR_MSG(IRET)
#ifdef SFX_MPI
  CALL MPL_ABORT('GRIB_SET_VALUE FAILED')
#endif
...
IF(PRESENT(KRET)) THEN
  KRET = IRET
ELSEIF(IRET /= JPGRIB_SUCCESS) THEN
  WRITE(0,*) 'GRIB_SET_REAL8_ARRAY',KHANDLE,' ',CDKEY,' FAILED',IRET
  CALL ERR_MSG(IRET)
#ifdef SFX_MPI
  CALL MPL_ABORT('GRIB_SET_VALUE FAILED')
#endif
...
IF(IRET /= JPGRIB_SUCCESS) THEN
  WRITE(0,*) 'GRIB_OPEN_FILE ',TRIM(CDPATH),' FAILED',IRET
  CALL ERR_MSG(IRET)
#ifdef SFX_MPI
...
IF(IRET /= JPGRIB_SUCCESS) THEN
  WRITE(0,*) 'GRIB_CLOSE_FILE ',KFILE,' FAILED',IRET
  CALL ERR_MSG(IRET)
#ifdef SFX_MPI
...
ELSEIF(IRET /= JPGRIB_SUCCESS .AND. IRET /= JPGRIB_END_OF_FILE ) THEN
  WRITE(0,*) 'GRIB_READ_FROM_FILE ',KFILE,' FAILED',IRET
  CALL ERR_MSG(IRET)
#ifdef SFX_MPI
...
IF(IRET /= JPGRIB_SUCCESS .AND. IRET /= JPGRIB_END_OF_FILE ) THEN
  WRITE(0,*) 'GRIB_READ_BYTES_INT ',KFILE,' ',KBYTES,' FAILED',IRET
  CALL ERR_MSG(IRET)
#ifdef SFX_MPI
...
IF(IRET /= JPGRIB_SUCCESS .AND. IRET /= JPGRIB_END_OF_FILE ) THEN
  WRITE(0,*) 'GRIB_READ_BYTES_INT ',KFILE,' FAILED',IRET
  CALL ERR_MSG(IRET)
#ifdef SFX_MPI
...
CALL GRIB_READ_BYTES(KFILE,PBUF,KBYTES,IRET)
IF(IRET /= JPGRIB_SUCCESS .AND. IRET /= JPGRIB_END_OF_FILE ) THEN
  WRITE(0,*) 'GRIB_READ_BYTES_REAL8 ',KFILE,' FAILED',IRET
  CALL ERR_MSG(IRET)
#ifdef SFX_MPI
...
IF(IRET /= JPGRIB_SUCCESS .AND. IRET /= JPGRIB_END_OF_FILE ) THEN
  WRITE(0,*) 'GRIB_READ_BYTES_CHAR ',KFILE,' FAILED',IRET
  CALL ERR_MSG(IRET)
#ifdef SFX_MPI
...
IF(IRET /= JPGRIB_SUCCESS ) THEN
  WRITE(0,*) 'GRIB_WRITE_BYTES_INT ',KFILE,' ',KBYTES,' FAILED',IRET
  CALL ERR_MSG(IRET)
#ifdef SFX_MPI
...
IF(IRET /= JPGRIB_SUCCESS ) THEN
  WRITE(0,*) 'GRIB_WRITE_BYTES_INT ',KFILE,' FAILED',IRET
  CALL ERR_MSG(IRET)
#ifdef SFX_MPI
...
IF(IRET /= JPGRIB_SUCCESS) THEN
  WRITE(0,*) 'GRIB_WRITE_BYTES_CHAR ',KFILE,' FAILED',IRET
  CALL ERR_MSG(IRET)
#ifdef SFX_MPI
...
IF(PRESENT(KRET)) THEN
  KRET = IRET
ELSEIF(IRET /= JPGRIB_SUCCESS .AND. IRET /= JPGRIB_END_OF_FILE ) THEN
  WRITE(0,*) 'GRIB_NEW_FROM_FILE ',KFILE,' FAILED',IRET
  CALL ERR_MSG(IRET)
#ifdef SFX_MPI
...
IF(IRET /= JPGRIB_SUCCESS) THEN
  WRITE(0,*) 'CALL TO GRIB_NEW_FROM_MESSAGE FAILED',IRET
  CALL ERR_MSG(IRET)
#ifdef SFX_MPI
...
IF(IRET /= JPGRIB_SUCCESS) THEN
  WRITE(0,*) 'GRIB_RELEASE ',KHANDLE,' FAILED',IRET
  CALL ERR_MSG(IRET)
#ifdef SFX_MPI
...
KBYTES = IBYTES
IF(IRET /= JPGRIB_SUCCESS) THEN
  WRITE(0,*) 'GRIB_GET_MESSAGE_SIZE ',KHANDLE,' FAILED',IRET
  CALL ERR_MSG(IRET)
#ifdef SFX_MPI
  CALL MPL_ABORT(' GRIB_GET_MESSAGE_SIZE FAIL')
#endif
ENDIF
...
IF(IRET /= JPGRIB_SUCCESS) THEN
  WRITE(0,*) 'GRIB_COPY_MESSAGE ',KHANDLE,' FAILED',IRET
  CALL ERR_MSG(IRET)
#ifdef SFX_MPI
...
IF (PRESENT (KRET)) THEN
  KRET = IRET
ELSEIF(IRET /= JPGRIB_SUCCESS) THEN
  WRITE(0,*) 'GRIB_NEW_FROM_SAMPLES ',TRIM(CDNAME),' FAILED',IRET
  CALL ERR_MSG(IRET)
#ifdef SFX_MPI
...
IF(IRET /= JPGRIB_SUCCESS) THEN
  WRITE(0,*) 'GRIB_CLONE FAILED',IRET
  CALL ERR_MSG(IRET)
#ifdef SFX_MPI
...
WRITE(0,*) 'GRIB_API ERROR MSG: ',TRIM(CLERRMSG)
...
IF (PRESENT (KRET)) THEN
  KRET = IRET
ELSEIF (IRET /= JPGRIB_SUCCESS) THEN
  WRITE(0,*) 'GRIB_IS_DEFINED',KHANDLE,' ',CDKEY,' FAILED',IRET
  CALL ERR_MSG(IRET)
#ifdef SFX_MPI
  CALL MPL_ABORT('GRIB_IS_DEFINED FAILED')
#endif
