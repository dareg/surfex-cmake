...
!
 ...
 REAL, DIMENSION(:), INTENT(IN) :: PRRCL
 REAL, DIMENSION(:), INTENT(IN) :: PRRSL
 REAL, DIMENSION(:), INTENT(IN) :: PRRCN
 REAL, DIMENSION(:), INTENT(IN) :: PRRSN
 REAL, DIMENSION(:), INTENT(IN) :: PATMNEB
 REAL, DIMENSION(:), INTENT(IN) :: PITM
 REAL, DIMENSION(:), INTENT(IN) :: PEVAPTR
 REAL, DIMENSION(:), INTENT(IN) :: PEVAP
 REAL, DIMENSION(:), INTENT(IN) :: PSNC
 REAL, DIMENSION(:), INTENT(IN) :: PTSC
 REAL, DIMENSION(:), INTENT(IN) :: PTS_O
 REAL, DIMENSION(:), INTENT(IN) :: PT2M_O
 REAL, DIMENSION(:), INTENT(IN) :: PHU2M_O
 REAL, DIMENSION(:), INTENT(OUT):: PSWE
...
!
 ...
 REAL, DIMENSION (SIZE(PRRCL)) :: PWS, PWP, PTS, PTP, PTL, PLAI, PVEG, PRSMIN, PD2, PSAB, PARG,        &
 ...
 REAL,DIMENSION(SIZE(PRRCL))   :: PLON,  PLAT
 INTEGER              :: I,J
