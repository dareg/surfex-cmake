SUBROUTINE INIT_INDEX_MPI (YSC, &
                           HPROGRAM,HINIT,HALG,PIO_FRAC,OSHADOWS)
!
...
IF ( NRANK==NPIO ) THEN
  ...
  IF (HINIT=='PGD') THEN
    ...
    CALL INI_CSTS
    !
    CALL PGD_GRID (YSC%UG, YSC%U, HPROGRAM,'                            ','      ',&
                   .FALSE.,YSC%UG%G%CGRID,YSC%UG%NGRID_FULL_PAR,YSC%UG%XGRID_FULL_PAR,'A')
    !
  ELSE
    !
    ...
    !
    CALL READ_SURF(&
                   HPROGRAM,'GRID_TYPE',YSC%UG%G%CGRID,IRESP,HDIR='A')
    !
    CALL READ_GRIDTYPE(&
...
!
 ...
 CALL READ_SURF(&
                 HPROGRAM,'NATURE     ',YNATURE,IRESP, HDIR='-')
 CALL READ_SURF(&
                 HPROGRAM,'VERSION    ',IVERSION,IRESP, HDIR='-')
