...
USE MODD_SURF_ATM_n, ONLY : NDIM_FULL, LTOWN_TO_ROCK, LWATER_TO_NATURE, LGARDEN
!
...
IF ( NRANK==NPIO ) THEN
  ...
  NINDX2SFX = NDIM_FULL
  !
  CALL READ_ARRANGE_COVER(HPROGRAM,LWATER_TO_NATURE,LTOWN_TO_ROCK,'A')
  CALL READ_COVER_GARDEN(HPROGRAM,LGARDEN,'A')
  !
