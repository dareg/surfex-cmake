...
IF (N2M>0) THEN
  ...
  CALL DEF_VAR_NETCDF(IFILE_ID,'T2MMIN_WAT' ,'Minimum 2m_Temperature         '   ,IDDIM,YATT_TITLE,YATT)
  CALL DEF_VAR_NETCDF(IFILE_ID,'T2MMAX_WAT' ,'Maximum 2m_Temperature         '   ,IDDIM,YATT_TITLE,YATT)
  YATT='kg/kg'
  ...
  CALL DEF_VAR_NETCDF(IFILE_ID,'HU2MMIN_WAT','Minimum 2m_Relative_Humidity   '   ,IDDIM,YATT_TITLE,YATT)
  CALL DEF_VAR_NETCDF(IFILE_ID,'HU2MMAX_WAT','Maximum 2m_Relative_Humidity   '   ,IDDIM,YATT_TITLE,YATT)  
  YATT='m/s'
  ...
  CALL DEF_VAR_NETCDF(IFILE_ID,'W10M_WAT','10m_Wind Strength     '   ,IDDIM,YATT_TITLE,YATT)
  CALL DEF_VAR_NETCDF(IFILE_ID,'W10MMAX_WAT','Maximum 10m_Wind Strength     '   ,IDDIM,YATT_TITLE,YATT)  
ENDIF
!
IF (N2M>0) THEN
  YATT='-'
