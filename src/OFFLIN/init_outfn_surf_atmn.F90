...
!     #########
       SUBROUTINE INIT_OUTFN_SURF_ATM_n (DGO, UG, U, CHE, CHU, SV, HPROGRAM, KLUOUT)
!     ###############################
!
!
...
!
 CALL OL_DEFINE_DIM(UG, U%NSIZE_FULL, HPROGRAM, KLUOUT, INI, IDIM1, &
                    YUNIT1, YUNIT2, ZX, ZY, IDIMS, IDDIM, YNAME_DIM)
...
ENDDO
!
 CALL OL_WRITE_COORD(DGO%CSELECT,YFILE,IFILE_ID,IDDIM,YATT_TITLE,YNAME_DIM,YUNIT1,YUNIT2,IDIM1,YDATE,ZX,ZY)
!
!
