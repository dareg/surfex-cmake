SUBROUTINE INIT_SLOPE_PARAM(PZS,KI,PLON)
...
USE MODD_SURF_ATM_GRID_n, ONLY : CGRID, XGRID_PAR,XGRID_FULL_PAR,XMESH_SIZE
!
IMPLICIT NONE
!
#ifndef NOMPI
...
IF (NRANK==NPIO) THEN
  ...
  CALL GET_MESH_DIM(CGRID,SIZE(XGRID_FULL_PAR),NIX*NIY,XGRID_FULL_PAR,ZDX,ZDY,XMESH_SIZE)
...
! 2d grid should be decreasing in longitude
LREVERTGRID=(PLON(1)<PLON(1+NIX))
