...
!$OMP THREADPRIVATE(NNXLOC)
!$OMP THREADPRIVATE(NNYLOC)
!$OMP THREADPRIVATE(NIXLOC)
!$OMP THREADPRIVATE(NIYLOC)

INTEGER,SAVE::NINDX1_X,NINDX2_X,NINDX1_Y,NINDX2_Y
!$OMP THREADPRIVATE(NINDX1_X)
!$OMP THREADPRIVATE(NINDX1_Y)
!$OMP THREADPRIVATE(NINDX2_X)
!$OMP THREADPRIVATE(NINDX2_Y)
...
!$OMP THREADPRIVATE(XXHAT_THREAD)
!$OMP THREADPRIVATE(XYHAT_THREAD)
...
!$OMP THREADPRIVATE(XZS_THREAD)
!$OMP THREADPRIVATE(XZS_XY_THREAD)
REAL,DIMENSION(:,:,:),ALLOCATABLE::XSLOPANG_THREAD,XSLOPAZI_THREAD,XSURF_TRIANGLE_THREAD
!$OMP THREADPRIVATE(XSLOPANG_THREAD)
!$OMP THREADPRIVATE(XSLOPAZI_THREAD)
!$OMP THREADPRIVATE(XSURF_TRIANGLE_THREAD)
