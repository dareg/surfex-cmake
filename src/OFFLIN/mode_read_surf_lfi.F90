...
IF (HDIR=='H' .OR. HDIR=='A') THEN
  ...
  DEALLOCATE(ZWORK)
ELSE
  CALL FMREADX1(CFILE_LFI,YREC,CLUOUT_LFI,SIZE(PFIELD),PFIELD,IGRID,ILENCH,HCOMMENT,KRESP)
  CALL ERROR_READ_SURF_LFI(YREC,KRESP)
END IF
...
IF (HDIR=='H' .OR. HDIR=='A') THEN
  ...
  DEALLOCATE(ZWORK)
ELSE
  CALL FMREADX2(CFILE_LFI,YREC,CLUOUT_LFI,SIZE(PFIELD),PFIELD(:,:),IGRID,ILENCH,HCOMMENT,KRESP)
  CALL ERROR_READ_SURF_LFI(YREC,KRESP)
END IF
...
IF (HDIR=='H' .OR. HDIR=='A')  THEN
  ...
  DEALLOCATE(IWORK)
ELSE
  CALL FMREADN1(CFILE_LFI,HREC,CLUOUT_LFI,SIZE(KFIELD),KFIELD(:),IGRID,ILENCH,HCOMMENT,KRESP)
  CALL ERROR_READ_SURF_LFI(HREC,KRESP)
END IF
