...
IF (NRANK==NPIO) THEN
  ...
  IF (NID_NC.NE.0) THEN
    ...
    !----------------------------
    IF (ITYPE==NF_DOUBLE) THEN
      IRET(1)=NF_GET_VAR_DOUBLE(NID_NC,IVAR_ID,ZWORK)
    ELSEIF (ITYPE==NF_FLOAT) THEN
...
IF (NRANK==NPIO) THEN
  ...
  IF (NID_NC.NE.0) THEN
    ...
    !
    IF (ITYPE==NF_DOUBLE) THEN
      IRET(2)=NF_GET_VAR_DOUBLE(NID_NC,IVAR_ID,ZWORK2)
    ELSEIF (ITYPE==NF_FLOAT) THEN
...
IF (NRANK==NPIO) THEN
  ...
  IF (NID_NC.NE.0) THEN
    ...
    IF (ITYPE==NF_INT) THEN
      IRET(1)=NF_GET_VAR_INT(NID_NC,IVAR_ID,IWORK)
    ENDIF
    !  
    IRET(2) = NF_GET_ATT_TEXT(NID_NC,IVAR_ID,"comment",HCOMMENT)
    !
  ENDIF
  !
  ! 3. Check for errors
...
IF (NRANK==NPIO) THEN
  ...
  IF (NID_NC.NE.0) THEN
    ...
    !
    IF (ITYPE==NF_INT) THEN
      IRET(2)=NF_GET_VAR_INT(NID_NC,IVAR_ID,IWORK2)
    ENDIF      
    !
    IRET(3) = NF_GET_ATT_TEXT(NID_NC,IVAR_ID,"comment",HCOMMENT)
  ENDIF
