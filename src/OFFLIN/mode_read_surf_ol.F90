...
IF (NRANK==NPIO) THEN
  ...
  IF (IFILE_ID.NE.0) THEN
    ...
    IF  (LPARTR) THEN
      ...
      IF (ITYPE==NF_DOUBLE) THEN
        IRET(1)=NF_GET_VARS_DOUBLE(IFILE_ID,IVAR_ID,ISTART,ICOUNT,ISTRIDE,ZWORK)
      ELSEIF (ITYPE==NF_FLOAT) THEN
    ...
    ELSE
      IF (ITYPE==NF_DOUBLE) THEN
        IRET(1)=NF_GET_VAR_DOUBLE(IFILE_ID,IVAR_ID,ZWORK)
      ELSEIF (ITYPE==NF_FLOAT) THEN
        ALLOCATE(ZTAB_1D4(IDIMLEN(1)*IDIMLEN(2)))
...
IF (NRANK==NPIO) THEN
  ...
  IF (IFILE_ID.NE.0) THEN
    ...
    IF (LPARTR) THEN
      ...
      IF (ITYPE==NF_DOUBLE) THEN
        IRET(2)=NF_GET_VARS_DOUBLE(IFILE_ID,IVAR_ID,ISTART,ICOUNT,ISTRIDE,ZWORK2)
      ELSEIF (ITYPE==NF_FLOAT) THEN
    ...
    ELSE
      ...
      IF (ITYPE==NF_DOUBLE) THEN
        IRET(2)=NF_GET_VAR_DOUBLE(IFILE_ID,IVAR_ID,ZWORK2)
      ELSEIF (ITYPE==NF_FLOAT) THEN
...
IF (NRANK==NPIO) THEN
  ...
  IF (IFILE_ID.NE.0) THEN
    ...
    IF (LPARTR) THEN
      ...
      IF (ITYPE==NF_DOUBLE) THEN
        IRET(2)=NF_GET_VARS_DOUBLE(IFILE_ID,IVAR_ID,ISTART,ICOUNT,ISTRIDE,ZWORK3)
      ELSEIF (ITYPE==NF_FLOAT) THEN
    ...
    ELSE
      ...
      IF (ITYPE==NF_DOUBLE) THEN
        IRET(2)=NF_GET_VAR_DOUBLE(IFILE_ID,IVAR_ID,ZWORK3)
      ELSEIF (ITYPE==NF_FLOAT) THEN
        ALLOCATE(ZTAB_3D4(ICOUNT(1),ICOUNT(2),ICOUNT(3)))
