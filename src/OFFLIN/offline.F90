...
ALLOCATE(ISIZE_OMP(0:NBLOCKTOT-1))
 CALL GET_SIZES_PARALLEL(YSURF_CUR%BOP, YSURF_CUR%BDD, YSURF_CUR%CHE, YSURF_CUR%CHI, YSURF_CUR%CHS, &
                YSURF_CUR%CHN, YSURF_CUR%CHU, YSURF_CUR%CHT, YSURF_CUR%CHW, YSURF_CUR%DTCO, YSURF_CUR%DTS, &
                YSURF_CUR%DTT, YSURF_CUR%DTZ, YSURF_CUR%DGEI, YSURF_CUR%DGF, YSURF_CUR%DGI, YSURF_CUR%DGMI, &
                YSURF_CUR%DGMTO, YSURF_CUR%DGO, YSURF_CUR%DGS, YSURF_CUR%DGSI, YSURF_CUR%DGU, YSURF_CUR%DGT, &
                YSURF_CUR%DGUT, YSURF_CUR%DGW, YSURF_CUR%F, YSURF_CUR%FSB, YSURF_CUR%GB, YSURF_CUR%ICP, &
                YSURF_CUR%I, YSURF_CUR%O, YSURF_CUR%S, YSURF_CUR%SSB, YSURF_CUR%SV, YSURF_CUR%TCP, YSURF_CUR%TGD, &
                YSURF_CUR%TGDO, YSURF_CUR%TGR, YSURF_CUR%TGRO, YSURF_CUR%T, YSURF_CUR%TOP, YSURF_CUR%TVG, &
                YSURF_CUR%W, YSURF_CUR%WSB, YSURF_CUR%IOB, YSURF_CUR%UG, YSURF_CUR%U, &
...
!
 CALL OL_READ_ATM(YSURF_CUR%IOB, &
...
#endif
!
 CALL INIT_CRODEBUG(YSURF_CUR%I)
!
! * SURFEX - OASIS  grid, partitions and local field definitions
!
IF(LOASIS)THEN
  CALL SFX_OASIS_DEF_OL(YSURF_CUR%I, &
                        YSURF_CUR%U, &
...
DO JFORC_STEP=1,INB_STEP_ATM
  ...
  DO JSURF_STEP=1,INB_ATM
    ...
    IF(LOASIS)THEN
     ...
     CALL SFX_OASIS_RECV_OL(YSURF_CUR%F, YSURF_CUR%I, YSURF_CUR%S, YSURF_CUR%U, YSURF_CUR%W, &
...
!$OMP END PARALLEL
    ...
    IF(LOASIS)THEN
     ...
     CALL SFX_OASIS_SEND_OL(YSURF_CUR%F, YSURF_CUR%I, YSURF_CUR%S, YSURF_CUR%U, YSURF_CUR%W, &
...
!$ NBLOCK = OMP_GET_THREAD_NUM()
        ...
        XTIME1 =  MPI_WTIME()
#endif
        CALL DIAG_SURF_ATM_n(YSURF_CUR%DGEI, YSURF_CUR%DGF, YSURF_CUR%DGL, YSURF_CUR%DGI, &
                             YSURF_CUR%DGS, YSURF_CUR%DGU, YSURF_CUR%DGT, YSURF_CUR%DGW, &
...
!
  ...
  !
  ISERIES = 0
  CALL GET_SURF_VAR_n(YSURF_CUR%DGF, YSURF_CUR%DGI, YSURF_CUR%DGMI, YSURF_CUR%DGS, YSURF_CUR%DGU, &
                      YSURF_CUR%DGT, YSURF_CUR%DGW, YSURF_CUR%F, YSURF_CUR%UG, YSURF_CUR%U, YSURF_CUR%USS, &
