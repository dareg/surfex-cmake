...
!
  ...
  !
  ISERIES = 0
  CALL GET_SURF_VAR_n(YSURF_CUR%FM%DGF, YSURF_CUR%IM%DGI, YSURF_CUR%IM%DGMI, YSURF_CUR%SM%DGS, YSURF_CUR%DGU, &
                      YSURF_CUR%TM%DGT, YSURF_CUR%WM%DGW, YSURF_CUR%FM%F, YSURF_CUR%UG, YSURF_CUR%U, YSURF_CUR%USS, &
