...
IF (LWRITE_COORD) THEN
  !
  IF (ASSOCIATED(UG%XGRID_FULL_PAR)) THEN
    CALL GET_GRID_COORD(KLUOUT,PX=PX,PY=PY,KL=KNI,HGRID=UG%CGRID,PGRID_PAR=UG%XGRID_FULL_PAR)
  ELSEIF (ASSOCIATED(UG%XGRID_PAR)) THEN
    CALL GET_GRID_COORD(KLUOUT,PX=PX,PY=PY,KL=KNI,HGRID=UG%CGRID,PGRID_PAR=UG%XGRID_PAR)
  ENDIF
  !
ELSEIF ( UG%CGRID.EQ.'CONF PROJ '.OR. UG%CGRID.EQ.'CARTESIAN '.OR. &
  ...
  !
  IF (ASSOCIATED(UG%XGRID_FULL_PAR)) THEN
    CALL GET_GRID_COORD(KLUOUT,PX=ZXX,PY=ZYY,KL=KNI,HGRID=UG%CGRID,PGRID_PAR=UG%XGRID_FULL_PAR)
  ELSEIF (ASSOCIATED(UG%XGRID_PAR)) THEN
    CALL GET_GRID_COORD(KLUOUT,PX=ZXX,PY=ZYY,KL=KNI,HGRID=UG%CGRID,PGRID_PAR=UG%XGRID_PAR)
  ENDIF
  !
