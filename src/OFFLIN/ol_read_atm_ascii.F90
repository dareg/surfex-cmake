...
CALL READ_SURF_ATM('ASCII ',PTA    (1:XCOUNT,:),KFORC_STEP,XCOUNT,250)
CALL READ_SURF_ATM('ASCII ',PQA    (1:XCOUNT,:),KFORC_STEP,XCOUNT,251)
CALL READ_SURF_ATM('ASCII ',PWIND  (1:XCOUNT,:),KFORC_STEP,XCOUNT,252)
CALL READ_SURF_ATM('ASCII ',PLW    (1:XCOUNT,:),KFORC_STEP,XCOUNT,253)
CALL READ_SURF_ATM('ASCII ',PDIR_SW(1:XCOUNT,:),KFORC_STEP,XCOUNT,254)
CALL READ_SURF_ATM('ASCII ',PSCA_SW(1:XCOUNT,:),KFORC_STEP,XCOUNT,255)
CALL READ_SURF_ATM('ASCII ',PRAIN  (1:XCOUNT,:),KFORC_STEP,XCOUNT,256)
CALL READ_SURF_ATM('ASCII ',PSNOW  (1:XCOUNT,:),KFORC_STEP,XCOUNT,257)
CALL READ_SURF_ATM('ASCII ',PPS    (1:XCOUNT,:),KFORC_STEP,XCOUNT,258)
CALL READ_SURF_ATM('ASCII ',PDIR   (1:XCOUNT,:),KFORC_STEP,XCOUNT,259)
CALL READ_SURF_ATM('ASCII ',PCO2   (1:XCOUNT,:),KFORC_STEP,XCOUNT,260)
!
