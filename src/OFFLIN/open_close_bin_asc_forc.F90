...
IF (HACTION=='OPEN ') THEN
  ...
  ELSE IF (HFORCING=='BINARY') THEN
    OPEN(UNIT=22,FILE='Forc_TA.bin      ',FORM='UNFORMATTED',STATUS=YSTATUS,ACCESS='DIRECT',RECL=KNI*4)
    OPEN(UNIT=23,FILE='Forc_QA.bin      ',FORM='UNFORMATTED',STATUS=YSTATUS,ACCESS='DIRECT',RECL=KNI*4)
    OPEN(UNIT=24,FILE='Forc_WIND.bin    ',FORM='UNFORMATTED',STATUS=YSTATUS,ACCESS='DIRECT',RECL=KNI*4)
    OPEN(UNIT=25,FILE='Forc_LW.bin      ',FORM='UNFORMATTED',STATUS=YSTATUS,ACCESS='DIRECT',RECL=KNI*4)
    OPEN(UNIT=26,FILE='Forc_DIR_SW.bin  ',FORM='UNFORMATTED',STATUS=YSTATUS,ACCESS='DIRECT',RECL=KNI*4)
    OPEN(UNIT=27,FILE='Forc_SCA_SW.bin  ',FORM='UNFORMATTED',STATUS=YSTATUS,ACCESS='DIRECT',RECL=KNI*4)
    OPEN(UNIT=28,FILE='Forc_RAIN.bin    ',FORM='UNFORMATTED',STATUS=YSTATUS,ACCESS='DIRECT',RECL=KNI*4)
    OPEN(UNIT=29,FILE='Forc_SNOW.bin    ',FORM='UNFORMATTED',STATUS=YSTATUS,ACCESS='DIRECT',RECL=KNI*4)
    OPEN(UNIT=30,FILE='Forc_PS.bin      ',FORM='UNFORMATTED',STATUS=YSTATUS,ACCESS='DIRECT',RECL=KNI*4)
    OPEN(UNIT=31,FILE='Forc_DIR.bin     ',FORM='UNFORMATTED',STATUS=YSTATUS,ACCESS='DIRECT',RECL=KNI*4)
    OPEN(UNIT=32,FILE='Forc_CO2.bin     ',FORM='UNFORMATTED',STATUS=YSTATUS,ACCESS='DIRECT',RECL=KNI*4)
  ENDIF
ENDIF
!
