...
!
  CALL READ_FROM_SURFEX_FILE(CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',DTI%XPAR_VEGTYPE(:,1),HNAM='VEGTY_P1')
  CALL READ_FROM_SURFEX_FILE(CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',DTI%XPAR_VEGTYPE(:,2),HNAM='VEGTY_P2')
  CALL READ_FROM_SURFEX_FILE(CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',DTI%XPAR_VEGTYPE(:,3),HNAM='VEGTY_P3')
  CALL READ_FROM_SURFEX_FILE(CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',DTI%XPAR_VEGTYPE(:,4),HNAM='VEGTY_P4')
  CALL READ_FROM_SURFEX_FILE(CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',DTI%XPAR_VEGTYPE(:,5),HNAM='VEGTY_P5')
  CALL READ_FROM_SURFEX_FILE(CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',DTI%XPAR_VEGTYPE(:,6),HNAM='VEGTY_P6')
  CALL READ_FROM_SURFEX_FILE(CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',DTI%XPAR_VEGTYPE(:,7),HNAM='VEGTY_P7')
  CALL READ_FROM_SURFEX_FILE(CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',DTI%XPAR_VEGTYPE(:,8),HNAM='VEGTY_P8')
  CALL READ_FROM_SURFEX_FILE(CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',DTI%XPAR_VEGTYPE(:,9),HNAM='VEGTY_P9')
  CALL READ_FROM_SURFEX_FILE(CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',DTI%XPAR_VEGTYPE(:,10),HNAM='VEGTY_P10')
  CALL READ_FROM_SURFEX_FILE(CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',DTI%XPAR_VEGTYPE(:,11),HNAM='VEGTY_P11')
  CALL READ_FROM_SURFEX_FILE(CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',DTI%XPAR_VEGTYPE(:,12),HNAM='VEGTY_P12')
  CALL READ_FROM_SURFEX_FILE(CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',DTI%XPAR_VEGTYPE(:,13),HNAM='VEGTY_P13')
  CALL READ_FROM_SURFEX_FILE(CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',DTI%XPAR_VEGTYPE(:,14),HNAM='VEGTY_P14')
  CALL READ_FROM_SURFEX_FILE(CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',DTI%XPAR_VEGTYPE(:,18),HNAM='VEGTY_P15')
  CALL READ_FROM_SURFEX_FILE(CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',DTI%XPAR_VEGTYPE(:,15),HNAM='VEGTY_P16')
  CALL READ_FROM_SURFEX_FILE(CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',DTI%XPAR_VEGTYPE(:,16),HNAM='VEGTY_P17')
  CALL READ_FROM_SURFEX_FILE(CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',DTI%XPAR_VEGTYPE(:,17),HNAM='VEGTY_P18')
  CALL READ_FROM_SURFEX_FILE(CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',DTI%XPAR_VEGTYPE(:,19),HNAM='VEGTY_P19')
!
ENDIF
!
...
ENDIF
!
IF (DTI%LDATA_VEGTYPE) CALL EXTRAPOL_FIELDS(HPROGRAM,ILUOUT)
!
