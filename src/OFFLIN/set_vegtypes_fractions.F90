...
!        
  LDATA_VEGTYPE=.TRUE.
!  
  CALL READ_FROM_SURFEX_FILE(CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',XPAR_VEGTYPE(:,1),HNAM='VEGTYPE_P1')
  CALL READ_FROM_SURFEX_FILE(CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',XPAR_VEGTYPE(:,2),HNAM='VEGTYPE_P2')
  CALL READ_FROM_SURFEX_FILE(CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',XPAR_VEGTYPE(:,3),HNAM='VEGTYPE_P3')
  CALL READ_FROM_SURFEX_FILE(CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',XPAR_VEGTYPE(:,4),HNAM='VEGTYPE_P4')
  CALL READ_FROM_SURFEX_FILE(CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',XPAR_VEGTYPE(:,5),HNAM='VEGTYPE_P5')
  CALL READ_FROM_SURFEX_FILE(CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',XPAR_VEGTYPE(:,6),HNAM='VEGTYPE_P6')
  CALL READ_FROM_SURFEX_FILE(CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',XPAR_VEGTYPE(:,7),HNAM='VEGTYPE_P7')
  CALL READ_FROM_SURFEX_FILE(CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',XPAR_VEGTYPE(:,8),HNAM='VEGTYPE_P8')
  CALL READ_FROM_SURFEX_FILE(CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',XPAR_VEGTYPE(:,9),HNAM='VEGTYPE_P9')
  CALL READ_FROM_SURFEX_FILE(CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',XPAR_VEGTYPE(:,10),HNAM='VEGTYPE_P10')
  CALL READ_FROM_SURFEX_FILE(CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',XPAR_VEGTYPE(:,11),HNAM='VEGTYPE_P11')
  CALL READ_FROM_SURFEX_FILE(CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',XPAR_VEGTYPE(:,12),HNAM='VEGTYPE_P12')
  CALL READ_FROM_SURFEX_FILE(CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',XPAR_VEGTYPE(:,13),HNAM='VEGTYPE_P13')
  CALL READ_FROM_SURFEX_FILE(CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',XPAR_VEGTYPE(:,14),HNAM='VEGTYPE_P14')
  CALL READ_FROM_SURFEX_FILE(CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',XPAR_VEGTYPE(:,18),HNAM='VEGTYPE_P15')
  CALL READ_FROM_SURFEX_FILE(CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',XPAR_VEGTYPE(:,15),HNAM='VEGTYPE_P16')
  CALL READ_FROM_SURFEX_FILE(CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',XPAR_VEGTYPE(:,16),HNAM='VEGTYPE_P17')
  CALL READ_FROM_SURFEX_FILE(CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',XPAR_VEGTYPE(:,17),HNAM='VEGTYPE_P18')
  CALL READ_FROM_SURFEX_FILE(CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',XPAR_VEGTYPE(:,19),HNAM='VEGTYPE_P19')
!
ENDIF
!
