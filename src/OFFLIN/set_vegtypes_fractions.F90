!     #########
      SUBROUTINE SET_VEGTYPES_FRACTIONS (DTCO, DTI, KDIM, IO, IP, UG, U, HPROGRAM)
!     ##############################################################
!
...
!
  CALL READ_FROM_SURFEX_FILE(DTCO, U, &
                             CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',DTI%XPAR_VEGTYPE(:,1),HNAM='VEGTYPE1')
  CALL READ_FROM_SURFEX_FILE(DTCO, U, &
                             CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',DTI%XPAR_VEGTYPE(:,2),HNAM='VEGTYPE2')
  CALL READ_FROM_SURFEX_FILE(DTCO, U, &
                             CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',DTI%XPAR_VEGTYPE(:,3),HNAM='VEGTYPE3')
  CALL READ_FROM_SURFEX_FILE(DTCO, U, &
                             CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',DTI%XPAR_VEGTYPE(:,4),HNAM='VEGTYPE4')
  CALL READ_FROM_SURFEX_FILE(DTCO, U, &
                             CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',DTI%XPAR_VEGTYPE(:,5),HNAM='VEGTYPE5')
  CALL READ_FROM_SURFEX_FILE(DTCO, U, &
                             CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',DTI%XPAR_VEGTYPE(:,6),HNAM='VEGTYPE6')
  CALL READ_FROM_SURFEX_FILE(DTCO, U, &
                             CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',DTI%XPAR_VEGTYPE(:,7),HNAM='VEGTYPE7')
  CALL READ_FROM_SURFEX_FILE(DTCO, U, &
                             CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',DTI%XPAR_VEGTYPE(:,8),HNAM='VEGTYPE8')
  CALL READ_FROM_SURFEX_FILE(DTCO, U, &
                             CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',DTI%XPAR_VEGTYPE(:,9),HNAM='VEGTYPE9')
  CALL READ_FROM_SURFEX_FILE(DTCO, U, &
                             CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',DTI%XPAR_VEGTYPE(:,10),HNAM='VEGTYPE10')
  CALL READ_FROM_SURFEX_FILE(DTCO, U, &
                             CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',DTI%XPAR_VEGTYPE(:,11),HNAM='VEGTYPE11')
  CALL READ_FROM_SURFEX_FILE(DTCO, U, &
                             CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',DTI%XPAR_VEGTYPE(:,12),HNAM='VEGTYPE12')
  CALL READ_FROM_SURFEX_FILE(DTCO, U, &
                             CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',DTI%XPAR_VEGTYPE(:,13),HNAM='VEGTYPE13')
  CALL READ_FROM_SURFEX_FILE(DTCO, U, &
                             CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',DTI%XPAR_VEGTYPE(:,14),HNAM='VEGTYPE14')
  CALL READ_FROM_SURFEX_FILE(DTCO, U, &
                             CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',DTI%XPAR_VEGTYPE(:,18),HNAM='VEGTYPE15')
  CALL READ_FROM_SURFEX_FILE(DTCO, U, &
                             CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',DTI%XPAR_VEGTYPE(:,15),HNAM='VEGTYPE16')
  CALL READ_FROM_SURFEX_FILE(DTCO, U, &
                             CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',DTI%XPAR_VEGTYPE(:,16),HNAM='VEGTYPE17')
  CALL READ_FROM_SURFEX_FILE(DTCO, U, &
                             CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',DTI%XPAR_VEGTYPE(:,17),HNAM='VEGTYPE18')
  CALL READ_FROM_SURFEX_FILE(DTCO, U, &
                             CFTYP_VEGTYPE,CFNAM_VEGTYPE,'NATURE','      ',DTI%XPAR_VEGTYPE(:,19),HNAM='VEGTYPE19')
!
ENDIF
!
...
ENDIF
!
IF (DTI%LDATA_VEGTYPE) CALL EXTRAPOL_FIELDS(DTCO, DTI, KDIM, IO, IP, UG, U, HPROGRAM,ILUOUT)
!
