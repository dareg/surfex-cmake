...
ABSTRACT INTERFACE
  ...
  SUBROUTINE IPREP(THIS, DTCO, U, GCP, YDCTL, KLU, HPROGRAM, HATMFILE, HATMFILETYPE, HPGDFILE, HPGDFILETYPE)
  ...
  SUBROUTINE IDAMPING(THIS, PSIC_EFOLDING_TIME, PSIT_EFOLDING_TIME)
    IMPORT :: SEA_ICE_t
    CLASS(SEA_ICE_t) :: THIS
