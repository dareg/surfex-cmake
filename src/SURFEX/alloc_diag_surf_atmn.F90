...
ALLOCATE(XEVAP_TILE   (NSIZE_FULL,NTILESFC))
ALLOCATE(XSUBL_TILE   (NSIZE_FULL,NTILESFC))
...
ALLOCATE(XAVG_EVAP   (NSIZE_FULL))
ALLOCATE(XAVG_SUBL   (NSIZE_FULL))
...
!
  ...
  ALLOCATE(XEVAPC_TILE   (NSIZE_FULL,NTILESFC))
  ALLOCATE(XSUBLC_TILE   (NSIZE_FULL,NTILESFC))  
...
!
  ...
  ALLOCATE(XAVG_EVAPC   (NSIZE_FULL))
  ALLOCATE(XAVG_SUBLC   (NSIZE_FULL))  
...
!
  ...
  ALLOCATE(XEVAPC_TILE   (0,0))
  ALLOCATE(XSUBLC_TILE   (0,0))  
