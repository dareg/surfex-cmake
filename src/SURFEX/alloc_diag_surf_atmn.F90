...
!
  ...
  ELSE
     ...
     YREC='LWUC'
     CALL READ_SURF(HPROGRAM,YREC,DGU%XAVG_LWUC,IRESP)
     YREC='FMUC'
     CALL READ_SURF(HPROGRAM,YREC,DGU%XAVG_FMUC,IRESP)
     YREC='FMVC'
     CALL READ_SURF(HPROGRAM,YREC,DGU%XAVG_FMVC,IRESP)   
!
     CALL READ_SURF(HPROGRAM,'VERSION',IVERSION,IRESP)
      ...
      ELSE
         YREC='EVAPC'
         CALL READ_SURF(HPROGRAM,YREC,DGU%XAVG_EVAPC,IRESP)
         YREC='SUBLC'
         CALL READ_SURF(HPROGRAM,YREC,DGU%XAVG_SUBLC,IRESP)              
      ENDIF
!     
  ENDIF
!
