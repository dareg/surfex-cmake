...
!
USE MODE_MODELN_SURFEX_HANDLER, ONLY : INIT_CURRENT_MODEL_INDEX_SURFEX
!
...
USE MODD_CH_FLAKE_n,   ONLY : CH_FLAKE_ALLOC
...
USE MODD_DIAG_MISC_TEB_n,   ONLY : DIAG_MISC_TEB_ALLOC
USE MODD_DIAG_MISC_TEB_OPTION_n,   ONLY : DIAG_MISC_TEB_OPTIONS_ALLOC
USE MODD_DIAG_UTCI_TEB_n,   ONLY : DIAG_UTCI_TEB_ALLOC
USE MODD_DIAG_OCEAN_n,   ONLY : DIAG_OCEAN_ALLOC
USE MODD_DIAG_SEAICE_n,   ONLY : DIAG_SEAICE_ALLOC
...
USE MODD_DIAG_TEB_GARDEN_n,   ONLY : DIAG_TEB_GARDEN_ALLOC
USE MODD_DIAG_TEB_GREENROOF_n,   ONLY : DIAG_TEB_GREENROOF_ALLOC
...
USE MODD_GR_BIOG_GREENROOF_n,   ONLY : GR_BIOG_GREENROOF_ALLOC
...
USE MODD_PACK_CH_ISBA,   ONLY : PACK_CH_ISBA_ALLOC
USE MODD_PACK_DIAG_ISBA,   ONLY : PACK_DIAG_ISBA_ALLOC
USE MODD_PACK_ISBA,   ONLY : PACK_ISBA_ALLOC
...
USE MODD_TEB_GARDEN_n,   ONLY : TEB_GARDEN_ALLOC
USE MODD_TEB_GARDEN_OPTION_n,   ONLY : TEB_GARDEN_OPTIONS_ALLOC
USE MODD_TEB_GARDEN_PGD_n,   ONLY : TEB_GARDEN_PGD_ALLOC
USE MODD_TEB_GARDEN_PGD_EVOL_n,   ONLY : TEB_GARDEN_PGD_EVOL_ALLOC
USE MODD_TEB_GRID_n,   ONLY : TEB_GRID_ALLOC
USE MODD_TEB_n,   ONLY : TEB_ALLOC
USE MODD_TEB_OPTION_n,   ONLY : TEB_OPTIONS_ALLOC
USE MODD_TEB_VEG_n,   ONLY : TEB_VEG_OPTIONS_ALLOC
USE MODD_BEM_n,   ONLY : BEM_ALLOC
USE MODD_BEM_OPTION_n,   ONLY : BEM_OPTIONS_ALLOC
USE MODD_TEB_GREENROOF_n,   ONLY : TEB_GREENROOF_ALLOC
USE MODD_TEB_GREENROOF_OPTION_n,   ONLY : TEB_GREENROOF_OPTIONS_ALLOC
USE MODD_TEB_GREENROOF_PGD_n,   ONLY :TEB_GREENROOF_PGD_ALLOC
USE MODD_TEB_GREENROOF_PGD_EVOL_n,   ONLY : TEB_GREENROOF_PGD_EVOL_ALLOC
USE MODD_TEB_IRRIG_n,   ONLY : TEB_IRRIG_ALLOC
USE MODD_TEB_PANEL_n,   ONLY : TEB_PANEL_ALLOC
...
!
 ...
 CALL DIAG_CUMUL_TEB_ALLOC(KMODEL,NTEB_PATCH_MAX)
 ...
 CALL DIAG_SEAICE_ALLOC(KMODEL)
 CALL DIAG_SEAFLUX_ALLOC(KMODEL)
 CALL DIAG_SURF_ATM_ALLOC(KMODEL)
 CALL DIAG_TEB_ALLOC(KMODEL)
 CALL DIAG_TEB_GARDEN_ALLOC(KMODEL)
 CALL DIAG_TEB_GREENROOF_ALLOC(KMODEL)
 ...
 CALL GR_BIOG_GREENROOF_ALLOC(KMODEL)
 ...
 CALL PACK_CH_ISBA_ALLOC(KMODEL)
 CALL PACK_DIAG_ISBA_ALLOC(KMODEL)
 CALL PACK_ISBA_ALLOC(KMODEL)
 ...
 CALL TEB_IRRIG_ALLOC(KMODEL)
 CALL TEB_PANEL_ALLOC(KMODEL)
