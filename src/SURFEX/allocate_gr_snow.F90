  ...
  IF (TPSNOW%SCHEME/='D95' .AND. TPSNOW%SCHEME/='EBA') THEN
    ...
    IF (TPSNOW%SCHEME/='1-L') THEN
      ...
      IF(TPSNOW%SCHEME=='CRO') THEN
        ...
        ALLOCATE(TPSNOW%IMPUR(KLU,TPSNOW%NLAYER,KPATCH))
        ALLOCATE(TPSNOW%IMPURV2(KLU,TPSNOW%NLAYER,NIMPUR,KPATCH))
...
IF (TPSNOW%SCHEME/='CRO') THEN
  ...
  ALLOCATE(TPSNOW%IMPURV2 (0,0,0,0))
  !
