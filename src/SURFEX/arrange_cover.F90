...
!-------------------------------------------------------------------------------
!
IF (ASSOCIATED(XDATA_NATURE)) DEALLOCATE(XDATA_NATURE)
IF (ASSOCIATED(XDATA_TOWN)) DEALLOCATE(XDATA_TOWN)
IF (ASSOCIATED(XDATA_SEA)) DEALLOCATE(XDATA_SEA)
IF (ASSOCIATED(XDATA_WATER)) DEALLOCATE(XDATA_WATER)
IF (ASSOCIATED(XDATA_VEGTYPE)) DEALLOCATE(XDATA_VEGTYPE)
IF (ASSOCIATED(XDATA_GARDEN)) DEALLOCATE(XDATA_GARDEN)
IF (ASSOCIATED(XDATA_BLD)) DEALLOCATE(XDATA_BLD)
IF (ASSOCIATED(XDATA_WALL_O_HOR)) DEALLOCATE(XDATA_WALL_O_HOR)
!
...
IF(LWATER_TO_NATURE)THEN
  DO JCOVER=1,JPCOVER
     IF(XDATA_WATER(JCOVER)>0.0.AND.XDATA_WATER(JCOVER)<1.0)THEN
