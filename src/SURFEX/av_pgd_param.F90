...
!
    DO JVEGTYPE=1,NVEGTYPE
      ...
      ZSUM_WEIGHT_PATCH(:,JPATCH) = ZSUM_WEIGHT_PATCH(:,JPATCH) + ZWEIGHT(:,JVEGTYPE)
      ZWORK(:,JPATCH) =  ZWORK(:,JPATCH) + PDATA(:,JVEGTYPE)  * ZWEIGHT(:,JVEGTYPE)
    END DO
!
!-------------------------------------------------------------------------------
!
...
!
   DO JVEGTYPE=1,NVEGTYPE 
     JPATCH=PATCH_LIST(JVEGTYPE) 
     ZSUM_WEIGHT_PATCH(:,JPATCH) = ZSUM_WEIGHT_PATCH(:,JPATCH)+ ZWEIGHT(:,JVEGTYPE)
     WHERE (ZWEIGHT(:,JVEGTYPE).NE.0.) &
             ZWORK(:,JPATCH)= ZWORK(:,JPATCH) + 1./ PDATA(:,JVEGTYPE) * ZWEIGHT(:,JVEGTYPE)
   END DO
!
!-------------------------------------------------------------------------------!
!
...
!
    DO JVEGTYPE=1,NVEGTYPE
      ...
      ZSUM_WEIGHT_PATCH(:,JPATCH) =  ZSUM_WEIGHT_PATCH(:,JPATCH)+ ZWEIGHT(:,JVEGTYPE)
      WHERE (ZWEIGHT(:,JVEGTYPE).NE.0.) &
        ZWORK(:,JPATCH)= ZWORK(:,JPATCH) + 1./(LOG(ZDZ(:,JPATCH)/ PDATA(:,JVEGTYPE)))**2    &
                            * ZWEIGHT(:,JVEGTYPE)  
    END DO   
!
!-------------------------------------------------------------------------------
