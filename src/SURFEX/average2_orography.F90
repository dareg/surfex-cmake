...
DO JI = 1,SIZE(USS%XAVG_ZS)
  ...
  IF (USS%XAVG_ZS(JI)/=XUNDEF) THEN
    ...
    ZINT = FLOAT(AINT(USS%XAVG_ZS(JI),KIND=16))
    IF (USS%XAVG_ZS(JI)/=ZINT) &
      USS%XAVG_ZS(JI) = ZINT + NINT((USS%XAVG_ZS(JI)-ZINT)*100000000.)/100000000.

    ZINT = FLOAT(AINT(USS%XSSO_STDEV(JI),KIND=16))
    IF (USS%XSSO_STDEV(JI)/=ZINT) &
      USS%XSSO_STDEV(JI) = ZINT + NINT((USS%XSSO_STDEV(JI)-ZINT)*100000000.)/100000000.

    ZINT = FLOAT(AINT(USS%XSIL_ZS(JI),KIND=16))
    IF (USS%XSIL_ZS(JI)/=ZINT) &
      USS%XSIL_ZS(JI) = ZINT + NINT((USS%XSIL_ZS(JI)-ZINT)*100000000.)/100000000.
