...
DO JP=1,KNPATCH
  DO JI=1,NP%AL(JP)%NSIZE_P
    ...
    !        
    IF (ISIZE_LMEB_PATCH>0) THEN
      DEA%XLEVCV    (IMASK) = DEA%XLEVCV    (IMASK) + NP%AL(JP)%XPATCH(JI) * NDEA%AL(JP)%XLEVCV(JI)
      DEA%XLESC     (IMASK) = DEA%XLESC     (IMASK) + NP%AL(JP)%XPATCH(JI) * NDEA%AL(JP)%XLESC(JI)
      DEA%XLETRCV   (IMASK) = DEA%XLETRCV   (IMASK) + NP%AL(JP)%XPATCH(JI) * NDEA%AL(JP)%XLETRCV(JI)
      ...
      DEA%XLERCV    (IMASK) = DEA%XLERCV    (IMASK) + NP%AL(JP)%XPATCH(JI) * NDEA%AL(JP)%XLERCV(JI)
      DEA%XLE_C_A   (IMASK) = DEA%XLE_C_A   (IMASK) + NP%AL(JP)%XPATCH(JI) * NDEA%AL(JP)%XLE_C_A(JI)
      DEA%XLE_V_C   (IMASK) = DEA%XLE_V_C   (IMASK) + NP%AL(JP)%XPATCH(JI) * NDEA%AL(JP)%XLE_V_C(JI)
      DEA%XLE_G_C   (IMASK) = DEA%XLE_G_C   (IMASK) + NP%AL(JP)%XPATCH(JI) * NDEA%AL(JP)%XLE_G_C(JI)
      DEA%XLE_N_C   (IMASK) = DEA%XLE_N_C   (IMASK) + NP%AL(JP)%XPATCH(JI) * NDEA%AL(JP)%XLE_N_C(JI)
      ...
      DEA%XH_V_C    (IMASK) = DEA%XH_V_C    (IMASK) + NP%AL(JP)%XPATCH(JI) * NDEA%AL(JP)%XH_V_C(JI)
      DEA%XH_G_C    (IMASK) = DEA%XH_G_C    (IMASK) + NP%AL(JP)%XPATCH(JI) * NDEA%AL(JP)%XH_G_C(JI)
      DEA%XH_C_A    (IMASK) = DEA%XH_C_A    (IMASK) + NP%AL(JP)%XPATCH(JI) * NDEA%AL(JP)%XH_C_A(JI)
      DEA%XH_N_C    (IMASK) = DEA%XH_N_C    (IMASK) + NP%AL(JP)%XPATCH(JI) * NDEA%AL(JP)%XH_N_C(JI)
      DEA%XSR_GN    (IMASK) = DEA%XSR_GN    (IMASK) + NP%AL(JP)%XPATCH(JI) * NDEA%AL(JP)%XSR_GN(JI)
      DEA%XMELTCV   (IMASK) = DEA%XMELTCV   (IMASK) + NP%AL(JP)%XPATCH(JI) * NDEA%AL(JP)%XMELTCV(JI)
      DEA%XFRZCV    (IMASK) = DEA%XFRZCV    (IMASK) + NP%AL(JP)%XPATCH(JI) * NDEA%AL(JP)%XFRZCV(JI)
    ENDIF
  END DO
ENDDO
!
