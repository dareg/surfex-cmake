!#############################################################
SUBROUTINE COMMON_PARTS2(KPATCH, KI, OCANOPY, HROUGH, TPSNOW, &
...
!#############################################################
!
!!****  *COMMON_PARTS2* - routine to initialize ISBA
!!
!!    PURPOSE
!!    -------
!!
...
!
IF (LHOOK) CALL DR_HOOK('COMMON_PARTS2',0,ZHOOK_HANDLE)
!
!-------------------------------------------------------------------------------
!
...
PTSRAD   = XUNDEF
!
IF (LHOOK) CALL DR_HOOK('COMMON_PARTS2',1,ZHOOK_HANDLE)
!
END SUBROUTINE COMMON_PARTS2
