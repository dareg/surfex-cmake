...
!
  ALLOCATE(ZWORK(KI,IO%NPATCH))
!
  CALL MAKE_CHOICE_ARRAY(HPROGRAM, IO%NPATCH, GDIM, 'PERTVEG', ZWORK)
  ALLOCATE(S%XPERTVEG(KI,IO%NPATCH))
  S%XPERTVEG(:,:)=ZWORK(:,:)
!
  CALL MAKE_CHOICE_ARRAY(HPROGRAM, IO%NPATCH, GDIM, 'PERTLAI', ZWORK)
  ALLOCATE(S%XPERTLAI(KI,IO%NPATCH))
  S%XPERTLAI(:,:)=ZWORK(:,:)
!
  CALL MAKE_CHOICE_ARRAY(HPROGRAM, IO%NPATCH, GDIM, 'PERTCV', ZWORK)
