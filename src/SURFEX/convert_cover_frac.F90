...
IF (LHOOK) CALL DR_HOOK('CONVERT_COVER_FRAC',0,ZHOOK_HANDLE)
 CALL AV_PGD (PSEA    ,PCOVER(:,:),DTCO%XDATA_SEA    (:),'ALL','ARI',OCOVER(:))
 CALL AV_PGD (PTOWN   ,PCOVER(:,:),DTCO%XDATA_TOWN   (:),'ALL','ARI',OCOVER(:))
 CALL AV_PGD (PNATURE ,PCOVER(:,:),DTCO%XDATA_NATURE (:),'ALL','ARI',OCOVER(:))
 CALL AV_PGD (PWATER  ,PCOVER(:,:),DTCO%XDATA_WATER  (:),'ALL','ARI',OCOVER(:))
