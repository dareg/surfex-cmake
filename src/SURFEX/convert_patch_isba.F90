...
IF (PRESENT(PALBNIR_SOIL)) THEN
  IF (LDATA_ALBNIR_SOIL) THEN
    CALL AV_PGD_PARAM(PALBNIR_SOIL,XPAR_VEGTYPE,XPAR_ALBNIR_SOIL,YBAR,'ARI',KDECADE=KDECADE)
  ELSEIF (CALBEDO=='CM13') THEN
...
IF (PRESENT(PALBVIS_SOIL)) THEN
  IF (LDATA_ALBVIS_SOIL) THEN
    CALL AV_PGD_PARAM(PALBVIS_SOIL,XPAR_VEGTYPE,XPAR_ALBVIS_SOIL,YBAR,'ARI',KDECADE=KDECADE)
  ELSEIF (CALBEDO=='CM13') THEN
