  ...
  IF (HPHOTO/='AGS' .AND. HPHOTO/='LAI') THEN
    ...
    IF (PRESENT(PDMAX)) THEN
      IF (SIZE(PDMAX)>0) THEN
        ...
        ELSE
          IF (HPHOTO == 'AST' .OR. HPHOTO == 'LST' .OR. HPHOTO == 'NIT' .OR. HPHOTO == 'NCB') THEN
            CALL AV_PGD (PDMAX,PCOVER,XDATA_DMAX_ST,YTREE,'ARI',OCOVER)  
          ELSE
            CALL AV_PGD (PDMAX,PCOVER,XDATA_DMAX,YTREE,'ARI',OCOVER)
          ENDIF
        ENDIF
      ENDIF
    ENDIF
...
IF (HISBA=='DIF' .OR. .NOT.LDATA_DG) THEN
  ...
  ELSE 
    ...
    CALL AV_PGD (ZDG2(:,:),PCOVER,XDATA_ROOT_DEPTH(:,:),YNAT,'ARI',OCOVER)
     
    IF (HISBA=='DIF') CALL AV_PGD (PDROOT(:,:),PCOVER,XDATA_ROOT_DEPTH(:,:),YDIF,'ARI',OCOVER)
  ...
  ELSEIF (LROOTFRAC) THEN
    ...
    IF(OPERM)THEN
      ...
      ELSE
        ...
        CALL AV_PGD (ZWORK_EXT(:,:),PCOVER,ZDATA_ROOT_EXTINCTION(:,:),YDIF,'ARI',OCOVER)
      ENDIF        
      DO JPATCH=1,KPATCH
        DO JJ=1,KNI
