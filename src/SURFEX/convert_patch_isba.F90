...
IF (PRESENT(PALBNIR_SOIL)) THEN
  IF (LDATA_ALBNIR_SOIL) THEN
    CALL AV_PGD_PARAM(PALBNIR_SOIL,XPAR_VEGTYPE,XPAR_ALBNIR_SOIL,YNAT,'ARI',KDECADE=KDECADE2)
  ELSE
...
IF (PRESENT(PALBVIS_SOIL)) THEN
  IF (LDATA_ALBVIS_SOIL) THEN
    CALL AV_PGD_PARAM(PALBVIS_SOIL,XPAR_VEGTYPE,XPAR_ALBVIS_SOIL,YNAT,'ARI',KDECADE=KDECADE2)  
  ELSE
