...
IF (PRESENT(PGARDEN)) THEN
  ...
  ELSE
    CALL AV_PGD (PGARDEN, PCOVER, DTCO%XDATA_GARDEN(:),'TWN','ARI',OCOVER)
  ENDIF
ENDIF
!
!
...
IF (PRESENT(PBLD)) THEN
  IF (DTT%LDATA_BLD) THEN
    PBLD=DTT%XPAR_BLD  
  ELSE
    CALL AV_PGD (PBLD, PCOVER, DTCO%XDATA_BLD(:),'TWN','ARI',OCOVER)
  ENDIF
ENDIF
!
!
...
IF (PRESENT(PZ0_TOWN)) THEN 
  ...
  ELSE
    CALL AV_PGD (PZ0_TOWN ,PCOVER ,XDATA_Z0_TOWN (:),'TWN','CDN',OCOVER)  
  ENDIF  
ENDIF
!
!      BLD Height
...
IF (PRESENT(PBLD_HEIGHT)) THEN 
  ...
  ELSE
    CALL AV_PGD (PBLD_HEIGHT ,PCOVER ,XDATA_BLD_HEIGHT (:),'BLD','ARI',OCOVER)  
  ENDIF  
ENDIF
!
!      WALL O HOR
...
IF (PRESENT(PWALL_O_HOR)) THEN
  ...
  ELSE
    CALL AV_PGD (PWALL_O_HOR ,PCOVER ,DTCO%XDATA_WALL_O_HOR (:),'BLD','ARI',OCOVER)  
  ENDIF  
ENDIF
!
!      ALB_ROOF
...
IF (PRESENT(PALB_ROOF)) THEN 
  ...
  ELSEIF (DTT%LDATA_BLDTYPE) THEN
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_BLDCODE,PALB_ROOF=PALB_ROOF)
  ELSE
    CALL AV_PGD (PALB_ROOF ,PCOVER ,XDATA_ALB_ROOF (:),YAREA,YAVG,OCOVER)  
  ENDIF  
ENDIF
!
!      EMIS_ROOF
...
IF (PRESENT(PEMIS_ROOF)) THEN 
  ...
  ELSEIF (DTT%LDATA_BLDTYPE) THEN
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_BLDCODE,PEMIS_ROOF=PEMIS_ROOF)
  ELSE
    CALL AV_PGD (PEMIS_ROOF ,PCOVER ,XDATA_EMIS_ROOF (:),YAREA,YAVG,OCOVER)  
  ENDIF  
ENDIF
!
...
IF (PRESENT(PHC_ROOF) .AND. PRESENT(PTC_ROOF) .AND. PRESENT(PD_ROOF)) THEN
  ...
  ELSEIF (DTT%LDATA_BLDTYPE) THEN
    ...
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_BLDCODE,PHC_ROOF=ZHC)
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_BLDCODE,PTC_ROOF=ZTC)
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_BLDCODE,PD_ROOF =ZD )
  ELSE
    CALL ALLOCATE_THERMAL_WORK(NDATA_ROOF_LAYER)
    DO JLAYER=1,NDATA_ROOF_LAYER
      CALL AV_PGD (ZHC(:,JLAYER), PCOVER, XDATA_HC_ROOF (:,JLAYER),YAREA,YAVG,OCOVER)
      CALL AV_PGD (ZTC(:,JLAYER), PCOVER ,XDATA_TC_ROOF (:,JLAYER),YAREA,YAVG,OCOVER)
      CALL AV_PGD (ZD (:,JLAYER), PCOVER ,XDATA_D_ROOF  (:,JLAYER),YAREA,YAVG,OCOVER)
    ENDDO
  ENDIF  
...
IF (PRESENT(PALB_ROAD)) THEN 
  ...
  ELSEIF (DTT%LDATA_BLDTYPE) THEN
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_BLDCODE,PALB_ROAD=PALB_ROAD)
  ELSE
    CALL AV_PGD (PALB_ROAD ,PCOVER ,XDATA_ALB_ROAD (:),'STR','ARI',OCOVER)  
  ENDIF  
ENDIF
!
!      EMIS_ROAD
...
IF (PRESENT(PEMIS_ROAD)) THEN 
  ...
  ELSEIF (DTT%LDATA_BLDTYPE) THEN
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_BLDCODE,PEMIS_ROAD=PEMIS_ROAD)
  ELSE
    CALL AV_PGD (PEMIS_ROAD ,PCOVER ,XDATA_EMIS_ROAD (:),'STR','ARI',OCOVER)  
  ENDIF  
ENDIF
!
...
IF (PRESENT(PHC_ROAD) .AND. PRESENT(PTC_ROAD) .AND. PRESENT(PD_ROAD)) THEN
  ...
  ELSEIF (DTT%LDATA_BLDTYPE) THEN
    ...
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_BLDCODE,PHC_ROAD=ZHC)
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_BLDCODE,PTC_ROAD=ZTC)
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_BLDCODE,PD_ROAD =ZD )
  ELSE
    CALL ALLOCATE_THERMAL_WORK(NDATA_ROAD_LAYER)
    DO JLAYER=1,NDATA_ROAD_LAYER
      CALL AV_PGD (ZHC(:,JLAYER), PCOVER, XDATA_HC_ROAD (:,JLAYER),YAREA,YAVG,OCOVER)
      CALL AV_PGD (ZTC(:,JLAYER), PCOVER ,XDATA_TC_ROAD (:,JLAYER),YAREA,YAVG,OCOVER)
      CALL AV_PGD (ZD (:,JLAYER), PCOVER ,XDATA_D_ROAD  (:,JLAYER),YAREA,YAVG,OCOVER)
...
IF (PRESENT(PALB_WALL)) THEN
  ...
  ELSEIF (DTT%LDATA_BLDTYPE) THEN
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_BLDCODE,PALB_WALL=PALB_WALL)
  ELSE
    CALL AV_PGD (PALB_WALL ,PCOVER ,XDATA_ALB_WALL (:),YAREA,YAVG,OCOVER)  
  ENDIF  
ENDIF
!
!      EMIS_WALL
...
IF (PRESENT(PEMIS_WALL)) THEN
  ...
  ELSEIF (DTT%LDATA_BLDTYPE) THEN
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_BLDCODE,PEMIS_WALL=PEMIS_WALL)
  ELSE
    CALL AV_PGD (PEMIS_WALL ,PCOVER ,XDATA_EMIS_WALL (:),YAREA,YAVG,OCOVER)  
  ENDIF  
ENDIF
!
...
IF (PRESENT(PHC_WALL) .AND. PRESENT(PTC_WALL) .AND. PRESENT(PD_WALL)) THEN
  ...
  ELSEIF (DTT%LDATA_BLDTYPE) THEN
    ...
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_BLDCODE,PHC_WALL=ZHC)
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_BLDCODE,PTC_WALL=ZTC)
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_BLDCODE,PD_WALL =ZD )
  ELSE
    CALL ALLOCATE_THERMAL_WORK(NDATA_WALL_LAYER)
    DO JLAYER=1,NDATA_WALL_LAYER
      CALL AV_PGD (ZHC(:,JLAYER), PCOVER, XDATA_HC_WALL (:,JLAYER),YAREA,YAVG,OCOVER)
      CALL AV_PGD (ZTC(:,JLAYER), PCOVER ,XDATA_TC_WALL (:,JLAYER),YAREA,YAVG,OCOVER)
      CALL AV_PGD (ZD (:,JLAYER), PCOVER ,XDATA_D_WALL  (:,JLAYER),YAREA,YAVG,OCOVER)
    ENDDO
  ENDIF  
...
IF (PRESENT(PHC_FLOOR) .AND. PRESENT(PTC_FLOOR) .AND. PRESENT(PD_FLOOR)) THEN
  ...
  ELSEIF (DTT%LDATA_BLDTYPE) THEN
    ...
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_BLDCODE,PHC_FLOOR=ZHC)
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_BLDCODE,PTC_FLOOR=ZTC)
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_BLDCODE,PD_FLOOR =ZD )
  ELSE
    CALL ALLOCATE_THERMAL_WORK(NDATA_FLOOR_LAYER)
    DO JLAYER=1,NDATA_FLOOR_LAYER
      CALL AV_PGD (ZHC(:,JLAYER), PCOVER, XDATA_HC_FLOOR (:,JLAYER),YAREA,YAVG,OCOVER)
      CALL AV_PGD (ZTC(:,JLAYER), PCOVER ,XDATA_TC_FLOOR (:,JLAYER),YAREA,YAVG,OCOVER)
      CALL AV_PGD (ZD (:,JLAYER), PCOVER ,XDATA_D_FLOOR  (:,JLAYER),YAREA,YAVG,OCOVER)
    ENDDO
  ENDIF  
...
IF (PRESENT(PH_TRAFFIC)) THEN
  ...
  ELSE
    CALL AV_PGD (PH_TRAFFIC ,PCOVER ,XDATA_H_TRAFFIC(:),'TWN','ARI',OCOVER)
  ENDIF  
ENDIF
!
!     LE_TRAFFIC
...
IF (PRESENT(PLE_TRAFFIC)) THEN
  ...
  ELSE
    CALL AV_PGD (PLE_TRAFFIC ,PCOVER ,XDATA_LE_TRAFFIC(:),'TWN','ARI',OCOVER)
  ENDIF  
ENDIF
!
!     H_INDUSTRY
...
IF (PRESENT(PH_INDUSTRY)) THEN
  ...
  ELSE
    CALL AV_PGD (PH_INDUSTRY ,PCOVER ,XDATA_H_INDUSTRY(:),'TWN','ARI',OCOVER)
  ENDIF  
ENDIF
!
!     SOLAR PANELS
...
IF (PRESENT(PEMIS_PANEL)) THEN
  ...
  ELSEIF (DTT%LDATA_BLDTYPE) THEN
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_BLDCODE,PEMIS_PANEL=PEMIS_PANEL)
  ELSE
    CALL AV_PGD (PEMIS_PANEL ,PCOVER ,XDATA_EMIS_PANEL(:),'BLD','ARI',OCOVER)
  ENDIF  
ENDIF
!
IF (PRESENT(PALB_PANEL)) THEN
  ...
  ELSEIF (DTT%LDATA_BLDTYPE) THEN
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_BLDCODE,PALB_PANEL=PALB_PANEL)
  ELSE
    CALL AV_PGD (PALB_PANEL ,PCOVER ,XDATA_ALB_PANEL(:),'BLD','ARI',OCOVER)
  ENDIF  
ENDIF
!
IF (PRESENT(PEFF_PANEL)) THEN
  ...
  ELSEIF (DTT%LDATA_BLDTYPE) THEN
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_BLDCODE,PEFF_PANEL=PEFF_PANEL)
  ELSE
    CALL AV_PGD (PEFF_PANEL ,PCOVER ,XDATA_EFF_PANEL(:),'BLD','ARI',OCOVER)
  ENDIF  
ENDIF
!
IF (PRESENT(PFRAC_PANEL)) THEN
  ...
  ELSEIF (DTT%LDATA_BLDTYPE) THEN
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_BLDCODE,PFRAC_PANEL=PFRAC_PANEL)
  ELSE
    CALL AV_PGD (PFRAC_PANEL ,PCOVER ,XDATA_FRAC_PANEL(:),'BLD','ARI',OCOVER)
  ENDIF  
ENDIF
!
!     LE_INDUSTRY
...
IF (PRESENT(PLE_INDUSTRY)) THEN
  ...
  ELSE
    CALL AV_PGD (PLE_INDUSTRY ,PCOVER ,XDATA_LE_INDUSTRY(:),'TWN','ARI',OCOVER)
  ENDIF  
ENDIF
!
!     TCOOL_TARGET
...
IF (PRESENT(PTCOOL_TARGET)) THEN
  ...
  ELSEIF (DTT%LDATA_USETYPE) THEN
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_USETYPE,PTCOOL_TARGET=PTCOOL_TARGET)
  ELSE
    CALL AV_PGD (PTCOOL_TARGET ,PCOVER ,XDATA_TCOOL_TARGET(:),'TWN','ARI',OCOVER)
  ENDIF  
ENDIF
!
!     THEAT_TARGET
...
IF (PRESENT(PTHEAT_TARGET)) THEN
  ...
  ELSEIF (DTT%LDATA_USETYPE) THEN
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_USETYPE,PTHEAT_TARGET=PTHEAT_TARGET)
  ELSE
    CALL AV_PGD (PTHEAT_TARGET ,PCOVER ,XDATA_THEAT_TARGET(:),'TWN','ARI',OCOVER)
  ENDIF  
ENDIF
!
!     -----------
IF (PRESENT(PF_WASTE_CAN)) THEN
  ...
  ELSEIF (DTT%LDATA_BLDTYPE) THEN
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_BLDCODE,PF_WASTE_CAN=PF_WASTE_CAN)
  ELSE
    CALL AV_PGD (PF_WASTE_CAN ,PCOVER ,XDATA_F_WASTE_CAN(:),'TWN','ARI',OCOVER)
  ENDIF  
ENDIF
!
!     EFF_HEAT
...
IF (PRESENT(PEFF_HEAT)) THEN
  ...
  ELSEIF (DTT%LDATA_BLDTYPE) THEN
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_BLDCODE,PEFF_HEAT=PEFF_HEAT)
  ELSE
    CALL AV_PGD (PEFF_HEAT ,PCOVER ,XDATA_EFF_HEAT(:),'TWN','ARI',OCOVER)
  ENDIF  
ENDIF
!
!     QIN
...
IF (PRESENT(PQIN)) THEN
  IF (DTB%LDATA_QIN) THEN
    PQIN=DTB%XPAR_QIN
  ELSEIF (DTT%LDATA_USETYPE) THEN
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_USETYPE,PQIN=PQIN)
  ELSE
    CALL AV_PGD (PQIN ,PCOVER ,XDATA_QIN(:),'TWN','ARI',OCOVER)
  ENDIF  
ENDIF
!
!     QIN_FRAD
...
IF (PRESENT(PQIN_FRAD)) THEN
  ...
  ELSEIF (DTT%LDATA_USETYPE) THEN
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_USETYPE,PQIN_FRAD=PQIN_FRAD)
  ELSE
    CALL AV_PGD (PQIN_FRAD ,PCOVER ,XDATA_QIN_FRAD(:),'TWN','ARI',OCOVER)
  ENDIF  
ENDIF
!
!     SHGC
...
IF (PRESENT(PSHGC)) THEN
  IF (DTB%LDATA_SHGC) THEN
    PSHGC=DTB%XPAR_SHGC
  ELSEIF (DTT%LDATA_BLDTYPE) THEN
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_BLDCODE,PSHGC=PSHGC)
  ELSE
    CALL AV_PGD (PSHGC ,PCOVER ,XDATA_SHGC(:),'TWN','ARI',OCOVER)
  ENDIF  
ENDIF
!
!     U_WIN
...
IF (PRESENT(PU_WIN)) THEN
  ...
  ELSEIF (DTT%LDATA_BLDTYPE) THEN
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_BLDCODE,PU_WIN=PU_WIN)
  ELSE
    CALL AV_PGD (PU_WIN ,PCOVER ,XDATA_U_WIN(:),'TWN','ARI',OCOVER)
  ENDIF  
ENDIF
!
!     GR
...
IF (PRESENT(PGR)) THEN
  IF (DTB%LDATA_GR) THEN
    PGR=DTB%XPAR_GR
  ELSEIF (DTT%LDATA_BLDTYPE) THEN
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_BLDCODE,PGR=PGR)
  ELSE
    CALL AV_PGD (PGR ,PCOVER ,XDATA_GR(:),'TWN','ARI',OCOVER)
  ENDIF  
ENDIF
!
!     SHGC_SH
...
IF (PRESENT(PSHGC_SH)) THEN
  ...
  ELSEIF (DTT%LDATA_USETYPE) THEN
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_USETYPE,PSHGC_SH=PSHGC_SH)
  ELSE
    CALL AV_PGD (PSHGC_SH ,PCOVER ,XDATA_SHGC_SH(:),'TWN','ARI',OCOVER)
  ENDIF  
ENDIF
!
!     FLOOR_HEIGHT
...
IF (PRESENT(PFLOOR_HEIGHT)) THEN
  ...
  ELSEIF (DTT%LDATA_BLDTYPE) THEN
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_BLDCODE,PFLOOR_HEIGHT=PFLOOR_HEIGHT)
  ELSE
    CALL AV_PGD (PFLOOR_HEIGHT ,PCOVER ,XDATA_FLOOR_HEIGHT(:),'TWN','ARI',OCOVER)
  ENDIF  
ENDIF
!
!     INF
...
IF (PRESENT(PINF)) THEN
  IF (DTB%LDATA_INF) THEN
    PINF=DTB%XPAR_INF
  ELSEIF (DTT%LDATA_BLDTYPE) THEN
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_BLDCODE,PINF=PINF)
  ELSE
    CALL AV_PGD (PINF ,PCOVER ,XDATA_INF(:),'TWN','ARI',OCOVER)
  ENDIF  
ENDIF
!
!     F_WATER_COND
...
IF (PRESENT(PF_WATER_COND)) THEN
  ...
  ELSEIF (DTT%LDATA_BLDTYPE) THEN
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_BLDCODE,PF_WATER_COND=PF_WATER_COND)
  ELSE
    CALL AV_PGD (PF_WATER_COND ,PCOVER ,XDATA_F_WATER_COND(:),'TWN','ARI',OCOVER)
  ENDIF  
ENDIF
!
!     QIN_FLAT
...
IF (PRESENT(PQIN_FLAT)) THEN
  ...
  ELSEIF (DTT%LDATA_USETYPE) THEN
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_USETYPE,PQIN_FLAT=PQIN_FLAT)
  ELSE
    CALL AV_PGD (PQIN_FLAT ,PCOVER ,XDATA_QIN_FLAT(:),'TWN','ARI',OCOVER)
  ENDIF  
ENDIF
!
!     HR_TARGET
...
IF (PRESENT(PHR_TARGET)) THEN
  ...
  ELSEIF (DTT%LDATA_USETYPE) THEN
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_USETYPE,PHR_TARGET=PHR_TARGET)
  ELSE
    CALL AV_PGD (PHR_TARGET ,PCOVER ,XDATA_HR_TARGET(:),'TWN','ARI',OCOVER)
  ENDIF  
ENDIF
!
!     V_VENT
...
IF (PRESENT(PV_VENT)) THEN
  ...
  ELSEIF (DTT%LDATA_BLDTYPE) THEN
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_BLDCODE,PV_VENT=PV_VENT)
  ELSE
    CALL AV_PGD (PV_VENT ,PCOVER ,XDATA_V_VENT(:),'TWN','ARI',OCOVER)
  ENDIF  
ENDIF
!
!     CAP_SYS_HEAT
...
IF (PRESENT(PCAP_SYS_HEAT)) THEN
  ...
  ELSEIF (DTT%LDATA_BLDTYPE) THEN
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_BLDCODE,PCAP_SYS_HEAT=PCAP_SYS_HEAT)
  ELSE
    CALL AV_PGD (PCAP_SYS_HEAT ,PCOVER ,XDATA_CAP_SYS_HEAT(:),'TWN','ARI',OCOVER)
  ENDIF  
ENDIF
!
!     CAP_SYS_RAT
...
IF (PRESENT(PCAP_SYS_RAT)) THEN
  ...
  ELSEIF (DTT%LDATA_BLDTYPE) THEN
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_BLDCODE,PCAP_SYS_RAT=PCAP_SYS_RAT)
  ELSE
    CALL AV_PGD (PCAP_SYS_RAT ,PCOVER ,XDATA_CAP_SYS_RAT(:),'TWN','ARI',OCOVER)
  ENDIF  
ENDIF
!
!     T_ADP
...
IF (PRESENT(PT_ADP)) THEN
  ...
  ELSEIF (DTT%LDATA_BLDTYPE) THEN
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_BLDCODE,PT_ADP=PT_ADP)
  ELSE
    CALL AV_PGD (PT_ADP ,PCOVER ,XDATA_T_ADP(:),'TWN','ARI',OCOVER)
  ENDIF  
ENDIF
!
!     M_SYS_RAT
...
IF (PRESENT(PM_SYS_RAT)) THEN
  ...
  ELSEIF (DTT%LDATA_BLDTYPE) THEN
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_BLDCODE,PM_SYS_RAT=PM_SYS_RAT)
  ELSE
    CALL AV_PGD (PM_SYS_RAT ,PCOVER ,XDATA_M_SYS_RAT(:),'TWN','ARI',OCOVER)
  ENDIF  
ENDIF
!
!     COP_RAT
...
IF (PRESENT(PCOP_RAT)) THEN
  ...
  ELSEIF (DTT%LDATA_BLDTYPE) THEN
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_BLDCODE,PCOP_RAT=PCOP_RAT)
  ELSE
    CALL AV_PGD (PCOP_RAT ,PCOVER ,XDATA_COP_RAT(:),'TWN','ARI',OCOVER)
  ENDIF  
ENDIF
!
!     GREENROOF FRACTION
...
IF (PRESENT(PGREENROOF)) THEN
  ...
  ELSEIF (DTT%LDATA_BLDTYPE) THEN
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_BLDCODE,PGREENROOF=PGREENROOF)
  ELSE
    CALL AV_PGD (PGREENROOF,PCOVER ,XDATA_FRAC_GR(:),'BLD','ARI',OCOVER)
  ENDIF  
ENDIF
!
!     T_SIZE_MAX
...
IF (PRESENT(PT_SIZE_MAX)) THEN
  ...
  ELSEIF (DTT%LDATA_BLDTYPE) THEN
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_BLDCODE,PT_SIZE_MAX=PT_SIZE_MAX)
  ELSE
    CALL AV_PGD (PT_SIZE_MAX ,PCOVER ,XDATA_T_SIZE_MAX(:),'TWN','ARI',OCOVER)
  ENDIF  
ENDIF
!
!     T_SIZE_MIN
...
IF (PRESENT(PT_SIZE_MIN)) THEN
  ...
  ELSEIF (DTT%LDATA_BLDTYPE) THEN
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_BLDCODE,PT_SIZE_MIN=PT_SIZE_MIN)
  ELSE
    CALL AV_PGD (PT_SIZE_MIN ,PCOVER ,XDATA_T_SIZE_MIN(:),'TWN','ARI',OCOVER)
  ENDIF  
ENDIF
!
!     SHADE
...
IF (PRESENT(PSHADE)) THEN
  ...
  ELSEIF (DTT%LDATA_USETYPE) THEN
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_USETYPE,PSHADE=PSHADE)
  ELSE
    CALL AV_PGD (PSHADE,PCOVER ,XDATA_SHADE(:),'TWN','ARI',OCOVER)
  ENDIF  
ENDIF
!
!     NATVENT
...
IF (PRESENT(PNATVENT)) THEN
  ...
  ELSEIF (DTT%LDATA_USETYPE) THEN
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_USETYPE,PNATVENT=PNATVENT)
  ELSE
    CALL AV_PGD (PNATVENT,PCOVER,XDATA_NATVENT(:),'TWN','ARI',OCOVER)
  ENDIF  
ENDIF
!
!
...
IF (PRESENT(PROUGH_ROOF)) THEN 
  ...
  ELSEIF (DTT%LDATA_BLDTYPE) THEN
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_BLDCODE,PROUGH_ROOF=PROUGH_ROOF)
  ELSE
    CALL AV_PGD (PROUGH_ROOF ,PCOVER ,XDATA_ROUGH_ROOF (:),YAREA,YAVG,OCOVER)  
  ENDIF  
ENDIF
!
!      ROUGH_WALL
...
IF (PRESENT(PROUGH_WALL)) THEN 
  ...
  ELSEIF (DTT%LDATA_BLDTYPE) THEN
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_BLDCODE,PROUGH_WALL=PROUGH_WALL)
  ELSE
    CALL AV_PGD (PROUGH_WALL ,PCOVER ,XDATA_ROUGH_WALL (:),YAREA,YAVG,OCOVER)  
  ENDIF  
ENDIF
!
...
IF (PRESENT(PRESIDENTIAL)) THEN 
  ...
  ELSEIF (DTT%LDATA_USETYPE) THEN
    CALL INI_DATA_PARAM_TEB(DTT%NPAR_USETYPE,PRESIDENTIAL=PRESIDENTIAL)
  ELSE
    CALL AV_PGD (PRESIDENTIAL ,PCOVER ,XDATA_RESIDENTIAL (:),YAREA,YAVG,OCOVER)  
  ENDIF  
ENDIF
! 
!
