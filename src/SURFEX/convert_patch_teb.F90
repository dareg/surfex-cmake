...
IF (PRESENT(PHC_ROOF) .AND. PRESENT(PTC_ROOF) .AND. PRESENT(PD_ROOF)) THEN
  ...
  ELSE
    ...
    ENDDO
  ENDIF 
  CALL THERMAL_LAYERS_CONF('ROOF ',ZD,PD_ROOF,ZHC,PHC_ROOF,ZTC,PTC_ROOF) 
...
IF (PRESENT(PHC_ROAD) .AND. PRESENT(PTC_ROAD) .AND. PRESENT(PD_ROAD)) THEN
  ...
  ELSE
    ...
    ENDDO
  ENDIF 
  CALL THERMAL_LAYERS_CONF('ROAD ',ZD,PD_ROAD,ZHC,PHC_ROAD,ZTC,PTC_ROAD) 
  CALL DEALLOCATE_THERMAL_WORK
ENDIF
!
!      ALB_WALL
...
IF (PRESENT(PHC_WALL) .AND. PRESENT(PTC_WALL) .AND. PRESENT(PD_WALL)) THEN
  ...
  ELSE
    ...
    ENDDO
  ENDIF 
  CALL THERMAL_LAYERS_CONF('WALL ',ZD,PD_WALL,ZHC,PHC_WALL,ZTC,PTC_WALL) 
  CALL DEALLOCATE_THERMAL_WORK
ENDIF
!
...
IF (PRESENT(PHC_FLOOR) .AND. PRESENT(PTC_FLOOR) .AND. PRESENT(PD_FLOOR)) THEN
  ...
  ELSE
    ...
    ENDDO
  ENDIF 
  CALL THERMAL_LAYERS_CONF('FLOOR',ZD,PD_FLOOR,ZHC,PHC_FLOOR,ZTC,PTC_FLOOR) 
  CALL DEALLOCATE_THERMAL_WORK
ENDIF
!
!     H_TRAFFIC
