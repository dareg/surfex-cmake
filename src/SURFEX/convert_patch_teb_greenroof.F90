!#############################################################
SUBROUTINE CONVERT_PATCH_TEB_GREENROOF (DTCO, DTI, TGRO, TVM, TOP, PPERM, &
                                        KLU,KDECADE)
!#############################################################
!
...
REAL,             DIMENSION(KLU,TGRO%NGROUND_LAYER,1) :: ZROOTFRAC
REAL,             DIMENSION(KLU,TGRO%NGROUND_LAYER,1) :: ZDG
...
!
!
  CALL CONVERT_PATCH_ISBA(DTCO, DTI, TGRO, &
                          TGRO%CISBA,KDECADE,KDECADE,TOP%XCOVER,TOP%LCOVER,TGRO%CPHOTO,.FALSE.,  &
                        .FALSE.,TGRO%LTR_ML,'GRD',PVEG=ZVEG,PLAI=ZLAI,              &
                        PRSMIN=ZRSMIN,PGAMMA=ZGAMMA,PWRMAX_CF=ZWRMAX_CF,       &
                        PRGL=ZRGL,PCV=ZCV,PSOILGRID=TGRO%XSOILGRID,              &
