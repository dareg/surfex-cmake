...
!
 CALL ISBA(IM%I%CISBA, IM%I%CPHOTO, IM%I%LTR_ML, IM%I%CRUNOFF, IM%I%CKSAT, IM%I%CRAIN, &
           ...
           IM%I%LSNOW_ABS_ZENITH, IM%I%CSNOWMETAMO, IM%I%CSNOWRAD,IM%I%LATMORAD,&
           IM%I%LSNOWSYTRON, IM%I%XCGMAX, ZP_ZREF, &
           ...
           ZP_DIR_SW, ZP_SCA_SW,IM%PKDI%XP_SPEC_ALB,IM%PKDI%XP_DIFF_RATIO,IM%PKDI%XP_SNOWIMPURV2)
!
