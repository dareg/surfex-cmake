...
!
 CALL ISBA(IM%I%CISBA, IM%I%CPHOTO, IM%I%LTR_ML, IM%I%CRUNOFF, IM%I%CKSAT, IM%I%CRAIN, &
           ...
           IM%PKDI%XP_SNOWSWE_7DAYS,IM%PKDI%XP_SNOWRAM_SONDE,IM%PKDI%XP_SNOW_WETTHICKNESS, &
	   IM%PKDI%XP_SNOW_REFROZENTHICKNESS, IM%PKDI%XP_PRODCOUNT, &
	   IM%I%LSNOWCOMPACT_BOOL,IM%I%LSNOWMAK_BOOL, IM%I%LSNOWTILLER, IM%I%LSELF_PROD, IM%I%LSNOWMAK_PROP, &
	   IM%I%LPRODSNOWMAK)
!
