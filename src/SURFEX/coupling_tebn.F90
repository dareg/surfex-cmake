...
!
INTEGER                    :: JTEB_PATCH, IBEG, IEND ! loop counter
!
...
DO JTEB_PATCH = 1,TOP%NTEB_PATCH
  ...
  CALL ADD_PATCH_CONTRIB(JTEB_PATCH,ZAVG_GFLX ,ZGFLX )
  !
  !* warning: aerodynamical resistance does not yet take into account gardens
  CALL ADD_PATCH_CONTRIB(JTEB_PATCH,ZAVG_RESA,1./ZRESA)
  IF (JTEB_PATCH==TOP%NTEB_PATCH) ZAVG_RESA = 1./ZAVG_RESA
  !
  !-------------------------------------------------------------------------------------
