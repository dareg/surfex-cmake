...
USE MODD_ISBA_n,      ONLY : LCOVER, XCOVER, XZS, XZ0EFFJPDIR, XCLAY, XSAND,       &
                               ...
                               XZ0REL, XSSO_SLOPE,                                 &
                               XWWILT, XWFC, XWSAT, XWD0, XKANISO,                 &
                               ...
                               XTAB_WTOP,XTAB_QTOP,XD_ICE,XKSAT_ICE,XMUF,XFSAT,    &
                               XFFLOOD, XPIFLOOD,                                  &
                               ...
                               XCPL_RUNOFF, XCPL_ICEFLUX, XCPL_RECHARGE,           &
                               XICE_STO, XFFROZEN, XDG_OLD,XPATCH_OLD,XABC,XPOI,   &
                               XFRACSOC, XTOPQS, XFWTD, XWTD
...
IF (ASSOCIATED(XWD0)) DEALLOCATE(XWD0)
IF (ASSOCIATED(XKANISO)) DEALLOCATE(XKANISO)
...
!
IF (ASSOCIATED(XVEGGV      )) DEALLOCATE(XVEGGV      )
...
IF (ASSOCIATED(XZ0GV       )) DEALLOCATE(XZ0GV       )
...
IF(ASSOCIATED(XTAB_QTOP))    DEALLOCATE(XTAB_QTOP)
...
IF(ASSOCIATED(XTOPQS))       DEALLOCATE(XTOPQS)
IF(ASSOCIATED(XFWTD))        DEALLOCATE(XFWTD)
IF(ASSOCIATED(XWTD))         DEALLOCATE(XWTD)
!
...
IF(ASSOCIATED(XCPL_RECHARGE)) DEALLOCATE(XCPL_RECHARGE)
!-------------------------------------------------------------------------------------
