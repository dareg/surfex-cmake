...
!
CALL DIAG_PATCH_INIT(IM%ID%DP,0)
CALL DIAG_PATCH_INIT(IM%ID%DPC,0)
CALL DIAG_EVAP_ISBA_PATCH_INIT(IM%ID%DEP,0)
CALL DIAG_EVAP_ISBA_PATCH_INIT(IM%ID%DEPC,0) 
CALL DIAG_MISC_ISBA_PATCH_INIT(IM%ID%DMP,0)
  !
