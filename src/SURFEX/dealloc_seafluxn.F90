...
!-------------------------------------------------------------------------------------
!
!IF (ASSOCIATED(SM%S%TGLT%bat) .AND. SM%S%CSEAICE_SCHEME=='GELATO' ) CALL GLTOOLS_DEALLOC(SM%S%TGLT,SM%S%GLTPARAM%nnflxin,SM%S%GLTPARAM%noutlu,SM%S%GLTPARAM%ntd,SM%S%GLTPARAM%lwg)
!ANTMPTEST
IF (SM%S%CSEAICE_SCHEME=='GELATO' ) CALL GLTOOLS_DEALLOC(SM%S%TGLT,SM%S%GLTPARAM%nnflxin,SM%S%GLTPARAM%noutlu,SM%S%GLTPARAM%ntd,SM%S%GLTPARAM%lwg)
!
