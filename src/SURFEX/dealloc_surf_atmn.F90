...
!-------------------------------------------------------------------------------------
!
IF (ASSOCIATED(YSC%UG%XGRID_FULL_PAR )) DEALLOCATE(YSC%UG%XGRID_FULL_PAR )
IF (ASSOCIATED(YSC%UG%G%XGRID_PAR )) DEALLOCATE(YSC%UG%G%XGRID_PAR )
IF (ASSOCIATED(YSC%UG%G%XLAT      )) DEALLOCATE(YSC%UG%G%XLAT      )
IF (ASSOCIATED(YSC%UG%G%XLON      )) DEALLOCATE(YSC%UG%G%XLON      )
IF (ASSOCIATED(YSC%UG%G%XMESH_SIZE)) DEALLOCATE(YSC%UG%G%XMESH_SIZE)
...
!-------------------------------------------------------------------------------------
!
 CALL DEALLOC_SEA_n(YSC%SM%CHS, YSC%SM%G, YSC%SM%S, YSC%U)
CALL DEALLOC_INLAND_WATER_n(YSC%FM%CHF, YSC%WM%CHW, YSC%FM%G, YSC%FM%F, YSC%U, YSC%WM%G, YSC%WM%W)
CALL DEALLOC_NATURE_n(YSC%IM, YSC%U)
 CALL DEALLOC_TOWN_n(YSC%TM%B, YSC%TM%CHT, YSC%TM%DTT, YSC%U, YSC%TM%G, &
