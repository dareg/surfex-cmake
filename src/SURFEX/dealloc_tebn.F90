...
USE MODD_TEB_n,        ONLY : XH_TRAFFIC, XLE_TRAFFIC, XH_INDUSTRY, XLE_INDUSTRY,    &
                              ...
                              XROUGH_ROOF, XROUGH_WALL, XRESIDENTIAL
...
!
IF(ASSOCIATED(XEMIS_PANEL)) DEALLOCATE(XEMIS_PANEL)
IF(ASSOCIATED(XALB_PANEL )) DEALLOCATE(XALB_PANEL )
IF(ASSOCIATED(XEFF_PANEL )) DEALLOCATE(XEFF_PANEL )
IF(ASSOCIATED(XFRAC_PANEL)) DEALLOCATE(XFRAC_PANEL)
IF(ASSOCIATED(XTHER_PRODC_DAY)) DEALLOCATE(XTHER_PRODC_DAY)
!
...
IF(ASSOCIATED(XPAR_RESIDENTIAL))  DEALLOCATE(XPAR_RESIDENTIAL)
IF(ASSOCIATED(XROUGH_ROOF ))  DEALLOCATE(XROUGH_ROOF)
IF(ASSOCIATED(XROUGH_WALL ))  DEALLOCATE(XROUGH_WALL)
IF(ASSOCIATED(XRESIDENTIAL))  DEALLOCATE(XRESIDENTIAL)
