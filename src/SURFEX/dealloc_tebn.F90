...
!
USE MODD_DIAG_EVAP_ISBA_n, ONLY : DIAG_EVAP_ISBA_PATCH_INIT
USE MODD_DIAG_n, ONLY : DIAG_INIT, DIAG_PATCH_INIT, DIAG_OPTIONS_INIT
USE MODD_DIAG_MISC_ISBA_n, ONLY : DIAG_MISC_ISBA_PATCH_INIT
!
...
!
CALL DIAG_PATCH_INIT(GDM%VD%DP,0)  
CALL DIAG_EVAP_ISBA_PATCH_INIT(GDM%VD%DEP,0)
CALL DIAG_EVAP_ISBA_PATCH_INIT(GDM%VD%DEPC,0)
CALL DIAG_MISC_ISBA_PATCH_INIT(GDM%VD%DMP,0)  
  !  
...
CALL TEB_IRRIG_INIT(GDM%TIR)    
!
CALL ISBA_NPE_INIT(GDM%NPE,0)  
!
CALL DIAG_PATCH_INIT(GRM%VD%DP,0)
CALL DIAG_EVAP_ISBA_PATCH_INIT(GRM%VD%DEP,0)
CALL DIAG_EVAP_ISBA_PATCH_INIT(GRM%VD%DEPC,0)
CALL DIAG_MISC_ISBA_PATCH_INIT(GRM%VD%DMP,0)
  !
...
!
CALL DIAG_MISC_TEB_INIT(TM%TD%DMT,0)   
CALL DIAG_MISC_TEB_INIT(TM%TD%DMTC,0)
! 
