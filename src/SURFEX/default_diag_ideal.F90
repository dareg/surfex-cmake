...
!     #########
      SUBROUTINE DEFAULT_DIAG_IDEAL(K2M,OSURF_BUDGET,O2M_MIN_ZS,OHU2M_QSAT,     &
                                    ORAD_BUDGET,OCOEF,OSURF_VARS,               &
                                    OSURF_BUDGETC,ORESET_BUDGETC,PDIAG_TSTEP    )  
!     ########################################################################
!
!!****  *DEFAULT_DIAG_IDEAL* - routine to set default values for the choice of diagnostics
!!
!!    PURPOSE
!!    -------
!!
...
!-------------------------------------------------------------------------------
!
IF (LHOOK) CALL DR_HOOK('DEFAULT_DIAG_IDEAL',0,ZHOOK_HANDLE)
K2M = 0
OSURF_BUDGET = .FALSE.
!
O2M_MIN_ZS = .FALSE.
...
PDIAG_TSTEP  = XUNDEF
!
IF (LHOOK) CALL DR_HOOK('DEFAULT_DIAG_IDEAL',1,ZHOOK_HANDLE)
!
!-------------------------------------------------------------------------------
!
END SUBROUTINE DEFAULT_DIAG_IDEAL
