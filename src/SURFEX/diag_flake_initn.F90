...
!
  ...
  ELSE
     ...
     ELSE
       YREC='RNC_WAT'
       CALL READ_SURF(HPROGRAM,YREC,DGF%XRNC,IRESP)
       YREC='HC_WAT'
       CALL READ_SURF(HPROGRAM,YREC,DGF%XHC ,IRESP)
       YREC='LEC_WAT'
       CALL READ_SURF(HPROGRAM,YREC,DGF%XLEC,IRESP)
       YREC='LEIC_WAT'
       CALL READ_SURF(HPROGRAM,YREC,DGF%XLEIC,IRESP)     
       YREC='GFLUXC_WAT'
       CALL READ_SURF(HPROGRAM,YREC,DGF%XGFLUXC,IRESP)
       YREC='SWDC_WAT'
       CALL READ_SURF(HPROGRAM,YREC,DGF%XSWDC,IRESP)
       YREC='SWUC_WAT'
       CALL READ_SURF(HPROGRAM,YREC,DGF%XSWUC,IRESP)
       YREC='LWDC_WAT'
       CALL READ_SURF(HPROGRAM,YREC,DGF%XLWDC,IRESP)
       YREC='LWUC_WAT'
       CALL READ_SURF(HPROGRAM,YREC,DGF%XLWUC,IRESP)
       YREC='FMUC_WAT'
       CALL READ_SURF(HPROGRAM,YREC,DGF%XFMUC,IRESP)
       YREC='FMVC_WAT'
       CALL READ_SURF(HPROGRAM,YREC,DGF%XFMVC,IRESP)
       YREC='EVAPC_WAT'
        CALL READ_SURF(HPROGRAM,YREC,DGF%XEVAPC,IRESP)
        YREC='SUBLC_WAT'
        CALL READ_SURF(HPROGRAM,YREC,DGF%XSUBLC,IRESP)              
      ENDIF
!
  ENDIF   
ELSE
