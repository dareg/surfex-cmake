...
IF (DGMI%LSURF_MISC_BUDGET) THEN
  ...
  IF (DGMI%LPROSNOW) THEN
    ALLOCATE(DGMI%XAVG_SNOWDEPTH_1DAYS(KLU))
    ALLOCATE(DGMI%XAVG_SNOWDEPTH_3DAYS(KLU))
    ALLOCATE(DGMI%XAVG_SNOWDEPTH_5DAYS(KLU))
    ALLOCATE(DGMI%XAVG_SNOWDEPTH_7DAYS(KLU))  
    ALLOCATE(DGMI%XAVG_SNOWSWE_1DAYS(KLU))
    ALLOCATE(DGMI%XAVG_SNOWSWE_3DAYS(KLU))
    ALLOCATE(DGMI%XAVG_SNOWSWE_5DAYS(KLU))
    ALLOCATE(DGMI%XAVG_SNOWSWE_7DAYS(KLU)) 
    ALLOCATE(DGMI%XAVG_SNOWRAM_SONDE(KLU)) 
    ALLOCATE(DGMI%XAVG_SNOW_WETTHICKNESS(KLU)) 
    ALLOCATE(DGMI%XAVG_SNOW_REFROZENTHICKNESS(KLU))
    IF (DGMI%LPROBANDS) THEN
      ALLOCATE(DGMI%XAVG_SPEC_ALB(KLU,KSW))
      ALLOCATE(DGMI%XAVG_DIFF_RATIO(KLU,KSW))
    ELSE 
      ALLOCATE(DGMI%XAVG_SPEC_ALB(0,0))
      ALLOCATE(DGMI%XAVG_DIFF_RATIO(0,0))
    ENDIF
  ELSE
    ALLOCATE(DGMI%XAVG_SNOWDEPTH_1DAYS(0))
    ALLOCATE(DGMI%XAVG_SNOWDEPTH_3DAYS(0))
    ALLOCATE(DGMI%XAVG_SNOWDEPTH_5DAYS(0))
    ALLOCATE(DGMI%XAVG_SNOWDEPTH_7DAYS(0))  
    ALLOCATE(DGMI%XAVG_SNOWSWE_1DAYS(0))
    ALLOCATE(DGMI%XAVG_SNOWSWE_3DAYS(0))
    ALLOCATE(DGMI%XAVG_SNOWSWE_5DAYS(0))
    ALLOCATE(DGMI%XAVG_SNOWSWE_7DAYS(0)) 
    ALLOCATE(DGMI%XAVG_SNOWRAM_SONDE(0)) 
    ALLOCATE(DGMI%XAVG_SNOW_WETTHICKNESS(0)) 
    ALLOCATE(DGMI%XAVG_SNOW_REFROZENTHICKNESS(0))
    ALLOCATE(DGMI%XAVG_SPEC_ALB(0,0))
    ALLOCATE(DGMI%XAVG_DIFF_RATIO(0,0))
  ENDIF
  
  ALLOCATE(DGMI%XAVG_SYTMASS      (KLU))
  ALLOCATE(DGMI%XAVG_SYTMASSC     (KLU))  
  !
  DGMI%XAVG_HV      = XUNDEF
  ...
  IF (DGMI%LPROSNOW) THEN
    DGMI%XAVG_SNOWDEPTH_1DAYS = XUNDEF
    DGMI%XAVG_SNOWDEPTH_3DAYS = XUNDEF  
    DGMI%XAVG_SNOWDEPTH_5DAYS = XUNDEF
    DGMI%XAVG_SNOWDEPTH_7DAYS = XUNDEF
    DGMI%XAVG_SNOWSWE_1DAYS = XUNDEF
    DGMI%XAVG_SNOWSWE_3DAYS = XUNDEF
    DGMI%XAVG_SNOWSWE_5DAYS = XUNDEF
    DGMI%XAVG_SNOWSWE_7DAYS = XUNDEF
    DGMI%XAVG_SNOWRAM_SONDE = XUNDEF
    DGMI%XAVG_SNOW_WETTHICKNESS = XUNDEF
    DGMI%XAVG_SNOW_REFROZENTHICKNESS = XUNDEF
    IF (DGMI%LPROBANDS) THEN
    DGMI%XAVG_SPEC_ALB=XUNDEF
    DGMI%XAVG_DIFF_RATIO=XUNDEF
    ENDIF
  ENDIF  
  DGMI%XAVG_SYTMASS = XUNDEF
  DGMI%XAVG_SYTMASSC= 0.
  !
  ALLOCATE(DGMI%XAVG_PRODCOUNT    (KLU))
  DGMI%XAVG_PRODCOUNT  = XUNDEF
  !
  ...
  IF (DGMI%LPROSNOW) THEN
    ALLOCATE(DGMI%XSNOWDZ (KLU,I%TSNOW%NLAYER,I%NPATCH))
    ALLOCATE(DGMI%XSNOWDEND (KLU,I%TSNOW%NLAYER,I%NPATCH))
    ALLOCATE(DGMI%XSNOWSPHER (KLU,I%TSNOW%NLAYER,I%NPATCH))
    ALLOCATE(DGMI%XSNOWSIZE (KLU,I%TSNOW%NLAYER,I%NPATCH))    
    ALLOCATE(DGMI%XSNOWSSA (KLU,I%TSNOW%NLAYER,I%NPATCH))
    ALLOCATE(DGMI%XSNOWTYPEMEPRA (KLU,I%TSNOW%NLAYER,I%NPATCH))
    ALLOCATE(DGMI%XSNOWRAM (KLU,I%TSNOW%NLAYER,I%NPATCH))  
    ALLOCATE(DGMI%XSNOWSHEAR (KLU,I%TSNOW%NLAYER,I%NPATCH))
!       
    ALLOCATE(DGMI%XSNOWDEPTH_1DAYS(KLU,I%NPATCH))
    ALLOCATE(DGMI%XSNOWDEPTH_3DAYS(KLU,I%NPATCH))
    ALLOCATE(DGMI%XSNOWDEPTH_5DAYS(KLU,I%NPATCH))
    ALLOCATE(DGMI%XSNOWDEPTH_7DAYS(KLU,I%NPATCH))  
    ALLOCATE(DGMI%XSNOWSWE_1DAYS(KLU,I%NPATCH))
    ALLOCATE(DGMI%XSNOWSWE_3DAYS(KLU,I%NPATCH))
    ALLOCATE(DGMI%XSNOWSWE_5DAYS(KLU,I%NPATCH))
    ALLOCATE(DGMI%XSNOWSWE_7DAYS(KLU,I%NPATCH)) 
    ALLOCATE(DGMI%XSNOWRAM_SONDE(KLU,I%NPATCH)) 
    ALLOCATE(DGMI%XIMPUR (KLU,I%TSNOW%NLAYER,NIMPUR,I%NPATCH)) 
    IF (DGMI%LPROBANDS) THEN
	ALLOCATE(DGMI%XSPEC_ALB(KLU,KSW,I%NPATCH))
	ALLOCATE(DGMI%XDIFF_RATIO(KLU,KSW,I%NPATCH))
    ELSE
        ALLOCATE(DGMI%XSPEC_ALB(0,0,0))
        ALLOCATE(DGMI%XDIFF_RATIO(0,0,0))   
    ENDIF 
    
    ALLOCATE(DGMI%XSNOW_WETTHICKNESS(KLU,I%NPATCH)) 
    ALLOCATE(DGMI%XSNOW_REFROZENTHICKNESS(KLU,I%NPATCH))
  ELSE
    ALLOCATE(DGMI%XSNOWDZ (0,0,0))
    ALLOCATE(DGMI%XSNOWDEND (0,0,0))
    ALLOCATE(DGMI%XSNOWSPHER (0,0,0))
    ALLOCATE(DGMI%XSNOWSIZE (0,0,0))    
    ALLOCATE(DGMI%XSNOWSSA (0,0,0))
    ALLOCATE(DGMI%XSNOWTYPEMEPRA (0,0,0))
    ALLOCATE(DGMI%XSNOWRAM (0,0,0))  
    ALLOCATE(DGMI%XSNOWSHEAR (0,0,0))
!       
    ALLOCATE(DGMI%XSNOWDEPTH_1DAYS(0,0))
    ALLOCATE(DGMI%XSNOWDEPTH_3DAYS(0,0))
    ALLOCATE(DGMI%XSNOWDEPTH_5DAYS(0,0))
    ALLOCATE(DGMI%XSNOWDEPTH_7DAYS(0,0))  
    ALLOCATE(DGMI%XSNOWSWE_1DAYS(0,0))
    ALLOCATE(DGMI%XSNOWSWE_3DAYS(0,0))
    ALLOCATE(DGMI%XSNOWSWE_5DAYS(0,0))
    ALLOCATE(DGMI%XSNOWSWE_7DAYS(0,0)) 
    ALLOCATE(DGMI%XSNOWRAM_SONDE(0,0))
    ALLOCATE(DGMI%XIMPUR (0,0,0,0)) 
    ALLOCATE(DGMI%XSNOW_WETTHICKNESS(0,0)) 
    ALLOCATE(DGMI%XSNOW_REFROZENTHICKNESS(0,0)) 
    ALLOCATE(DGMI%XSPEC_ALB(0,0,0))
    ALLOCATE(DGMI%XDIFF_RATIO(0,0,0))   
  ENDIF
  
  ALLOCATE(DGMI%XSYTMASS (KLU,I%NPATCH))
  ALLOCATE(DGMI%XSYTMASSC(KLU,I%NPATCH))
  !
  DGMI%XHV      = XUNDEF
  DGMI%XSWI     = XUNDEF
  DGMI%XTSWI    = XUNDEF
  ...
  IF (DGMI%LPROSNOW) THEN
    DGMI%XSNOWDZ= XUNDEF
    DGMI%XSNOWDEND= XUNDEF
    DGMI%XSNOWSPHER= XUNDEF
    DGMI%XSNOWSIZE= XUNDEF
    DGMI%XSNOWSSA= XUNDEF
    DGMI%XSNOWTYPEMEPRA= XUNDEF
    DGMI%XSNOWRAM= XUNDEF
    IF (DGMI%LPROBANDS) THEN
	DGMI%XSPEC_ALB=XUNDEF
	DGMI%XDIFF_RATIO=XUNDEF
    ENDIF 
    DGMI%XSNOWSHEAR= XUNDEF
    DGMI%XSNOWDEPTH_1DAYS= XUNDEF
    DGMI%XSNOWDEPTH_3DAYS= XUNDEF
    DGMI%XSNOWDEPTH_5DAYS= XUNDEF
    DGMI%XSNOWDEPTH_7DAYS= XUNDEF  
    DGMI%XSNOWSWE_1DAYS= XUNDEF
    DGMI%XSNOWSWE_3DAYS= XUNDEF
    DGMI%XSNOWSWE_5DAYS= XUNDEF
    DGMI%XSNOWSWE_7DAYS= XUNDEF    
    DGMI%XSNOWRAM_SONDE= XUNDEF  
    DGMI%XIMPUR= XUNDEF  
    DGMI%XSNOW_WETTHICKNESS= XUNDEF 
    DGMI%XSNOW_REFROZENTHICKNESS= XUNDEF 
  ENDIF
  DGMI%XSYTMASS = XUNDEF
  DGMI%XSYTMASSC= 0.
  !
  ALLOCATE(DGMI%XPRODCOUNT (KLU,I%NPATCH))
  DGMI%XPRODCOUNT = XUNDEF
  !
...
!
  ...
  ALLOCATE(DGMI%XAVG_SYTMASS (0))
  ALLOCATE(DGMI%XAVG_SYTMASSC(0))
  ALLOCATE(DGMI%XAVG_PRODCOUNT(0))
!
!
...
!       
  ...
  ALLOCATE(DGMI%XSYTMASS (0,0))
  ALLOCATE(DGMI%XSYTMASSC(0,0))
!
  ALLOCATE(DGMI%XPRODCOUNT(0,0))
!
END IF
!
IF (I%CISBA/='DIF') THEN
