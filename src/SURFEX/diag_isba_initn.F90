...
IF (DGI%LSURF_BUDGET) THEN
  ...
  DGI%XAVG_FMV     = XUNDEF
  !
  ALLOCATE(DGI%XRN       (KLU,IO%NPATCH))
  ALLOCATE(DGI%XH        (KLU,IO%NPATCH))
  ALLOCATE(DGI%XGFLUX    (KLU,IO%NPATCH))
  ALLOCATE(DGI%XLEI      (KLU,IO%NPATCH))
  ALLOCATE(DGI%XSWD      (KLU,IO%NPATCH))
  ALLOCATE(DGI%XSWU      (KLU,IO%NPATCH))
  ALLOCATE(DGI%XSWBD     (KLU,KSW,IO%NPATCH))
  ALLOCATE(DGI%XSWBU     (KLU,KSW,IO%NPATCH))
  ALLOCATE(DGI%XLWD      (KLU,IO%NPATCH))
  ALLOCATE(DGI%XLWU      (KLU,IO%NPATCH))
  ALLOCATE(DGI%XFMU      (KLU,IO%NPATCH))
  ALLOCATE(DGI%XFMV      (KLU,IO%NPATCH))
  !
  DGI%XRN      = XUNDEF
  DGI%XH       = XUNDEF
  DGI%XGFLUX   = XUNDEF
...
IF (DGEI%LSURF_EVAP_BUDGET) THEN
  ...
  !
  ALLOCATE(DGEI%XLEG       (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XLEGI      (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XLEV       (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XLES       (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XLESL      (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XLER       (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XLETR      (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XEVAP      (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XSUBL      (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XSNDRIFT   (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XDRAIN     (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XQSB       (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XRUNOFF    (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XHORT      (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XDRIP      (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XRRVEG     (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XMELT      (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XIRRIG_FLUX(KLU,IO%NPATCH))
  ALLOCATE(DGEI%XGPP       (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XRESP_AUTO (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XRESP_ECO  (KLU,IO%NPATCH))
  !
  DGEI%XLEG           = XUNDEF 
  DGEI%XLEGI          = XUNDEF
  DGEI%XLEV           = XUNDEF
  ...
  !
  ALLOCATE(DGEI%XIFLOOD (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XPFLOOD (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XLE_FLOOD(KLU,IO%NPATCH))
  ALLOCATE(DGEI%XLEI_FLOOD(KLU,IO%NPATCH))
  DGEI%XIFLOOD        = XUNDEF
  DGEI%XPFLOOD        = XUNDEF
...
!
    ...
    !
    ALLOCATE(DGEI%XLEVCV  (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XLESC   (KLU,IO%NPATCH))
!    ALLOCATE(XLETRGV (KLU,NPATCH))
    ALLOCATE(DGEI%XLETRCV (KLU,IO%NPATCH))
!    ALLOCATE(XLERGV  (KLU,NPATCH))
    ALLOCATE(DGEI%XLELITTER (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XLELITTERI(KLU,IO%NPATCH))
    ALLOCATE(DGEI%XDRIPLIT  (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XRRLIT    (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XLERCV  (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XLE_C_A (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XLE_V_C (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XLE_G_C (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XLE_N_C (KLU,IO%NPATCH))
    !
    ALLOCATE(DGEI%XSWNET_V    (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XSWNET_G    (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XSWNET_N    (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XSWNET_NS   (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XLWNET_V    (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XLWNET_G    (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XLWNET_N    (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XSWDOWN_GN  (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XLWDOWN_GN  (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XH_V_C      (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XH_G_C      (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XH_C_A      (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XH_N_C      (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XSR_GN      (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XMELTCV     (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XFRZCV      (KLU,IO%NPATCH))
!
    DGEI%XLEVCV         = XUNDEF
    DGEI%XLESC          = XUNDEF
!    XLETRGV        = XUNDEF
...
!    ALLOCATE(XLERGV  (0,0))
  ...
  IF(DGEI%LWATER_BUDGET)THEN
    ...
    !
    ALLOCATE(DGEI%XDWG   (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XDWGI  (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XDWR   (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XDSWE  (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XWATBUD(KLU,IO%NPATCH))
    DGEI%XDWG    = XUNDEF
    DGEI%XDWGI   = XUNDEF
    DGEI%XDWR    = XUNDEF
    DGEI%XDSWE   = XUNDEF
...
IF (DGEI%LSURF_BUDGETC .OR. .NOT.DGEI%LRESET_BUDGETC) THEN
  ...
  !
  ALLOCATE(DGEI%XRNC        (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XHC         (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XLEC        (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XLEIC       (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XGFLUXC     (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XLEGC       (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XLEGIC      (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XLEVC       (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XLESAC      (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XLESLC      (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XLERC       (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XLETRC      (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XEVAPC      (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XSUBLC      (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XSNDRIFTC   (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XDRAINC     (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XQSBC       (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XRUNOFFC    (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XHORTC      (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XDRIPC      (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XRRVEGC     (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XMELTC      (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XIRRIG_FLUXC(KLU,IO%NPATCH))
  ALLOCATE(DGEI%XGPPC       (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XRESPC_AUTO (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XRESPC_ECO  (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XIFLOODC    (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XPFLOODC    (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XLE_FLOODC  (KLU,IO%NPATCH))
  ALLOCATE(DGEI%XLEI_FLOODC (KLU,IO%NPATCH))
  !
  IF (ISIZE_LMEB_PATCH>0) THEN
    ...
    !
    ALLOCATE(DGEI%XLEVCVC  (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XLESCC   (KLU,IO%NPATCH))
!    ALLOCATE(XLETRGVC  (KLU,NPATCH))
    ALLOCATE(DGEI%XLETRCVC  (KLU,IO%NPATCH))
!    ALLOCATE(XLERGVC   (KLU,NPATCH))
    ALLOCATE(DGEI%XLERCVC   (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XLE_C_AC  (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XLE_V_CC  (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XLE_G_CC  (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XLE_N_CC  (KLU,IO%NPATCH))
    !
    ALLOCATE(DGEI%XSWNET_VC    (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XSWNET_GC    (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XSWNET_NC    (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XSWNET_NSC   (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XLWNET_VC    (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XLWNET_GC    (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XLWNET_NC    (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XSWDOWN_GNC  (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XLWDOWN_GNC  (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XH_V_CC      (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XH_G_CC      (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XH_C_AC      (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XH_N_CC      (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XSR_GNC      (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XMELTCVC     (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XFRZCVC      (KLU,IO%NPATCH))
  ELSE
...
!    ALLOCATE(XLERGVC   (0,0))
  ...
  ALLOCATE(DGI%XSWDC     (KLU,IO%NPATCH))
  ALLOCATE(DGI%XSWUC     (KLU,IO%NPATCH))
  ALLOCATE(DGI%XLWDC     (KLU,IO%NPATCH))
  ALLOCATE(DGI%XLWUC     (KLU,IO%NPATCH))
  ALLOCATE(DGI%XFMUC     (KLU,IO%NPATCH))
  ALLOCATE(DGI%XFMVC     (KLU,IO%NPATCH))
  !
  IF(IO%LGLACIER)THEN
    ALLOCATE(DGEI%XAVG_ICEFLUXC(KLU))
    ALLOCATE(DGEI%XICEFLUXC(KLU,IO%NPATCH))
  ENDIF
  !
#ifdef SFX_OL
  ...
  IF(DGEI%LWATER_BUDGET .OR. .NOT.DGEI%LRESET_BUDGETC)THEN
    ...
    !
    ALLOCATE(DGEI%XDWGC   (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XDWGIC  (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XDWRC   (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XDSWEC  (KLU,IO%NPATCH))
    ALLOCATE(DGEI%XWATBUDC(KLU,IO%NPATCH))
    !
  ELSE
    !      
...
!
ALLOCATE(DGI%XTS    (KLU,IO%NPATCH))
ALLOCATE(DGI%XAVG_TS(KLU))
DGI%XTS     = XUNDEF
DGI%XAVG_TS = XUNDEF
ALLOCATE(DGI%XTSRAD    (KLU,IO%NPATCH))
DGI%XTSRAD     = XUNDEF
!
IF (DGI%N2M>=1) THEN
  ...
  !
  ALLOCATE(DGI%XRI     (KLU,IO%NPATCH))
  ALLOCATE(DGI%XT2M    (KLU,IO%NPATCH))
  ALLOCATE(DGI%XQ2M    (KLU,IO%NPATCH))
  ALLOCATE(DGI%XHU2M   (KLU,IO%NPATCH))
  ALLOCATE(DGI%XZON10M (KLU,IO%NPATCH))
  ALLOCATE(DGI%XMER10M (KLU,IO%NPATCH))
  ALLOCATE(DGI%XWIND10M(KLU,IO%NPATCH))
  ALLOCATE(DGI%XT2M_MIN(KLU,IO%NPATCH))
  ALLOCATE(DGI%XT2M_MAX(KLU,IO%NPATCH))
  !
  DGI%XRI      = XUNDEF
  DGI%XT2M     = XUNDEF
  DGI%XQ2M     = XUNDEF
...
IF (DGMI%LSURF_MISC_BUDGET) THEN
  ...
  ALLOCATE(DGMI%XAVG_SWI          (KLU,IO%NGROUND_LAYER))
  ALLOCATE(DGMI%XAVG_TSWI         (KLU,IO%NGROUND_LAYER))
  !
  ...
  !
  ALLOCATE(DGMI%XHV     (KLU,IO%NPATCH))
  ALLOCATE(DGMI%XSWI    (KLU,IO%NGROUND_LAYER,IO%NPATCH))
  ALLOCATE(DGMI%XTSWI   (KLU,IO%NGROUND_LAYER,IO%NPATCH))
  ALLOCATE(DGMI%XTWSNOW (KLU,IO%NPATCH))
  ALLOCATE(DGMI%XTDSNOW (KLU,IO%NPATCH))
  ALLOCATE(DGMI%XTTSNOW (KLU,IO%NPATCH))
  ALLOCATE(DGMI%XDPSNG  (KLU,IO%NPATCH))
  ALLOCATE(DGMI%XDPSNV  (KLU,IO%NPATCH))
  ALLOCATE(DGMI%XDPSN   (KLU,IO%NPATCH))
  ALLOCATE(DGMI%XALBT   (KLU,IO%NPATCH))
  !
  ALLOCATE(DGMI%XDFSAT  (KLU,IO%NPATCH))
  ALLOCATE(DGMI%XDFFG   (KLU,IO%NPATCH))
  ALLOCATE(DGMI%XDFFV   (KLU,IO%NPATCH))
  ALLOCATE(DGMI%XDFF    (KLU,IO%NPATCH))
  !
  ALLOCATE(DGMI%XSNOWLIQ  (KLU,KSNOW_LAYER,IO%NPATCH))
  ALLOCATE(DGMI%XSNOWTEMP (KLU,KSNOW_LAYER,IO%NPATCH))
  !
  DGMI%XHV      = XUNDEF
  DGMI%XSWI     = XUNDEF
  DGMI%XTSWI    = XUNDEF
  ...
  IF(IO%CISBA=='DIF')THEN
    ALLOCATE(DGMI%XALT(KLU,IO%NPATCH))
    ALLOCATE(DGMI%XFLT(KLU,IO%NPATCH))
  ...
  !
  IF (IO%LTR_ML) THEN
    ALLOCATE (DGMI%XFAPAR      (KLU, IO%NPATCH))
    ALLOCATE (DGMI%XFAPIR      (KLU, IO%NPATCH))
    ALLOCATE (DGMI%XFAPAR_BS   (KLU, IO%NPATCH))
    ALLOCATE (DGMI%XFAPIR_BS   (KLU, IO%NPATCH))
    ALLOCATE (DGMI%XDFAPARC    (KLU, IO%NPATCH))
    ALLOCATE (DGMI%XDFAPIRC    (KLU, IO%NPATCH))
    ALLOCATE (DGMI%XDLAI_EFFC  (KLU, IO%NPATCH))
    !
    DGMI%XFAPAR      = XUNDEF
    DGMI%XFAPIR      = XUNDEF
...
IF (DGI%LCOEF) THEN
  ...
  !
  ALLOCATE(DGI%XCD            (KLU,IO%NPATCH))
  ALLOCATE(DGI%XCH            (KLU,IO%NPATCH))
  ALLOCATE(DGI%XCE            (KLU,IO%NPATCH))
  ALLOCATE(DGI%XZ0_WITH_SNOW  (KLU,IO%NPATCH))
  ALLOCATE(DGI%XZ0H_WITH_SNOW (KLU,IO%NPATCH))
  ALLOCATE(DGI%XZ0EFF         (KLU,IO%NPATCH))
  !
  DGI%XCD            = XUNDEF
  DGI%XCH            = XUNDEF
  DGI%XCE            = XUNDEF
...
IF (DGI%LSURF_VARS) THEN
  ...
  DGI%XAVG_QS      = XUNDEF
  !
  ALLOCATE(DGI%XQS            (KLU,IO%NPATCH))
  !
  DGI%XQS            = XUNDEF
ELSE
...
!
IF (LAGRIP) THEN
  ALLOCATE(DGMI%XSEUIL         (KLU,IO%NPATCH))
  !
  DGMI%XSEUIL         = XUNDEF
ELSE
