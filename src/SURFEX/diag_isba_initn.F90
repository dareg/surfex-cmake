...
!        XLERGVC    = 0.0
  ...
  ELSE
    ...
    !
    YREC='RNC_ISBA'
    CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_RNC    ,IRESP)
    YREC='HC_ISBA'
    CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_HC     ,IRESP)
    YREC='LEC_ISBA'
    CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_LEC    ,IRESP)
    YREC='LEIC_ISBA'
    CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_LEIC   ,IRESP)      
    YREC='GFLUXC_ISBA'
    CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_GFLUXC ,IRESP)
    YREC='LEGC_ISBA'
    CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_LEGC   ,IRESP)
    YREC='LEGIC_ISBA'
    CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_LEGIC  ,IRESP)
    YREC='LEVC_ISBA'
    CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_LEVC   ,IRESP)
    YREC='LESC_ISBA'
    CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_LESAC  ,IRESP)
    IF(I%TSNOW%SCHEME=='3-L' .OR. I%TSNOW%SCHEME=='CRO')THEN
       IF(IVERSION>7 .OR. IVERSION==7 .AND. IBUG>=3)THEN
         YREC='LESLC_ISBA'
         CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_LESLC,IRESP)  
       ELSE
         DGEI%XAVG_LESLC=0.0
       ENDIF
       IF(IVERSION>=8)THEN
         YREC='SNDRIFC_ISBA'
         CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_SNDRIFTC,IRESP)      
       ELSE
         DGEI%XAVG_SNDRIFTC = 0.0
       ENDIF
    ELSE
    ...
    ENDIF
    YREC='LERC_ISBA'
    CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_LERC   ,IRESP)
    YREC='LETRC_ISBA'
    CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_LETRC  ,IRESP)
    YREC='EVAPC_ISBA'
    CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_EVAPC  ,IRESP)
    IF (IVERSION<8)THEN
       DGEI%XAVG_SUBLC = 0.0
    ELSE
       YREC='SUBLC_ISBA'
       CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_SUBLC  ,IRESP) 
    ENDIF    
    YREC='DRAINC_ISBA'
    CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_DRAINC ,IRESP)
    YREC='RUNOFFC_ISBA'
    CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_RUNOFFC,IRESP)
    YREC='DRIVEGC_ISBA'
    CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_DRIPC  ,IRESP)
    YREC='RRVEGC_ISBA'
    CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_RRVEGC ,IRESP)
    YREC='SNOMLTC_ISBA'
    CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_MELTC,IRESP)
    !
    IF (ISIZE_LMEB_PATCH>0) THEN
      YREC='LEVCVC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_LEVCVC ,IRESP)
      YREC='LESCC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_LESCC ,IRESP)
      YREC='LETRGVC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_LETRGVC ,IRESP)
      YREC='LETRCVC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_LETRCVC ,IRESP)
      YREC='LERGVC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_LERGVC ,IRESP)
      YREC='LERCVC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_LERCVC ,IRESP)
      YREC='LE_C_AC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_LE_C_AC ,IRESP)
      YREC='LE_V_CC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_LE_V_CC ,IRESP)
      YREC='LE_G_CC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_LE_G_CC ,IRESP)
      YREC='LE_N_CC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_LE_N_CC ,IRESP)
      !
      YREC='SWNT_VC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_SWNET_VC ,IRESP)
      YREC='SWNT_GC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_SWNET_GC ,IRESP)
      YREC='SWNT_NC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_SWNET_NC ,IRESP)
      YREC='SWNT_NSC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_SWNET_NSC ,IRESP)
      YREC='LWNT_VC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_LWNET_VC ,IRESP)
      YREC='LWNT_GC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_LWNET_GC ,IRESP)
      YREC='LWNT_NC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_LWNET_NC ,IRESP)
      YREC='SWDN_GNC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_SWDOWN_GNC ,IRESP)
      YREC='LWDN_GNC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_LWDOWN_GNC ,IRESP)
      YREC='H_V_CC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_H_V_CC ,IRESP)
      YREC='H_G_CC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_H_G_CC ,IRESP)
      YREC='H_C_AC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_H_C_AC ,IRESP)
      YREC='H_N_CC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_H_N_CC ,IRESP)
      YREC='SR_GNC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_SR_GNC ,IRESP)
      YREC='MELTCVC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_MELTCVC ,IRESP)
      YREC='FRZCVC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_FRZCVC ,IRESP)
    ENDIF
    !
    IF (LAGRIP) THEN
      YREC='IRRIGC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_IRRIG_FLUXC,IRESP)    
    ELSE
      DGEI%XAVG_IRRIG_FLUXC = 0.0
    ENDIF
    !
    IF(I%CPHOTO/='NON' .AND. (IVERSION>7 .OR. IVERSION==7 .AND. IBUG>=3))THEN
      YREC='GPPC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_GPPC,IRESP)
      YREC='RC_AUTO_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_RESPC_AUTO,IRESP)
      YREC='RC_ECO_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_RESPC_ECO,IRESP)        
    ELSE
      DGEI%XAVG_GPPC = 0.0
      DGEI%XAVG_RESPC_AUTO = 0.0
      DGEI%XAVG_RESPC_ECO = 0.0
    ...
    IF((I%CRUNOFF=='SGH'.AND.I%CISBA=='DIF').AND.IVERSION>=8)THEN
      YREC='QSBC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_QSBC,IRESP)              
    ELSE
      DGEI%XAVG_QSBC = 0.0
    ENDIF
    !
    IF(I%CHORT=='SGH'.OR.I%CISBA=='DIF')THEN
      YREC='HORTONC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_HORTC,IRESP)
    ELSE
      DGEI%XAVG_HORTC = 0.0
    ENDIF
    !
    IF(I%LFLOOD)THEN
      YREC='IFLOODC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_IFLOODC,IRESP)
      YREC='PFLOODC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_PFLOODC,IRESP)
      YREC='LEFC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_LE_FLOODC,IRESP)
      YREC='LEIFC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_LEI_FLOODC,IRESP)
    ELSE
      DGEI%XAVG_IFLOODC   = 0.0
      DGEI%XAVG_PFLOODC   = 0.0
      DGEI%XAVG_LE_FLOODC = 0.0
...
!      
    IF (DGI%LRAD_BUDGET) THEN
      YREC='SWDC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGI%XAVG_SWDC,IRESP)
      YREC='SWUC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGI%XAVG_SWUC,IRESP)
      YREC='LWDC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGI%XAVG_LWDC,IRESP)
      YREC='LWUC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGI%XAVG_LWUC,IRESP)
    ENDIF
    YREC='FMUC_ISBA'
    CALL READ_SURF(HPROGRAM,YREC,DGI%XAVG_FMUC,IRESP)
    YREC='FMVC_ISBA'
    CALL READ_SURF(HPROGRAM,YREC,DGI%XAVG_FMVC,IRESP)      
    !
    IF(I%LGLACIER)THEN
      YREC='ICE_FC_ISBA'         
      CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_ICEFLUXC,IRESP)      
    ENDIF
    !  
    IF(DGEI%LWATER_BUDGET .AND. (IVERSION>7 .OR. IVERSION==7 .AND. IBUG>=3))THEN 
      YREC='RAINFC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGEI%XRAINFALLC,IRESP)
      YREC='SNOWFC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGEI%XSNOWFALLC,IRESP)
      YREC='DWGC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_DWGC,IRESP)
      YREC='DWGIC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_DWGIC,IRESP)
      YREC='DWRC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_DWRC,IRESP)
      YREC='DSWEC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_DSWEC,IRESP)
      YREC='WATBUDC_ISBA'
      CALL READ_SURF(HPROGRAM,YREC,DGEI%XAVG_WATBUDC,IRESP)
    ELSE
      DGEI%XRAINFALLC = 0.0
      DGEI%XSNOWFALLC = 0.0
      DGEI%XAVG_DWGC = 0.0
    ...
    IF(DGI%LPATCH_BUDGET .AND. I%NPATCH>1)THEN
      ...
      YREC='RNC_P'
      CALL READ_SURF(HPROGRAM,TRIM(YREC)//YREC2,DGEI%XRNC    ,IRESP)
      YREC='HC_P'
      CALL READ_SURF(HPROGRAM,TRIM(YREC)//YREC2,DGEI%XHC     ,IRESP)
      YREC='LEC_P'
      CALL READ_SURF(HPROGRAM,TRIM(YREC)//YREC2,DGEI%XLEC    ,IRESP)
      YREC='LEIC_P'
      CALL READ_SURF(HPROGRAM,TRIM(YREC)//YREC2,DGEI%XLEIC   ,IRESP)        
      YREC='GFLUXC_P'
      CALL READ_SURF(HPROGRAM,TRIM(YREC)//YREC2,DGEI%XGFLUXC ,IRESP)
      YREC='LEGC_P'
      CALL READ_SURF(HPROGRAM,TRIM(YREC)//YREC2,DGEI%XLEGC   ,IRESP)
      YREC='LEGIC_P'
      CALL READ_SURF(HPROGRAM,TRIM(YREC)//YREC2,DGEI%XLEGIC  ,IRESP)
      YREC='LEVC_P'
      CALL READ_SURF(HPROGRAM,TRIM(YREC)//YREC2,DGEI%XLEVC   ,IRESP)
      YREC='LESC_P'
      CALL READ_SURF(HPROGRAM,TRIM(YREC)//YREC2,DGEI%XLESAC  ,IRESP)
      IF(I%TSNOW%SCHEME=='3-L' .OR. I%TSNOW%SCHEME=='CRO')THEN
         IF(IVERSION>7 .OR. IVERSION==7 .AND. IBUG>=3)THEN
           YREC='LESLC_P'
           CALL READ_SURF(HPROGRAM,TRIM(YREC)//YREC2,DGEI%XLESLC,IRESP)  
         ELSE
           DGEI%XLESLC = 0.0
         ENDIF
         IF(IVERSION>=8)THEN
           YREC='SNDRIFC_P'
           CALL READ_SURF(HPROGRAM,TRIM(YREC)//YREC2,DGEI%XSNDRIFTC,IRESP)        
         ELSE
           DGEI%XSNDRIFTC = 0.0
         ENDIF        
      ELSE
      ...
      ENDIF
      YREC='LERC_P'
      CALL READ_SURF(HPROGRAM,TRIM(YREC)//YREC2,DGEI%XLERC   ,IRESP)
      YREC='LETRC_P'
      CALL READ_SURF(HPROGRAM,TRIM(YREC)//YREC2,DGEI%XLETRC  ,IRESP)
      YREC='EVAPC_P'
      CALL READ_SURF(HPROGRAM,TRIM(YREC)//YREC2,DGEI%XEVAPC  ,IRESP)
      IF (IVERSION<8)THEN
         DGEI%XSUBLC = 0.0
      ELSE
         YREC='SUBLC_P'
         CALL READ_SURF(HPROGRAM,YREC,DGEI%XSUBLC,IRESP)
      ENDIF    
      YREC='DRAINC_P'
      CALL READ_SURF(HPROGRAM,TRIM(YREC)//YREC2,DGEI%XDRAINC ,IRESP)
      YREC='RUNOFFC_P'
      CALL READ_SURF(HPROGRAM,TRIM(YREC)//YREC2,DGEI%XRUNOFFC,IRESP)
      YREC='DRIVEGC_P'
      CALL READ_SURF(HPROGRAM,TRIM(YREC)//YREC2,DGEI%XDRIPC,IRESP)
      YREC='RRVEGC_P'
      CALL READ_SURF(HPROGRAM,TRIM(YREC)//YREC2,DGEI%XRRVEGC,IRESP)
      YREC='SNOMLTC_P'
      CALL READ_SURF(HPROGRAM,TRIM(YREC)//YREC2,DGEI%XMELTC,IRESP)
      !
      IF (ISIZE_LMEB_PATCH>0) THEN
        YREC='LEVCVC_P'
        CALL READ_SURF(HPROGRAM,YREC,DGEI%XLEVCVC ,IRESP)
        YREC='LESCC_P'
        CALL READ_SURF(HPROGRAM,YREC,DGEI%XLESCC ,IRESP)
!        YREC='LETRGVC_P'
!        CALL READ_SURF(HPROGRAM,YREC,XLETRGVC ,IRESP)
        YREC='LETRCVC_P'
        CALL READ_SURF(HPROGRAM,YREC,DGEI%XLETRCVC ,IRESP)
!        YREC='LERGVC_P'
!        CALL READ_SURF(HPROGRAM,YREC,XLERGVC ,IRESP)
        YREC='LERCVC_P'
        CALL READ_SURF(HPROGRAM,YREC,DGEI%XLERCVC ,IRESP)
        YREC='LE_C_AC_P'
        CALL READ_SURF(HPROGRAM,YREC,DGEI%XLE_C_AC ,IRESP)
        YREC='LE_V_CC_P'
        CALL READ_SURF(HPROGRAM,YREC,DGEI%XLE_V_CC ,IRESP)
        YREC='LE_G_CC_P'
        CALL READ_SURF(HPROGRAM,YREC,DGEI%XLE_G_CC ,IRESP)
        YREC='LE_N_CC_P'
        CALL READ_SURF(HPROGRAM,YREC,DGEI%XLE_N_CC ,IRESP)
        !
        YREC='SWNT_VC_P'
        CALL READ_SURF(HPROGRAM,YREC,DGEI%XSWNET_VC ,IRESP)
        YREC='SWNT_GC_P'
        CALL READ_SURF(HPROGRAM,YREC,DGEI%XSWNET_GC ,IRESP)
        YREC='SWNT_NC_P'
        CALL READ_SURF(HPROGRAM,YREC,DGEI%XSWNET_NC ,IRESP)
        YREC='SWNT_NSC_P'
        CALL READ_SURF(HPROGRAM,YREC,DGEI%XSWNET_NSC ,IRESP)
        YREC='LWNT_VC_P'
        CALL READ_SURF(HPROGRAM,YREC,DGEI%XLWNET_VC ,IRESP)
        YREC='LWNT_GC_P'
        CALL READ_SURF(HPROGRAM,YREC,DGEI%XLWNET_GC ,IRESP)
        YREC='LWNT_NC_P'
        CALL READ_SURF(HPROGRAM,YREC,DGEI%XLWNET_NC ,IRESP)
        YREC='SWDN_GNC_P'
        CALL READ_SURF(HPROGRAM,YREC,DGEI%XSWDOWN_GNC ,IRESP)
        YREC='LWDN_GNC_P'
        CALL READ_SURF(HPROGRAM,YREC,DGEI%XLWDOWN_GNC ,IRESP)
        YREC='H_V_CC_P'
        CALL READ_SURF(HPROGRAM,YREC,DGEI%XH_V_CC ,IRESP)
        YREC='H_G_CC_P'
        CALL READ_SURF(HPROGRAM,YREC,DGEI%XH_G_CC ,IRESP)
        YREC='H_C_AC_P'
        CALL READ_SURF(HPROGRAM,YREC,DGEI%XH_C_AC ,IRESP)
        YREC='H_N_CC_P'
        CALL READ_SURF(HPROGRAM,YREC,DGEI%XH_N_CC ,IRESP)
        YREC='SR_GNC_P'
        CALL READ_SURF(HPROGRAM,YREC,DGEI%XSR_GNC ,IRESP)
        YREC='MELTCVC_P'
        CALL READ_SURF(HPROGRAM,YREC,DGEI%XMELTCVC ,IRESP)
        YREC='FRZCVC_P'
        CALL READ_SURF(HPROGRAM,YREC,DGEI%XFRZCVC ,IRESP)
      ENDIF
      !
      IF((I%CRUNOFF=='SGH'.AND.I%CISBA=='DIF').AND.IVERSION>=8)THEN
        YREC='QSBC_P'
        CALL READ_SURF(HPROGRAM,TRIM(YREC)//YREC2,DGEI%XQSBC,IRESP)              
      ELSE
        DGEI%XQSBC = 0.0
      ENDIF
      !      
      IF (LAGRIP) THEN
        YREC='IRRIGC_P'
        CALL READ_SURF(HPROGRAM,TRIM(YREC)//YREC2,DGEI%XIRRIG_FLUXC,IRESP)
      ELSE
        DGEI%XIRRIG_FLUXC = 0.0
      ENDIF
      !
      IF(I%CPHOTO/='NON' .AND. (IVERSION>7 .OR. IVERSION==7 .AND. IBUG>=3))THEN
        YREC='GPPC_P'
        CALL READ_SURF(HPROGRAM,TRIM(YREC)//YREC2,DGEI%XGPPC,IRESP)
        YREC='RC_AUTO_P'
        CALL READ_SURF(HPROGRAM,TRIM(YREC)//YREC2,DGEI%XRESPC_AUTO,IRESP)
        YREC='RC_ECO_P'
        CALL READ_SURF(HPROGRAM,TRIM(YREC)//YREC2,DGEI%XRESPC_ECO,IRESP)  
      ELSE
        DGEI%XGPPC      =0.0
        DGEI%XRESPC_AUTO=0.0
        DGEI%XRESPC_ECO =0.0
      ...
      IF (DGI%LRAD_BUDGET) THEN
        YREC='SWDC_P'
        CALL READ_SURF(HPROGRAM,TRIM(YREC)//YREC2,DGI%XSWDC,IRESP)
        YREC='SWUC_P'
        CALL READ_SURF(HPROGRAM,TRIM(YREC)//YREC2,DGI%XSWUC,IRESP)
        YREC='LWDC_P'
        CALL READ_SURF(HPROGRAM,TRIM(YREC)//YREC2,DGI%XLWDC,IRESP)
        YREC='LWUC_P'
        CALL READ_SURF(HPROGRAM,TRIM(YREC)//YREC2,DGI%XLWUC,IRESP)
      ENDIF
      YREC='FMUC_P'
      CALL READ_SURF(HPROGRAM,TRIM(YREC)//YREC2,DGI%XFMUC,IRESP)
      YREC='FMVC_P'
      CALL READ_SURF(HPROGRAM,TRIM(YREC)//YREC2,DGI%XFMVC,IRESP)
      !
      IF(I%LGLACIER)THEN
        YREC='ICE_FC_P'         
        CALL READ_SURF(HPROGRAM,TRIM(YREC)//YREC2,DGEI%XICEFLUXC,IRESP)      
      ENDIF
      !
      IF(I%CHORT=='SGH'.OR.I%CISBA=='DIF')THEN
        YREC='HORTONC_P'
        CALL READ_SURF(HPROGRAM,TRIM(YREC)//YREC2,DGEI%XHORTC    ,IRESP)
      ELSE
        DGEI%XHORTC     = 0.0
      ENDIF
      !
      IF(I%LFLOOD)THEN
        YREC='IFLOODC_P'
        CALL READ_SURF(HPROGRAM,TRIM(YREC)//YREC2,DGEI%XIFLOODC,IRESP)
        YREC='PFLOODC_P'
        CALL READ_SURF(HPROGRAM,TRIM(YREC)//YREC2,DGEI%XPFLOODC,IRESP)
        YREC='LEFC_P'
        CALL READ_SURF(HPROGRAM,TRIM(YREC)//YREC2,DGEI%XLE_FLOODC,IRESP)
        YREC='LEIFC_P'
        CALL READ_SURF(HPROGRAM,TRIM(YREC)//YREC2,DGEI%XLEI_FLOODC,IRESP)
      ELSE
        DGEI%XIFLOODC       = 0.0
        DGEI%XPFLOODC       = 0.0
        DGEI%XLE_FLOODC     = 0.0
      ...
      IF(DGEI%LWATER_BUDGET .AND. (IVERSION>7 .OR. IVERSION==7 .AND. IBUG>=3))THEN 
        YREC='DWGC_P'
        CALL READ_SURF(HPROGRAM,TRIM(YREC)//YREC2,DGEI%XDWGC,IRESP)
        YREC='DWGIC_P'
        CALL READ_SURF(HPROGRAM,TRIM(YREC)//YREC2,DGEI%XDWGIC,IRESP)
        YREC='DWRC_P'
        CALL READ_SURF(HPROGRAM,TRIM(YREC)//YREC2,DGEI%XDWRC,IRESP)
        YREC='DSWEC_P'
        CALL READ_SURF(HPROGRAM,TRIM(YREC)//YREC2,DGEI%XDSWEC,IRESP)
        YREC='WATBUDC_P'
        CALL READ_SURF(HPROGRAM,TRIM(YREC)//YREC2,DGEI%XWATBUDC,IRESP)
      ELSE
        DGEI%XDWGC = 0.0
        DGEI%XDWGIC = 0.0
        DGEI%XDWRC = 0.0
