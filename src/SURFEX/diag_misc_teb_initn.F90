...
!IF (DMTO%LSURF_MISC_BUDGET) THEN
  ...
  ALLOCATE(DMT%XRN_GARDEN        (KLU))
  ALLOCATE(DMT%XH_GARDEN         (KLU))
  ALLOCATE(DMT%XLE_GARDEN        (KLU))
  ALLOCATE(DMT%XGFLUX_GARDEN     (KLU))
  ...
  ALLOCATE(DMT%XRN_GREENROOF     (KLU))
  ALLOCATE(DMT%XH_GREENROOF      (KLU))
  ALLOCATE(DMT%XLE_GREENROOF     (KLU))
  ALLOCATE(DMT%XGFLUX_GREENROOF  (KLU))
  ALLOCATE(DMT%XG_GREENROOF_ROOF (KLU))
  ALLOCATE(DMT%XRUNOFF_TOWN      (KLU))
  ALLOCATE(DMT%XRUNOFF_GARDEN    (KLU))
  ALLOCATE(DMT%XRUNOFF_ROAD      (KLU))
  ALLOCATE(DMT%XRUNOFF_STRLROOF  (KLU))
  ALLOCATE(DMT%XRUNOFF_ROOF      (KLU))
  ALLOCATE(DMT%XRUNOFF_GREENROOF (KLU))
  ALLOCATE(DMT%XDRAIN_GREENROOF  (KLU))
  ALLOCATE(DMT%XDRAIN_GARDEN     (KLU))
  ...
  !
    ...
    ALLOCATE(DMTC%XRUNOFF_GARDEN    (KLU))
    ALLOCATE(DMTC%XDRAIN_GARDEN     (KLU))
    ...
    ALLOCATE(DMTC%XRUNOFF_GREENROOF (KLU))
    ALLOCATE(DMTC%XDRAIN_GREENROOF  (KLU))
  ...
  DMT%XRN_GARDEN         = XUNDEF
  DMT%XH_GARDEN          = XUNDEF
  DMT%XLE_GARDEN         = XUNDEF
  DMT%XGFLUX_GARDEN      = XUNDEF  
  DMT%XRN_BLT            = XUNDEF
  DMT%XH_BLT             = XUNDEF
  DMT%XLE_BLT            = XUNDEF
...
!  
    ...
    DMTC%XRUNOFF_GARDEN     = 0.0  
    DMTC%XRUNOFF_ROAD       = 0.0  
    DMTC%XRUNOFF_ROOF       = 0.0  
    DMTC%XRUNOFF_STRLROOF   = 0.0  
    DMTC%XRUNOFF_GREENROOF  = 0.0  
    DMTC%XDRAIN_GREENROOF   = 0.0  
    DMTC%XDRAIN_GARDEN      = 0.0  
