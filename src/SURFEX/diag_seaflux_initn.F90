...
!
  ...
  ELSE
     ...
     YREC='RNC_SEA'
     CALL READ_SURF(&
                    HPROGRAM,YREC,DGSC%XRN,IRESP)
     YREC='HC_SEA'
     CALL READ_SURF(&
                    HPROGRAM,YREC,DGSC%XH,IRESP)
     YREC='LEC_SEA'
     CALL READ_SURF(&
                    HPROGRAM,YREC,DGSC%XLE,IRESP)
     YREC='LEIC_SEA'
     CALL READ_SURF(&
                    HPROGRAM,YREC,DGSC%XLEI,IRESP) 
     YREC='GFLUXC_SEA'
     CALL READ_SURF(&
                    HPROGRAM,YREC,DGSC%XGFLUX,IRESP)
     YREC='SWDC_SEA'
     CALL READ_SURF(&
                    HPROGRAM,YREC,DGSC%XSWD,IRESP)
     YREC='SWUC_SEA'
     CALL READ_SURF(&
                    HPROGRAM,YREC,DGSC%XSWU,IRESP)
     YREC='LWDC_SEA'
     CALL READ_SURF(&
                    HPROGRAM,YREC,DGSC%XLWD,IRESP)
     YREC='LWUC_SEA'
     CALL READ_SURF(&
                    HPROGRAM,YREC,DGSC%XLWU,IRESP)
     YREC='FMUC_SEA'
     CALL READ_SURF(&
                    HPROGRAM,YREC,DGSC%XFMU,IRESP)
     YREC='FMVC_SEA'
     CALL READ_SURF(&
                    HPROGRAM,YREC,DGSC%XFMV,IRESP)
     IF (IVERSION<8)THEN
        DGSC%XEVAP     = 0.0
        DGSC%XSUBL     = 0.0              
     ELSE
        ...
        YREC='EVAPC_SEA'
        CALL READ_SURF(&
                    HPROGRAM,YREC,DGSC%XEVAP,IRESP)
        YREC='SUBLC_SEA'
        CALL READ_SURF(&
                    HPROGRAM,YREC,DGSC%XSUBL,IRESP)
     ENDIF
  ENDIF   
ELSE
  ALLOCATE(DGSC%XRN   (0))
