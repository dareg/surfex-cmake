...
!
  ...
  ELSE
     ...
     YREC='RNC_SEA'
     CALL READ_SURF(HPROGRAM,YREC,DGS%XRNC,IRESP)
     YREC='HC_SEA'
     CALL READ_SURF(HPROGRAM,YREC,DGS%XHC ,IRESP)
     YREC='LEC_SEA'
     CALL READ_SURF(HPROGRAM,YREC,DGS%XLEC,IRESP)
     YREC='LEIC_SEA'
     CALL READ_SURF(HPROGRAM,YREC,DGS%XLEC_ICE,IRESP) 
     YREC='GFLUXC_SEA'
     CALL READ_SURF(HPROGRAM,YREC,DGS%XGFLUXC ,IRESP)
     YREC='SWDC_SEA'
     CALL READ_SURF(HPROGRAM,YREC,DGS%XSWDC,IRESP)
     YREC='SWUC_SEA'
     CALL READ_SURF(HPROGRAM,YREC,DGS%XSWUC,IRESP)
     YREC='LWDC_SEA'
     CALL READ_SURF(HPROGRAM,YREC,DGS%XLWDC,IRESP)
     YREC='LWUC_SEA'
     CALL READ_SURF(HPROGRAM,YREC,DGS%XLWUC,IRESP)
     YREC='FMUC_SEA'
     CALL READ_SURF(HPROGRAM,YREC,DGS%XFMUC,IRESP)
     YREC='FMVC_SEA'
     CALL READ_SURF(HPROGRAM,YREC,DGS%XFMVC,IRESP)
     IF (IVERSION<8)THEN
        DGS%XEVAPC      = 0.0
        DGS%XSUBLC      = 0.0              
     ELSE
        !
        YREC='EVAPC_SEA'
        CALL READ_SURF(HPROGRAM,YREC,DGS%XEVAPC,IRESP)
        YREC='SUBLC_SEA'
        CALL READ_SURF(HPROGRAM,YREC,DGS%XSUBLC,IRESP)
     ENDIF
     DGS%XRNC_ICE    = 0.0
     DGS%XHC_ICE     = 0.0
     DGS%XGFLUXC_ICE = 0.0
