!     #########
      SUBROUTINE DIAG_TEB_GARDEN_INIT_n (DGMTO, DGU, DGGD, DGT, TGD, TGDO, TGDP, TVG, &
                                         HPROGRAM,KLU,KSW)
!     #####################
!
...
END IF
!
ALLOCATE(DGGD%XSNOWTEMP(KLU,TGD%TSNOW%NLAYER        )) 
ALLOCATE(DGGD%XSNOWLIQ (KLU,TGD%TSNOW%NLAYER        )) 
ALLOCATE(DGGD%XSNOWDZ  (KLU,TGD%TSNOW%NLAYER        )) 
