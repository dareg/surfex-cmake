...
!
  ...
  ELSE
     YREC='RNC_WAT'
     CALL READ_SURF(HPROGRAM,YREC,DGW%XRNC,IRESP)
     YREC='HC_WAT'
     CALL READ_SURF(HPROGRAM,YREC,DGW%XHC ,IRESP)
     YREC='LEC_WAT'
     CALL READ_SURF(HPROGRAM,YREC,DGW%XLEC,IRESP)
     YREC='LEIC_WAT'
     CALL READ_SURF(HPROGRAM,YREC,DGW%XLEIC,IRESP)     
     YREC='GFLUXC_WAT'
     CALL READ_SURF(HPROGRAM,YREC,DGW%XGFLUXC,IRESP)
     YREC='SWDC_WAT'
     CALL READ_SURF(HPROGRAM,YREC,DGW%XSWDC,IRESP)
     YREC='SWUC_WAT'
     CALL READ_SURF(HPROGRAM,YREC,DGW%XSWUC,IRESP)
     YREC='LWDC_WAT'
     CALL READ_SURF(HPROGRAM,YREC,DGW%XLWDC,IRESP)
     YREC='LWUC_WAT'
     CALL READ_SURF(HPROGRAM,YREC,DGW%XLWUC,IRESP)
     YREC='FMUC_WAT'
     CALL READ_SURF(HPROGRAM,YREC,DGW%XFMUC,IRESP)
     YREC='FMVC_WAT'
     CALL READ_SURF(HPROGRAM,YREC,DGW%XFMVC,IRESP)
!
     CALL READ_SURF(HPROGRAM,'VERSION',IVERSION,IRESP)
      ...
      ELSE
         YREC='EVAPC_WAT'
         CALL READ_SURF(HPROGRAM,YREC,DGW%XEVAPC,IRESP)
         YREC='SUBLC_WAT'
         CALL READ_SURF(HPROGRAM,YREC,DGW%XSUBLC,IRESP)              
      ENDIF
!
  ENDIF   
ELSE
