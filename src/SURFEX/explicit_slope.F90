...
USE MODD_SURF_ATM_GRID_n, ONLY : CGRID, XGRID_PAR, NGRID_PAR,XMESH_SIZE
...
!            -----------------------------
!
CALL GET_GRID_DIM(CGRID,SIZE(XGRID_PAR),XGRID_PAR,GRECT,IX,IY)
!
INNX=IX+2
INNY=IY+2
...
CALL GET_MESH_DIM(CGRID,SIZE(XGRID_PAR),IX*IY,XGRID_PAR,ZDX,ZDY,XMESH_SIZE)
