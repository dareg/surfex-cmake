...
!            -----------------------------
!
CALL GET_GRID_DIM(UG%CGRID,SIZE(UG%XGRID_FULL_PAR),UG%XGRID_FULL_PAR,GRECT,IX,IY)
!
INNX=IX+2
INNY=IY+2
...
CALL GET_MESH_DIM(UG%CGRID,SIZE(UG%XGRID_FULL_PAR),IX*IY,UG%XGRID_FULL_PAR,ZDX,ZDY,UG%XMESH_SIZE)
