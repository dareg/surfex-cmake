...
!   ECOCLIMAP spatial distribution field
    ...
    CALL AV_PGD(DTCO, &
                ZWORK(:,JTIME,:),I%P%XCOVER,XDATA_LAI(:,JTIME,:),YVEG,'ARI',I%P%LCOVER,KDECADE=JTIME)
    DO JVEGTYPE=1,3
...
!   H_TREE
!   ------
IF (.NOT.DTI%LDATA_H_TREE .AND. (I%O%CPHOTO/='NON' .OR. .NOT.DTI%LDATA_Z0)) THEN
!
...
! ECOCLIMAP spatial distribution field  
  IF (ASSOCIATED(DTCO%XDATA_WEIGHT)) DEALLOCATE(DTCO%XDATA_WEIGHT)
  CALL AV_PGD(DTCO, &
                DTI%XPAR_H_TREE,I%P%XCOVER,XDATA_H_TREE,YTREE,'ARI',I%P%LCOVER,KDECADE=1)
!
! Extrapolation toward new vegtype distribution field from updated land-use map or user  
  CALL INI_VAR_FROM_VEGTYPE_DATA(DTCO, DTI, UG, U, &
...
IF (.NOT.DTI%LDATA_DG .AND. .NOT.DTI%LDATA_ROOT_DEPTH) THEN
  YROOT=YNAT
  IF(I%O%CISBA=='DIF')YROOT=YDIF
  ALLOCATE(DTI%XPAR_ROOT_DEPTH    (IG%NDIM,NVEGTYPE))
  IF (ASSOCIATED(DTCO%XDATA_WEIGHT)) DEALLOCATE(DTCO%XDATA_WEIGHT)        
  CALL AV_PGD(DTCO, &
                DTI%XPAR_ROOT_DEPTH(:,:),I%P%XCOVER,XDATA_ROOT_DEPTH(:,:),YNAT,CDGAVG,I%P%LCOVER,KDECADE=1)
...
IF (.NOT.DTI%LDATA_DG .AND. .NOT.DTI%LDATA_ROOT_DEPTHGV) THEN
  ...
  IF (ASSOCIATED(DTCO%XDATA_WEIGHT)) DEALLOCATE(DTCO%XDATA_WEIGHT)        
  CALL AV_PGD(DTCO, &
                DTI%XPAR_ROOT_DEPTHGV(:,:),I%P%XCOVER,XDATA_ROOT_DEPTHGV(:,:),YNAT,CDGAVG,I%P%LCOVER,KDECADE=1)
...
IF (.NOT.DTI%LDATA_DG .AND. I%O%CISBA/='2-L' .AND. .NOT.DTI%LDATA_GROUND_DEPTH) THEN
  ZDATA_GROUND_DEPTH(:,:)=XDATA_GROUND_DEPTH(:,:)
  IF(I%O%CISBA=='DIF'.AND.CDGDIF=='ROOT')THEN
    DO JVEGTYPE=1,NVEGTYPE
  ...
  IF (ASSOCIATED(DTCO%XDATA_WEIGHT)) DEALLOCATE(DTCO%XDATA_WEIGHT)      
  CALL AV_PGD(DTCO, &
                DTI%XPAR_GROUND_DEPTH(:,:),I%P%XCOVER,ZDATA_GROUND_DEPTH(:,:),YNAT,CDGAVG,I%P%LCOVER,KDECADE=1)
...
!   ECOCLIMAP spatial distribution field      
    IF (ASSOCIATED(DTCO%XDATA_WEIGHT)) DEALLOCATE(DTCO%XDATA_WEIGHT)
    CALL AV_PGD(DTCO, &
                ZWORK(:,JTIME,:),I%P%XCOVER,XDATA_IRRIG,YVEG,'ARI',I%P%LCOVER,KDECADE=JTIME)
!   Extrapolation toward new vegtype distribution field from updated land-use map or user  
    CALL INI_VAR_FROM_VEGTYPE_DATA(DTCO, DTI, UG, U, &
...
!   ECOCLIMAP spatial distribution field    
    IF (ASSOCIATED(DTCO%XDATA_WEIGHT)) DEALLOCATE(DTCO%XDATA_WEIGHT)
    CALL AV_PGD(DTCO, &
                ZWORK(:,JTIME,:),I%P%XCOVER,XDATA_WATSUP,YVEG,'ARI',I%P%LCOVER,KDECADE=JTIME)  
!   Extrapolation toward new vegtype distribution field from updated land-use map or user  
    CALL INI_VAR_FROM_VEGTYPE_DATA(DTCO, DTI, UG, U, &
