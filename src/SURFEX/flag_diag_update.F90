...
!
IF (CSEA=='SEAFLX') CALL FLAG_SEA_UPDATE(KBEQ, ODIAG_OCEAN, OINTERPOL_SST, LSURF_BUDGETC, K2M)
IF (CWATER=='FLAKE ' .OR. CWATER=='WATFLX') &
  CALL FLAG_WATER_UPDATE(KBEQ, OWATER_PROFILE, OINTERPOL_TS, LSURF_BUDGETC ,K2M)
...
CONTAINS
!
SUBROUTINE FLAG_SEA_UPDATE(KBEQ, ODIAG_OCEAN, OINTERPOL_SST, OSURF_BUDGETC, K2M)
!
...
!
SUBROUTINE FLAG_WATER_UPDATE(KBEQ, OWATER_PROFILE, OINTERPOL_TS, OSURF_BUDGETC, K2M)
!
