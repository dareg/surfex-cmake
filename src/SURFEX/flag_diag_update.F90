...
!
IF (CSEA=='SEAFLX') CALL FLAG_SEA_UPDATE(KBEQ, ODIAG_OCEAN, OINTERPOL_SST,LSURF_BUDGETC)
IF (CWATER=='FLAKE ' .OR. CWATER=='WATFLX') &
  CALL FLAG_WATER_UPDATE(KBEQ, OWATER_PROFILE, OINTERPOL_TS,LSURF_BUDGETC)
IF (CNATURE=='ISBA  ') CALL FLAG_ISBA_UPDATE(KBEQ, KDSTEQ, OSURF_EVAP_BUDGET, OFLOOD, &
                                OPGD_ISBA, OCH_NO_FLUX_ISBA, OSURF_MISC_BUDGET_ISBA,LSURF_BUDGETC)
...
CONTAINS
!
SUBROUTINE FLAG_SEA_UPDATE(KBEQ, ODIAG_OCEAN, OINTERPOL_SST, OSURF_BUDGETC)
!
USE MODD_CH_SEAFLUX_n, ONLY : NBEQ
USE MODD_DIAG_OCEAN_n,   ONLY : LDIAG_OCEAN
USE MODD_SEAFLUX_n,     ONLY : LINTERPOL_SST
USE MODD_DIAG_SEAFLUX_n, ONLY : LSURF_BUDGETC
!
IMPLICIT NONE
!
INTEGER, INTENT(IN) :: KBEQ
...
!
SUBROUTINE FLAG_WATER_UPDATE(KBEQ, OWATER_PROFILE, OINTERPOL_TS, OSURF_BUDGETC)
!
USE MODD_CH_WATFLUX_n, ONLY : NBEQ
USE MODD_DIAG_MISC_FLAKE_n,ONLY : LWATER_PROFILE
USE MODD_WATFLUX_n,ONLY : LINTERPOL_TS
USE MODD_DIAG_WATFLUX_n, ONLY : LSURF_BUDGETC
!
IMPLICIT NONE
!
INTEGER, INTENT(IN) :: KBEQ
