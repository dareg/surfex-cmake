...
!
 CALL ISBA(GDM%TVG%CISBA, GDM%TVG%CPHOTO, GDM%TVG%LTR_ML, GDM%TVG%CRUNOFF, &
          ...
          GDM%TGDP%XDMAX, GDM%TGDP%XAH, GDM%TGDP%XBH, PCO2,GDM%TGD%CUR%TSNOW%GRAN2(:,:,1), &
          GDM%TGD%CUR%TSNOW%GRAN2(:,:,1), GDM%TGDP%XGMES, GDM%TGDP%XPOI, &
          ...
          ZSPEC_ALB, ZDIFF_RATIO,GDM%TGD%CUR%TSNOW%IMPUR(:,:,:,1),     &
	  ZPRODCOUNT, 						       &
