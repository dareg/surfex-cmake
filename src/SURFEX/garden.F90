...
REAL, DIMENSION(SIZE(PPS),GDM%TGD%CUR%TSNOW%NLAYER) :: ZSNOWDEND
REAL, DIMENSION(SIZE(PPS),GDM%TGD%CUR%TSNOW%NLAYER) :: ZSNOWSPHER
REAL, DIMENSION(SIZE(PPS),GDM%TGD%CUR%TSNOW%NLAYER) :: ZSNOWSIZE
REAL, DIMENSION(SIZE(PPS),GDM%TGD%CUR%TSNOW%NLAYER) :: ZSNOWSSA
REAL, DIMENSION(SIZE(PPS),GDM%TGD%CUR%TSNOW%NLAYER) :: ZSNOWTYPEMEPRA
REAL, DIMENSION(SIZE(PPS),GDM%TGD%CUR%TSNOW%NLAYER) :: ZSNOWRAM
REAL, DIMENSION(SIZE(PPS),GDM%TGD%CUR%TSNOW%NLAYER) :: ZSNOWSHEAR
...
CHARACTER(3) :: YSNOWMETAMO,YSNOWRAD, YSNOWFALL, YSNOWCOND, YSNOWHOLD, YSNOWCOMP !B Cluzet added YSNOWFALL YSNOWHOLDand YSNOWCOND
...
!
 CALL ISBA(GDM%TVG%CISBA, GDM%TVG%CPHOTO, GDM%TVG%LTR_ML, GDM%TVG%CRUNOFF, &
          ...
          XCVHEATF,GDM%TVG%XCGMAX, PZ_LOWCAN, PZ_LOWCAN, ZDIRCOSZW,            &
          ZSLOPEDIR,PT_LOWCAN,                                        &
          ...
          GDM%TGD%CUR%TSNOW%AGE(:,:,1), GDM%TGD%CUR%TSNOW%IMPUR(:,:,1),ZGRNDFLUX, ZHPSNOW, ZSNOWHMASS,    &
