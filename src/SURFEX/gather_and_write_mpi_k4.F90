...
USE MODD_SURFEX_OMP, ONLY : NINDX1, NINDX2, XWORK, XWORK_FULL
!
...
USE MODD_SURFEX_OMP, ONLY : NINDX1, NINDX2, XWORK2, XWORK2_FULL, NBLOCK
!
USE MODI_UNPACK_SAME_RANK
!
USE YOMHOOK   ,ONLY : LHOOK,   DR_HOOK
...
!$OMP END SINGLE
!
XWORK2(NINDX1:NINDX2,1:IP2) = XUNDEF
!
#ifndef NOMPI
XTIME0 = MPI_WTIME()
#endif
...
IF (SIZE(PWORK,1)>0) THEN
  IF (PRESENT(KMASK)) THEN
    CALL UNPACK_SAME_RANK(KMASK,PWORK,XWORK2(NINDX1:NINDX2,1:IP2))
  ELSE
    XWORK2(NINDX1:NINDX2,1:IP2) = PWORK(:,:)
  ENDIF
ENDIF
!
#ifndef NOMPI
