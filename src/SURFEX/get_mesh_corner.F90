...
!     
  CASE("LONLAT REG")
      CALL GET_MESH_CORNER_LONLAT_REG(NGRID_PAR,IL,IC,XGRID_PAR,PCORNER_LAT,PCORNER_LON) 
  CASE("CONF PROJ")
      CALL GET_MESH_CORNER_CONF_PROJ(NGRID_PAR,IL,IC,XGRID_PAR,PCORNER_LAT,PCORNER_LON)      
  CASE("GAUSS     ")
      CALL GET_MESH_CORNER_GAUSS(NGRID_PAR,IL,IC,XGRID_PAR,PCORNER_LAT,PCORNER_LON)
  CASE("IGN       ")
      CALL GET_MESH_CORNER_IGN(NGRID_PAR,IL,IC,XGRID_PAR,PCORNER_LAT,PCORNER_LON)  
  CASE("LONLATVAL ")
      CALL GET_MESH_CORNER_LONLATVAL(NGRID_PAR,IL,IC,XGRID_PAR,PCORNER_LAT,PCORNER_LON)  
  CASE DEFAULT
