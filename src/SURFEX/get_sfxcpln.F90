...
!
REAL, DIMENSION(:), INTENT(OUT), OPTIONAL :: PRUI
REAL, DIMENSION(:), INTENT(OUT), OPTIONAL :: PWIND
REAL, DIMENSION(:), INTENT(OUT), OPTIONAL :: PFWSU
REAL, DIMENSION(:), INTENT(OUT), OPTIONAL :: PFWSV
REAL, DIMENSION(:), INTENT(OUT), OPTIONAL :: PSNET
REAL, DIMENSION(:), INTENT(OUT), OPTIONAL :: PHEAT
REAL, DIMENSION(:), INTENT(OUT), OPTIONAL :: PEVAP
REAL, DIMENSION(:), INTENT(OUT), OPTIONAL :: PRAIN
REAL, DIMENSION(:), INTENT(OUT), OPTIONAL :: PSNOW
REAL, DIMENSION(:), INTENT(OUT), OPTIONAL :: PICEFLUX
REAL, DIMENSION(:), INTENT(OUT), OPTIONAL :: PFWSM
REAL, DIMENSION(:), INTENT(OUT), OPTIONAL :: PHEAT_ICE
REAL, DIMENSION(:), INTENT(OUT), OPTIONAL :: PEVAP_ICE
REAL, DIMENSION(:), INTENT(OUT), OPTIONAL :: PSNET_ICE
!
