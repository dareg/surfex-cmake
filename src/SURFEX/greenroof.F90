...
!
!Snow options
LOGICAL :: GSNOWDRIFT_SUBLIM,GSNOW_ABS_ZENITH,GSNOWSYTRON
...
!
 CALL ISBA(GRM%TGRO%CISBA_GR, TVG%CPHOTO, GRM%TGRO%LTR_ML_GR, 'WSAT', GRM%TGRO%CKSAT_GR,     &
          ...
          YSNOWMETAMO,YSNOWRAD,GSNOWSYTRON, YSNOWFALL, YSNOWCOND, YSNOWHOLD, YSNOWCOMP, YSNOWZREF, &          
          ...
          GRM%TGR%CUR%TSNOW%AGE(:,:,1),GRM%TGR%CUR%TSNOW%IMPUR(:,:,1), ZGRNDFLUX, ZHPSNOW, ZSNOWHMASS,    &
