...
USE MODD_TEB_OPTION_n,         ONLY: LECOCLIMAP, XCOVER, NROOF_LAYER
USE MODD_TEB_n,                ONLY: XT_ROOF, XD_ROOF, XTC_ROOF, XHC_ROOF
...
USE MODD_TEB_GREENROOF_OPTION_n, ONLY: LTR_ML_GR,                             &
