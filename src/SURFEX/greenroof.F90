...
CHARACTER(3) :: YSNOWMETAMO,YSNOWRAD, YSNOWFALL, YSNOWCOND, YSNOWHOLD,YSNOWCOMP !<B Cluzet added YSNOWFALL YSNOWHOLD and YSNOWCOND>
...
!
 CALL ISBA(GRM%TGRO%CISBA_GR, TVG%CPHOTO, GRM%TGRO%LTR_ML_GR, 'WSAT', GRM%TGRO%CKSAT_GR,     &
          ...
          YSNOWMETAMO,YSNOWRAD,GSNOWSYTRON, YSNOWFALL, YSNOWCOND, YSNOWHOLD, YSNOWCOMP, &          
