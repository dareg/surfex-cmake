...
REAL, DIMENSION(SIZE(PPS),GRM%TGR%CUR%TSNOW%NLAYER) :: ZSNOWDEND
REAL, DIMENSION(SIZE(PPS),GRM%TGR%CUR%TSNOW%NLAYER) :: ZSNOWSPHER
REAL, DIMENSION(SIZE(PPS),GRM%TGR%CUR%TSNOW%NLAYER) :: ZSNOWSIZE
REAL, DIMENSION(SIZE(PPS),GRM%TGR%CUR%TSNOW%NLAYER) :: ZSNOWSSA
REAL, DIMENSION(SIZE(PPS),GRM%TGR%CUR%TSNOW%NLAYER) :: ZSNOWTYPEMEPRA
REAL, DIMENSION(SIZE(PPS),GRM%TGR%CUR%TSNOW%NLAYER) :: ZSNOWRAM
REAL, DIMENSION(SIZE(PPS),GRM%TGR%CUR%TSNOW%NLAYER) :: ZSNOWSHEAR
REAL, DIMENSION(SIZE(PPS))   :: ZSNOWHMASS
REAL, DIMENSION(SIZE(PPS))   :: ZSYTMASS
REAL, DIMENSION(SIZE(PPS)) :: ZSNOWDEPTH_1DAYS,ZSNOWDEPTH_3DAYS,ZSNOWDEPTH_5DAYS,ZSNOWDEPTH_7DAYS
REAL, DIMENSION(SIZE(PPS)) :: ZSNOWSWE_1DAYS,ZSNOWSWE_3DAYS,ZSNOWSWE_5DAYS,ZSNOWSWE_7DAYS
REAL, DIMENSION(SIZE(PPS)) :: ZSNOWRAM_SONDE
REAL, DIMENSION(SIZE(PPS)) :: ZSNOW_WETTHICKNESS
REAL, DIMENSION(SIZE(PPS)) :: ZSNOW_REFROZENTHICKNESS
...
CHARACTER(3) :: YSNOWMETAMO,YSNOWRAD, YSNOWFALL, YSNOWCOND, YSNOWHOLD,YSNOWCOMP, YSNOWZREF !<B Cluzet added YSNOWFALL YSNOWHOLD and YSNOWCOND>
...
! ZDIFF_RATIO=XUNDEF
 ...
 CALL ISBA(GRM%TGRO%CISBA_GR, TVG%CPHOTO, GRM%TGRO%LTR_ML_GR, 'WSAT', GRM%TGRO%CKSAT_GR,     &
          ...
          YSNOWDRIFT,GSNOWDRIFT_SUBLIM,GSNOW_ABS_ZENITH,           &
          YSNOWMETAMO,YSNOWRAD,GATMORAD,GSNOWSYTRON, YSNOWFALL, YSNOWCOND, YSNOWHOLD, YSNOWCOMP, YSNOWZREF, &          
          XCVHEATF,TVG%XCGMAX, PZREF, PUREF, ZDIRCOSZW, ZSLOPEDIR, PTA,         &
          ...
          GRM%TGRP%XDMAX, GRM%TGRP%XAH, GRM%TGRP%XBH, PCO2,GRM%TGR%CUR%TSNOW%GRAN2(:,:,1), &
          GRM%TGR%CUR%TSNOW%GRAN2(:,:,1), GRM%TGRP%XGMES, &
          ...
          GRM%TGR%CUR%TSNOW%AGE(:,:,1) ,GRM%TGR%CUR%TSNOW%IMPUR(:,:,:,1),&
          ...
          KTAB_SYT,ZSYTMASS,&
          ZSNOWDEND,ZSNOWSPHER,ZSNOWSIZE,ZSNOWSSA,ZSNOWTYPEMEPRA,ZSNOWRAM,          &
          ...
          ZP_DIR_SW, ZP_SCA_SW, ZSPEC_ALB, ZDIFF_RATIO,                             &
          GRM%TGR%CUR%TSNOW%IMPUR(:,:,:,1), ZPRODCOUNT,                             & 						      
	  GSNOWCOMPACT_BOOL, GSNOWMAK_BOOL, GSNOWTILLER,	                    &
