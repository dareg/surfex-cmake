!     #########
      SUBROUTINE GREENROOF_PROPERTIES (PGREENROOF, VO, VR, VMT, VMA, &
...
!
 CALL FLAG_TEB_GREENROOF_n(VR, VO, VMT%XLAI, PGREENROOF, 1)
!
!
!*      2.     Computes several properties of green roofs
!              ------------------------------------------
!
 CALL ISBA_PROPERTIES(VO, VR, VMT, VMA, &
                      1, PDIR_SW, PSCA_SW, PSW_BANDS, KSW,                  &
