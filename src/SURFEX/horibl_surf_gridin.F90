...
!     #########
    SUBROUTINE HORIBL_SURF_GRIDIN(KINLA,KINLO,KILEN,PARIN,KOLEN,ODVECT,KLUOUT,&
                                 OGLOBS,OGLOBN,OGLOBLON,KP,PARIN0_OUT, &
                                 PARIN_OUT,KLSMIN_OUT,KLSMIN,KLSMOUT )  
!   ###########################################################################
!
...
INTEGER :: JL, JL2, JT, INL   ! Dummy counter
