...
IF (U%LECOSG) THEN
  ...
  !root_depth
  ! these values follw the recommended values in NAM_DATA_ISBA
  ! provided at https://opensource.umr-cnrm.fr/projects/ecoclimap-sg/wiki
  ...
  WHERE(XDATA_VEGTYPE(:,4)>0.) XDATA_ROOT_DEPTH(:,4) = 1.0
  WHERE(XDATA_VEGTYPE(:,5)>0.) XDATA_ROOT_DEPTH(:,5) = 1.5
  WHERE(XDATA_VEGTYPE(:,6)>0.) XDATA_ROOT_DEPTH(:,6) = 2.0
  WHERE(XDATA_VEGTYPE(:,7)>0.) XDATA_ROOT_DEPTH(:,7) = 1.5
  WHERE(XDATA_VEGTYPE(:,8)>0.) XDATA_ROOT_DEPTH(:,8) = 3.0
  WHERE(XDATA_VEGTYPE(:,9)>0.) XDATA_ROOT_DEPTH(:,9) = 1.0
  WHERE(XDATA_VEGTYPE(:,10)>0.) XDATA_ROOT_DEPTH(:,10) = 2.0
  WHERE(XDATA_VEGTYPE(:,11)>0.) XDATA_ROOT_DEPTH(:,11) = 1.0
  WHERE(XDATA_VEGTYPE(:,12)>0.) XDATA_ROOT_DEPTH(:,12) = 1.0
  WHERE(XDATA_VEGTYPE(:,13)>0.) XDATA_ROOT_DEPTH(:,13) = 1.0
  WHERE(XDATA_VEGTYPE(:,14)>0.) XDATA_ROOT_DEPTH(:,14) = 2.0
  WHERE(XDATA_VEGTYPE(:,15)>0.) XDATA_ROOT_DEPTH(:,15) = 3.0
  WHERE(XDATA_VEGTYPE(:,16)>0.) XDATA_ROOT_DEPTH(:,16) = 1.2
  ...
  ! these values follw the recommended values in NAM_DATA_ISBA
  ! provided at https://opensource.umr-cnrm.fr/projects/ecoclimap-sg/wiki
  WHERE(XDATA_VEGTYPE(:,1)>0.) XDATA_GROUND_DEPTH(:,1) = 0.5
  ...
  WHERE(XDATA_VEGTYPE(:,6)>0.) XDATA_GROUND_DEPTH(:,6) = 4.0
  WHERE(XDATA_VEGTYPE(:,7)>0.) XDATA_GROUND_DEPTH(:,7) = 3.0
  WHERE(XDATA_VEGTYPE(:,8)>0.) XDATA_GROUND_DEPTH(:,8) = 6.0
  ...
  WHERE(XDATA_VEGTYPE(:,13)>0.) XDATA_GROUND_DEPTH(:,13) = 2.0
  WHERE(XDATA_VEGTYPE(:,14)>0.) XDATA_GROUND_DEPTH(:,14) = 1.2
  WHERE(XDATA_VEGTYPE(:,15)>0.) XDATA_GROUND_DEPTH(:,15) = 4.0
  WHERE(XDATA_VEGTYPE(:,16)>0.) XDATA_GROUND_DEPTH(:,16) = 2.2
  WHERE(XDATA_VEGTYPE(:,17)>0.) XDATA_GROUND_DEPTH(:,17) = 2.5
  WHERE(XDATA_VEGTYPE(:,18)>0.) XDATA_GROUND_DEPTH(:,18) = 2.5
  WHERE(XDATA_VEGTYPE(:,19)>0.) XDATA_GROUND_DEPTH(:,19) = 3.0
  WHERE(XDATA_VEGTYPE(:,20)>0.) XDATA_GROUND_DEPTH(:,20) = 2.5
  ...
  WHERE(XDATA_VEGTYPE(:,6)>0.) XDATA_DICE(:,6) = 2.0
  WHERE(XDATA_VEGTYPE(:,7)>0.) XDATA_DICE(:,7) = 1.5
  WHERE(XDATA_VEGTYPE(:,8)>0.) XDATA_DICE(:,8) = 3.0
  WHERE(XDATA_VEGTYPE(:,9)>0.) XDATA_DICE(:,9) = 1.0
  WHERE(XDATA_VEGTYPE(:,10)>0.) XDATA_DICE(:,10) = 2.0
  WHERE(XDATA_VEGTYPE(:,11)>0.) XDATA_DICE(:,11) = 1.0
  WHERE(XDATA_VEGTYPE(:,12)>0.) XDATA_DICE(:,12) = 1.0
  WHERE(XDATA_VEGTYPE(:,13)>0.) XDATA_DICE(:,13) = 1.0
  WHERE(XDATA_VEGTYPE(:,14)>0.) XDATA_DICE(:,14) = 2.0
  WHERE(XDATA_VEGTYPE(:,15)>0.) XDATA_DICE(:,15) = 3.0
  WHERE(XDATA_VEGTYPE(:,16)>0.) XDATA_DICE(:,16) = 1.2
  WHERE(XDATA_VEGTYPE(:,17)>0.) XDATA_DICE(:,17) = 1.5
  WHERE(XDATA_VEGTYPE(:,18)>0.) XDATA_DICE(:,18) = 1.5
  WHERE(XDATA_VEGTYPE(:,19)>0.) XDATA_DICE(:,19) = 2.0
  WHERE(XDATA_VEGTYPE(:,20)>0.) XDATA_DICE(:,20) = 1.5
