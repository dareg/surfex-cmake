...
IF (U%LECOSG) THEN
  ...
  DO JDEC = 1,SIZE(XDATA_LAI,2)
    ...
    WHERE(XDATA_VEGTYPE(:,7)>0.) XDATA_LAI(:,JDEC,7) = 2.
    WHERE(XDATA_VEGTYPE(:,8)>0.) XDATA_LAI(:,JDEC,8) = 2.
    WHERE(XDATA_VEGTYPE(:,9)>0.) XDATA_LAI(:,JDEC,9) = 2.
    WHERE(XDATA_VEGTYPE(:,10)>0.) XDATA_LAI(:,JDEC,10) = 3.
    WHERE(XDATA_VEGTYPE(:,11)>0.) XDATA_LAI(:,JDEC,11) = 3.
    WHERE(XDATA_VEGTYPE(:,12)>0.) XDATA_LAI(:,JDEC,12) = 3.
    WHERE(XDATA_VEGTYPE(:,13)>0.) XDATA_LAI(:,JDEC,13) = 4.
    WHERE(XDATA_VEGTYPE(:,14)>0.) XDATA_LAI(:,JDEC,14) = 4.
    WHERE(XDATA_VEGTYPE(:,15)>0.) XDATA_LAI(:,JDEC,15) = 4.
    WHERE(XDATA_VEGTYPE(:,16)>0.) XDATA_LAI(:,JDEC,16) = 4.
    WHERE(XDATA_VEGTYPE(:,17)>0.) XDATA_LAI(:,JDEC,17) = 4.
    WHERE(XDATA_VEGTYPE(:,18)>0.) XDATA_LAI(:,JDEC,18) = 4.
  ...
  WHERE(XDATA_VEGTYPE(:,6)>0.) XDATA_ROOT_DEPTH(:,6) = 5.0
  WHERE(XDATA_VEGTYPE(:,7)>0.) XDATA_ROOT_DEPTH(:,7) = 1.5
  WHERE(XDATA_VEGTYPE(:,8)>0.) XDATA_ROOT_DEPTH(:,8) = 1.5
  WHERE(XDATA_VEGTYPE(:,9)>0.) XDATA_ROOT_DEPTH(:,9) = 1.5
  WHERE(XDATA_VEGTYPE(:,10)>0.) XDATA_ROOT_DEPTH(:,10) = 1.0
  WHERE(XDATA_VEGTYPE(:,11)>0.) XDATA_ROOT_DEPTH(:,11) = 1.5
  WHERE(XDATA_VEGTYPE(:,12)>0.) XDATA_ROOT_DEPTH(:,12) = 1.5
  WHERE(XDATA_VEGTYPE(:,13)>0.) XDATA_ROOT_DEPTH(:,13) = 3.0
  WHERE(XDATA_VEGTYPE(:,14)>0.) XDATA_ROOT_DEPTH(:,14) = 2.0
  WHERE(XDATA_VEGTYPE(:,15)>0.) XDATA_ROOT_DEPTH(:,15) = 2.0
  WHERE(XDATA_VEGTYPE(:,16)>0.) XDATA_ROOT_DEPTH(:,16) = 2.0
  WHERE(XDATA_VEGTYPE(:,17)>0.) XDATA_ROOT_DEPTH(:,17) = 2.0
  WHERE(XDATA_VEGTYPE(:,18)>0.) XDATA_ROOT_DEPTH(:,18) = 1.0
  ...
  WHERE(XDATA_VEGTYPE(:,6)>0.) XDATA_GROUND_DEPTH(:,6) = 8.0
  WHERE(XDATA_VEGTYPE(:,7)>0.) XDATA_GROUND_DEPTH(:,7) = 2.0
  WHERE(XDATA_VEGTYPE(:,8)>0.) XDATA_GROUND_DEPTH(:,8) = 2.0
  WHERE(XDATA_VEGTYPE(:,9)>0.) XDATA_GROUND_DEPTH(:,9) = 2.0
  WHERE(XDATA_VEGTYPE(:,10)>0.) XDATA_GROUND_DEPTH(:,10) = 1.5
  WHERE(XDATA_VEGTYPE(:,11)>0.) XDATA_GROUND_DEPTH(:,11) = 2.0
  WHERE(XDATA_VEGTYPE(:,12)>0.) XDATA_GROUND_DEPTH(:,12) = 2.0
  WHERE(XDATA_VEGTYPE(:,13)>0.) XDATA_GROUND_DEPTH(:,13) = 3.0
  WHERE(XDATA_VEGTYPE(:,14)>0.) XDATA_GROUND_DEPTH(:,14) = 3.0
  WHERE(XDATA_VEGTYPE(:,15)>0.) XDATA_GROUND_DEPTH(:,15) = 3.0
  WHERE(XDATA_VEGTYPE(:,16)>0.) XDATA_GROUND_DEPTH(:,16) = 3.0
  WHERE(XDATA_VEGTYPE(:,17)>0.) XDATA_GROUND_DEPTH(:,17) = 3.0
  WHERE(XDATA_VEGTYPE(:,18)>0.) XDATA_GROUND_DEPTH(:,18) = 1.5
  WHERE(XDATA_VEGTYPE(:,19)>0.) XDATA_GROUND_DEPTH(:,19) = 3.0
 
  !height_trees
  WHERE(XDATA_VEGTYPE(:,4)>0.) XDATA_H_TREE(:,4) = 10.0
  WHERE(XDATA_VEGTYPE(:,5)>0.) XDATA_H_TREE(:,5) = 10.0
  WHERE(XDATA_VEGTYPE(:,6)>0.) XDATA_H_TREE(:,6) = 30.0
  WHERE(XDATA_VEGTYPE(:,13)>0.) XDATA_H_TREE(:,13) = 10.0
  WHERE(XDATA_VEGTYPE(:,14)>0.) XDATA_H_TREE(:,14) = 10.0
  WHERE(XDATA_VEGTYPE(:,15)>0.) XDATA_H_TREE(:,15) = 15.0
  WHERE(XDATA_VEGTYPE(:,16)>0.) XDATA_H_TREE(:,16) = 15.0
  WHERE(XDATA_VEGTYPE(:,17)>0.) XDATA_H_TREE(:,17) = 15.0
  WHERE(XDATA_VEGTYPE(:,19)>0.) XDATA_H_TREE(:,19) = 0.2
    
  !ice_depth
  WHERE(XDATA_VEGTYPE(:,1)>0.) XDATA_DICE(:,1) = 0.5
  WHERE(XDATA_VEGTYPE(:,2)>0.) XDATA_DICE(:,2) = 0.2
  WHERE(XDATA_VEGTYPE(:,3)>0.) XDATA_DICE(:,3) = 0.2
  WHERE(XDATA_VEGTYPE(:,4)>0.) XDATA_DICE(:,4) = 1.5
  WHERE(XDATA_VEGTYPE(:,5)>0.) XDATA_DICE(:,5) = 1.0
  WHERE(XDATA_VEGTYPE(:,6)>0.) XDATA_DICE(:,6) = 8.0
  WHERE(XDATA_VEGTYPE(:,7)>0.) XDATA_DICE(:,7) = 1.0
  WHERE(XDATA_VEGTYPE(:,8)>0.) XDATA_DICE(:,8) = 1.2
  WHERE(XDATA_VEGTYPE(:,9)>0.) XDATA_DICE(:,9) = 1.5
  WHERE(XDATA_VEGTYPE(:,10)>0.) XDATA_DICE(:,10) = 1.0
  WHERE(XDATA_VEGTYPE(:,11)>0.) XDATA_DICE(:,11) = 1.5
  WHERE(XDATA_VEGTYPE(:,12)>0.) XDATA_DICE(:,12) = 1.0
  WHERE(XDATA_VEGTYPE(:,13)>0.) XDATA_DICE(:,13) = 3.0
  WHERE(XDATA_VEGTYPE(:,14)>0.) XDATA_DICE(:,14) = 2.0
  WHERE(XDATA_VEGTYPE(:,15)>0.) XDATA_DICE(:,15) = 1.5
  WHERE(XDATA_VEGTYPE(:,16)>0.) XDATA_DICE(:,16) = 1.
  WHERE(XDATA_VEGTYPE(:,17)>0.) XDATA_DICE(:,17) = 0.3
  WHERE(XDATA_VEGTYPE(:,18)>0.) XDATA_DICE(:,18) = 0.3
