!     #########
      SUBROUTINE INI_DATA_ROOTFRAC1( PDG, PROOTDEPTH, PROOT_EXT, PROOT_LIN,  &
                                    PROOTFRAC, OGV                          )
...
!               --------------
!
IF (LHOOK) CALL DR_HOOK('INI_DATA_ROOTFRAC1',0,ZHOOK_HANDLE)
!
INI    = SIZE(PDG,1)
INL    = SIZE(PDG,2)
!
...
!
IF (LHOOK) CALL DR_HOOK('INI_DATA_ROOTFRAC1',1,ZHOOK_HANDLE)
!-------------------------------------------------------------------------------
END SUBROUTINE INI_DATA_ROOTFRAC1
