!     #########
      SUBROUTINE INI_DATA_SOIL1(HISBA,PDG_OUT,PSURF,PSURF2,PROOTDEPTH, &
...
!            -----------
!
IF (LHOOK) CALL DR_HOOK('INI_DATA_SOIL1',0,ZHOOK_HANDLE)
!
PDG_OUT(:,:) = XUNDEF
!
!-------------------------------------------------------------------------------
...
IF (HISBA=='2-L') THEN
  ...
  IF (.NOT.PRESENT(PROOTDEPTH)) CALL ABOR1_SFX("INI_DATA_SOIL1: FOR HISBA==2-L, PROOTDEPTH IS NEEDED")
...
!
  ELSE
    ...
    CALL SOILGRID1(PSOILGRID,PSOILDEPTH,PDG_OUT,KWG_LAYER)

  ENDIF

ENDIF
!
IF (LHOOK) CALL DR_HOOK('INI_DATA_SOIL1',1,ZHOOK_HANDLE)
!-------------------------------------------------------------------------------
!
END SUBROUTINE INI_DATA_SOIL1
