...
CHARACTER(LEN=16), DIMENSION(KI), INTENT(IN)  :: HSV       ! name of all scalar variables
...
IF (LNAM_READ) THEN
 ...
 CALL DEFAULT_DIAG_FLAKE(FM%DFO%N2M,FM%DFO%LSURF_BUDGET,FM%DFO%L2M_MIN_ZS,FM%DFO%LHU2M_QSAT,FM%DFO%LRAD_BUDGET,&
