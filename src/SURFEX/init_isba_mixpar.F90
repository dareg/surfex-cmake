...
IF (LDATA_VEG) THEN
  ...
  IF (.NOT.LDATA_ALBNIR_VEG) &
     CALL INI_DATA_PARAM(XPAR_VEGTYPE,OAGRI_TO_GRASS=LAGRI_TO_GRASS,PALBNIR_VEG=XPAR_ALBNIR_VEG)
  IF (.NOT.LDATA_ALBVIS_VEG) &
     CALL INI_DATA_PARAM(XPAR_VEGTYPE,OAGRI_TO_GRASS=LAGRI_TO_GRASS,PALBVIS_VEG=XPAR_ALBVIS_VEG)
