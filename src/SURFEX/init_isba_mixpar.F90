...
IF (.NOT.DTI%LDATA_VEGTYPE) THEN
  ...
  DO JVEGTYPE=1,NVEGTYPE
    CALL AV_PGD (DTI%XPAR_VEGTYPE(:,JVEGTYPE),PCOVER ,DTCO%XDATA_VEGTYPE(:,JVEGTYPE),YNAT,'ARI',OCOVER)
  END DO
ENDIF
!
...
IF (.NOT.DTI%LDATA_LAI) THEN
  ...
  CALL AV_PGD(DTI%XPAR_LAI(:,KDECADE2,:),PCOVER,XDATA_LAI(:,KDECADE,:),YVEG,'ARI',OCOVER,KDECADE=KDECADE2)
ENDIF
!veg
IF (.NOT.DTI%LDATA_VEG) THEN
  ...
  IF (DTI%LDATA_LAI) THEN
    ...
    DTI%LDATA_VEG=.TRUE.
  ELSE
    CALL AV_PGD(DTI%XPAR_VEG(:,KDECADE2,:),PCOVER,XDATA_VEG(:,KDECADE,:),YNAT,'ARI',OCOVER,KDECADE=KDECADE2)
  ENDIF
ENDIF
...
IF (.NOT.DTI%LDATA_H_TREE .AND. .NOT.DTI%LDATA_Z0 .AND. DTI%LDATA_LAI) THEN
  ...
  CALL AV_PGD(DTI%XPAR_H_TREE,PCOVER,XDATA_H_TREE,YTREE,'ARI',OCOVER,KDECADE=KDECADE2)
...
IF (DTI%LDATA_VEG) THEN
  ...
  IF (.NOT.DTI%LDATA_IRRIG) THEN
    ...
    CALL AV_PGD(DTI%XPAR_IRRIG(:,KDECADE2,:),PCOVER,XDATA_IRRIG(:,:),YVEG,'ARI',OCOVER,KDECADE=KDECADE2)
    DTI%LDATA_IRRIG=.TRUE.
  ENDIF
  !
  IF (.NOT.DTI%LDATA_WATSUP) THEN
    ALLOCATE(DTI%XPAR_WATSUP     (IG%NDIM,DTI%NTIME,NVEGTYPE))
    CALL AV_PGD(DTI%XPAR_WATSUP(:,KDECADE2,:),PCOVER,XDATA_WATSUP(:,:),YVEG,'ARI',OCOVER,KDECADE=KDECADE2)
...
!
  ...
  IF (.NOT.DTI%LDATA_ZF_TALLVEG) ALLOCATE(DTI%XPAR_ZF_TALLVEG     (IG%NDIM,NVEGTYPE))
  ...
  IF (.NOT.DTI%LDATA_ZF_TALLVEG) CALL INI_DATA_PARAM(DTI%XPAR_VEGTYPE,PZF_TALLVEG=DTI%XPAR_ZF_TALLVEG)
