...
!               --------
 ...
 CALL DEFAULT_ISBA(IM%I%XTSTEP, IM%I%XOUT_TSTEP,                           &
                     ...
                     IM%I%NNBYEARSPINS, IM%I%NNBYEARSPINW, IM%I%LNITRO_DILU, IM%I%XCVHEATF )
 !                  
 ...
 CALL DEFAULT_DIAG_ISBA(IM%DGI%N2M,IM%DGI%LSURF_BUDGET,IM%DGI%L2M_MIN_ZS,IM%DGI%LRAD_BUDGET,   &
                        ...
                        IM%DGMI%LPROSNOW,IM%DGMI%LPROBANDS,&
                        IM%DGMI%LVOLUMETRIC_SNOWLIQ,IM%DGI%XDIAG_TSTEP )  

 !
 CALL DEFAULT_CROCUS(IM%I%CSNOWDRIFT,IM%I%LSNOWDRIFT_SUBLIM,IM%I%LSNOW_ABS_ZENITH,&
                     IM%I%CSNOWMETAMO,IM%I%CSNOWRAD,IM%I%LATMORAD,IM%I%LSNOWSYTRON,IM%I%CSNOWFALL,&
                     IM%I%CSNOWCOND, IM%I%CSNOWHOLD, IM%I%CSNOWCOMP, IM%I%CSNOWZREF)
 ! 
ENDIF
!
...
ENDIF
IF (IM%I%TSNOW%SCHEME=='CRO' .AND. IM%I%LSNOWSYTRON .AND. IM%I%CSNOWMETAMO.NE.'B92') THEN
    CALL ABOR1_SFX("INIT_ISBAN: with SYTRON B92 must be used for snow metamorphism")
ENDIF
!
 CALL END_IO_SURF_n(HPROGRAM)
...
ENDIF
!
IF ( IM%I%CSNOWRAD=="TAR" .OR. IM%I%CSNOWRAD=="TA1" .OR.  IM%I%CSNOWRAD=="TA2" &
     .OR. IM%I%CSNOWRAD=="TA3" .OR. IM%I%CSNOWRAD=="TA4") THEN
  CALL INIT_TARTES()
END IF
!
IF (LHOOK) CALL DR_HOOK('INIT_ISBA_N',1,ZHOOK_HANDLE)
