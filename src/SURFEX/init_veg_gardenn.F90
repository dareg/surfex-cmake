...
!              -------------------------------
!
REAL, DIMENSION(:,:), POINTER :: ZFAPARC=>NULL()
!$OMP THREADPRIVATE(ZFAPARC)
REAL, DIMENSION(:,:), POINTER :: ZFAPIRC=>NULL()
!$OMP THREADPRIVATE(ZFAPIRC)
REAL, DIMENSION(:,:), POINTER :: ZLAI_EFFC=>NULL()
!$OMP THREADPRIVATE(ZLAI_EFFC)
REAL, DIMENSION(:,:), POINTER :: ZMUS=>NULL()
!$OMP THREADPRIVATE(ZMUS)
!
REAL, DIMENSION(:,:), POINTER :: ZALBNIR_SOIL=>NULL()
!$OMP THREADPRIVATE(ZALBNIR_SOIL)
REAL, DIMENSION(:,:), POINTER :: ZALBVIS_SOIL=>NULL()
!$OMP THREADPRIVATE(ZALBVIS_SOIL)
REAL, DIMENSION(:,:), POINTER :: ZALBUV_SOIL=>NULL()
!$OMP THREADPRIVATE(ZALBUV_SOIL)
REAL, DIMENSION(:,:), POINTER :: ZALBNIR=>NULL()
!$OMP THREADPRIVATE(ZALBNIR)
REAL, DIMENSION(:,:), POINTER :: ZALBVIS=>NULL()
!$OMP THREADPRIVATE(ZALBVIS)
REAL, DIMENSION(:,:), POINTER :: ZALBUV=>NULL()
!$OMP THREADPRIVATE(ZALBUV)
!
REAL, DIMENSION(:,:), POINTER :: ZPSN=>NULL()
!$OMP THREADPRIVATE(ZPSN)
REAL, DIMENSION(:,:), POINTER :: ZPSNG=>NULL()
!$OMP THREADPRIVATE(ZPSNG)
REAL, DIMENSION(:,:), POINTER :: ZPSNV=>NULL()
!$OMP THREADPRIVATE(ZPSNV)
REAL, DIMENSION(:,:), POINTER :: ZPSNV_A=>NULL()
!$OMP THREADPRIVATE(ZPSNV_A)
!
