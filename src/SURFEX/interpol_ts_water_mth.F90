...
!
IF(W%CINTERPOL_TS=='MONTH ')THEN
  CALL INTERPOL_QUADRA(ZDAT,ZNDAT,W%XTS_MTH(:,1),W%XTS_MTH(:,2),W%XTS_MTH(:,3),PTS)
ELSE
  IMTH1=KMONTH
  IMTH2=KMONTH+1
  IMTH3=KMONTH+2
  CALL INTERPOL_QUADRA(ZDAT,ZNDAT,W%XTS_MTH(:,IMTH1),W%XTS_MTH(:,IMTH2),W%XTS_MTH(:,IMTH3),PTS)
ENDIF
