...
!
!
SUBROUTINE BEM_INIT_1P(YBEM_1P)
TYPE(BEM_1P_t), INTENT(INOUT) :: YBEM_1P
REAL(KIND=JPRB) :: ZHOOK_HANDLE
IF (LHOOK) CALL DR_HOOK("MODD_BEM_N:BEM_INIT_1P",0,ZHOOK_HANDLE)
  NULLIFY(YBEM_1P%XF_WATER_COND)
  NULLIFY(YBEM_1P%XHC_FLOOR)
  NULLIFY(YBEM_1P%XTC_FLOOR)
  NULLIFY(YBEM_1P%XD_FLOOR)
  NULLIFY(YBEM_1P%XTCOOL_TARGET)
  NULLIFY(YBEM_1P%XTHEAT_TARGET)
  NULLIFY(YBEM_1P%XTI_BLD)
  NULLIFY(YBEM_1P%XT_FLOOR)
  NULLIFY(YBEM_1P%XT_MASS)
  NULLIFY(YBEM_1P%XQIN)
  NULLIFY(YBEM_1P%XQIN_FRAD)
  NULLIFY(YBEM_1P%XSHGC)
  NULLIFY(YBEM_1P%XSHGC_SH)
  NULLIFY(YBEM_1P%XU_WIN)
  NULLIFY(YBEM_1P%XTRAN_WIN)
  NULLIFY(YBEM_1P%XGR)
  NULLIFY(YBEM_1P%XFLOOR_HEIGHT)
  NULLIFY(YBEM_1P%XEFF_HEAT)
  NULLIFY(YBEM_1P%XINF)
  NULLIFY(YBEM_1P%XF_WASTE_CAN)
  NULLIFY(YBEM_1P%XAUX_MAX)
  NULLIFY(YBEM_1P%XQIN_FLAT)
  NULLIFY(YBEM_1P%XHR_TARGET)
  NULLIFY(YBEM_1P%XT_WIN2)
  NULLIFY(YBEM_1P%XQI_BLD)
  NULLIFY(YBEM_1P%XV_VENT)
  NULLIFY(YBEM_1P%XCAP_SYS_HEAT)
  NULLIFY(YBEM_1P%XCAP_SYS_RAT)
  NULLIFY(YBEM_1P%XT_ADP)
  NULLIFY(YBEM_1P%XM_SYS_RAT)
  NULLIFY(YBEM_1P%XCOP_RAT)
  NULLIFY(YBEM_1P%XT_WIN1)
  NULLIFY(YBEM_1P%XALB_WIN)
  NULLIFY(YBEM_1P%XABS_WIN)
  NULLIFY(YBEM_1P%XT_SIZE_MAX)
  NULLIFY(YBEM_1P%XT_SIZE_MIN)
  NULLIFY(YBEM_1P%XUGG_WIN)
  NULLIFY(YBEM_1P%LSHAD_DAY)
  NULLIFY(YBEM_1P%LNATVENT_NIGHT)
  NULLIFY(YBEM_1P%LSHADE)
  NULLIFY(YBEM_1P%XSHADE)
  NULLIFY(YBEM_1P%CNATVENT)
  NULLIFY(YBEM_1P%XNATVENT)
  NULLIFY(YBEM_1P%XN_FLOOR)
  NULLIFY(YBEM_1P%XGLAZ_O_BLD)
  NULLIFY(YBEM_1P%XMASS_O_BLD)
  NULLIFY(YBEM_1P%XFLOOR_HW_RATIO)
  NULLIFY(YBEM_1P%XF_FLOOR_MASS)
  NULLIFY(YBEM_1P%XF_FLOOR_WALL)
  NULLIFY(YBEM_1P%XF_FLOOR_WIN)
  NULLIFY(YBEM_1P%XF_FLOOR_ROOF)
  NULLIFY(YBEM_1P%XF_WALL_FLOOR)
  NULLIFY(YBEM_1P%XF_WALL_MASS)
  NULLIFY(YBEM_1P%XF_WALL_WIN)
  NULLIFY(YBEM_1P%XF_WIN_FLOOR)
  NULLIFY(YBEM_1P%XF_WIN_MASS)
  NULLIFY(YBEM_1P%XF_WIN_WALL)
  NULLIFY(YBEM_1P%XF_WIN_WIN)
  NULLIFY(YBEM_1P%XF_MASS_FLOOR)
  NULLIFY(YBEM_1P%XF_MASS_WALL)
  NULLIFY(YBEM_1P%XF_MASS_WIN)
IF (LHOOK) CALL DR_HOOK("MODD_BEM_N:BEM_INIT_1P",1,ZHOOK_HANDLE)
END SUBROUTINE BEM_INIT_1P
!
...
IF (.NOT.ASSOCIATED(YBEM%ALP)) THEN
  ALLOCATE(YBEM%ALP(KPATCH))
  YBEM%CUR => YBEM%ALP(1)
  DO JP=1,KPATCH
    CALL BEM_INIT_1P(YBEM%ALP(JP))
  ENDDO
ELSE
  DO JP=1,KPATCH
    CALL BEM_INIT_1P(YBEM%ALP(JP))
