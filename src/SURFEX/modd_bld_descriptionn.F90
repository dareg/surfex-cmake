...
REAL, POINTER, DIMENSION(:)   :: XDESC_EMIS_PANEL=>NULL()
!$OMP THREADPRIVATE(XDESC_EMIS_PANEL)
REAL, POINTER, DIMENSION(:)   :: XDESC_ALB_PANEL=>NULL()
!$OMP THREADPRIVATE(XDESC_ALB_PANEL)
REAL, POINTER, DIMENSION(:)   :: XDESC_EFF_PANEL=>NULL()
!$OMP THREADPRIVATE(XDESC_EFF_PANEL)
REAL, POINTER, DIMENSION(:)   :: XDESC_FRAC_PANEL=>NULL()
!$OMP THREADPRIVATE(XDESC_FRAC_PANEL)
REAL, POINTER, DIMENSION(:)   :: XDESC_RESIDENTIAL=>NULL()
!$OMP THREADPRIVATE(XDESC_RESIDENTIAL)
!
CONTAINS
...
BLD_DESC_MODEL(KFROM)%XDESC_EMIS_PANEL=>XDESC_EMIS_PANEL
BLD_DESC_MODEL(KFROM)%XDESC_ALB_PANEL=>XDESC_ALB_PANEL
BLD_DESC_MODEL(KFROM)%XDESC_EFF_PANEL=>XDESC_EFF_PANEL
BLD_DESC_MODEL(KFROM)%XDESC_FRAC_PANEL=>XDESC_FRAC_PANEL
BLD_DESC_MODEL(KFROM)%XDESC_RESIDENTIAL=>XDESC_RESIDENTIAL
ENDIF
!
...
XDESC_EMIS_PANEL=>BLD_DESC_MODEL(KTO)%XDESC_EMIS_PANEL
XDESC_ALB_PANEL=>BLD_DESC_MODEL(KTO)%XDESC_ALB_PANEL
XDESC_EFF_PANEL=>BLD_DESC_MODEL(KTO)%XDESC_EFF_PANEL
XDESC_FRAC_PANEL=>BLD_DESC_MODEL(KTO)%XDESC_FRAC_PANEL
XDESC_RESIDENTIAL=>BLD_DESC_MODEL(KTO)%XDESC_RESIDENTIAL
