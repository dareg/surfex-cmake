...
REAL, POINTER, DIMENSION(:,:,:)   :: XDATA_WEIGHT=>NULL()
!$OMP THREADPRIVATE(XDATA_WEIGHT)
...
IF (LKFROM) THEN
DATA_COVER_MODEL(KFROM)%XDATA_WEIGHT=>XDATA_WEIGHT
...
XDATA_WEIGHT=>DATA_COVER_MODEL(KTO)%XDATA_WEIGHT
