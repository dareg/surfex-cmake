...
! - For multi-energy balance (MEB)
!
  REAL, POINTER, DIMENSION(:,:,:) :: XPAR_VEGGV          ! understory vegetation fraction
  REAL, POINTER, DIMENSION(:,:,:) :: XPAR_LAIGV          ! understory LAI
  REAL, POINTER, DIMENSION(:,:,:) :: XPAR_Z0GV           ! understory roughness length
...
LOGICAL, POINTER:: LDATA_VEGGV=>NULL()
!$OMP THREADPRIVATE(LDATA_VEGGV)
LOGICAL, POINTER:: LDATA_LAIGV=>NULL()
!$OMP THREADPRIVATE(LDATA_LAIGV)
LOGICAL, POINTER:: LDATA_Z0GV=>NULL()
!$OMP THREADPRIVATE(LDATA_Z0GV)
LOGICAL, POINTER:: LDATA_RSMINGV=>NULL()
!$OMP THREADPRIVATE(LDATA_RSMINGV)
LOGICAL, POINTER:: LDATA_GAMMAGV=>NULL()
!$OMP THREADPRIVATE(LDATA_GAMMAGV)
LOGICAL, POINTER:: LDATA_WRMAX_CFGV=>NULL()
!$OMP THREADPRIVATE(LDATA_WRMAX_CFGV)
LOGICAL, POINTER:: LDATA_RGLGV=>NULL()
!$OMP THREADPRIVATE(LDATA_RGLGV)
LOGICAL, POINTER:: LDATA_ZF_TALLVEG=>NULL()
!$OMP THREADPRIVATE(LDATA_ZF_TALLVEG)
LOGICAL, POINTER:: LDATA_ROOTFRACGV=>NULL()
!$OMP THREADPRIVATE(LDATA_ROOTFRACGV)
LOGICAL, POINTER:: LDATA_ROOT_DEPTHGV=>NULL()
!$OMP THREADPRIVATE(LDATA_ROOT_DEPTHGV)
LOGICAL, POINTER:: LDATA_ROOT_EXTINCTIONGV=>NULL()
!$OMP THREADPRIVATE(LDATA_ROOT_EXTINCTIONGV)
LOGICAL, POINTER:: LDATA_H_VEG=>NULL()
!$OMP THREADPRIVATE(LDATA_H_VEG)
...
REAL, POINTER, DIMENSION(:,:,:) :: XPAR_VEGGV=>NULL()
!$OMP THREADPRIVATE(XPAR_VEGGV)
REAL, POINTER, DIMENSION(:,:,:) :: XPAR_LAIGV=>NULL()
!$OMP THREADPRIVATE(XPAR_LAIGV)
REAL, POINTER, DIMENSION(:,:,:) :: XPAR_Z0GV=>NULL()
!$OMP THREADPRIVATE(XPAR_Z0GV)
REAL, POINTER, DIMENSION(:,:)   :: XPAR_RSMINGV=>NULL()
!$OMP THREADPRIVATE(XPAR_RSMINGV)
REAL, POINTER, DIMENSION(:,:)   :: XPAR_GAMMAGV=>NULL()
!$OMP THREADPRIVATE(XPAR_GAMMAGV)
REAL, POINTER, DIMENSION(:,:)   :: XPAR_WRMAX_CFGV=>NULL()
!$OMP THREADPRIVATE(XPAR_WRMAX_CFGV)
REAL, POINTER, DIMENSION(:,:)   :: XPAR_RGLGV=>NULL()
!$OMP THREADPRIVATE(XPAR_RGLGV)
REAL, POINTER, DIMENSION(:,:)   :: XPAR_ZF_TALLVEG=>NULL()
!$OMP THREADPRIVATE(XPAR_ZF_TALLVEG)
REAL, POINTER, DIMENSION(:,:,:) :: XPAR_ROOTFRACGV=>NULL()
!$OMP THREADPRIVATE(XPAR_ROOTFRACGV)
REAL, POINTER, DIMENSION(:,:) :: XPAR_ROOT_DEPTHGV=>NULL()
!$OMP THREADPRIVATE(XPAR_ROOT_DEPTHGV)
REAL, POINTER, DIMENSION(:,:) :: XPAR_ROOT_EXTINCTIONGV=>NULL()
!$OMP THREADPRIVATE(XPAR_ROOT_EXTINCTIONGV)
REAL, POINTER, DIMENSION(:,:,:) :: XPAR_H_VEG=>NULL()
!$OMP THREADPRIVATE(XPAR_H_VEG)
...
!
DATA_ISBA_MODEL(KFROM)%XPAR_VEGGV=>XPAR_VEGGV
DATA_ISBA_MODEL(KFROM)%XPAR_LAIGV=>XPAR_LAIGV
DATA_ISBA_MODEL(KFROM)%XPAR_Z0GV=>XPAR_Z0GV
DATA_ISBA_MODEL(KFROM)%XPAR_RSMINGV=>XPAR_RSMINGV
DATA_ISBA_MODEL(KFROM)%XPAR_GAMMAGV=>XPAR_GAMMAGV
DATA_ISBA_MODEL(KFROM)%XPAR_WRMAX_CFGV=>XPAR_WRMAX_CFGV
DATA_ISBA_MODEL(KFROM)%XPAR_RGLGV=>XPAR_RGLGV
DATA_ISBA_MODEL(KFROM)%XPAR_ZF_TALLVEG=>XPAR_ZF_TALLVEG
DATA_ISBA_MODEL(KFROM)%XPAR_ROOTFRACGV=>XPAR_ROOTFRACGV
DATA_ISBA_MODEL(KFROM)%XPAR_ROOT_DEPTHGV=>XPAR_ROOT_DEPTHGV
DATA_ISBA_MODEL(KFROM)%XPAR_ROOT_EXTINCTIONGV=>XPAR_ROOT_EXTINCTIONGV
DATA_ISBA_MODEL(KFROM)%XPAR_H_VEG=>XPAR_H_VEG
!
ENDIF
!
...
LDATA_VEGGV=>DATA_ISBA_MODEL(KTO)%LDATA_VEGGV
LDATA_LAIGV=>DATA_ISBA_MODEL(KTO)%LDATA_LAIGV
LDATA_Z0GV=>DATA_ISBA_MODEL(KTO)%LDATA_Z0GV
LDATA_RSMINGV=>DATA_ISBA_MODEL(KTO)%LDATA_RSMINGV
LDATA_GAMMAGV=>DATA_ISBA_MODEL(KTO)%LDATA_GAMMAGV
LDATA_WRMAX_CFGV=>DATA_ISBA_MODEL(KTO)%LDATA_WRMAX_CFGV
LDATA_RGLGV=>DATA_ISBA_MODEL(KTO)%LDATA_RGLGV
LDATA_ZF_TALLVEG=>DATA_ISBA_MODEL(KTO)%LDATA_ZF_TALLVEG
LDATA_ROOTFRACGV=>DATA_ISBA_MODEL(KTO)%LDATA_ROOTFRACGV
LDATA_ROOT_DEPTHGV=>DATA_ISBA_MODEL(KTO)%LDATA_ROOT_DEPTHGV
LDATA_ROOT_EXTINCTIONGV=>DATA_ISBA_MODEL(KTO)%LDATA_ROOT_EXTINCTIONGV
LDATA_H_VEG=>DATA_ISBA_MODEL(KTO)%LDATA_H_VEG
!
...
XPAR_VEGGV=>DATA_ISBA_MODEL(KTO)%XPAR_VEGGV
XPAR_LAIGV=>DATA_ISBA_MODEL(KTO)%XPAR_LAIGV
XPAR_Z0GV=>DATA_ISBA_MODEL(KTO)%XPAR_Z0GV
XPAR_RSMINGV=>DATA_ISBA_MODEL(KTO)%XPAR_RSMINGV
XPAR_GAMMAGV=>DATA_ISBA_MODEL(KTO)%XPAR_GAMMAGV
XPAR_WRMAX_CFGV=>DATA_ISBA_MODEL(KTO)%XPAR_WRMAX_CFGV
XPAR_RGLGV=>DATA_ISBA_MODEL(KTO)%XPAR_RGLGV
XPAR_ZF_TALLVEG=>DATA_ISBA_MODEL(KTO)%XPAR_ZF_TALLVEG
XPAR_ROOTFRACGV=>DATA_ISBA_MODEL(KTO)%XPAR_ROOTFRACGV
XPAR_ROOT_DEPTHGV=>DATA_ISBA_MODEL(KTO)%XPAR_ROOT_DEPTHGV
XPAR_ROOT_EXTINCTIONGV=>DATA_ISBA_MODEL(KTO)%XPAR_ROOT_EXTINCTIONGV
XPAR_H_VEG=>DATA_ISBA_MODEL(KTO)%XPAR_H_VEG
...
DO J=1,KMODEL
  ...
  NULLIFY(DATA_ISBA_MODEL(J)%XPAR_VEGGV)
  NULLIFY(DATA_ISBA_MODEL(J)%XPAR_LAIGV)
  NULLIFY(DATA_ISBA_MODEL(J)%XPAR_Z0GV)
...
DATA_ISBA_MODEL(:)%LDATA_VEGGV=.FALSE.
DATA_ISBA_MODEL(:)%LDATA_LAIGV=.FALSE.
DATA_ISBA_MODEL(:)%LDATA_Z0GV=.FALSE.
