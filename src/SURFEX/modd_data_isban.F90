...
LOGICAL, POINTER:: LDATA_Z0LITTER=>NULL()
!$OMP THREADPRIVATE(LDATA_Z0LITTER)
...
REAL, POINTER, DIMENSION(:,:,:) :: XPAR_Z0LITTER=>NULL()
!$OMP THREADPRIVATE(XPAR_Z0LITTER)
...
DATA_ISBA_MODEL(KFROM)%XPAR_Z0LITTER=>XPAR_Z0LITTER
...
LDATA_Z0LITTER=>DATA_ISBA_MODEL(KTO)%LDATA_Z0LITTER
...
XPAR_Z0LITTER=>DATA_ISBA_MODEL(KTO)%XPAR_Z0LITTER
