...
!
!
  LOGICAL, DIMENSION(NVEGTYPE)   :: LDATA_H_TREE
  LOGICAL, DIMENSION(NVEGTYPE)   :: LDATA_DG
  LOGICAL, DIMENSION(NVEGTYPE)   :: LDATA_DICE  
  LOGICAL, DIMENSION(NVEGTYPE)   :: LDATA_ROOTFRAC
  LOGICAL, DIMENSION(NVEGTYPE)   :: LDATA_GROUND_DEPTH
  LOGICAL, DIMENSION(NVEGTYPE)   :: LDATA_ROOT_DEPTH
  LOGICAL, DIMENSION(NVEGTYPE)   :: LDATA_ROOT_EXTINCTION
  LOGICAL, DIMENSION(NVEGTYPE)   :: LDATA_ROOT_LIN
  LOGICAL, DIMENSION(NVEGTYPE)   :: LDATA_RSMIN
  LOGICAL, DIMENSION(NVEGTYPE)   :: LDATA_GAMMA
  LOGICAL, DIMENSION(NVEGTYPE)   :: LDATA_WRMAX_CF
  LOGICAL, DIMENSION(NVEGTYPE)   :: LDATA_CV
  LOGICAL, DIMENSION(NVEGTYPE)   :: LDATA_Z0_O_Z0H
  LOGICAL, DIMENSION(NVEGTYPE)   :: LDATA_RGL
  LOGICAL, DIMENSION(NVEGTYPE)   :: LDATA_BSLAI
  LOGICAL, DIMENSION(NVEGTYPE)   :: LDATA_LAIMIN
  LOGICAL, DIMENSION(NVEGTYPE)   :: LDATA_SEFOLD
  LOGICAL, DIMENSION(NVEGTYPE)   :: LDATA_GMES
  LOGICAL, DIMENSION(NVEGTYPE)   :: LDATA_RE25
  LOGICAL, DIMENSION(NVEGTYPE)   :: LDATA_STRESS
  LOGICAL, DIMENSION(NVEGTYPE)   :: LDATA_F2I
  LOGICAL, DIMENSION(NVEGTYPE)   :: LDATA_GC
  LOGICAL, DIMENSION(NVEGTYPE)   :: LDATA_DMAX
  LOGICAL, DIMENSION(NVEGTYPE)   :: LDATA_CE_NITRO
  LOGICAL, DIMENSION(NVEGTYPE)   :: LDATA_CF_NITRO
  LOGICAL, DIMENSION(NVEGTYPE)   :: LDATA_CNA_NITRO
  LOGICAL, DIMENSION(NVEGTYPE)   :: LDATA_SEED_M
  LOGICAL, DIMENSION(NVEGTYPE)   :: LDATA_SEED_D
  LOGICAL, DIMENSION(NVEGTYPE)   :: LDATA_REAP_M
  LOGICAL, DIMENSION(NVEGTYPE)   :: LDATA_REAP_D
!
  LOGICAL   :: LIMP_VEG
  LOGICAL   :: LIMP_Z0
  LOGICAL   :: LIMP_EMIS
