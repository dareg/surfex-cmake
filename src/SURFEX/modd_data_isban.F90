...
LOGICAL, POINTER:: LDATA_GNDLITTER=>NULL()
!$OMP THREADPRIVATE(LDATA_GNDLITTER)
...
REAL, POINTER, DIMENSION(:,:,:) :: XPAR_GNDLITTER=>NULL()
!$OMP THREADPRIVATE(XPAR_GNDLITTER)
...
!
DATA_ISBA_MODEL(KFROM)%XPAR_GNDLITTER=>XPAR_GNDLITTER
...
LDATA_GNDLITTER=>DATA_ISBA_MODEL(KTO)%LDATA_GNDLITTER
...
XPAR_GNDLITTER=>DATA_ISBA_MODEL(KTO)%XPAR_GNDLITTER
