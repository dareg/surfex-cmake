...
!-------------------------------------------------------------------------------
!
  LOGICAL                       :: LDATA_FRAC_GR

  REAL, POINTER, DIMENSION(:)   :: XPAR_FRAC_GR         ! fraction of green roof
...
LOGICAL, POINTER                    :: LDATA_FRAC_GR=>NULL()
!$OMP THREADPRIVATE(LDATA_FRAC_GR)
REAL, POINTER, DIMENSION(:)         :: XPAR_FRAC_GR=>NULL()
!$OMP THREADPRIVATE(XPAR_FRAC_GR)
...
IF (LKFROM) THEN
DATA_TEB_GREENROOF_MODEL(KFROM)%XPAR_FRAC_GR=>XPAR_FRAC_GR
...
LDATA_FRAC_GR=>DATA_TEB_GREENROOF_MODEL(KTO)%LDATA_FRAC_GR
XPAR_FRAC_GR=>DATA_TEB_GREENROOF_MODEL(KTO)%XPAR_FRAC_GR
...
DO J=1,KMODEL
  NULLIFY(DATA_TEB_GREENROOF_MODEL(J)%XPAR_FRAC_GR)
...
ENDDO
DATA_TEB_GREENROOF_MODEL(:)%LDATA_FRAC_GR=.FALSE.
