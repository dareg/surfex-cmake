...
LOGICAL, POINTER :: LDATA_RESIDENTIAL=>NULL()
!$OMP THREADPRIVATE(LDATA_RESIDENTIAL)
LOGICAL, POINTER :: LDATA_EMIS_PANEL=>NULL()
!$OMP THREADPRIVATE(LDATA_EMIS_PANEL)
LOGICAL, POINTER :: LDATA_ALB_PANEL=>NULL()
!$OMP THREADPRIVATE(LDATA_ALB_PANEL)
LOGICAL, POINTER :: LDATA_EFF_PANEL=>NULL()
!$OMP THREADPRIVATE(LDATA_EFF_PANEL)
LOGICAL, POINTER :: LDATA_FRAC_PANEL=>NULL()
!$OMP THREADPRIVATE(LDATA_FRAC_PANEL)
...
REAL, POINTER, DIMENSION(:)   :: XPAR_RESIDENTIAL=>NULL()
!$OMP THREADPRIVATE(XPAR_RESIDENTIAL)
REAL, POINTER, DIMENSION(:)   :: XPAR_EMIS_PANEL=>NULL()
!$OMP THREADPRIVATE(XPAR_EMIS_PANEL)
REAL, POINTER, DIMENSION(:)   :: XPAR_ALB_PANEL=>NULL()
!$OMP THREADPRIVATE(XPAR_ALB_PANEL)
REAL, POINTER, DIMENSION(:)   :: XPAR_EFF_PANEL=>NULL()
!$OMP THREADPRIVATE(XPAR_EFF_PANEL)
REAL, POINTER, DIMENSION(:)   :: XPAR_FRAC_PANEL=>NULL()
!$OMP THREADPRIVATE(XPAR_FRAC_PANEL)
...
DATA_TEB_MODEL(KFROM)%XPAR_RESIDENTIAL=>XPAR_RESIDENTIAL
DATA_TEB_MODEL(KFROM)%XPAR_EMIS_PANEL=>XPAR_EMIS_PANEL
DATA_TEB_MODEL(KFROM)%XPAR_ALB_PANEL=>XPAR_ALB_PANEL
DATA_TEB_MODEL(KFROM)%XPAR_EFF_PANEL=>XPAR_EFF_PANEL
DATA_TEB_MODEL(KFROM)%XPAR_FRAC_PANEL=>XPAR_FRAC_PANEL
ENDIF
!
...
LDATA_RESIDENTIAL=>DATA_TEB_MODEL(KTO)%LDATA_RESIDENTIAL
LDATA_EMIS_PANEL=>DATA_TEB_MODEL(KTO)%LDATA_EMIS_PANEL
LDATA_ALB_PANEL=>DATA_TEB_MODEL(KTO)%LDATA_ALB_PANEL
LDATA_EFF_PANEL=>DATA_TEB_MODEL(KTO)%LDATA_EFF_PANEL
LDATA_FRAC_PANEL=>DATA_TEB_MODEL(KTO)%LDATA_FRAC_PANEL
...
XPAR_RESIDENTIAL=>DATA_TEB_MODEL(KTO)%XPAR_RESIDENTIAL
XPAR_EMIS_PANEL=>DATA_TEB_MODEL(KTO)%XPAR_EMIS_PANEL
XPAR_ALB_PANEL=>DATA_TEB_MODEL(KTO)%XPAR_ALB_PANEL
XPAR_EFF_PANEL=>DATA_TEB_MODEL(KTO)%XPAR_EFF_PANEL
XPAR_FRAC_PANEL=>DATA_TEB_MODEL(KTO)%XPAR_FRAC_PANEL
