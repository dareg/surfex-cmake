...
!------------------------------------------------------------------------------
!
SUBROUTINE DIAG_CUMUL_TEB_GOTO_MODEL(KFROM, KTO, LKFROM)
...
DIAG_CUMUL_TEB => DIAG_CUMUL_TEB_MODEL(KTO)
...
!
SUBROUTINE DIAG_CUMUL_TEB_GOTO_PATCH(KTO_PATCH)
...
DIAG_CUMUL_TEB%CUR => DIAG_CUMUL_TEB%ALP(KTO_PATCH)
...
ALLOCATE(DIAG_CUMUL_TEB_MODEL(KMODEL))
DIAG_CUMUL_TEB => DIAG_CUMUL_TEB_MODEL(KMODEL)
DO J=1,KMODEL
  ALLOCATE(DIAG_CUMUL_TEB_MODEL(J)%ALP(KPATCH))
 DO JP=1,KPATCH
  NULLIFY(DIAG_CUMUL_TEB_MODEL(J)%ALP(JP)%XRUNOFFC_TOWN)
  NULLIFY(DIAG_CUMUL_TEB_MODEL(J)%ALP(JP)%XRUNOFFC_GARDEN)
  NULLIFY(DIAG_CUMUL_TEB_MODEL(J)%ALP(JP)%XRUNOFFC_ROAD)
  NULLIFY(DIAG_CUMUL_TEB_MODEL(J)%ALP(JP)%XRUNOFFC_ROOF)
  NULLIFY(DIAG_CUMUL_TEB_MODEL(J)%ALP(JP)%XRUNOFFC_STRLROOF)
  NULLIFY(DIAG_CUMUL_TEB_MODEL(J)%ALP(JP)%XRUNOFFC_GREENROOF)
  NULLIFY(DIAG_CUMUL_TEB_MODEL(J)%ALP(JP)%XDRAINC_GREENROOF)
  NULLIFY(DIAG_CUMUL_TEB_MODEL(J)%ALP(JP)%XDRAINC_GARDEN)
  NULLIFY(DIAG_CUMUL_TEB_MODEL(J)%ALP(JP)%XIRRIGC_GREENROOF)
  NULLIFY(DIAG_CUMUL_TEB_MODEL(J)%ALP(JP)%XIRRIGC_GARDEN)
  NULLIFY(DIAG_CUMUL_TEB_MODEL(J)%ALP(JP)%XIRRIGC_ROAD)
  NULLIFY(DIAG_CUMUL_TEB_MODEL(J)%ALP(JP)%XHVACC_COOL)
  NULLIFY(DIAG_CUMUL_TEB_MODEL(J)%ALP(JP)%XHVACC_HEAT)
  NULLIFY(DIAG_CUMUL_TEB_MODEL(J)%ALP(JP)%XTHER_PROD_BLDC)
  NULLIFY(DIAG_CUMUL_TEB_MODEL(J)%ALP(JP)%XPHOT_PROD_BLDC)
 ENDDO
ENDDO
