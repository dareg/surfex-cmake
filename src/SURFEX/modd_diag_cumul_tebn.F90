...
!------------------------------------------------------------------------------
!
SUBROUTINE DIAG_CUMUL_TEB_1P_INIT(YDIAG_CUMUL_TEB_1P)
TYPE(DIAG_CUMUL_TEB_1P_t), INTENT(INOUT) :: YDIAG_CUMUL_TEB_1P
REAL(KIND=JPRB) :: ZHOOK_HANDLE
IF (LHOOK) CALL DR_HOOK("MODD_DIAG_CUMUL_TEB_N:DIAG_CUMUL_TEB_1P_INIT",0,ZHOOK_HANDLE)
  NULLIFY(YDIAG_CUMUL_TEB_1P%XRUNOFFC_TOWN)
  NULLIFY(YDIAG_CUMUL_TEB_1P%XRUNOFFC_GARDEN)
  NULLIFY(YDIAG_CUMUL_TEB_1P%XRUNOFFC_ROAD)
  NULLIFY(YDIAG_CUMUL_TEB_1P%XRUNOFFC_ROOF)
  NULLIFY(YDIAG_CUMUL_TEB_1P%XRUNOFFC_STRLROOF)
  NULLIFY(YDIAG_CUMUL_TEB_1P%XRUNOFFC_GREENROOF)
  NULLIFY(YDIAG_CUMUL_TEB_1P%XDRAINC_GREENROOF)
  NULLIFY(YDIAG_CUMUL_TEB_1P%XDRAINC_GARDEN)
  NULLIFY(YDIAG_CUMUL_TEB_1P%XIRRIGC_GREENROOF)
  NULLIFY(YDIAG_CUMUL_TEB_1P%XIRRIGC_GARDEN)
  NULLIFY(YDIAG_CUMUL_TEB_1P%XIRRIGC_ROAD)
  NULLIFY(YDIAG_CUMUL_TEB_1P%XHVACC_COOL)
  NULLIFY(YDIAG_CUMUL_TEB_1P%XHVACC_HEAT)
  NULLIFY(YDIAG_CUMUL_TEB_1P%XTHER_PROD_BLDC)
  NULLIFY(YDIAG_CUMUL_TEB_1P%XPHOT_PROD_BLDC)
IF (LHOOK) CALL DR_HOOK("MODD_DIAG_CUMUL_TEB_N:DIAG_CUMUL_TEB_1P_INIT",1,ZHOOK_HANDLE)
END SUBROUTINE DIAG_CUMUL_TEB_1P_INIT
!
...
DO JP=1,KPATCH
  CALL DIAG_CUMUL_TEB_1P_INIT(YDIAG_CUMUL_TEB%ALP(JP))
ENDDO 
