...
REAL, POINTER, DIMENSION(:)   :: XSWE=>NULL()
!$OMP THREADPRIVATE(XSWE)
...
DIAG_FLAKE_MODEL(KFROM)%XEVAP=>XEVAP
DIAG_FLAKE_MODEL(KFROM)%XSUBL=>XSUBL
DIAG_FLAKE_MODEL(KFROM)%XT2M=>XT2M
DIAG_FLAKE_MODEL(KFROM)%XT2M_MIN=>XT2M_MIN
DIAG_FLAKE_MODEL(KFROM)%XT2M_MAX=>XT2M_MAX
DIAG_FLAKE_MODEL(KFROM)%XQ2M=>XQ2M
DIAG_FLAKE_MODEL(KFROM)%XHU2M=>XHU2M
DIAG_FLAKE_MODEL(KFROM)%XHU2M_MIN=>XHU2M_MIN
DIAG_FLAKE_MODEL(KFROM)%XHU2M_MAX=>XHU2M_MAX
DIAG_FLAKE_MODEL(KFROM)%XQS=>XQS
DIAG_FLAKE_MODEL(KFROM)%XZON10M=>XZON10M
DIAG_FLAKE_MODEL(KFROM)%XMER10M=>XMER10M
DIAG_FLAKE_MODEL(KFROM)%XWIND10M=>XWIND10M
DIAG_FLAKE_MODEL(KFROM)%XWIND10M_MAX=>XWIND10M_MAX
...
DIAG_FLAKE_MODEL(KFROM)%XRNC=>XRNC
DIAG_FLAKE_MODEL(KFROM)%XHC=>XHC
DIAG_FLAKE_MODEL(KFROM)%XLEC=>XLEC
DIAG_FLAKE_MODEL(KFROM)%XLEIC=>XLEIC
DIAG_FLAKE_MODEL(KFROM)%XGFLUXC=>XGFLUXC
DIAG_FLAKE_MODEL(KFROM)%XEVAPC=>XEVAPC
DIAG_FLAKE_MODEL(KFROM)%XSUBLC=>XSUBLC
DIAG_FLAKE_MODEL(KFROM)%XLWDC=>XLWDC
DIAG_FLAKE_MODEL(KFROM)%XLWUC=>XLWUC
DIAG_FLAKE_MODEL(KFROM)%XSWDC=>XSWDC
DIAG_FLAKE_MODEL(KFROM)%XSWUC=>XSWUC
DIAG_FLAKE_MODEL(KFROM)%XFMUC=>XFMUC
DIAG_FLAKE_MODEL(KFROM)%XFMVC=>XFMVC
DIAG_FLAKE_MODEL(KFROM)%XDIAG_TS=>XDIAG_TS
DIAG_FLAKE_MODEL(KFROM)%XALBT=>XALBT
DIAG_FLAKE_MODEL(KFROM)%XSWE=>XSWE
ENDIF
!
...
XEVAP=>DIAG_FLAKE_MODEL(KTO)%XEVAP
XSUBL=>DIAG_FLAKE_MODEL(KTO)%XSUBL
XT2M=>DIAG_FLAKE_MODEL(KTO)%XT2M
XT2M_MIN=>DIAG_FLAKE_MODEL(KTO)%XT2M_MIN
XT2M_MAX=>DIAG_FLAKE_MODEL(KTO)%XT2M_MAX
XQ2M=>DIAG_FLAKE_MODEL(KTO)%XQ2M
XHU2M=>DIAG_FLAKE_MODEL(KTO)%XHU2M
XHU2M_MIN=>DIAG_FLAKE_MODEL(KTO)%XHU2M_MIN
XHU2M_MAX=>DIAG_FLAKE_MODEL(KTO)%XHU2M_MAX
XQS=>DIAG_FLAKE_MODEL(KTO)%XQS
XZON10M=>DIAG_FLAKE_MODEL(KTO)%XZON10M
XMER10M=>DIAG_FLAKE_MODEL(KTO)%XMER10M
XWIND10M=>DIAG_FLAKE_MODEL(KTO)%XWIND10M
XWIND10M_MAX=>DIAG_FLAKE_MODEL(KTO)%XWIND10M_MAX
...
XRNC=>DIAG_FLAKE_MODEL(KTO)%XRNC
XHC=>DIAG_FLAKE_MODEL(KTO)%XHC
XLEC=>DIAG_FLAKE_MODEL(KTO)%XLEC
XLEIC=>DIAG_FLAKE_MODEL(KTO)%XLEIC
XGFLUXC=>DIAG_FLAKE_MODEL(KTO)%XGFLUXC
XEVAPC=>DIAG_FLAKE_MODEL(KTO)%XEVAPC
XSUBLC=>DIAG_FLAKE_MODEL(KTO)%XSUBLC
XLWDC=>DIAG_FLAKE_MODEL(KTO)%XLWDC
XLWUC=>DIAG_FLAKE_MODEL(KTO)%XLWUC
XSWDC=>DIAG_FLAKE_MODEL(KTO)%XSWDC
XSWUC=>DIAG_FLAKE_MODEL(KTO)%XSWUC
XFMUC=>DIAG_FLAKE_MODEL(KTO)%XFMUC
XFMVC=>DIAG_FLAKE_MODEL(KTO)%XFMVC
XDIAG_TS=>DIAG_FLAKE_MODEL(KTO)%XDIAG_TS
XALBT=>DIAG_FLAKE_MODEL(KTO)%XALBT
XSWE=>DIAG_FLAKE_MODEL(KTO)%XSWE
