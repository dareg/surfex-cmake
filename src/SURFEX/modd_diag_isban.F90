...
DIAG_ISBA_MODEL(KFROM)%XT2M_MIN=>XT2M_MIN
DIAG_ISBA_MODEL(KFROM)%XT2M_MAX=>XT2M_MAX
...
XT2M_MIN=>DIAG_ISBA_MODEL(KTO)%XT2M_MIN
XT2M_MAX=>DIAG_ISBA_MODEL(KTO)%XT2M_MAX
