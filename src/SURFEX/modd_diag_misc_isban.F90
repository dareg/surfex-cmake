...
REAL, POINTER, DIMENSION(:)     :: XSOIL_SWI=>NULL()
!$OMP THREADPRIVATE(XSOIL_SWI)
...
REAL, POINTER, DIMENSION(:)     :: XSOIL_WG=>NULL()
!$OMP THREADPRIVATE(XSOIL_WG)
REAL, POINTER, DIMENSION(:)     :: XSOIL_WGI=>NULL()
!$OMP THREADPRIVATE(XSOIL_WGI)
...
DIAG_MISC_ISBA_MODEL(KFROM)%XSOIL_SWI=>XSOIL_SWI
...
DIAG_MISC_ISBA_MODEL(KFROM)%XSOIL_WG=>XSOIL_WG
DIAG_MISC_ISBA_MODEL(KFROM)%XSOIL_WGI=>XSOIL_WGI
...
XSOIL_SWI=>DIAG_MISC_ISBA_MODEL(KTO)%XSOIL_SWI
...
XSOIL_WG=>DIAG_MISC_ISBA_MODEL(KTO)%XSOIL_WG
XSOIL_WGI=>DIAG_MISC_ISBA_MODEL(KTO)%XSOIL_WGI
