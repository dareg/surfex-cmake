...
!
  ...
  REAL, POINTER, DIMENSION(:) :: XDEEP_TSWI      ! Deep soil wetness index (DIF option)
  REAL, POINTER, DIMENSION(:) :: XDEEP_TWG       ! Deep soil water content (liquid+ice) (DIF option)
  REAL, POINTER, DIMENSION(:) :: XDEEP_TWGI      ! Deep soil ice content (DIF option)
!
!------------------------------------------------------------------------------
!
...
REAL, POINTER, DIMENSION(:) :: XDEEP_TSWI=>NULL()
!$OMP THREADPRIVATE(XDEEP_TSWI)
REAL, POINTER, DIMENSION(:) :: XDEEP_TWG =>NULL()
!$OMP THREADPRIVATE(XDEEP_TWG)
REAL, POINTER, DIMENSION(:) :: XDEEP_TWGI=>NULL()
!$OMP THREADPRIVATE(XDEEP_TWGI)
!
CONTAINS
...
DIAG_MISC_ISBA_MODEL(KFROM)%XDEEP_TSWI=>XDEEP_TSWI
DIAG_MISC_ISBA_MODEL(KFROM)%XDEEP_TWG=>XDEEP_TWG
DIAG_MISC_ISBA_MODEL(KFROM)%XDEEP_TWGI=>XDEEP_TWGI
!
ENDIF
!
!
...
XDEEP_TSWI=>DIAG_MISC_ISBA_MODEL(KTO)%XDEEP_TSWI
XDEEP_TWG=>DIAG_MISC_ISBA_MODEL(KTO)%XDEEP_TWG
XDEEP_TWGI=>DIAG_MISC_ISBA_MODEL(KTO)%XDEEP_TWGI
!
...
DO J=1,KMODEL
  ...
  NULLIFY(DIAG_MISC_ISBA_MODEL(J)%XDEEP_TSWI)
  NULLIFY(DIAG_MISC_ISBA_MODEL(J)%XDEEP_TWG)
  NULLIFY(DIAG_MISC_ISBA_MODEL(J)%XDEEP_TWGI)
ENDDO
