...
IF (LHOOK) CALL DR_HOOK("MODD_DIAG_MISC_TEB_N:DIAG_MISC_TEB_INIT_1P",0,ZHOOK_HANDLE)
  ...
  NULLIFY(YDIAG_MISC_TEB_1P%XH_GARDEN)
  NULLIFY(YDIAG_MISC_TEB_1P%XH_GREENROOF)
  ...
  NULLIFY(YDIAG_MISC_TEB_1P%XRN_GARDEN)
  NULLIFY(YDIAG_MISC_TEB_1P%XRN_GREENROOF)
  ...
  NULLIFY(YDIAG_MISC_TEB_1P%XGFLUX_GARDEN)
  NULLIFY(YDIAG_MISC_TEB_1P%XGFLUX_GREENROOF)
  ...
  NULLIFY(YDIAG_MISC_TEB_1P%XLE_GARDEN)
  NULLIFY(YDIAG_MISC_TEB_1P%XLE_GREENROOF)
  NULLIFY(YDIAG_MISC_TEB_1P%XLE_STRLROOF)
  NULLIFY(YDIAG_MISC_TEB_1P%XLE_BLT)
  NULLIFY(YDIAG_MISC_TEB_1P%XRUNOFF_TOWN)
  NULLIFY(YDIAG_MISC_TEB_1P%XRUNOFF_GARDEN)
  NULLIFY(YDIAG_MISC_TEB_1P%XDRAIN_GARDEN)
  ...
  NULLIFY(YDIAG_MISC_TEB_1P%XRUNOFF_GREENROOF)
  NULLIFY(YDIAG_MISC_TEB_1P%XDRAIN_GREENROOF)
  NULLIFY(YDIAG_MISC_TEB_1P%XIRRIG_GREENROOF)
  NULLIFY(YDIAG_MISC_TEB_1P%XABS_SW_ROOF)
  NULLIFY(YDIAG_MISC_TEB_1P%XABS_SW_SNOW_ROOF)
  NULLIFY(YDIAG_MISC_TEB_1P%XABS_LW_ROOF)
  NULLIFY(YDIAG_MISC_TEB_1P%XABS_LW_SNOW_ROOF)
  NULLIFY(YDIAG_MISC_TEB_1P%XABS_SW_ROAD)
  NULLIFY(YDIAG_MISC_TEB_1P%XABS_SW_SNOW_ROAD)
  NULLIFY(YDIAG_MISC_TEB_1P%XABS_LW_ROAD)
  NULLIFY(YDIAG_MISC_TEB_1P%XABS_LW_SNOW_ROAD)
  NULLIFY(YDIAG_MISC_TEB_1P%XABS_SW_WALL_A)
  NULLIFY(YDIAG_MISC_TEB_1P%XABS_SW_WALL_B)
  NULLIFY(YDIAG_MISC_TEB_1P%XABS_LW_WALL_A)
  NULLIFY(YDIAG_MISC_TEB_1P%XABS_LW_WALL_B)
  NULLIFY(YDIAG_MISC_TEB_1P%XABS_SW_GARDEN)
  NULLIFY(YDIAG_MISC_TEB_1P%XABS_LW_GARDEN)
  NULLIFY(YDIAG_MISC_TEB_1P%XABS_SW_GREENROOF)
