...
!
REAL, POINTER, DIMENSION(:)   :: XRUNOFF_TOWN=>NULL()
!$OMP THREADPRIVATE(XRUNOFF_TOWN)
REAL, POINTER, DIMENSION(:)   :: XRUNOFF_GARDEN=>NULL()
!$OMP THREADPRIVATE(XRUNOFF_GARDEN)
REAL, POINTER, DIMENSION(:)   :: XDRAIN_GARDEN=>NULL()
!$OMP THREADPRIVATE(XDRAIN_GARDEN)
REAL, POINTER, DIMENSION(:)   :: XIRRIG_GARDEN=>NULL()
!$OMP THREADPRIVATE(XIRRIG_GARDEN)
REAL, POINTER, DIMENSION(:)   :: XRUNOFF_ROAD=>NULL()
!$OMP THREADPRIVATE(XRUNOFF_ROAD)
REAL, POINTER, DIMENSION(:)   :: XIRRIG_ROAD=>NULL()
!$OMP THREADPRIVATE(XIRRIG_ROAD)
REAL, POINTER, DIMENSION(:)   :: XRUNOFF_ROOF=>NULL()
!$OMP THREADPRIVATE(XRUNOFF_ROOF)
REAL, POINTER, DIMENSION(:)   :: XRUNOFF_STRLROOF=>NULL()
!$OMP THREADPRIVATE(XRUNOFF_STRLROOF)
...
REAL, POINTER, DIMENSION(:)   :: XIRRIG_GREENROOF=>NULL()
!$OMP THREADPRIVATE(XIRRIG_GREENROOF)
!
...
REAL, POINTER, DIMENSION(:)   :: XABS_SW_PANEL=>NULL()
!$OMP THREADPRIVATE(XABS_SW_PANEL)
REAL, POINTER, DIMENSION(:)   :: XABS_LW_PANEL=>NULL()
!$OMP THREADPRIVATE(XABS_LW_PANEL)
REAL, POINTER, DIMENSION(:)   :: XRN_PANEL=>NULL()
!$OMP THREADPRIVATE(XRN_PANEL)
REAL, POINTER, DIMENSION(:)   :: XH_PANEL=>NULL()
!$OMP THREADPRIVATE(XH_PANEL)
REAL, POINTER, DIMENSION(:)   :: XTHER_PROD_PANEL=>NULL()
!$OMP THREADPRIVATE(XTHER_PROD_PANEL)
REAL, POINTER, DIMENSION(:)   :: XPHOT_PROD_PANEL=>NULL()
!$OMP THREADPRIVATE(XPHOT_PROD_PANEL)
REAL, POINTER, DIMENSION(:)   :: XPROD_PANEL=>NULL()
!$OMP THREADPRIVATE(XPROD_PANEL)
REAL, POINTER, DIMENSION(:)   :: XTHER_PROD_BLD=>NULL()
!$OMP THREADPRIVATE(XTHER_PROD_BLD)
REAL, POINTER, DIMENSION(:)   :: XPHOT_PROD_BLD=>NULL()
!$OMP THREADPRIVATE(XPHOT_PROD_BLD)
...
REAL, POINTER, DIMENSION(:)   :: XTCOOL_CUR_TARGET=>NULL()
!$OMP THREADPRIVATE(XTCOOL_CUR_TARGET)
REAL, POINTER, DIMENSION(:)   :: XTHEAT_CUR_TARGET=>NULL()
!$OMP THREADPRIVATE(XTHEAT_CUR_TARGET)
REAL, POINTER, DIMENSION(:)   :: XCUR_QIN=>NULL()
!$OMP THREADPRIVATE(XCUR_QIN)
...
!
DIAG_MISC_TEB_MODEL(KFROM,KFROM_PATCH)%XRUNOFF_TOWN=>XRUNOFF_TOWN
DIAG_MISC_TEB_MODEL(KFROM,KFROM_PATCH)%XRUNOFF_GARDEN=>XRUNOFF_GARDEN
DIAG_MISC_TEB_MODEL(KFROM,KFROM_PATCH)%XDRAIN_GARDEN=>XDRAIN_GARDEN
DIAG_MISC_TEB_MODEL(KFROM,KFROM_PATCH)%XIRRIG_GARDEN=>XIRRIG_GARDEN
DIAG_MISC_TEB_MODEL(KFROM,KFROM_PATCH)%XRUNOFF_ROAD=>XRUNOFF_ROAD
DIAG_MISC_TEB_MODEL(KFROM,KFROM_PATCH)%XIRRIG_ROAD=>XIRRIG_ROAD
DIAG_MISC_TEB_MODEL(KFROM,KFROM_PATCH)%XRUNOFF_ROOF=>XRUNOFF_ROOF
DIAG_MISC_TEB_MODEL(KFROM,KFROM_PATCH)%XRUNOFF_STRLROOF=>XRUNOFF_STRLROOF
...
DIAG_MISC_TEB_MODEL(KFROM,KFROM_PATCH)%XIRRIG_GREENROOF=>XIRRIG_GREENROOF
!
...
DIAG_MISC_TEB_MODEL(KFROM,KFROM_PATCH)%XG_GREENROOF_ROOF=>XG_GREENROOF_ROOF
DIAG_MISC_TEB_MODEL(KFROM,KFROM_PATCH)%XABS_SW_PANEL=>XABS_SW_PANEL
DIAG_MISC_TEB_MODEL(KFROM,KFROM_PATCH)%XABS_LW_PANEL=>XABS_LW_PANEL
DIAG_MISC_TEB_MODEL(KFROM,KFROM_PATCH)%XRN_PANEL=>XRN_PANEL
DIAG_MISC_TEB_MODEL(KFROM,KFROM_PATCH)%XH_PANEL=>XH_PANEL
DIAG_MISC_TEB_MODEL(KFROM,KFROM_PATCH)%XTHER_PROD_PANEL=>XTHER_PROD_PANEL
DIAG_MISC_TEB_MODEL(KFROM,KFROM_PATCH)%XPHOT_PROD_PANEL=>XPHOT_PROD_PANEL
DIAG_MISC_TEB_MODEL(KFROM,KFROM_PATCH)%XPROD_PANEL=>XPROD_PANEL
DIAG_MISC_TEB_MODEL(KFROM,KFROM_PATCH)%XTHER_PROD_BLD=>XTHER_PROD_BLD
DIAG_MISC_TEB_MODEL(KFROM,KFROM_PATCH)%XPHOT_PROD_BLD=>XPHOT_PROD_BLD
!
...
DIAG_MISC_TEB_MODEL(KFROM,KFROM_PATCH)%XTCOOL_CUR_TARGET=>XTCOOL_CUR_TARGET
DIAG_MISC_TEB_MODEL(KFROM,KFROM_PATCH)%XTHEAT_CUR_TARGET=>XTHEAT_CUR_TARGET
DIAG_MISC_TEB_MODEL(KFROM,KFROM_PATCH)%XCUR_QIN=>XCUR_QIN
ENDIF
!
! Current model is set to model KTO
...
!
XRUNOFF_TOWN=>DIAG_MISC_TEB_MODEL(KTO,KTO_PATCH)%XRUNOFF_TOWN
XRUNOFF_GARDEN=>DIAG_MISC_TEB_MODEL(KTO,KTO_PATCH)%XRUNOFF_GARDEN
XDRAIN_GARDEN=>DIAG_MISC_TEB_MODEL(KTO,KTO_PATCH)%XDRAIN_GARDEN
XIRRIG_GARDEN=>DIAG_MISC_TEB_MODEL(KTO,KTO_PATCH)%XIRRIG_GARDEN
XRUNOFF_ROAD=>DIAG_MISC_TEB_MODEL(KTO,KTO_PATCH)%XRUNOFF_ROAD
XIRRIG_ROAD=>DIAG_MISC_TEB_MODEL(KTO,KTO_PATCH)%XIRRIG_ROAD
XRUNOFF_ROOF=>DIAG_MISC_TEB_MODEL(KTO,KTO_PATCH)%XRUNOFF_ROOF
XRUNOFF_STRLROOF=>DIAG_MISC_TEB_MODEL(KTO,KTO_PATCH)%XRUNOFF_STRLROOF
...
XIRRIG_GREENROOF=>DIAG_MISC_TEB_MODEL(KTO,KTO_PATCH)%XIRRIG_GREENROOF
!
...
XG_GREENROOF_ROOF=>DIAG_MISC_TEB_MODEL(KTO,KTO_PATCH)%XG_GREENROOF_ROOF
XABS_SW_PANEL=>DIAG_MISC_TEB_MODEL(KTO,KTO_PATCH)%XABS_SW_PANEL
XABS_LW_PANEL=>DIAG_MISC_TEB_MODEL(KTO,KTO_PATCH)%XABS_LW_PANEL
XRN_PANEL=>DIAG_MISC_TEB_MODEL(KTO,KTO_PATCH)%XRN_PANEL
XH_PANEL=>DIAG_MISC_TEB_MODEL(KTO,KTO_PATCH)%XH_PANEL
XTHER_PROD_PANEL=>DIAG_MISC_TEB_MODEL(KTO,KTO_PATCH)%XTHER_PROD_PANEL
XPHOT_PROD_PANEL=>DIAG_MISC_TEB_MODEL(KTO,KTO_PATCH)%XPHOT_PROD_PANEL
XPROD_PANEL=>DIAG_MISC_TEB_MODEL(KTO,KTO_PATCH)%XPROD_PANEL
XTHER_PROD_BLD=>DIAG_MISC_TEB_MODEL(KTO,KTO_PATCH)%XTHER_PROD_BLD
XPHOT_PROD_BLD=>DIAG_MISC_TEB_MODEL(KTO,KTO_PATCH)%XPHOT_PROD_BLD
!
...
XTCOOL_CUR_TARGET => DIAG_MISC_TEB_MODEL(KTO,KTO_PATCH)%XTCOOL_CUR_TARGET
XTHEAT_CUR_TARGET => DIAG_MISC_TEB_MODEL(KTO,KTO_PATCH)%XTHEAT_CUR_TARGET
XCUR_QIN => DIAG_MISC_TEB_MODEL(KTO,KTO_PATCH)%XCUR_QIN
