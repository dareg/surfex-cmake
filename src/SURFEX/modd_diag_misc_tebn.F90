...
DIAG_MISC_TEB => DIAG_MISC_TEB_MODEL(KTO,KTO_PATCH)
...
DO J=1,KMODEL
 DO JP=1,KPATCH
  ...
  NULLIFY(DIAG_MISC_TEB_MODEL(J,JP)%XRUNOFF_TOWN)
  NULLIFY(DIAG_MISC_TEB_MODEL(J,JP)%XRUNOFF_GARDEN)
  NULLIFY(DIAG_MISC_TEB_MODEL(J,JP)%XDRAIN_GARDEN)
  NULLIFY(DIAG_MISC_TEB_MODEL(J,JP)%XIRRIG_GARDEN)
  NULLIFY(DIAG_MISC_TEB_MODEL(J,JP)%XRUNOFF_ROAD)
  NULLIFY(DIAG_MISC_TEB_MODEL(J,JP)%XIRRIG_ROAD)
  NULLIFY(DIAG_MISC_TEB_MODEL(J,JP)%XRUNOFF_ROOF)
  NULLIFY(DIAG_MISC_TEB_MODEL(J,JP)%XRUNOFF_STRLROOF)
  NULLIFY(DIAG_MISC_TEB_MODEL(J,JP)%XRUNOFF_GREENROOF)
  NULLIFY(DIAG_MISC_TEB_MODEL(J,JP)%XDRAIN_GREENROOF)
  NULLIFY(DIAG_MISC_TEB_MODEL(J,JP)%XIRRIG_GREENROOF)
  ...
  NULLIFY(DIAG_MISC_TEB_MODEL(J,JP)%XG_GREENROOF_ROOF)
  NULLIFY(DIAG_MISC_TEB_MODEL(J,JP)%XABS_SW_PANEL)
  NULLIFY(DIAG_MISC_TEB_MODEL(J,JP)%XABS_LW_PANEL)
  NULLIFY(DIAG_MISC_TEB_MODEL(J,JP)%XRN_PANEL)
  NULLIFY(DIAG_MISC_TEB_MODEL(J,JP)%XH_PANEL)
  NULLIFY(DIAG_MISC_TEB_MODEL(J,JP)%XTHER_PROD_PANEL)
  NULLIFY(DIAG_MISC_TEB_MODEL(J,JP)%XPHOT_PROD_PANEL)
  NULLIFY(DIAG_MISC_TEB_MODEL(J,JP)%XPROD_PANEL)
  NULLIFY(DIAG_MISC_TEB_MODEL(J,JP)%XTHER_PROD_BLD)
  NULLIFY(DIAG_MISC_TEB_MODEL(J,JP)%XPHOT_PROD_BLD)
  ...
  NULLIFY(DIAG_MISC_TEB_MODEL(J,JP)%XTCOOL_CUR_TARGET)
  NULLIFY(DIAG_MISC_TEB_MODEL(J,JP)%XTHEAT_CUR_TARGET)
  NULLIFY(DIAG_MISC_TEB_MODEL(J,JP)%XCUR_QIN)
 ENDDO
ENDDO
