...
LOGICAL, POINTER :: LT2MMW=>NULL()
!$OMP THREADPRIVATE(LT2MMW)
...
REAL, POINTER, DIMENSION(:,:) :: XEVAP_TILE=>NULL()
!$OMP THREADPRIVATE(XEVAP_TILE)
REAL, POINTER, DIMENSION(:,:) :: XSUBL_TILE=>NULL()
!$OMP THREADPRIVATE(XSUBL_TILE)
...
REAL, POINTER, DIMENSION(:,:) :: XEVAPC_TILE=>NULL()
!$OMP THREADPRIVATE(XEVAPC_TILE)
REAL, POINTER, DIMENSION(:,:) :: XSUBLC_TILE=>NULL()
!$OMP THREADPRIVATE(XSUBLC_TILE)
...
DIAG_SURF_ATM_MODEL(KFROM)%XEVAP_TILE=>XEVAP_TILE
DIAG_SURF_ATM_MODEL(KFROM)%XSUBL_TILE=>XSUBL_TILE
...
DIAG_SURF_ATM_MODEL(KFROM)%XEVAPC_TILE=>XEVAPC_TILE
DIAG_SURF_ATM_MODEL(KFROM)%XSUBLC_TILE=>XSUBLC_TILE
...
DIAG_SURF_ATM_MODEL(KFROM)%XAVG_EVAP=>XAVG_EVAP
DIAG_SURF_ATM_MODEL(KFROM)%XAVG_SUBL=>XAVG_SUBL
...
DIAG_SURF_ATM_MODEL(KFROM)%XAVG_EVAPC=>XAVG_EVAPC
DIAG_SURF_ATM_MODEL(KFROM)%XAVG_SUBLC=>XAVG_SUBLC
...
LT2MMW=>DIAG_SURF_ATM_MODEL(KTO)%LT2MMW
...
XEVAP_TILE=>DIAG_SURF_ATM_MODEL(KTO)%XEVAP_TILE
XSUBL_TILE=>DIAG_SURF_ATM_MODEL(KTO)%XSUBL_TILE
...
XEVAPC_TILE=>DIAG_SURF_ATM_MODEL(KTO)%XEVAPC_TILE
XSUBLC_TILE=>DIAG_SURF_ATM_MODEL(KTO)%XSUBLC_TILE
...
XAVG_EVAP=>DIAG_SURF_ATM_MODEL(KTO)%XAVG_EVAP
XAVG_SUBL=>DIAG_SURF_ATM_MODEL(KTO)%XAVG_SUBL
...
XAVG_EVAPC=>DIAG_SURF_ATM_MODEL(KTO)%XAVG_EVAPC
XAVG_SUBLC=>DIAG_SURF_ATM_MODEL(KTO)%XAVG_SUBLC
