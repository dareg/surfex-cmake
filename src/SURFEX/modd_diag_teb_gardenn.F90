...
DIAG_TEB_GARDEN_MODEL(KFROM)%XSNOWFREE_ALB=>XSNOWFREE_ALB
DIAG_TEB_GARDEN_MODEL(KFROM)%XSNOWFREE_ALB_VEG=>XSNOWFREE_ALB_VEG
DIAG_TEB_GARDEN_MODEL(KFROM)%XSNOWFREE_ALB_SOIL=>XSNOWFREE_ALB_SOIL
...
XSNOWFREE_ALB=>DIAG_TEB_GARDEN_MODEL(KTO)%XSNOWFREE_ALB
XSNOWFREE_ALB_VEG=>DIAG_TEB_GARDEN_MODEL(KTO)%XSNOWFREE_ALB_VEG
XSNOWFREE_ALB_SOIL=>DIAG_TEB_GARDEN_MODEL(KTO)%XSNOWFREE_ALB_SOIL
...
DO J=1,KMODEL
  ...
  NULLIFY(DIAG_TEB_GARDEN_MODEL(J)%XSNOWFREE_ALB)
  NULLIFY(DIAG_TEB_GARDEN_MODEL(J)%XSNOWFREE_ALB_VEG)
  NULLIFY(DIAG_TEB_GARDEN_MODEL(J)%XSNOWFREE_ALB_SOIL)
