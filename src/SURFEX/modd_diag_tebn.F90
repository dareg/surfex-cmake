...
DIAG_TEB_MODEL(KFROM)%XT2M_MIN=>XT2M_MIN
DIAG_TEB_MODEL(KFROM)%XT2M_MAX=>XT2M_MAX
DIAG_TEB_MODEL(KFROM)%XQ2M=>XQ2M
DIAG_TEB_MODEL(KFROM)%XHU2M=>XHU2M
DIAG_TEB_MODEL(KFROM)%XHU2M_MIN=>XHU2M_MIN
DIAG_TEB_MODEL(KFROM)%XHU2M_MAX=>XHU2M_MAX
DIAG_TEB_MODEL(KFROM)%XQS=>XQS
DIAG_TEB_MODEL(KFROM)%XZON10M=>XZON10M
DIAG_TEB_MODEL(KFROM)%XMER10M=>XMER10M
DIAG_TEB_MODEL(KFROM)%XWIND10M=>XWIND10M
DIAG_TEB_MODEL(KFROM)%XWIND10M_MAX=>XWIND10M_MAX
...
XT2M_MIN=>DIAG_TEB_MODEL(KTO)%XT2M_MIN
XT2M_MAX=>DIAG_TEB_MODEL(KTO)%XT2M_MAX
XQ2M=>DIAG_TEB_MODEL(KTO)%XQ2M
XHU2M=>DIAG_TEB_MODEL(KTO)%XHU2M
XHU2M_MIN=>DIAG_TEB_MODEL(KTO)%XHU2M_MIN
XHU2M_MAX=>DIAG_TEB_MODEL(KTO)%XHU2M_MAX
XQS=>DIAG_TEB_MODEL(KTO)%XQS
XZON10M=>DIAG_TEB_MODEL(KTO)%XZON10M
XMER10M=>DIAG_TEB_MODEL(KTO)%XMER10M
XWIND10M=>DIAG_TEB_MODEL(KTO)%XWIND10M
XWIND10M_MAX=>DIAG_TEB_MODEL(KTO)%XWIND10M_MAX
