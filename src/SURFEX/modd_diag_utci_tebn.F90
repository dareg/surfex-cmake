...
REAL, POINTER, DIMENSION(:,:)   :: XUTCIC_IN=>NULL()
!$OMP THREADPRIVATE(XUTCIC_IN)
REAL, POINTER, DIMENSION(:,:)   :: XUTCIC_OUTSUN=>NULL()
!$OMP THREADPRIVATE(XUTCIC_OUTSUN)
REAL, POINTER, DIMENSION(:,:)   :: XUTCIC_OUTSHADE=>NULL()
!$OMP THREADPRIVATE(XUTCIC_OUTSHADE)
...
DIAG_UTCI_TEB_MODEL(KFROM)%XUTCIC_IN=>XUTCIC_IN
DIAG_UTCI_TEB_MODEL(KFROM)%XUTCIC_OUTSUN=>XUTCIC_OUTSUN
DIAG_UTCI_TEB_MODEL(KFROM)%XUTCIC_OUTSHADE=>XUTCIC_OUTSHADE
ENDIF
!
...
XUTCIC_IN => DIAG_UTCI_TEB_MODEL(KTO)%XUTCIC_IN
XUTCIC_OUTSUN => DIAG_UTCI_TEB_MODEL(KTO)%XUTCIC_OUTSUN
XUTCIC_OUTSHADE => DIAG_UTCI_TEB_MODEL(KTO)%XUTCIC_OUTSHADE
