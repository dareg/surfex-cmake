...
DIAG_WATFLUX_MODEL(KFROM)%XEVAP=>XEVAP
DIAG_WATFLUX_MODEL(KFROM)%XSUBL=>XSUBL
...
DIAG_WATFLUX_MODEL(KFROM)%XEVAPC=>XEVAPC
DIAG_WATFLUX_MODEL(KFROM)%XSUBLC=>XSUBLC
...
XEVAP=>DIAG_WATFLUX_MODEL(KTO)%XEVAP
XSUBL=>DIAG_WATFLUX_MODEL(KTO)%XSUBL
...
XEVAPC=>DIAG_WATFLUX_MODEL(KTO)%XEVAPC
XSUBLC=>DIAG_WATFLUX_MODEL(KTO)%XSUBLC
