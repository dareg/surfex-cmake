...
CONTAINS
!
SUBROUTINE DIAG_OPTIONS_INIT(YDIAG_OPTIONS)
TYPE(DIAG_OPTIONS_t), INTENT(INOUT) :: YDIAG_OPTIONS
REAL(KIND=JPRB) :: ZHOOK_HANDLE
IF (LHOOK) CALL DR_HOOK("MODD_DIAG_N:DIAG_OPTIONS_INIT",0,ZHOOK_HANDLE)
  NULLIFY(YDIAG_OPTIONS%CSELECT)
YDIAG_OPTIONS%XDIAG_TSTEP=0.
YDIAG_OPTIONS%N2M=0
YDIAG_OPTIONS%LT2MMW=.FALSE.
YDIAG_OPTIONS%L2M_MIN_ZS=.FALSE.
YDIAG_OPTIONS%LSURF_BUDGET=.FALSE.
YDIAG_OPTIONS%LRAD_BUDGET=.FALSE.
YDIAG_OPTIONS%LCOEF=.FALSE.
YDIAG_OPTIONS%LSURF_VARS=.FALSE.
YDIAG_OPTIONS%LFRAC=.FALSE.
YDIAG_OPTIONS%LDIAG_GRID=.FALSE.
YDIAG_OPTIONS%LPGD=.FALSE.
YDIAG_OPTIONS%LPATCH_BUDGET=.FALSE.
YDIAG_OPTIONS%LSURF_BUDGETC=.FALSE.
YDIAG_OPTIONS%LRESET_BUDGETC=.FALSE.
YDIAG_OPTIONS%LREAD_BUDGETC=.FALSE.
YDIAG_OPTIONS%LPROVAR_TO_DIAG=.FALSE.
YDIAG_OPTIONS%LSELECT=.FALSE.
