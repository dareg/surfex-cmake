...
TYPE(DUMMY_SURF_FIELDS_t), POINTER :: DUMMY_SURF_FIELDS => NULL()
!$OMP THREADPRIVATE(DUMMY_SURF_FIELDS)
...
DUMMY_SURF_FIELDS => DUMMY_SURF_FIELDS_MODEL(KTO)
...
DUMMY_SURF_FIELDS => DUMMY_SURF_FIELDS_MODEL(KMODEL)
...
IF (ASSOCIATED(DUMMY_SURF_FIELDS)) NULLIFY(DUMMY_SURF_FIELDS)
