...
TYPE GRID_NP_t
!
TYPE(GRID_t), DIMENSION(:), POINTER :: AL
!
END TYPE GRID_NP_t
!
CONTAINS
...
INTEGER :: JP
REAL(KIND=JPRB) :: ZHOOK_HANDLE
IF (LHOOK) CALL DR_HOOK("MODD_GRID_N:GRID_NP_INIT",0,ZHOOK_HANDLE)
...
ENDIF  
!
IF (LHOOK) CALL DR_HOOK("MODD_GRID_N:GRID_NP_INIT",1,ZHOOK_HANDLE)
