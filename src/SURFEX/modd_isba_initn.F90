...
!
SUBROUTINE ISBA_INIT_PGD_INIT(IP)
...
NULLIFY(IP%NSIZE_NATURE_P)
NULLIFY(IP%NR_NATURE_P)
NULLIFY(IP%XPATCH_OLD)  
NULLIFY(IP%XTDEEP)  
NULLIFY(IP%XGAMMAT)
NULLIFY(IP%XABC)
NULLIFY(IP%XPOI) 
...
NULLIFY(I%XTOPQS)
NULLIFY(I%XF_PARAM)
NULLIFY(I%XC_DEPTH_RATIO)
NULLIFY(I%XMUF)
NULLIFY(I%XFSAT)
NULLIFY(I%XCPL_DRAIN)
NULLIFY(I%XCPL_RUNOFF)
NULLIFY(I%XCPL_ICEFLUX)
NULLIFY(I%XCPL_RECHARGE)
NULLIFY(I%XCPL_EFLOOD)
NULLIFY(I%XCPL_PFLOOD)
NULLIFY(I%XCPL_IFLOOD)
NULLIFY(I%XFFLOOD)
NULLIFY(I%XPIFLOOD)  
NULLIFY(I%XFF)
NULLIFY(I%XFFG)
