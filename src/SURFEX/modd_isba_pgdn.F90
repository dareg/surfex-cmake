...
TYPE ISBA_PGD_NP_t
!
TYPE(ISBA_PGD_t), ALLOCATABLE :: AL(:) 
!
END TYPE ISBA_PGD_NP_t
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!
CONTAINS

SUBROUTINE ISBA_PGD_INIT(P)
...
!
SUBROUTINE ISBA_PGD_NP_INIT(P,KPATCH)
TYPE(ISBA_PGD_NP_t), INTENT(INOUT) :: P
INTEGER, INTENT(IN) :: KPATCH
INTEGER :: JP
REAL(KIND=JPRB) :: ZHOOK_HANDLE
IF (LHOOK) CALL DR_HOOK("MODD_ISBA_PGD_N:ISBA_PGD_NP_INIT",0,ZHOOK_HANDLE)
 ALLOCATE(P%AL(KPATCH))
DO JP=1,KPATCH
  CALL ISBA_PGD_INIT(P%AL(JP))
ENDDO         
IF (LHOOK) CALL DR_HOOK("MODD_ISBA_PGD_N:ISBA_PGD_NP_INIT",1,ZHOOK_HANDLE)
END SUBROUTINE ISBA_PGD_NP_INIT
!
