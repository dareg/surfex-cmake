...
TYPE ISBA_NK_t
!
TYPE(ISBA_K_t), DIMENSION(:), POINTER :: AL
!
END TYPE ISBA_NK_t
!
TYPE ISBA_NP_t
!
TYPE(ISBA_P_t), DIMENSION(:), POINTER :: AL
!
END TYPE ISBA_NP_t
!
TYPE ISBA_NPE_t
!
TYPE(ISBA_PE_t), DIMENSION(:), POINTER :: AL
!
END TYPE ISBA_NPE_t
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
NULLIFY(YISBA_P%XPCPS)
NULLIFY(YISBA_P%XPLVTT)
NULLIFY(YISBA_P%XPLSTT)
