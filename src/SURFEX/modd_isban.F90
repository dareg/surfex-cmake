...
REAL, POINTER, DIMENSION(:,:) :: XGNDLITTER=>NULL()
!$OMP THREADPRIVATE(XGNDLITTER)
...
REAL, POINTER, DIMENSION(:,:) :: XZ0LITTER=>NULL()
!$OMP THREADPRIVATE(XZ0LITTER)
...
!$OMP THREADPRIVATE(XPERTLAI)
REAL, POINTER, DIMENSION(:) :: XPERTCV=>NULL()
!$OMP THREADPRIVATE(XPERTCV)
REAL, POINTER, DIMENSION(:) :: XPERTALB=>NULL()
!$OMP THREADPRIVATE(XPERTALB)
REAL, POINTER, DIMENSION(:) :: XPERTZ0=>NULL()
!$OMP THREADPRIVATE(XPERTZ0)
!
CONTAINS
...
ISBA_MODEL(KFROM)%XGNDLITTER=>XGNDLITTER
...
ISBA_MODEL(KFROM)%XZ0LITTER=>XZ0LITTER
...
!Random Perturbations
!
ISBA_MODEL(KFROM)%XPERTVEG=>XPERTVEG
ISBA_MODEL(KFROM)%XPERTLAI=>XPERTLAI
ISBA_MODEL(KFROM)%XPERTCV=>XPERTCV
ISBA_MODEL(KFROM)%XPERTALB=>XPERTALB
ISBA_MODEL(KFROM)%XPERTZ0=>XPERTZ0
ENDIF
!
...
XGNDLITTER=>ISBA_MODEL(KTO)%XGNDLITTER
...
XZ0LITTER=>ISBA_MODEL(KTO)%XZ0LITTER
...
DO J=1,KMODEL
  ...
  NULLIFY(ISBA_MODEL(J)%XZ0LITTER)
