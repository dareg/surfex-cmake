...
TYPE(ISBA_OPTIONS_t) :: O
TYPE(ISBA_PGD_t) :: P
TYPE(ISBA_PARAM_PATCH_t) :: M
TYPE(ISBA_INIT_PATCH_t) :: I
TYPE(ISBA_INIT_PGD_PATCH_t) :: IP
TYPE(ISBA_PROG_PATCH_t) :: R
!
END TYPE ISBA_PATCH_t
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!
!TYPE TEB_VEG_PROG_t
...
CONTAINS
!
SUBROUTINE ISBA_PROG_PATCH_INIT(YISBA_PROG_PATCH,KPATCH)
TYPE(ISBA_PROG_PATCH_t), INTENT(INOUT) :: YISBA_PROG_PATCH 
INTEGER, INTENT(IN) :: KPATCH
INTEGER :: JP
REAL(KIND=JPRB) :: ZHOOK_HANDLE
IF (LHOOK) CALL DR_HOOK("MODD_ISBA_N:ISBA_PROG_PATCH_INIT",0,ZHOOK_HANDLE)
 ALLOCATE(YISBA_PROG_PATCH%AL(KPATCH))
DO JP=1,KPATCH
  CALL ISBA_PROG_INIT(YISBA_PROG_PATCH%AL(JP))
ENDDO         
IF (LHOOK) CALL DR_HOOK("MODD_ISBA_N:ISBA_PROG_PATCH_INIT",1,ZHOOK_HANDLE)
END SUBROUTINE ISBA_PROG_PATCH_INIT
!
...
SUBROUTINE ISBA_PATCH_INIT(YISBA_PATCH,KPATCH)
TYPE(ISBA_PATCH_t), INTENT(INOUT) :: YISBA_PATCH
INTEGER, INTENT(IN) :: KPATCH
REAL(KIND=JPRB) :: ZHOOK_HANDLE
IF (LHOOK) CALL DR_HOOK("MODD_ISBA_N:ISBA_PATCH_INIT",0,ZHOOK_HANDLE)
!
CALL ISBA_PROG_PATCH_INIT(YISBA_PATCH%R,KPATCH)
CALL ISBA_INIT_PATCH_INIT(YISBA_PATCH%I,KPATCH)
CALL ISBA_INIT_PGD_PATCH_INIT(YISBA_PATCH%IP,KPATCH)
CALL ISBA_PARAM_PATCH_INIT(YISBA_PATCH%M,KPATCH)
CALL ISBA_PGD_INIT(YISBA_PATCH%P)
CALL ISBA_OPTIONS_INIT(YISBA_PATCH%O)
!
IF (LHOOK) CALL DR_HOOK("MODD_ISBA_N:ISBA_PATCH_INIT",1,ZHOOK_HANDLE)
END SUBROUTINE ISBA_PATCH_INIT
