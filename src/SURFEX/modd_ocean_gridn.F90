...
REAL, POINTER, DIMENSION(:) :: XK1=>NULL()
!$OMP THREADPRIVATE(XK1)
REAL, POINTER, DIMENSION(:) :: XK2=>NULL()
!$OMP THREADPRIVATE(XK2)
REAL, POINTER, DIMENSION(:) :: XK3=>NULL()
!$OMP THREADPRIVATE(XK3)
REAL, POINTER, DIMENSION(:) :: XK4=>NULL()
!$OMP THREADPRIVATE(XK4)
REAL, POINTER, DIMENSION(:) :: XZHOC=>NULL()
!$OMP THREADPRIVATE(XZHOC)
REAL, POINTER, DIMENSION(:) :: XZ2=>NULL()
!$OMP THREADPRIVATE(XZ2)
REAL, POINTER, DIMENSION(:) :: XDZ1=>NULL()
!$OMP THREADPRIVATE(XDZ1)
REAL, POINTER, DIMENSION(:) :: XDZ2=>NULL()
!$OMP THREADPRIVATE(XDZ2)
REAL, POINTER, DIMENSION(:) :: XRAY=>NULL()
!$OMP THREADPRIVATE(XRAY)
