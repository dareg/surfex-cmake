...
!
REAL, POINTER :: XTAU_REL 
!$OMP THREADPRIVATE(XTAU_REL)
REAL, POINTER :: XQCORR
!$OMP THREADPRIVATE(XQCORR)
!
LOGICAL, POINTER :: LREL_CUR
!$OMP THREADPRIVATE(LREL_CUR)
LOGICAL, POINTER :: LREL_TS
!$OMP THREADPRIVATE(LREL_TS)
LOGICAL, POINTER :: LFLUX_NULL
!$OMP THREADPRIVATE(LFLUX_NULL)
!
LOGICAL, POINTER :: LFLX_CORR
!$OMP THREADPRIVATE(LFLX_CORR)
LOGICAL, POINTER :: LDIAPYCNAL
!$OMP THREADPRIVATE(LDIAPYCNAL)
!
REAL, POINTER, DIMENSION(:,:) :: XSEAU_REL
!$OMP THREADPRIVATE(XSEAU_REL)
REAL, POINTER, DIMENSION(:,:) :: XSEAV_REL
!$OMP THREADPRIVATE(XSEAV_REL)
REAL, POINTER, DIMENSION(:,:) :: XSEAT_REL
!$OMP THREADPRIVATE(XSEAT_REL)
REAL, POINTER, DIMENSION(:,:) :: XSEAS_REL
