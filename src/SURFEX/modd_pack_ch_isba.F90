...
TYPE PACK_CH_ISBA_t
  ...
  REAL, POINTER, DIMENSION(:)   :: XSOILRC_SO2 ! for SO2 deposition
  REAL, POINTER, DIMENSION(:)   :: XSOILRC_O3  ! for SO2 deposition
  REAL, POINTER, DIMENSION(:,:) :: XDEP        ! deposition velocity
...
IF (LHOOK) CALL DR_HOOK("MODD_PACK_CH_ISBA_N:PACK_CH_ISBA_INIT",0,ZHOOK_HANDLE)
  ...
  NULLIFY(YPACK_CH_ISBA%XSOILRC_SO2)
  NULLIFY(YPACK_CH_ISBA%XSOILRC_O3)
  NULLIFY(YPACK_CH_ISBA%XDEP)
