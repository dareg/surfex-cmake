...
!                                               ! calculations only. (ISBA-ES:3-L)              (J/m2)
  REAL, POINTER, DIMENSION(:,:)::XP_SNOWDEND   ! dendricity (Crocus)
  ...
  REAL, POINTER, DIMENSION(:) :: XP_SNOWDEPTH_1DAYS,XP_SNOWDEPTH_3DAYS,XP_SNOWDEPTH_5DAYS,XP_SNOWDEPTH_7DAYS ! fresh snow depth in 1, 3, 5, 7 days
  REAL, POINTER, DIMENSION(:) :: XP_SNOWSWE_1DAYS,XP_SNOWSWE_3DAYS,XP_SNOWSWE_5DAYS,XP_SNOWSWE_7DAYS ! fresh snow depth in 1, 3, 5, 7 days 
  REAL, POINTER, DIMENSION(:) :: XP_SNOWRAM_SONDE ! penetration depth of the ram resistance sensor (2 DaN)
  REAL, POINTER, DIMENSION(:,:) :: XP_SPEC_ALB ! sepctral snow albedo
  REAL, POINTER, DIMENSION(:,:) :: XP_DIFF_RATIO ! spectral diffuse to total ratio
  REAL, POINTER, DIMENSION(:) :: XP_SNOW_WETTHICKNESS  ! Thickness of wet snow at the top of the snowpack
  REAL, POINTER, DIMENSION(:) :: XP_SNOW_REFROZENTHICKNESS  ! Thickness of refrozen snow at the top of the snowpack
...
IF (LHOOK) CALL DR_HOOK("MODD_PACK_DIAG_ISBA_N:PACK_DIAG_ISBA_INIT",0,ZHOOK_HANDLE)
  ...
  NULLIFY(YPACK_DIAG_ISBA%XBLOCK_IMPUR)
  ...
  NULLIFY(YPACK_DIAG_ISBA%XP_SNOWDEND)
  NULLIFY(YPACK_DIAG_ISBA%XP_SNOWSPHER)
  NULLIFY(YPACK_DIAG_ISBA%XP_SNOWSIZE)  
  NULLIFY(YPACK_DIAG_ISBA%XP_SNOWSSA)
  NULLIFY(YPACK_DIAG_ISBA%XP_SNOWTYPEMEPRA)
  NULLIFY(YPACK_DIAG_ISBA%XP_SNOWRAM)
  NULLIFY(YPACK_DIAG_ISBA%XP_SNOWSHEAR)
  NULLIFY(YPACK_DIAG_ISBA%XP_SNOWDEPTH_1DAYS)
  NULLIFY(YPACK_DIAG_ISBA%XP_SNOWDEPTH_3DAYS)
  NULLIFY(YPACK_DIAG_ISBA%XP_SNOWDEPTH_5DAYS)
  NULLIFY(YPACK_DIAG_ISBA%XP_SNOWDEPTH_7DAYS)
  NULLIFY(YPACK_DIAG_ISBA%XP_SNOWSWE_1DAYS)
  NULLIFY(YPACK_DIAG_ISBA%XP_SNOWSWE_3DAYS)
  NULLIFY(YPACK_DIAG_ISBA%XP_SNOWSWE_5DAYS)
  NULLIFY(YPACK_DIAG_ISBA%XP_SNOWSWE_7DAYS)
  NULLIFY(YPACK_DIAG_ISBA%XP_SNOWRAM_SONDE)
  NULLIFY(YPACK_DIAG_ISBA%XP_SPEC_ALB)
  NULLIFY(YPACK_DIAG_ISBA%XP_DIFF_RATIO )
