...
!
  ...
  CHARACTER(LEN=4)                  :: CSEA_CO2    ! type of CO2 flux computation
...
!$OMP THREADPRIVATE(CSEA_ALB)
 CHARACTER(LEN=4), POINTER :: CSEA_CO2=>NULL()
!$OMP THREADPRIVATE(CSEA_CO2)
...
CSEA_CO2=>SEAFLUX_MODEL(KTO)%CSEA_CO2
