...
REAL,PARAMETER        :: XIMPUR_EFOLD = 0.02 !(m) e-folding of the exponential decay rate with depth below the surface of the middle of the considered snow layer (0.5*PSNOWDZ(JJ,1)) for the deposition of snow impurities
