...
REAL, POINTER, DIMENSION(:)   :: XRAIN=>NULL()
!$OMP THREADPRIVATE(XRAIN)
REAL, POINTER, DIMENSION(:)   :: XSNOW=>NULL()
!$OMP THREADPRIVATE(XSNOW)
REAL, POINTER, DIMENSION(:)   :: XZ0=>NULL()
!$OMP THREADPRIVATE(XZ0)
REAL, POINTER, DIMENSION(:)   :: XZ0H=>NULL()
!$OMP THREADPRIVATE(XZ0H)
REAL, POINTER, DIMENSION(:)   :: XQSURF=>NULL()
!$OMP THREADPRIVATE(XQSURF)
...
SURF_ATM_MODEL(KFROM)%XRAIN=>XRAIN
SURF_ATM_MODEL(KFROM)%XSNOW=>XSNOW
SURF_ATM_MODEL(KFROM)%XZ0=>XZ0
SURF_ATM_MODEL(KFROM)%XZ0H=>XZ0H
SURF_ATM_MODEL(KFROM)%XQSURF=>XQSURF
ENDIF
!
...
XRAIN=>SURF_ATM_MODEL(KTO)%XRAIN
XSNOW=>SURF_ATM_MODEL(KTO)%XSNOW
XZ0=>SURF_ATM_MODEL(KTO)%XZ0
XZ0H=>SURF_ATM_MODEL(KTO)%XZ0H
XQSURF=>SURF_ATM_MODEL(KTO)%XQSURF
!
