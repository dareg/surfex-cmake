...
LOGICAL :: LWORK0
LOGICAL, DIMENSION(:), POINTER :: LWORKD=>NULL()
INTEGER :: NWORK0, NWORKVAR, NWORKB, NWORKDIMS
INTEGER, DIMENSION(4) :: NWORKLEN
INTEGER, DIMENSION(4) :: NWORKIDS
INTEGER, DIMENSION(:), POINTER :: NWORK_FULL=>NULL()
INTEGER, DIMENSION(:), POINTER :: NWORKD=>NULL()
INTEGER, DIMENSION(:), POINTER :: NWORK=>NULL()
INTEGER, DIMENSION(:,:), POINTER :: NWORK2_FULL=>NULL()
INTEGER, DIMENSION(:,:), POINTER :: NWORKD2=>NULL()
INTEGER, DIMENSION(:,:), POINTER :: NWORK2=>NULL()
INTEGER, DIMENSION(:,:,:), POINTER :: NWORKD3=>NULL()
REAL :: XWORK0
REAL, DIMENSION(:), POINTER :: XWORK_FULL=>NULL()
REAL, DIMENSION(:), POINTER :: XWORKD=>NULL()
REAL, DIMENSION(:), POINTER :: XWORK=>NULL()
REAL, DIMENSION(:,:), POINTER :: XWORK2_FULL=>NULL()
REAL, DIMENSION(:,:), POINTER :: XWORKD2=>NULL()
REAL, DIMENSION(:,:), POINTER :: XWORK2=>NULL()
REAL, DIMENSION(:,:,:), POINTER :: XWORKD3=>NULL()
REAL, DIMENSION(:,:,:), POINTER :: XWORK3=>NULL()
!
CONTAINS
!
!*********************************************************
