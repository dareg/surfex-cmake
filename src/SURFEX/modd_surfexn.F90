...
TYPE(DIAG_EVAP_ISBA_t) :: DGEIC
TYPE(DIAG_EVAP_ISBA_PATCH_t) :: DGEIP
TYPE(DIAG_EVAP_ISBA_PATCH_t) :: DGEIPC
TYPE(DIAG_t) :: DGI
TYPE(DIAG_t) :: DGIC
TYPE(DIAG_PATCH_t) :: DGIP
TYPE(DIAG_PATCH_t) :: DGIPC
TYPE(DIAG_MISC_ISBA_t) :: DGMI
TYPE(DIAG_MISC_ISBA_PATCH_t) :: DGMIP
TYPE(GR_BIOG_t) :: GB
TYPE(CANOPY_t) :: ICP
TYPE(GRID_t) :: IG
!TYPE(ISBA_PATCH_t) :: I
