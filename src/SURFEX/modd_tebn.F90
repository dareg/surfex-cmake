...
REAL, POINTER, DIMENSION(:)   :: XRESIDENTIAL=>NULL()
!$OMP THREADPRIVATE(XRESIDENTIAL)
REAL, POINTER :: XDT_RES=>NULL()
!$OMP THREADPRIVATE(XDT_RES)
REAL, POINTER :: XDT_OFF=>NULL()
!$OMP THREADPRIVATE(XDT_OFF)
!
!----------------------------------------------------------------------------
CONTAINS
!----------------------------------------------------------------------------
...
TEB_MODEL(KFROM,KFROM_PATCH)%XRESIDENTIAL=>XRESIDENTIAL
ENDIF
...
XRESIDENTIAL=>TEB_MODEL(KTO,KTO_PATCH)%XRESIDENTIAL
XDT_RES=>TEB_MODEL(KTO,KTO_PATCH)%XDT_RES
XDT_OFF=>TEB_MODEL(KTO,KTO_PATCH)%XDT_OFF
