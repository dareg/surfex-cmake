...
!
SUBROUTINE TEB_GOTO_PATCH(KTO_PATCH)
...
TEB => TEB_MODEL(KMODEL)
DO J=1,KMODEL
 ALLOCATE(TEB_MODEL(J)%ALP(KPATCH))
 DO JP=1,KPATCH
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XROAD_DIR)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XGARDEN)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XGREENROOF)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XBLD)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XROAD)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XCAN_HW_RATIO)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XBLD_HEIGHT)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XWALL_O_HOR)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XROAD_O_GRND)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XGARDEN_O_GRND)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XWALL_O_GRND)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XWALL_O_BLD)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XZ0_TOWN)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XSVF_ROAD)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XSVF_GARDEN)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XSVF_WALL)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XALB_ROOF)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XEMIS_ROOF)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XHC_ROOF)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XTC_ROOF)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XD_ROOF)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XALB_ROAD)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XEMIS_ROAD)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XHC_ROAD)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XTC_ROAD)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XD_ROAD)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XALB_WALL)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XEMIS_WALL)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XHC_WALL)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XTC_WALL)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XD_WALL)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XH_TRAFFIC)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XLE_TRAFFIC)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XH_INDUSTRY)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XLE_INDUSTRY)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XTI_ROAD)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XWS_ROOF)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XWS_ROAD)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XT_ROOF)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XT_ROAD)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XT_WALL_A)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XT_WALL_B)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XAC_ROOF)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XAC_ROAD)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XAC_WALL)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XAC_TOP)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XAC_ROOF_WAT)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XAC_ROAD_WAT)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XQSAT_ROOF)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XQSAT_ROAD)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XDELT_ROOF)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XDELT_ROAD)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XT_CANYON)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XQ_CANYON)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XROUGH_ROOF)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XROUGH_WALL)
  NULLIFY(TEB_MODEL(J)%ALP(JP)%XRESIDENTIAL)
 ENDDO
 TEB_MODEL(J)%ALP(:)%XDT_RES=0.
 TEB_MODEL(J)%ALP(:)%XDT_OFF=0.
ENDDO
