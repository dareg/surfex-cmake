...
IF (LHOOK) CALL DR_HOOK('MODI_AV_PGD_1P:DATE2DOY',0,ZHOOK_HANDLE)
!
...
DO JJ = 1, SIZE(OCOVER)
  ...
  END DO
END DO
IF (LHOOK) CALL DR_HOOK('MODI_AV_PGD_1P:DATE2DOY',1,ZHOOK_HANDLE)
...
IF (LHOOK) CALL DR_HOOK('MODI_AV_PGD_1P:DOY2DATE',0,ZHOOK_HANDLE)
!
KMONTH = NUNDEF
KDAY   = NUNDEF 
!
...
DO J = 2, 12
   ...
   ENDIF
END DO 
IF (LHOOK) CALL DR_HOOK('MODI_AV_PGD_1P:DOY2DATE',1,ZHOOK_HANDLE)
