...
SUBROUTINE GET_MASS_HEAT(KJ,KNLVLS_NEW,KNLVLS_OLD,                                &
                         ...
                         PSNOWAGEO,PSNOWIMPUROV2,PSNOWHEATO,                        &
                         PSNOWRHON,PSNOWDZN,PSNOWGRAN1N,PSNOWGRAN2N,PSNOWHISTN,   &
                         PSNOWAGEN, PSNOWIMPURNV2, PSNOWHEATN,HSNOWMETAMO            )
!
...
REAL, DIMENSION(:,:), INTENT(IN) :: PSNOWIMPUROV2
...
DO JST_NEW = 1,KNLVLS_NEW
  ...
  DO JST_OLD = 1,KNLVLS_OLD
    ...
    ELSE
      ...
      DO JIMP=1,NIMPUR
        ZIMPURMOYNV2(JIMP)=ZIMPURMOYNV2(JIMP)+ZMASDZ_OLD*PSNOWIMPUROV2(JST_OLD,JIMP)
      ENDDO
      !
    ENDIF
    !
  ...
  DO JIMP=1,NIMPUR
    PSNOWIMPURNV2(JST_NEW,JIMP)=ZIMPURMOYNV2(JIMP) /ZMASTOTN
  ENDDO
  !
ENDDO     
!
