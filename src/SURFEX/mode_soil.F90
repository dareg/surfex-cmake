...
!
   ...
   SELECT CASE (HPEDOTF)
     ...
     CASE ('CO84')
       WHERE(PCLAY/=XUNDEF) &
       WWILT_FUNC_2D = 0.1286080232-0.1226625916*PSAND+0.4236331746*PCLAY-0.1475897616*(PCLAY**2)
   END SELECT
   ...
   SELECT CASE (HPEDOTF)
     ...
     CASE ('CO84')
       WHERE(PCLAY/=XUNDEF) &
         WFC_FUNC_2D = 0.1002040088-0.0894369113*PSAND+0.3402956492*PCLAY**(1./3.)
   END SELECT
   ...
   SELECT CASE (HPEDOTF)
     ...
     CASE ('CO84')
       WHERE(PCLAY/=XUNDEF) &
         W33_FUNC_2D = 0.3154912613-0.2409888312*PSAND+0.4308755588*PCLAY-0.2991388694*(PCLAY**2) 
   END SELECT
...
!
   ...
   SELECT CASE (HPEDOTF)
     ...
     CASE ('CO84')
       WHERE(PCLAY/=XUNDEF) &
       WWILT_FUNC_1D = 0.1286080232-0.1226625916*PSAND+0.4236331746*PCLAY-0.1475897616*(PCLAY**2)
   END SELECT   
   !
   ...
   SELECT CASE (HPEDOTF)
     ...
     CASE ('CO84')
       WHERE(PCLAY/=XUNDEF) &
         WFC_FUNC_1D = 0.1002040088-0.0894369113*PSAND+0.3402956492*PCLAY**(1./3.)
   END SELECT 
   !
   ...
   SELECT CASE (HPEDOTF)
     ...
     CASE ('CO84')
       WHERE(PCLAY/=XUNDEF) &
         W33_FUNC_1D = 0.3154912613-0.2409888312*PSAND+0.4308755588*PCLAY-0.2991388694*(PCLAY**2) 
   END SELECT
