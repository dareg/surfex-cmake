...
!
SUBROUTINE INIT_NAM_DIAG_SURFn (DFO)
!
...
!
  ...
  XDIAG_TSTEP = DFO%XDIAG_TSTEP
  N2M = DFO%N2M
  L2M_MIN_ZS = DFO%L2M_MIN_ZS
  LSURF_BUDGET = DFO%LSURF_BUDGET
  LRAD_BUDGET = DFO%LRAD_BUDGET
  LSURF_BUDGETC = DFO%LSURF_BUDGETC
  LRESET_BUDGETC = DFO%LRESET_BUDGETC  
  LCOEF = DFO%LCOEF
  LSURF_VARS = DFO%LSURF_VARS
IF (LHOOK) CALL DR_HOOK('MODN_FLAKE_N:INIT_NAM_DIAG_SURFN',1,ZHOOK_HANDLE)
END SUBROUTINE INIT_NAM_DIAG_SURFn

SUBROUTINE UPDATE_NAM_DIAG_SURFn (DFO)
!
  USE MODD_DIAG_n, ONLY : DIAG_OPTIONS_t
!
  IMPLICIT NONE
...
!
  ...
  DFO%XDIAG_TSTEP = XDIAG_TSTEP  
  DFO%N2M = N2M
  DFO%L2M_MIN_ZS = L2M_MIN_ZS
  DFO%LSURF_BUDGET = LSURF_BUDGET
  DFO%LRAD_BUDGET = LRAD_BUDGET 
  DFO%LSURF_BUDGETC = LSURF_BUDGETC
  DFO%LRESET_BUDGETC = LRESET_BUDGETC  
  DFO%LCOEF = LCOEF
  DFO%LSURF_VARS = LSURF_VARS
