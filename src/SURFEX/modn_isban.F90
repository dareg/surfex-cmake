...
NAMELIST/NAM_ISBAn/CC1DRY,CSCOND,CSOILFRZ,CDIFSFCOND,CSNOWRES,CALBEDO,CROUGH,CCPSURF, &
                     XTSTEP,XCVHEATF,XCGMAX,XCDRAG,LGLACIER,LCANOPY_DRAG,LVEGUPD,LPERTSURF
...
NAMELIST/NAM_DIAG_ISBAn/LPGD,LSURF_EVAP_BUDGET,LSURF_MISC_BUDGET,LSURF_DIAG_ALBEDO,LPATCH_BUDGET, &
                        LSURF_MISC_DIF, LWATER_BUDGET, LPROSNOW,LPROBANDS,  LVOLUMETRIC_SNOWLIQ
...
NAMELIST/NAM_ISBA_SNOWn/CSNOWDRIFT,LSNOWDRIFT_SUBLIM, LSNOW_ABS_ZENITH, CSNOWMETAMO, CSNOWRAD,LATMORAD, &
                        LSNOWSYTRON, CSNOWFALL, CSNOWCOND, CSNOWHOLD, CSNOWCOMP, CSNOWZREF,             &
			LSNOWCOMPACT_BOOL, LSNOWMAK_BOOL, LPRODSNOWMAK, LSNOWMAK_PROP, &
...
!
  ...
  LPROSNOW = DGMI%LPROSNOW
  LPROBANDS = DGMI%LPROBANDS
  LVOLUMETRIC_SNOWLIQ = DGMI%LPROSNOW
...
!
  ...
  DGMI%LPROSNOW = LPROSNOW
  DGMI%LPROBANDS = LPROBANDS
  DGMI%LVOLUMETRIC_SNOWLIQ = LVOLUMETRIC_SNOWLIQ
...
!
  ...
  CSNOWDRIFT = I%CSNOWDRIFT
  LSNOWDRIFT_SUBLIM =  I%LSNOWDRIFT_SUBLIM
  LSNOW_ABS_ZENITH = I%LSNOW_ABS_ZENITH
  CSNOWMETAMO = I%CSNOWMETAMO
  CSNOWRAD = I%CSNOWRAD  
  LATMORAD = I%LATMORAD
  LSNOWSYTRON = I%LSNOWSYTRON

  CSNOWFALL = I%CSNOWFALL 
  CSNOWCOND = I%CSNOWCOND
  CSNOWHOLD = I%CSNOWHOLD
  CSNOWCOMP = I%CSNOWCOMP
  CSNOWZREF = I%CSNOWZREF
  !Snowmaking option
  LSNOWCOMPACT_BOOL = I%LSNOWCOMPACT_BOOL
  LSNOWMAK_BOOL = I%LSNOWMAK_BOOL
  LPRODSNOWMAK = I%LPRODSNOWMAK
  LSNOWMAK_PROP = I%LSNOWMAK_PROP
  LSNOWTILLER = I%LSNOWTILLER
  LSELF_PROD = I%LSELF_PROD
...
!
  ...
  IF (LHOOK) CALL DR_HOOK('MODN_ISBA_N:INIT_NAM_ISBA_SNOWn',0,ZHOOK_HANDLE)
  I%CSNOWDRIFT = CSNOWDRIFT
  I%LSNOWDRIFT_SUBLIM = LSNOWDRIFT_SUBLIM
  I%LSNOW_ABS_ZENITH = LSNOW_ABS_ZENITH
  I%CSNOWMETAMO = CSNOWMETAMO
  I%CSNOWRAD=CSNOWRAD  
  I%LATMORAD=LATMORAD
  I%LSNOWSYTRON=LSNOWSYTRON
  I%CSNOWFALL= CSNOWFALL
  I%CSNOWCOND= CSNOWCOND
  I%CSNOWHOLD= CSNOWHOLD 
  I%CSNOWCOMP = CSNOWCOMP!
  I%CSNOWZREF = CSNOWZREF
!Snowmaking option
  I%LSNOWCOMPACT_BOOL = LSNOWCOMPACT_BOOL
  I%LSNOWMAK_BOOL = LSNOWMAK_BOOL
  I%LPRODSNOWMAK = LPRODSNOWMAK
  I%LSNOWMAK_PROP = LSNOWMAK_PROP
  I%LSNOWTILLER = LSNOWTILLER
  I%LSELF_PROD = LSELF_PROD
  IF (LHOOK) CALL DR_HOOK('MODN_ISBA_N:INIT_NAM_ISBA_SNOWn',1,ZHOOK_HANDLE)
