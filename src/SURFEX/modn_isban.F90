...
USE MODD_ISBA_n, ONLY: &
           ...
           XCO2_START_n   => XCO2_START, &          
           XCO2_END_n   => XCO2_END, &        
           LPERTSURF_n => LPERTSURF, &
           LSNOWDRIFT_n => LSNOWDRIFT, &
           LSNOWDRIFT_SUBLIM_n => LSNOWDRIFT_SUBLIM,&
           LSNOW_ABS_ZENITH_n => LSNOW_ABS_ZENITH,&
           CSNOWMETAMO_n => CSNOWMETAMO,&
           CSNOWRAD_n => CSNOWRAD
!
...
SUBROUTINE UPDATE_NAM_ISBA_AGSn
...
SUBROUTINE INIT_NAM_DIAG_ISBAn
  ...
  LSURF_DIAG_ALBEDO = LSURF_DIAG_ALBEDO_n
...
SUBROUTINE INIT_NAM_ISBA_SNOWn
