...
NAMELIST/NAM_ISBA_SNOWn/LSNOWDRIFT,LSNOWDRIFT_SUBLIM, LSNOW_ABS_ZENITH, CSNOWMETAMO, CSNOWRAD,LATMORAD, &
                        LSNOWSYTRON, CSNOWFALL, CSNOWCOND, CSNOWHOLD, CSNOWCOMP
!
CONTAINS
!
