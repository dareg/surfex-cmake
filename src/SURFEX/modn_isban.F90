...
SUBROUTINE INIT_NAM_DIAG_ISBAn (DGEI, DIO, DGMI)
!
...
!
  ...
  XDIAG_TSTEP = DIO%XDIAG_TSTEP  
  N2M = DIO%N2M
  L2M_MIN_ZS = DIO%L2M_MIN_ZS
  LSURF_BUDGET = DIO%LSURF_BUDGET
  LRAD_BUDGET = DIO%LRAD_BUDGET
  LSURF_BUDGETC = DIO%LSURF_BUDGETC
  LRESET_BUDGETC = DIO%LRESET_BUDGETC  
  LCOEF = DIO%LCOEF
  LSURF_VARS = DIO%LSURF_VARS
IF (LHOOK) CALL DR_HOOK('MODN_ISBA_N:INIT_NAM_DIAG_SURFN',1,ZHOOK_HANDLE)
END SUBROUTINE INIT_NAM_DIAG_SURFn

SUBROUTINE UPDATE_NAM_DIAG_SURFn (DIO)
!
  USE MODD_DIAG_EVAP_ISBA_n, ONLY : DIAG_EVAP_ISBA_t
  USE MODD_DIAG_n, ONLY : DIAG_OPTIONS_t
!
...
!
  ...
  DIO%XDIAG_TSTEP = XDIAG_TSTEP  
  DIO%N2M = N2M
  DIO%L2M_MIN_ZS = L2M_MIN_ZS
  DIO%LSURF_BUDGET = LSURF_BUDGET
  DIO%LRAD_BUDGET = LRAD_BUDGET 
  DIO%LSURF_BUDGETC = LSURF_BUDGETC
  DIO%LRESET_BUDGETC = LRESET_BUDGETC  
  DIO%LCOEF = LCOEF
  DIO%LSURF_VARS = LSURF_VARS
