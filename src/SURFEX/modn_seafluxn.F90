...
REAL :: XOCEAN_TSTEP
REAL :: XCMO_COEF
LOGICAL  :: LVOLATILE_SIC
CHARACTER(LEN=6)  :: CINTERPOL_SST
CHARACTER(LEN=6)  :: CONSTRAIN_CSV  ! Under constrain, conservation method
...
NAMELIST/NAM_SEAICEn/LDIAG_MISC_SEAICE, CINTERPOL_SIC, CINTERPOL_SIT,      &
                     CONSTRAIN_CSV, LSIC_CST,                              &
                     XFREEZING_SST, XSIC_EFOLDING_TIME, XSIT_EFOLDING_TIME,&
                     XSEAICE_TSTEP, XCD_ICE_CST, XSI_FLX_DRV, LVOLATILE_SIC
!
CONTAINS
!
...
!
  ...
  LREAD_CURRENT = O%LREAD_CURRENT
  LCMO_COEFF = O%LCMO_COEFF
  XICHCE = S%XICHCE
...
!
  ...
  O%LREAD_CURRENT = LREAD_CURRENT
  O%LCMO_COEFF = LCMO_COEFF
  S%XICHCE = XICHCE
