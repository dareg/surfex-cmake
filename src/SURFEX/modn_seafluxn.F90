...
!
SUBROUTINE INIT_NAM_DIAG_SURFn (DSO)
!
...
!
  ...
  XDIAG_TSTEP = DSO%XDIAG_TSTEP  
  N2M = DSO%N2M
  L2M_MIN_ZS = DSO%L2M_MIN_ZS
  LSURF_BUDGET = DSO%LSURF_BUDGET
  LRAD_BUDGET = DSO%LRAD_BUDGET
  LSURF_BUDGETC = DSO%LSURF_BUDGETC
  LRESET_BUDGETC = DSO%LRESET_BUDGETC  
  LCOEF = DSO%LCOEF
  LSURF_VARS = DSO%LSURF_VARS
IF (LHOOK) CALL DR_HOOK('MODN_SEAFLUX_N:INIT_NAM_DIAG_SURFN',1,ZHOOK_HANDLE)
END SUBROUTINE INIT_NAM_DIAG_SURFn

SUBROUTINE UPDATE_NAM_DIAG_SURFn (DSO)
!
  USE MODD_DIAG_n, ONLY : DIAG_OPTIONS_t
!
  IMPLICIT NONE
...
!
  ...
  DSO%XDIAG_TSTEP = XDIAG_TSTEP  
  DSO%N2M = N2M
  DSO%L2M_MIN_ZS = L2M_MIN_ZS
  DSO%LSURF_BUDGET = LSURF_BUDGET
  DSO%LRAD_BUDGET = LRAD_BUDGET 
  DSO%LSURF_BUDGETC = LSURF_BUDGETC
  DSO%LRESET_BUDGETC = LRESET_BUDGETC  
  DSO%LCOEF = LCOEF
  DSO%LSURF_VARS = LSURF_VARS
