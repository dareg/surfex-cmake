...
!                        
NAMELIST/NAM_WRITE_DIAG_SURFn/LPROVAR_TO_DIAG,LSELECT,CSELECT,LSNOWDIMNC,LRESETCUMUL
!
CONTAINS
!
...
!
  ...
  LSELECT = DGU%LSELECT
  CSELECT(:) = '            '
  LSNOWDIMNC = DGU%LSNOWDIMNC
  LRESETCUMUL = DGU%LRESETCUMUL
...
!
  ...
  DGU%LSNOWDIMNC = LSNOWDIMNC
  DGU%LRESETCUMUL = LRESETCUMUL
!
  DGU%LSELECT = LSELECT
  IF (LSELECT) THEN
