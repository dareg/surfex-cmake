...
CONTAINS
!
SUBROUTINE INIT_NAM_DIAG_SURFn (DTO, TOP)
!
...
!
  ...
  XDIAG_TSTEP = DTO%XDIAG_TSTEP  
  N2M = DTO%N2M
  L2M_MIN_ZS = DTO%L2M_MIN_ZS
  LSURF_BUDGET = DTO%LSURF_BUDGET
  LRAD_BUDGET = DTO%LRAD_BUDGET
  LCOEF = DTO%LCOEF
  LSURF_VARS = DTO%LSURF_VARS
IF (LHOOK) CALL DR_HOOK('MODN_TEB_N:INIT_NAM_DIAG_SURFN',1,ZHOOK_HANDLE)
END SUBROUTINE INIT_NAM_DIAG_SURFn

SUBROUTINE UPDATE_NAM_DIAG_SURFn (DTO)
!
  USE MODD_DIAG_n, ONLY : DIAG_OPTIONS_t
!
  IMPLICIT NONE
...
!
  ...
  DTO%XDIAG_TSTEP = XDIAG_TSTEP  
  DTO%N2M = N2M
  DTO%L2M_MIN_ZS = L2M_MIN_ZS
  DTO%LSURF_BUDGET = LSURF_BUDGET
  DTO%LRAD_BUDGET = LRAD_BUDGET 
  DTO%LCOEF = LCOEF
  DTO%LSURF_VARS = LSURF_VARS
...
SUBROUTINE INIT_NAM_DIAG_TEBn (DGMTO, DTO, DGUT)
!
...
SUBROUTINE UPDATE_NAM_DIAG_TEBn (DGMTO, DTO, DGUT)
!
  USE MODD_DIAG_MISC_TEB_OPTION_n, ONLY : DIAG_MISC_TEB_OPTIONS_t
  USE MODD_DIAG_n, ONLY : DIAG_OPTIONS_t
  USE MODD_DIAG_UTCI_TEB_n, ONLY : DIAG_UTCI_TEB_t
