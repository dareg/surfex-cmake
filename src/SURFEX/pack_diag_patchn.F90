...
ALLOCATE(PKDI%XBLOCK_GROUND(KSIZE,I%O%NGROUND_LAYER,PKDI%NSIZE_GROUND))
ALLOCATE(PKDI%XBLOCK_SNOW(KSIZE,I%R%TSNOW%NLAYER,PKDI%NSIZE_SNOW))
ALLOCATE(PKDI%XBLOCK_KSW(KSIZE,KSW,PKDI%NSIZE_KSW))
ALLOCATE(PKDI%XBLOCK_ABC(KSIZE,SIZE(I%IP%XABC),PKDI%NSIZE_ABC))
