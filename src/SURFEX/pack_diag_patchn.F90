!     #########
SUBROUTINE PACK_DIAG_PATCH_n(KSIZE,KSW,KPATCH)
!##############################################
!
...
USE MODD_PACK_DIAG_ISBA, ONLY :   XP_RNSNOW, XP_HSNOW, XP_HPSNOW, XP_SMELTFLUX, &
                                  ...
                                  XP_SWUP, XP_SWNET_V, XP_SWNET_G, XP_SWNET_N, XP_SWNET_NS,       &
                                  XP_LWUP, XP_LWNET_V, XP_LWNET_G, XP_LWNET_N,                    &
                                  XP_LEVCV, XP_LESC, XP_H_V_C, XP_H_G_C,                          &
                                  XP_LETRGV, XP_LETRCV, XP_LERGV, XP_LERCV, XP_H_C_A, XP_H_N_C,   &
...
IF (TSNOW%SCHEME=='3-L' .OR. TSNOW%SCHEME=='CRO') THEN
  ...
  ISIZE_SIMPLE = ISIZE_SIMPLE + 1
  XP_SWNET_N    => XBLOCK_SIMPLE(:,ISIZE_SIMPLE)
  ISIZE_SIMPLE = ISIZE_SIMPLE + 1
  XP_SWNET_NS    => XBLOCK_SIMPLE(:,ISIZE_SIMPLE)
  ISIZE_SIMPLE = ISIZE_SIMPLE + 1
  XP_LWNET_N    => XBLOCK_SIMPLE(:,ISIZE_SIMPLE)
ELSE
  ISIZE_0 = ISIZE_0 + 1
  ...
  ISIZE_0 = ISIZE_0 + 1
  XP_SWNET_N  => XBLOCK_0(:,ISIZE_0)
  ISIZE_0 = ISIZE_0 + 1
  XP_SWNET_NS  => XBLOCK_0(:,ISIZE_0)
  ISIZE_0 = ISIZE_0 + 1
  XP_LWNET_N  => XBLOCK_0(:,ISIZE_0)
END IF
!
...
IF (LMEB_PATCH(KPATCH))THEN
  ISIZE_SIMPLE = ISIZE_SIMPLE + 1
  XP_SWUP    => XBLOCK_SIMPLE(:,ISIZE_SIMPLE)
  ISIZE_SIMPLE = ISIZE_SIMPLE + 1
  XP_SWNET_V    => XBLOCK_SIMPLE(:,ISIZE_SIMPLE)
  ISIZE_SIMPLE = ISIZE_SIMPLE + 1
  XP_SWNET_G    => XBLOCK_SIMPLE(:,ISIZE_SIMPLE)
  ISIZE_SIMPLE = ISIZE_SIMPLE + 1
  XP_LWUP    => XBLOCK_SIMPLE(:,ISIZE_SIMPLE)
  ISIZE_SIMPLE = ISIZE_SIMPLE + 1
  XP_LWNET_V    => XBLOCK_SIMPLE(:,ISIZE_SIMPLE)
  ISIZE_SIMPLE = ISIZE_SIMPLE + 1
  XP_LWNET_G    => XBLOCK_SIMPLE(:,ISIZE_SIMPLE)
  ISIZE_SIMPLE = ISIZE_SIMPLE + 1
  XP_LEVCV    => XBLOCK_SIMPLE(:,ISIZE_SIMPLE)
  ISIZE_SIMPLE = ISIZE_SIMPLE + 1
  XP_LESC    => XBLOCK_SIMPLE(:,ISIZE_SIMPLE)
  ISIZE_SIMPLE = ISIZE_SIMPLE + 1
  XP_H_V_C    => XBLOCK_SIMPLE(:,ISIZE_SIMPLE)
  ISIZE_SIMPLE = ISIZE_SIMPLE + 1
  XP_H_G_C    => XBLOCK_SIMPLE(:,ISIZE_SIMPLE)
  ISIZE_SIMPLE = ISIZE_SIMPLE + 1
  XP_LETRGV    => XBLOCK_SIMPLE(:,ISIZE_SIMPLE)
  ISIZE_SIMPLE = ISIZE_SIMPLE + 1
  XP_LETRCV    => XBLOCK_SIMPLE(:,ISIZE_SIMPLE)
  ISIZE_SIMPLE = ISIZE_SIMPLE + 1
  XP_LERGV    => XBLOCK_SIMPLE(:,ISIZE_SIMPLE)
  ISIZE_SIMPLE = ISIZE_SIMPLE + 1
  XP_LERCV    => XBLOCK_SIMPLE(:,ISIZE_SIMPLE)
  ISIZE_SIMPLE = ISIZE_SIMPLE + 1
  XP_H_C_A    => XBLOCK_SIMPLE(:,ISIZE_SIMPLE)
  ISIZE_SIMPLE = ISIZE_SIMPLE + 1
  XP_H_N_C    => XBLOCK_SIMPLE(:,ISIZE_SIMPLE)
  ISIZE_SIMPLE = ISIZE_SIMPLE + 1
  XP_LE_C_A    => XBLOCK_SIMPLE(:,ISIZE_SIMPLE)
  ISIZE_SIMPLE = ISIZE_SIMPLE + 1
  XP_LE_V_C    => XBLOCK_SIMPLE(:,ISIZE_SIMPLE)
  ISIZE_SIMPLE = ISIZE_SIMPLE + 1
  XP_LE_G_C    => XBLOCK_SIMPLE(:,ISIZE_SIMPLE)
  ISIZE_SIMPLE = ISIZE_SIMPLE + 1
  XP_LE_N_C    => XBLOCK_SIMPLE(:,ISIZE_SIMPLE)
  ISIZE_SIMPLE = ISIZE_SIMPLE + 1
  XP_EVAP_N_C    => XBLOCK_SIMPLE(:,ISIZE_SIMPLE)
  ISIZE_SIMPLE = ISIZE_SIMPLE + 1
  XP_EVAP_G_C    => XBLOCK_SIMPLE(:,ISIZE_SIMPLE)
  ISIZE_SIMPLE = ISIZE_SIMPLE + 1
  XP_SR_GN    => XBLOCK_SIMPLE(:,ISIZE_SIMPLE)
  ISIZE_SIMPLE = ISIZE_SIMPLE + 1
  XP_MELTCV    => XBLOCK_SIMPLE(:,ISIZE_SIMPLE)
  ISIZE_SIMPLE = ISIZE_SIMPLE + 1
  XP_FRZCV    => XBLOCK_SIMPLE(:,ISIZE_SIMPLE)
  ISIZE_SIMPLE = ISIZE_SIMPLE + 1
  XP_SWDOWN_GN    => XBLOCK_SIMPLE(:,ISIZE_SIMPLE)
  ISIZE_SIMPLE = ISIZE_SIMPLE + 1
  XP_LWDOWN_GN    => XBLOCK_SIMPLE(:,ISIZE_SIMPLE)
ELSE
  ISIZE_0 = ISIZE_0 + 1
  XP_SWUP  => XBLOCK_0(:,ISIZE_0)
  ISIZE_0 = ISIZE_0 + 1
  XP_SWNET_V  => XBLOCK_0(:,ISIZE_0)
  ISIZE_0 = ISIZE_0 + 1
  XP_SWNET_G  => XBLOCK_0(:,ISIZE_0)
  ISIZE_0 = ISIZE_0 + 1
  XP_LWUP  => XBLOCK_0(:,ISIZE_0)
  ISIZE_0 = ISIZE_0 + 1
  XP_LWNET_V  => XBLOCK_0(:,ISIZE_0)
  ISIZE_0 = ISIZE_0 + 1
  XP_LWNET_G  => XBLOCK_0(:,ISIZE_0)
  ISIZE_0 = ISIZE_0 + 1
  XP_LEVCV  => XBLOCK_0(:,ISIZE_0)
  ISIZE_0 = ISIZE_0 + 1
  XP_LESC  => XBLOCK_0(:,ISIZE_0)
  ISIZE_0 = ISIZE_0 + 1
  XP_H_V_C  => XBLOCK_0(:,ISIZE_0)
  ISIZE_0 = ISIZE_0 + 1
  XP_H_G_C  => XBLOCK_0(:,ISIZE_0)
  ISIZE_0 = ISIZE_0 + 1
  XP_LETRGV  => XBLOCK_0(:,ISIZE_0)
  ISIZE_0 = ISIZE_0 + 1
  XP_LETRCV  => XBLOCK_0(:,ISIZE_0)
  ISIZE_0 = ISIZE_0 + 1
  XP_LERGV  => XBLOCK_0(:,ISIZE_0)
  ISIZE_0 = ISIZE_0 + 1
  XP_LERCV  => XBLOCK_0(:,ISIZE_0)
  ISIZE_0 = ISIZE_0 + 1
  XP_H_C_A  => XBLOCK_0(:,ISIZE_0)
  ISIZE_0 = ISIZE_0 + 1
  XP_H_N_C  => XBLOCK_0(:,ISIZE_0)
  ISIZE_0 = ISIZE_0 + 1
  XP_LE_C_A  => XBLOCK_0(:,ISIZE_0)
  ISIZE_0 = ISIZE_0 + 1
  XP_LE_V_C  => XBLOCK_0(:,ISIZE_0)
  ISIZE_0 = ISIZE_0 + 1
  XP_LE_G_C  => XBLOCK_0(:,ISIZE_0)
  ISIZE_0 = ISIZE_0 + 1
  XP_LE_N_C  => XBLOCK_0(:,ISIZE_0)
  ISIZE_0 = ISIZE_0 + 1
  XP_EVAP_N_C  => XBLOCK_0(:,ISIZE_0)
  ISIZE_0 = ISIZE_0 + 1
  XP_EVAP_G_C  => XBLOCK_0(:,ISIZE_0)
  ISIZE_0 = ISIZE_0 + 1
  XP_SR_GN  => XBLOCK_0(:,ISIZE_0)
  ISIZE_0 = ISIZE_0 + 1
  XP_MELTCV  => XBLOCK_0(:,ISIZE_0)
  ISIZE_0 = ISIZE_0 + 1
  XP_FRZCV  => XBLOCK_0(:,ISIZE_0)
  ISIZE_0 = ISIZE_0 + 1
  XP_SWDOWN_GN  => XBLOCK_0(:,ISIZE_0)
  ISIZE_0 = ISIZE_0 + 1
  XP_LWDOWN_GN  => XBLOCK_0(:,ISIZE_0)
ENDIF
