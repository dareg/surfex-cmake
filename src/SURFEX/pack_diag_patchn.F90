...
INTEGER :: ISIZE_SIMPLE, ISIZE_GROUND, ISIZE_SNOW, ISIZE_KSW, &
           ISIZE_ABC, ISIZE_0, ISIZE_00,ISIZE_000,ISIZE_IMPUR
...
ALLOCATE(PKDI%XBLOCK_IMPUR(KSIZE,I%TSNOW%NLAYER,NIMPUR,PKDI%NSIZE_IMPUR))
...
IF (I%TSNOW%SCHEME=='3-L' .OR. I%TSNOW%SCHEME=='CRO') THEN
  ...
  ISIZE_SIMPLE = ISIZE_SIMPLE + 1
  PKDI%XP_PRODCOUNT => PKDI%XBLOCK_SIMPLE(:,ISIZE_SIMPLE) 
ELSE
  ISIZE_0 = ISIZE_0 + 1
...
IF (I%TSNOW%SCHEME=='CRO') THEN
  ISIZE_SIMPLE = ISIZE_SIMPLE + 1
  PKDI%XP_SYTMASS    => PKDI%XBLOCK_SIMPLE(:,ISIZE_SIMPLE)
ELSE
  ISIZE_0 = ISIZE_0 + 1
  PKDI%XP_SYTMASS  => PKDI%XBLOCK_0(:,ISIZE_0)
ENDIF
  
IF ((I%TSNOW%SCHEME=='CRO').AND.(DGMI%LPROSNOW)) THEN
  ISIZE_SNOW = ISIZE_SNOW + 1  
  PKDI%XP_SNOWDEND=> PKDI%XBLOCK_SNOW(:,:,ISIZE_SNOW)
  ISIZE_SNOW = ISIZE_SNOW + 1  
  PKDI%XP_SNOWSPHER=> PKDI%XBLOCK_SNOW(:,:,ISIZE_SNOW)
  ISIZE_SNOW = ISIZE_SNOW + 1  
  PKDI%XP_SNOWSIZE=> PKDI%XBLOCK_SNOW(:,:,ISIZE_SNOW)    
  ISIZE_SNOW = ISIZE_SNOW + 1  
  PKDI%XP_SNOWSSA=> PKDI%XBLOCK_SNOW(:,:,ISIZE_SNOW)
  ISIZE_SNOW = ISIZE_SNOW + 1  
  PKDI%XP_SNOWTYPEMEPRA=> PKDI%XBLOCK_SNOW(:,:,ISIZE_SNOW)
  ISIZE_SNOW = ISIZE_SNOW + 1  
  PKDI%XP_SNOWRAM=> PKDI%XBLOCK_SNOW(:,:,ISIZE_SNOW)  
  ISIZE_SNOW = ISIZE_SNOW + 1  
  PKDI%XP_SNOWSHEAR=> PKDI%XBLOCK_SNOW(:,:,ISIZE_SNOW) 
  ISIZE_SIMPLE = ISIZE_SIMPLE + 1
  PKDI%XP_SNOWDEPTH_1DAYS    => PKDI%XBLOCK_SIMPLE(:,ISIZE_SIMPLE)
  ISIZE_SIMPLE = ISIZE_SIMPLE + 1
  PKDI%XP_SNOWDEPTH_3DAYS    => PKDI%XBLOCK_SIMPLE(:,ISIZE_SIMPLE)
  ISIZE_SIMPLE = ISIZE_SIMPLE + 1
  PKDI%XP_SNOWDEPTH_5DAYS    => PKDI%XBLOCK_SIMPLE(:,ISIZE_SIMPLE)
  ISIZE_SIMPLE = ISIZE_SIMPLE + 1
  PKDI%XP_SNOWDEPTH_7DAYS    => PKDI%XBLOCK_SIMPLE(:,ISIZE_SIMPLE)    
  ISIZE_SIMPLE = ISIZE_SIMPLE + 1
  PKDI%XP_SNOWSWE_1DAYS    => PKDI%XBLOCK_SIMPLE(:,ISIZE_SIMPLE)
  ISIZE_SIMPLE = ISIZE_SIMPLE + 1
  PKDI%XP_SNOWSWE_3DAYS    => PKDI%XBLOCK_SIMPLE(:,ISIZE_SIMPLE)
  ISIZE_SIMPLE = ISIZE_SIMPLE + 1
  PKDI%XP_SNOWSWE_5DAYS    => PKDI%XBLOCK_SIMPLE(:,ISIZE_SIMPLE)
  ISIZE_SIMPLE = ISIZE_SIMPLE + 1
  PKDI%XP_SNOWSWE_7DAYS    => PKDI%XBLOCK_SIMPLE(:,ISIZE_SIMPLE) 
  ISIZE_SIMPLE = ISIZE_SIMPLE + 1
  PKDI%XP_SNOWRAM_SONDE    => PKDI%XBLOCK_SIMPLE(:,ISIZE_SIMPLE)
  ISIZE_SIMPLE = ISIZE_SIMPLE + 1
  PKDI%XP_SNOW_WETTHICKNESS    => PKDI%XBLOCK_SIMPLE(:,ISIZE_SIMPLE)
  ISIZE_SIMPLE = ISIZE_SIMPLE + 1
  PKDI%XP_SNOW_REFROZENTHICKNESS    => PKDI%XBLOCK_SIMPLE(:,ISIZE_SIMPLE)
  ISIZE_IMPUR = ISIZE_IMPUR + 1
  PKDI%XP_SNOWIMPUR       => PKDI%XBLOCK_IMPUR(:,:,:,ISIZE_IMPUR)
  !     
   IF (DGMI%LPROBANDS) THEN
      ISIZE_KSW=ISIZE_KSW+1
      PKDI%XP_SPEC_ALB => PKDI%XBLOCK_KSW(:,:,ISIZE_KSW)
      ISIZE_KSW=ISIZE_KSW+1
      PKDI%XP_DIFF_RATIO => PKDI%XBLOCK_KSW(:,:,ISIZE_KSW)
    ELSE 
      ISIZE_00 = ISIZE_00 + 1  
      PKDI%XP_SPEC_ALB=> PKDI%XBLOCK_00(:,:,ISIZE_00)
      ISIZE_00 = ISIZE_00 + 1  
      PKDI%XP_DIFF_RATIO=> PKDI%XBLOCK_00(:,:,ISIZE_00)
    ENDIF
ELSE
  ISIZE_00 = ISIZE_00 + 1  
  PKDI%XP_SNOWDEND=> PKDI%XBLOCK_00(:,:,ISIZE_00)
  ISIZE_00 = ISIZE_00 + 1  
  PKDI%XP_SNOWSPHER=> PKDI%XBLOCK_00(:,:,ISIZE_00)
  ISIZE_00 = ISIZE_00 + 1  
  PKDI%XP_SNOWSIZE=> PKDI%XBLOCK_00(:,:,ISIZE_00)    
  ISIZE_00 = ISIZE_00 + 1  
  PKDI%XP_SNOWSSA=> PKDI%XBLOCK_00(:,:,ISIZE_00)
  ISIZE_00 = ISIZE_00 + 1  
  PKDI%XP_SNOWTYPEMEPRA=> PKDI%XBLOCK_00(:,:,ISIZE_00)
  ISIZE_00 = ISIZE_00 + 1  
  PKDI%XP_SNOWRAM=> PKDI%XBLOCK_00(:,:,ISIZE_00)  
  ISIZE_00 = ISIZE_00 + 1  
  PKDI%XP_SNOWSHEAR=> PKDI%XBLOCK_00(:,:,ISIZE_00) 
  ISIZE_0 = ISIZE_0 + 1
  PKDI%XP_SNOWDEPTH_1DAYS    => PKDI%XBLOCK_0(:,ISIZE_0)
  ISIZE_0 = ISIZE_0 + 1
  PKDI%XP_SNOWDEPTH_3DAYS    => PKDI%XBLOCK_0(:,ISIZE_0)
  ISIZE_0 = ISIZE_0 + 1
  PKDI%XP_SNOWDEPTH_5DAYS    => PKDI%XBLOCK_0(:,ISIZE_0)
  ISIZE_0 = ISIZE_0 + 1
  PKDI%XP_SNOWDEPTH_7DAYS    => PKDI%XBLOCK_0(:,ISIZE_0)    
  ISIZE_0 = ISIZE_0 + 1
  PKDI%XP_SNOWSWE_1DAYS    => PKDI%XBLOCK_0(:,ISIZE_0)
  ISIZE_0 = ISIZE_0 + 1
  PKDI%XP_SNOWSWE_3DAYS    => PKDI%XBLOCK_0(:,ISIZE_0)
  ISIZE_0 = ISIZE_0 + 1
  PKDI%XP_SNOWSWE_5DAYS    => PKDI%XBLOCK_0(:,ISIZE_0)
  ISIZE_0 = ISIZE_0 + 1
  PKDI%XP_SNOWSWE_7DAYS    => PKDI%XBLOCK_0(:,ISIZE_0) 
  ISIZE_0 = ISIZE_0 + 1
  PKDI%XP_SNOWRAM_SONDE    => PKDI%XBLOCK_0(:,ISIZE_0)
  ISIZE_0 = ISIZE_0 + 1
  PKDI%XP_SNOW_WETTHICKNESS    => PKDI%XBLOCK_0(:,ISIZE_0)
  ISIZE_0 = ISIZE_0 + 1
  PKDI%XP_SNOW_REFROZENTHICKNESS    => PKDI%XBLOCK_0(:,ISIZE_0)      
  ISIZE_00 = ISIZE_00 + 1  
  PKDI%XP_SPEC_ALB=> PKDI%XBLOCK_00(:,:,ISIZE_00)
  ISIZE_00 = ISIZE_00 + 1  
  PKDI%XP_DIFF_RATIO=> PKDI%XBLOCK_00(:,:,ISIZE_00)
  ISIZE_000 = ISIZE_000 + 1  
  PKDI%XP_SNOWIMPUR => PKDI%XBLOCK_000(:,:,:,ISIZE_000)
ENDIF
...
IF (ISIZE_KSW.GT.PKDI%NSIZE_KSW) & 
  ...
  IF (ISIZE_IMPUR.GT.PKDI%NSIZE_IMPUR) & 
  CALL ABOR1_SFX("PACK_DIAG_PATCH_n: PROBLEM DEFINING SIZE_IMPUR / NUMBER OF FIELDS")
