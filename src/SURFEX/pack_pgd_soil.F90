...
ALLOCATE(I%P%XSAND(IG%NDIM,I%O%NGROUND_LAYER))
 CALL PACK_SAME_RANK(IMASK,PSAND(:,:),I%P%XSAND(:,:))
!
ALLOCATE(I%P%XCLAY(IG%NDIM,I%O%NGROUND_LAYER))
 CALL PACK_SAME_RANK(IMASK,PCLAY(:,:),I%P%XCLAY(:,:))
!
!- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
!
ALLOCATE(I%P%XRUNOFFB(IG%NDIM))
 CALL PACK_SAME_RANK(IMASK,PRUNOFFB(:),I%P%XRUNOFFB(:))
!
ALLOCATE(I%P%XWDRAIN(IG%NDIM))
 CALL PACK_SAME_RANK(IMASK,PWDRAIN(:),I%P%XWDRAIN(:))
