...
USE MODD_CH_SNAP_n,          ONLY : JPEMISMAX,JPSNAPMAX,                     &
...
DO JSPEC=1,NEMIS_NBR
  ...
  CALL PGD_SNAP_TEMP_PROFILE(HPROGRAM,CSNAP_MONTHLY_FILE(JSPEC),XSNAP_MONTHLY(:,:,JSPEC),NEMIS_SNAP,NSNAP_M)
  CALL PGD_SNAP_TEMP_PROFILE(HPROGRAM,CSNAP_DAILY_FILE(JSPEC),  XSNAP_DAILY(:,:,JSPEC),NEMIS_SNAP,NSNAP_D)
  CALL PGD_SNAP_TEMP_PROFILE(HPROGRAM,CSNAP_HOURLY_FILE(JSPEC), XSNAP_HOURLY(:,:,JSPEC),NEMIS_SNAP,NSNAP_H,CSNAP_TIME_REF)
  ...
  print*,NEMIS_SNAP,JSPEC
  DO JSNAP=1,NEMIS_SNAP
  print*,CSNAP_POTENTIAL_FILE(JSPEC,JSNAP),CSNAP_POTENTIAL_FILETYPE(JSPEC)
    CATYPE = 'ARI'
