...
IF (LHOOK) CALL DR_HOOK('PGD_FIELD_1D',0,ZHOOK_HANDLE)
...
IF (LHOOK) CALL DR_HOOK('PGD_FIELD_1D',1,ZHOOK_HANDLE)
!
!-------------------------------------------------------------------------------
!
END SUBROUTINE PGD_FIELD_1D
...
IF (LHOOK) CALL DR_HOOK('PGD_FIELD_2D',0,ZHOOK_HANDLE)
!
IF (PRESENT(PVEGTYPE)) THEN
  CALL PGD_FIELDIN(DTCO, UG, U, USS, &
...
IF (LHOOK) CALL DR_HOOK('PGD_FIELD_2D',1,ZHOOK_HANDLE)
!
!-------------------------------------------------------------------------------
!
END SUBROUTINE PGD_FIELD_2D
