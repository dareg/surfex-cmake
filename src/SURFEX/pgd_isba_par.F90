!     #########
      SUBROUTINE PGD_ISBA_PAR (DTCO, UG, U, USS, DTV, IO, S, KDIM, &
                               HPROGRAM)
!     ##############################################################
!
...
CALL INI_VAR_FROM_DATA(DTCO, UG, U, USS, DTV%XPAR_VEGTYPE, &
       ...
       CFTYP_VEGTYPE,XUNIF_VEGTYPE,DTV%XPAR_VEGTYPE,DTV%LDATA_ISBATYPE) 
IF (.NOT. DTV%LDATA_ISBATYPE ) THEN
  DEALLOCATE(DTV%XPAR_VEGTYPE)
  ALLOCATE(DTV%XPAR_VEGTYPE(0,0))
ENDIF
!
IF (.NOT.IO%LECOCLIMAP .AND. .NOT.DTV%LDATA_ISBATYPE) THEN
  !
  WRITE(ILUOUT,*) ' '
  WRITE(ILUOUT,*) '***********************************************************'
  ...
  !
ELSEIF (DTV%LDATA_ISBATYPE) THEN
  !
...
CALL INI_VAR_FROM_DATA(DTCO, UG, U, USS, DTV%XPAR_VEGTYPE, &
                        ...
                        DTV%XPAR_VEG,DTV%LDATA_ISBA)
IF (.NOT. DTV%LDATA_ISBA) DEALLOCATE(DTV%XPAR_VEG)
!
...
IF (.NOT. DTV%LDATA_LAI) DEALLOCATE(DTV%XPAR_LAI)
!
...
IF (.NOT. DTV%LDATA_H_VEG) DEALLOCATE(DTV%XPAR_H_VEG)
!
...
IF (.NOT. DTV%LDATA_Z0) DEALLOCATE(DTV%XPAR_Z0)
!
...
IF (.NOT. DTV%LDATA_EMIS) DEALLOCATE(DTV%XPAR_EMIS)
!
IF (.NOT.IO%LECOCLIMAP .AND. .NOT.(DTV%LDATA_ISBA .AND. DTV%LDATA_LAI .AND. DTV%LDATA_Z0 .AND. DTV%LDATA_EMIS)) THEN
  !
  WRITE(ILUOUT,*) ' '
  WRITE(ILUOUT,*) '***********************************************************'
  WRITE(ILUOUT,*) '* Error in PGD field preparation of temporal fields       *'
  WRITE(ILUOUT,*) '* There is no prescribed value and no input file :        *'
  IF (.NOT.DTV%LDATA_ISBA ) WRITE(ILUOUT,*) '* for VEG                            *'
  IF (.NOT.DTV%LDATA_LAI ) WRITE(ILUOUT,*) '* for LAI                            *'
  IF (.NOT.DTV%LDATA_Z0  ) WRITE(ILUOUT,*) '* for Z0                             *'
  IF (.NOT.DTV%LDATA_EMIS) WRITE(ILUOUT,*) '* for EMIS                           *'
...
CALL INI_VAR_FROM_DATA(DTCO, UG, U, USS, DTV%XPAR_VEGTYPE, &
  ...
  IF (.NOT. DTV%LDATA_GNDLITTER) DEALLOCATE(DTV%XPAR_GNDLITTER)
  !
...
CALL INI_VAR_FROM_DATA(DTCO, UG, U, USS, DTV%XPAR_VEGTYPE, &
  ...
  IF (.NOT. DTV%LDATA_Z0LITTER) DEALLOCATE(DTV%XPAR_Z0LITTER)
  !
ENDIF
! ------------ End MEB parameters ---------------------
!
...
IF (.NOT. DTV%LDATA_DG) DEALLOCATE(DTV%XPAR_DG)
!  
...
IF (.NOT. DTV%LDATA_ROOT_DEPTH) DEALLOCATE(DTV%XPAR_ROOT_DEPTH)
!
...
IF (.NOT. DTV%LDATA_GROUND_DEPTH) DEALLOCATE(DTV%XPAR_GROUND_DEPTH)
!
...
CALL INI_VAR_FROM_DATA(DTCO, UG, U, USS, DTV%XPAR_VEGTYPE, &
        ...
        XUNIF_ROOTFRAC,DTV%XPAR_ROOTFRAC,DTV%LDATA_ROOTFRAC)
  IF (.NOT. DTV%LDATA_ROOTFRAC) DEALLOCATE(DTV%XPAR_ROOTFRAC)
  !
...
CALL INI_VAR_FROM_DATA(DTCO, UG, U, USS, DTV%XPAR_VEGTYPE, &
  ...
  IF (.NOT. DTV%LDATA_ROOT_EXTINCTION) DEALLOCATE(DTV%XPAR_ROOT_EXTINCTION)
  !        
...
CALL INI_VAR_FROM_DATA(DTCO, UG, U, USS, DTV%XPAR_VEGTYPE, &
  ...
  IF (.NOT. DTV%LDATA_ROOT_LIN) DEALLOCATE(DTV%XPAR_ROOT_LIN)
  !
  IF (.NOT.IO%LECOCLIMAP) THEN
    IF(DTV%LDATA_DG .AND. .NOT.DTV%LDATA_ROOTFRAC .AND. &
       (.NOT.DTV%LDATA_ROOT_DEPTH.OR..NOT.DTV%LDATA_ROOT_EXTINCTION.OR..NOT.DTV%LDATA_ROOT_LIN)) THEN
      WRITE(ILUOUT,*) ' '
      WRITE(ILUOUT,*) '****************************************************************************'
    ...
    ELSEIF( .NOT.ALL(IO%XSOILGRID(:)==XUNDEF) .AND. &
           (.NOT.DTV%LDATA_GROUND_DEPTH   .OR..NOT.DTV%LDATA_ROOT_DEPTH.OR. &
            .NOT.DTV%LDATA_ROOT_EXTINCTION.OR..NOT.DTV%LDATA_ROOT_LIN  )) THEN
      WRITE(ILUOUT,*) ' '
      WRITE(ILUOUT,*) '****************************************************************************'
      WRITE(ILUOUT,*) '* Without ECOCLIMAP, Error in PGD field preparation for ISBA-DIF           *'
      WRITE(ILUOUT,*) '* There is no prescribed value and no input file.                          *'
      ...
      CALL ABOR1_SFX("PGD_ISBA_PAR: PROBLEM IN SOIL GRID COMPUTATION") 
    ENDIF
    IF(.NOT.DTV%LDATA_DG .AND.ALL(IO%XSOILGRID(:)==XUNDEF))THEN
      WRITE(ILUOUT,*) ' '
      WRITE(ILUOUT,*) '****************************************************************************'
      WRITE(ILUOUT,*) '* Without ECOCLIMAP, Error in PGD field preparation for ISBA-DIF           *'
...
ELSE   
  !
  IF ( .NOT.IO%LECOCLIMAP .AND. .NOT.DTV%LDATA_DG .AND. &
      (.NOT.DTV%LDATA_GROUND_DEPTH.OR..NOT.DTV%LDATA_ROOT_DEPTH) ) THEN
    WRITE(ILUOUT,*) ' '
    WRITE(ILUOUT,*) '****************************************************************************'
...
!
IF (.NOT.IO%LECOCLIMAP.AND..NOT. DTV%LDATA_DICE) THEN
  IF(IO%CISBA/='DIF' .AND. (DTV%LDATA_DG.OR.DTV%LDATA_ROOT_DEPTH)) THEN   
    IF(DTV%LDATA_DG)THEN
      DTV%XPAR_DICE(:,:) = MAX(0.2,0.8*DTV%XPAR_DG(:,2,:))
    ELSEIF(DTV%LDATA_ROOT_DEPTH)THEN
      DTV%XPAR_DICE(:,:) = MAX(0.2,0.8*DTV%XPAR_ROOT_DEPTH(:,:))
    ENDIF
    DTV%LDATA_DICE=.TRUE.
  ...
  ENDIF
ENDIF  
IF (.NOT.DTV%LDATA_DICE) DEALLOCATE(DTV%XPAR_DICE)
!
!---------------------classical fields---------------------------------------------
!
...
IF (.NOT. DTV%LDATA_RSMIN) DEALLOCATE(DTV%XPAR_RSMIN)
!
...
IF (.NOT. DTV%LDATA_GAMMA) DEALLOCATE(DTV%XPAR_GAMMA)
!
...
IF (.NOT. DTV%LDATA_WRMAX_CF) DEALLOCATE(DTV%XPAR_WRMAX_CF)
!
...
IF (.NOT. DTV%LDATA_RGL) DEALLOCATE(DTV%XPAR_RGL)
!
...
IF (.NOT. DTV%LDATA_CV) DEALLOCATE(DTV%XPAR_CV)
!
...
IF (.NOT. DTV%LDATA_Z0_O_Z0H) DEALLOCATE(DTV%XPAR_Z0_O_Z0H)
!
...
IF (.NOT. DTV%LDATA_ALBNIR_VEG) DEALLOCATE(DTV%XPAR_ALBNIR_VEG)
!
...
IF (.NOT. DTV%LDATA_ALBVIS_VEG) DEALLOCATE(DTV%XPAR_ALBVIS_VEG)
!
...
IF (.NOT. DTV%LDATA_ALBUV_VEG) DEALLOCATE(DTV%XPAR_ALBUV_VEG)
!
...
IF (.NOT. DTV%LDATA_ALBNIR_SOIL) DEALLOCATE(DTV%XPAR_ALBNIR_SOIL)
!
...
IF (.NOT. DTV%LDATA_ALBVIS_SOIL) DEALLOCATE(DTV%XPAR_ALBVIS_SOIL)
!
...
IF (.NOT. DTV%LDATA_ALBUV_SOIL) DEALLOCATE(DTV%XPAR_ALBUV_SOIL)
!
IF (.NOT.IO%LECOCLIMAP .AND. .NOT.(DTV%LDATA_RSMIN.AND.DTV%LDATA_GAMMA.AND.DTV%LDATA_WRMAX_CF.AND.DTV%LDATA_RGL &
         .AND.DTV%LDATA_CV.AND.DTV%LDATA_Z0_O_Z0H.AND.DTV%LDATA_ALBNIR_VEG.AND.DTV%LDATA_ALBVIS_VEG.AND.&
         DTV%LDATA_ALBUV_VEG.AND.DTV%LDATA_ALBNIR_SOIL.AND.DTV%LDATA_ALBVIS_SOIL.AND.DTV%LDATA_ALBUV_SOIL)) THEN
  !
  WRITE(ILUOUT,*) ' '
  WRITE(ILUOUT,*) '***********************************************************'
  WRITE(ILUOUT,*) '* Error in PGD field preparation of classical fields      *'
  WRITE(ILUOUT,*) '* There is no prescribed value and no input file :        *'
  IF (.NOT.DTV%LDATA_RSMIN       ) WRITE(ILUOUT,*) '* for RSMIN                  *'
  IF (.NOT.DTV%LDATA_GAMMA       ) WRITE(ILUOUT,*) '* for GAMMA                  *'
  IF (.NOT.DTV%LDATA_WRMAX_CF    ) WRITE(ILUOUT,*) '* for WRMAX_CF               *'
  IF (.NOT.DTV%LDATA_RGL         ) WRITE(ILUOUT,*) '* for RGL                    *'
  IF (.NOT.DTV%LDATA_CV          ) WRITE(ILUOUT,*) '* for CV                     *'
  IF (.NOT.DTV%LDATA_Z0_O_Z0H    ) WRITE(ILUOUT,*) '* for Z0_O_Z0H               *'
  IF (.NOT.DTV%LDATA_ALBNIR_VEG  ) WRITE(ILUOUT,*) '* for ALBNIR_VEG             *'
  IF (.NOT.DTV%LDATA_ALBVIS_VEG  ) WRITE(ILUOUT,*) '* for ALBVIS_VEG             *'
  IF (.NOT.DTV%LDATA_ALBUV_VEG   ) WRITE(ILUOUT,*) '* for ALBUV_VEG              *'
  IF (.NOT.DTV%LDATA_ALBNIR_SOIL ) WRITE(ILUOUT,*) '* for ALBNIR_SOIL            *'
  IF (.NOT.DTV%LDATA_ALBVIS_SOIL ) WRITE(ILUOUT,*) '* for ALBVIS_SOIL            *'
  IF (.NOT.DTV%LDATA_ALBUV_SOIL  ) WRITE(ILUOUT,*) '* for ALBUV_SOIL             *'
  WRITE(ILUOUT,*) '* Without ECOCLIMAP, these fields must be prescribed      *'
  WRITE(ILUOUT,*) '***********************************************************'
  WRITE(ILUOUT,*) ' '
...
!--------------------------------------AGS parameters----------------------------
!
IF (IO%CPHOTO/='NON' .OR. (.NOT.DTV%LDATA_Z0.AND.(DTV%LDATA_LAI.OR.DTV%LDATA_ISBATYPE)) .OR. ISIZE_LMEB_PATCH>0) THEN
  !
...
CALL INI_VAR_FROM_DATA(DTCO, UG, U, USS, DTV%XPAR_VEGTYPE, &
  ...
  IF (.NOT. DTV%LDATA_H_TREE) DEALLOCATE(DTV%XPAR_H_TREE)
  !
ENDIF
...
CALL INI_VAR_FROM_DATA(DTCO, UG, U, USS, DTV%XPAR_VEGTYPE, &
  ...
  IF (.NOT. DTV%LDATA_BSLAI) DEALLOCATE(DTV%XPAR_BSLAI)
ENDIF
!
IF (.NOT.IO%LECOCLIMAP .AND. ISIZE_LMEB_PATCH>0 .AND. .NOT.(DTV%LDATA_H_TREE      &
         .AND. DTV%LDATA_GNDLITTER .AND. DTV%LDATA_Z0LITTER  &
         .AND. DTV%LDATA_BSLAI))THEN
  WRITE(ILUOUT,*) ' '
  WRITE(ILUOUT,*) '***********************************************************'
  WRITE(ILUOUT,*) '* Error in PGD field preparation of MEB fields            *'
  WRITE(ILUOUT,*) '* There is no prescribed value and no input file :        *'
  IF (.NOT.DTV%LDATA_GNDLITTER   ) WRITE(ILUOUT,*) '* for GNDLITTER              *'
  IF (.NOT.DTV%LDATA_Z0LITTER    ) WRITE(ILUOUT,*) '* for Z0LITTER               *'
  IF (.NOT.DTV%LDATA_H_TREE      ) WRITE(ILUOUT,*) '* for H_TREE                 *'
  IF (.NOT.DTV%LDATA_BSLAI       ) WRITE(ILUOUT,*) '* for BSLAI                  *'
  WRITE(ILUOUT,*) '* Without ECOCLIMAP, these fields must be prescribed      *'
  WRITE(ILUOUT,*) '***********************************************************'
  WRITE(ILUOUT,*) ' '
...
CALL INI_VAR_FROM_DATA(DTCO, UG, U, USS, DTV%XPAR_VEGTYPE, &
  ...
  IF (.NOT. DTV%LDATA_RE25) DEALLOCATE(DTV%XPAR_RE25)  
  !
...
CALL INI_VAR_FROM_DATA(DTCO, UG, U, USS, DTV%XPAR_VEGTYPE, &
  ...
  IF (.NOT. DTV%LDATA_LAIMIN) DEALLOCATE(DTV%XPAR_LAIMIN)          
  !
...
CALL INI_VAR_FROM_DATA(DTCO, UG, U, USS, DTV%XPAR_VEGTYPE, &
  ...
  IF (.NOT. DTV%LDATA_SEFOLD) DEALLOCATE(DTV%XPAR_SEFOLD)
  !  
...
CALL INI_VAR_FROM_DATA(DTCO, UG, U, USS, DTV%XPAR_VEGTYPE, &
  ...
  IF (.NOT. DTV%LDATA_GMES) DEALLOCATE(DTV%XPAR_GMES)
  !
...
CALL INI_VAR_FROM_DATA(DTCO, UG, U, USS, DTV%XPAR_VEGTYPE, &
  ...
  IF (.NOT. DTV%LDATA_GC) DEALLOCATE(DTV%XPAR_GC)
  !
  IF (.NOT.IO%LECOCLIMAP .AND. .NOT.(DTV%LDATA_H_TREE.AND.DTV%LDATA_RE25.AND.DTV%LDATA_LAIMIN.AND.&
           DTV%LDATA_BSLAI.AND.DTV%LDATA_SEFOLD.AND.DTV%LDATA_GMES.AND.DTV%LDATA_GC)) THEN
    !
    WRITE(ILUOUT,*) ' '
    WRITE(ILUOUT,*) '***********************************************************'
    ...
    WRITE(ILUOUT,*) '* There is no prescribed value and no input file :        *'
    IF (.NOT.DTV%LDATA_H_TREE ) WRITE(ILUOUT,*) '* for H_TREE                      *'
    IF (.NOT.DTV%LDATA_RE25   ) WRITE(ILUOUT,*) '* for RE25                        *'    
    IF (.NOT.DTV%LDATA_LAIMIN ) WRITE(ILUOUT,*) '* for LAIMIN                      *'    
    IF (.NOT.DTV%LDATA_BSLAI  ) WRITE(ILUOUT,*) '* for BSLAI                       *'
    IF (.NOT.DTV%LDATA_SEFOLD ) WRITE(ILUOUT,*) '* for SEFOLD                      *'
    IF (.NOT.DTV%LDATA_GMES   ) WRITE(ILUOUT,*) '* for GMES                        *'
    IF (.NOT.DTV%LDATA_GC     ) WRITE(ILUOUT,*) '* for GC                          *'
    WRITE(ILUOUT,*) '* Without ECOCLIMAP, these fields must be prescribed      *'
    WRITE(ILUOUT,*) '***********************************************************'
    WRITE(ILUOUT,*) ' '
...
CALL INI_VAR_FROM_DATA(DTCO, UG, U, USS, DTV%XPAR_VEGTYPE, &
    ...
    IF (.NOT. DTV%LDATA_F2I) DEALLOCATE(DTV%XPAR_F2I)
    !
...
CALL INI_VAR_FROM_DATA(DTCO, UG, U, USS, DTV%XPAR_VEGTYPE, &
    ...
    IF (.NOT. DTV%LDATA_DMAX) DEALLOCATE(DTV%XPAR_DMAX)
    !
    ALLOCATE(DTV%LPAR_STRESS      (KDIM,NVEGTYPE))
    DO JVEGTYPE=1,NVEGTYPE
      GPAR_STRESS = LUNIF_STRESS(JVEGTYPE)
      IF (XSTRESS(JVEGTYPE)<1.) GPAR_STRESS = .FALSE.
      IF (XSTRESS(JVEGTYPE)==1. .AND. .NOT.GPAR_STRESS) DTV%LDATA_STRESS=.TRUE.
      DTV%LPAR_STRESS(:,JVEGTYPE) = GPAR_STRESS
    ENDDO
    IF (.NOT. DTV%LDATA_STRESS) DEALLOCATE(DTV%LPAR_STRESS)
    !
    IF (.NOT.IO%LECOCLIMAP .AND. .NOT.(DTV%LDATA_F2I.AND.DTV%LDATA_DMAX)) THEN
      !
      WRITE(ILUOUT,*) ' '
      WRITE(ILUOUT,*) '***********************************************************'
      WRITE(ILUOUT,*) '* Error in PGD field preparation of AGS Stress fields     *'
      WRITE(ILUOUT,*) '* There is no prescribed value and no input file :        *'
      IF (.NOT.DTV%LDATA_F2I  ) WRITE(ILUOUT,*) '* for F2I                           *'
      IF (.NOT.DTV%LDATA_DMAX ) WRITE(ILUOUT,*) '* for DMAX                          *'
      WRITE(ILUOUT,*) '* Without ECOCLIMAP, these fields must be prescribed      *'
      WRITE(ILUOUT,*) '***********************************************************'
      WRITE(ILUOUT,*) ' '
...
CALL INI_VAR_FROM_DATA(DTCO, UG, U, USS, DTV%XPAR_VEGTYPE, &
      ...
      IF (.NOT. DTV%LDATA_CE_NITRO) DEALLOCATE(DTV%XPAR_CE_NITRO)
      !
...
CALL INI_VAR_FROM_DATA(DTCO, UG, U, USS, DTV%XPAR_VEGTYPE, &
      ...
      IF (.NOT. DTV%LDATA_CF_NITRO) DEALLOCATE(DTV%XPAR_CF_NITRO)
      !
...
CALL INI_VAR_FROM_DATA(DTCO, UG, U, USS, DTV%XPAR_VEGTYPE, &
      ...
      IF (.NOT. DTV%LDATA_CNA_NITRO) DEALLOCATE(DTV%XPAR_CNA_NITRO)
      !
      IF (.NOT.IO%LECOCLIMAP .AND. .NOT.(DTV%LDATA_CE_NITRO.AND.DTV%LDATA_CF_NITRO.AND.DTV%LDATA_CNA_NITRO)) THEN
        !
        WRITE(ILUOUT,*) ' '
        WRITE(ILUOUT,*) '***********************************************************'
        WRITE(ILUOUT,*) '* Error in PGD field preparation of AGS Nitrogen fields   *'
        WRITE(ILUOUT,*) '* There is no prescribed value and no input file :        *'
        IF (.NOT.DTV%LDATA_CE_NITRO  ) WRITE(ILUOUT,*) '* for CE_NITRO                 *'
        IF (.NOT.DTV%LDATA_CF_NITRO  ) WRITE(ILUOUT,*) '* for CF_NITRO                 *'
        IF (.NOT.DTV%LDATA_CNA_NITRO ) WRITE(ILUOUT,*) '* for CNA_NITRO                *'
        WRITE(ILUOUT,*) '* Without ECOCLIMAP, these fields must be prescribed      *'
        WRITE(ILUOUT,*) '***********************************************************'
        WRITE(ILUOUT,*) ' '
...
!----------------------------------------------------------------------------------------
!
IF (IO%LECOCLIMAP .AND. DTV%LDATA_ISBATYPE) THEN
  !  
