!     #########
      SUBROUTINE PGD_TEB_GREENROOF (DTCO, UG, U, USS, GRO, GRP, GRTI, KDIM, HPROGRAM)
!     ##############################################################
!
...
GRO%CISBA  = 'DIF'
GRO%CSCOND = 'PL98 ' ! CSCOND_GR = 'PL98' !begin test 29092011 ! normalement pas besoin
GRO%CHORT  = 'DEF '
GRO%CKSAT  = 'DEF '
GRO%LSOC   = .FALSE.
GRO%LTR_ML = .FALSE.
...
GRO%LPAR = .TRUE.
!
CALL PGD_TEB_GREENROOF_PAR(DTCO, GRTI, UG, U, USS, GRO, GRP, KDIM, HPROGRAM)
!
!
