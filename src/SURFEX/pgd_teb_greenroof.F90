...
USE MODD_TEB_OPTION_n,         ONLY : LECOCLIMAP, XCOVER, LCOVER, XZS
USE MODD_TEB_GRID_n,           ONLY : NDIM
USE MODD_TEB_VEG_n,            ONLY : CPEDOTF, CPHOTO, NNBIOMASS
USE MODD_TEB_GREENROOF_OPTION_n,ONLY: LTR_ML_GR, NLAYER_GR, NTIME_GR, CISBA_GR, &
                                      CSCOND_GR, CHORT_GR, CKSAT_GR, LSOC_GR
