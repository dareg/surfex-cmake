!     #########
      SUBROUTINE PGD_TEB_GREENROOF_PAR (DTCO, DTGR, UG, U, USS, TGRO, TGRP, KDIM, HPROGRAM)
!     ##############################################################
!
...
!
!
ALLOCATE(TGRP%XSOC       (KDIM,TGRO%NGROUND_LAYER))
ALLOCATE(TGRP%XCLAY      (KDIM,TGRO%NGROUND_LAYER))
ALLOCATE(TGRP%XSAND      (KDIM,TGRO%NGROUND_LAYER))
ALLOCATE(DTGR%XPAR_LAI   (KDIM,DTGR%NTIME ,1))
!
!-------------------------------------------------------------------------------
!
