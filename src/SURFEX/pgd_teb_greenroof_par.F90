!     #########
      SUBROUTINE PGD_TEB_GREENROOF_PAR (DTCO, DTGR, UG, U, USS, TGRO, TGRP, TG, &
                                        HPROGRAM)
!     ##############################################################
!
...
!
DTGR%NTIME              = ITIME_GR
TGRO%NGROUND_LAYER      = ILAYER_GR
TGRO%CTYP_COV           = YTYP_GR
!
!*           Coherence of options for the green roof type
!             -------------------------------------------
!
 CALL TEST_NAM_VAR_SURF(ILUOUT,'CTYP_GR',TGRO%CTYP_COV,'GRASS','SEDUM')
!
!
