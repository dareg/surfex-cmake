!     #########
      SUBROUTINE PGD_TEB_PAR (DTCO, DGU, IOB, UG, U, USS, BDD, DTT, DTI, TG, &
...
CALL INI_VAR_FROM_DATA_0D(DTCO, DGU, IOB, UG, U, USS, &
...
!
CALL INI_VAR_FROM_DATA(DTCO, DGU, IOB, UG, U, USS, DTI, &
