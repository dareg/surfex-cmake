...
!     #########
      SUBROUTINE PGD_TEB_PAR (DTCO, UG, U, USS, BDD, DTT, PPAR_TYPE, KDIM, &
...
REAL, DIMENSION(:,:), INTENT(IN) :: PPAR_TYPE
!
...
CALL INI_VAR_FROM_DATA(DTCO, UG, U, USS, PPAR_TYPE, HPROGRAM,CBLD_ATYPE,'HC_ROOF  ','TWN',&
...
CALL INI_VAR_FROM_DATA(DTCO, UG, U, USS, PPAR_TYPE, HPROGRAM,CBLD_ATYPE,'TC_ROOF  ','TWN',&
...
CALL INI_VAR_FROM_DATA(DTCO, UG, U, USS, PPAR_TYPE, HPROGRAM,CBLD_ATYPE,'D_ROOF   ','TWN',&
...
CALL INI_VAR_FROM_DATA(DTCO, UG, U, USS, PPAR_TYPE, &
