...
!
USE MODD_TYPE_SNOW, ONLY: SURF_SNOW, NSURF_SNOW
...
USE MODD_PREP_SNOW,      ONLY : XGRID_SNOW,NIMPUR, XRM_LITTLE_SNOW
...
!
IF (XRM_LITTLE_SNOW.GT.0.0.AND.HFILETYPE.NE.'GRIB  ') THEN
  CALL ABOR1_SFX('PREP_HOR_SNOW_FIELD: XRM_LITTLE_SNOW supported only for GRIBs')
END IF
!
