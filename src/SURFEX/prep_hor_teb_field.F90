...
IF (HSURF=='SN_ROOF') THEN
  ...
  ALLOCATE(ZIMPURSNOW(SIZE(XWSNOW_ROOF)))
  ...
  CALL PREP_HOR_SNOW_FIELDS(DTCO, &
                            ...
                            ZSG2SNOW, ZHISTSNOW, ZAGESNOW, ZIMPURSNOW,ZIMPURSNOWV2)
  DEALLOCATE(ZSG1SNOW)
  DEALLOCATE(ZSG2SNOW)
...
ELSE IF (HSURF=='SN_ROAD') THEN
  ...
  ALLOCATE(ZIMPURSNOW(SIZE(XWSNOW_ROAD)))
  ...
  CALL PREP_HOR_SNOW_FIELDS(DTCO, &
                            ...
                            ZIMPURSNOW,ZIMPURSNOWV2)
  DEALLOCATE(ZSG1SNOW)
  DEALLOCATE(ZSG2SNOW)
  DEALLOCATE(ZHISTSNOW)
  DEALLOCATE(ZAGESNOW)                           
  DEALLOCATE(ZIMPURSNOW,ZIMPURSNOWV2)
  IF (LHOOK) CALL DR_HOOK('PREP_HOR_TEB_FIELD',1,ZHOOK_HANDLE)
  RETURN
END IF
!
