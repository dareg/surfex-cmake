...
IF (U%CWATER=='WATFLX') THEN
  CALL PREP_WATFLUX(DTCO, UG, U, WM%G, WM%W, WM%SB, HPROGRAM,HATMFILE,HATMFILETYPE,HPGDFILE,HPGDFILETYPE)
ELSE IF (U%CWATER=='FLAKE ') THEN
  CALL PREP_FLAKE(DTCO, USS, FM%G, FM%F, FM%SB, UG, U, HPROGRAM,HATMFILE,HATMFILETYPE,HPGDFILE,HPGDFILETYPE)
END IF
