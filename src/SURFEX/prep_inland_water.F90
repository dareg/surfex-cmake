...
IF (U%CWATER=='WATFLX') THEN
  CALL PREP_WATFLUX(DTCO, UG, U, WM%WG, WM%W, WM%WSB, HPROGRAM,HATMFILE,HATMFILETYPE,HPGDFILE,HPGDFILETYPE)
ELSE IF (U%CWATER=='FLAKE ') THEN
  CALL PREP_FLAKE(DTCO, USS, FM%FG, FM%F, FM%FSB, UG, U, HPROGRAM,HATMFILE,HATMFILETYPE,HPGDFILE,HPGDFILETYPE)
END IF
