!     #########
SUBROUTINE PREP_TEB (DTCO, UG, U, USS, TM, GDM, GRM, &
...
!
 CALL PREP_HOR_TEB_FIELD(TM%B, TM%BOP, DTCO, U, TM%TG, TM%T, TM%TOP, &
...
DO JPATCH=1,TM%TOP%NTEB_PATCH
  ...
  IF (TM%TOP%LGARDEN)    CALL PREP_TEB_GARDEN(DTCO, UG, U, USS, &
                                              TM%TG, TM%TOP, GDM,  &
                                              HPROGRAM,HATMFILE,HATMFILETYPE,HPGDFILE,HPGDFILETYPE, JPATCH)
  IF (TM%TOP%LGREENROOF) CALL PREP_TEB_GREENROOF(DTCO, UG, U, USS, &
                                                 TM%TG, TM%T, TM%TOP, GRM, &
                                              HPROGRAM,HATMFILE,HATMFILETYPE,HPGDFILE,HPGDFILETYPE, JPATCH)
  !  
ENDDO
!
