!     #########
SUBROUTINE PREP_TEB (DTCO, IOB, UG, U, USS, IG, I, TM, GDM, GRM, &
...
!
 CALL PREP_HOR_TEB_FIELD(TM%B, TM%BOP, DTCO, IOB, IG, U, TM%TG, TM%T, TM%TOP, &
...
DO JPATCH=1,TM%TOP%NTEB_PATCH
  ...
  IF (TM%TOP%LGARDEN)    CALL PREP_TEB_GARDEN(DTCO, IOB, UG, U, USS, IG, I, &
                                              TM%TG, TM%TOP, GDM,  &
                                              HPROGRAM,HATMFILE,HATMFILETYPE,HPGDFILE,HPGDFILETYPE)
  IF (TM%TOP%LGREENROOF) CALL PREP_TEB_GREENROOF(DTCO, IOB, UG, U, USS, IG, I, &
