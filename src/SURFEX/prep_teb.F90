...
CALL PREP_HOR_TEB_FIELD(HPROGRAM,'T_WALL ',HATMFILE,HATMFILETYPE,HPGDFILE,HPGDFILETYPE)
...
!*      5.     Urban green areas
!
IF (LGARDEN) CALL PREP_TEB_GARDEN(HPROGRAM,HATMFILE,HATMFILETYPE,HPGDFILE,HPGDFILETYPE,LTEB_CANOPY)
!
DEALLOCATE(XZS_LS)
!-------------------------------------------------------------------------------------
