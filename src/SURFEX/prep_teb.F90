!     #########
SUBROUTINE PREP_TEB (DTCO, UG, U, USS, IG, TM, GDM, GRM, &
...
DO JPATCH=1,TM%TOP%NTEB_PATCH
  ...
  IF (TM%TOP%LGARDEN)    CALL PREP_TEB_GARDEN(DTCO, UG, U, USS, IG, &
                                              TM%TG, TM%TOP, GDM,  &
                                              HPROGRAM,HATMFILE,HATMFILETYPE,HPGDFILE,HPGDFILETYPE, JPATCH)
  IF (TM%TOP%LGREENROOF) CALL PREP_TEB_GREENROOF(DTCO, UG, U, USS, IG, &
