...
!
    CASE('T_ROAD','T_ROOF','T_WALLA','T_WALLB','T_FLOOR','T_MASS')
      ...
      IF (YSURF=='T_ROAD') CALL GET_TEB_DEPTHS(HFILEPGD,HFILEPGDTYPE,PD_ROAD=ZD)
      IF (YSURF=='T_ROOF') CALL GET_TEB_DEPTHS(HFILEPGD,HFILEPGDTYPE,PD_ROOF=ZD)
      IF (YSURF=='T_WALL') CALL GET_TEB_DEPTHS(HFILEPGD,HFILEPGDTYPE,PD_WALL=ZD)
      IF (YSURF=='T_WALLA') CALL GET_TEB_DEPTHS(HFILEPGD,HFILEPGDTYPE,PD_WALL=ZD)
      IF (YSURF=='T_WALLB') CALL GET_TEB_DEPTHS(HFILEPGD,HFILEPGDTYPE,PD_WALL=ZD)
      IF (YSURF=='T_MASS') CALL GET_TEB_DEPTHS(HFILEPGD,HFILEPGDTYPE,PD_FLOOR=ZD)
      IF (YSURF=='T_FLOO') CALL GET_TEB_DEPTHS(HFILEPGD,HFILEPGDTYPE,PD_FLOOR=ZD)
      !
