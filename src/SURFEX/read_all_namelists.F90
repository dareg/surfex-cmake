...
! 
  ...
  CALL READ_NAMELISTS_SURF_n(YSC%CHU, YSC%DGU, YSC%USS, &
                             HPROGRAM,HINIT)
  !
  CALL READ_NAMELISTS_FLAKE_n(YSC%CHF, YSC%DGF, YSC%DGMF, YSC%F, &
                              HPROGRAM,HINIT)
  CALL READ_NAMELISTS_WATFLUX_n(YSC%CHW, YSC%DGW, YSC%W, &
                                HPROGRAM,HINIT)
  CALL READ_NAMELISTS_SEAFLUX_n(YSC%CHS, YSC%DGO, YSC%DGS, YSC%DGSI, YSC%O, YSC%S, &
                                HPROGRAM,HINIT)
  CALL READ_NAMELISTS_ISBA_n(YSC%CHI, YSC%DGEI, YSC%DGI, YSC%DGMI, YSC%I, &
                             HPROGRAM,HINIT)
  CALL READ_NAMELISTS_TEB_n(YSC%CHT, YSC%DGMTO, YSC%DGT, YSC%DGUT, YSC%TGRO, YSC%T, YSC%TOP, YSC%TVG, &
                            HPROGRAM,HINIT)
