...
SELECT CASE (HGRID)
  ...
  CASE ("LONLAT REG")
    CALL READ_GRIDTYPE_LONLAT_REG(HPROGRAM,KGRID_PAR,KLU,OREAD,IGRID_PAR,ZGRID_PAR,IRESP)

  CASE ("GAUSS     ")
    CALL READ_GRIDTYPE_GAUSS(HPROGRAM,KGRID_PAR,KLU,OREAD,IGRID_PAR,ZGRID_PAR,IRESP)

  CASE ("IGN       ")
    CALL READ_GRIDTYPE_IGN(HPROGRAM,KGRID_PAR,KLU,OREAD,IGRID_PAR,ZGRID_PAR,IRESP)

  CASE ("LONLATVAL ")
    CALL READ_GRIDTYPE_LONLATVAL(HPROGRAM,KGRID_PAR,KLU,OREAD,IGRID_PAR,ZGRID_PAR,IRESP)
