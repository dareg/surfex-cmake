...
SELECT CASE (HGRID)
  ...
  CASE ("CONF PROJ ")
    CALL READ_GRIDTYPE_CONF_PROJ(IOB, &
                                 HPROGRAM,KGRID_PAR,KLU,OREAD,IGRID_PAR,ZGRID_PAR,IRESP,YDIR)

  CASE ("CARTESIAN ")
    CALL READ_GRIDTYPE_CARTESIAN(IOB, &
                                 HPROGRAM,KGRID_PAR,KLU,OREAD,IGRID_PAR,ZGRID_PAR,IRESP,YDIR)

  CASE ("LONLAT REG")
    CALL READ_GRIDTYPE_LONLAT_REG(IOB, &
                                  HPROGRAM,KGRID_PAR,KLU,OREAD,IGRID_PAR,ZGRID_PAR,IRESP,YDIR)

  CASE ("GAUSS     ")
    CALL READ_GRIDTYPE_GAUSS(IOB, &
                             HPROGRAM,KGRID_PAR,KLU,OREAD,IGRID_PAR,ZGRID_PAR,IRESP,YDIR)

  CASE ("IGN       ")
    CALL READ_GRIDTYPE_IGN(IOB, &
                           HPROGRAM,KGRID_PAR,KLU,OREAD,IGRID_PAR,ZGRID_PAR,IRESP,YDIR)

  CASE ("LONLATVAL ")
    CALL READ_GRIDTYPE_LONLATVAL(IOB, &
                                 HPROGRAM,KGRID_PAR,KLU,OREAD,IGRID_PAR,ZGRID_PAR,IRESP,YDIR)

  CASE ("LONLAT ROT")
    CALL READ_GRIDTYPE_LONLAT_ROT(IOB, &
                                  HPROGRAM,KGRID_PAR,KLU,OREAD,IGRID_PAR,ZGRID_PAR,IRESP,YDIR)
