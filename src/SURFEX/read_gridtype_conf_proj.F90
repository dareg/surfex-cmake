...
CALL READ_SURF(HPROGRAM,'LAT0',ZLAT0,KRESP)
CALL READ_SURF(HPROGRAM,'LON0',ZLON0,KRESP)
CALL READ_SURF(HPROGRAM,'RPK ',ZRPK, KRESP)
CALL READ_SURF(HPROGRAM,'BETA',ZBETA,KRESP)
!
!---------------------------------------------------------------------------
!
...
!              ------------------------------
!
CALL READ_SURF(HPROGRAM,'LATORI',ZLATORI,KRESP)
CALL READ_SURF(HPROGRAM,'LONORI',ZLONORI,KRESP)
CALL READ_SURF(HPROGRAM,'IMAX ',IIMAX, KRESP)
CALL READ_SURF(HPROGRAM,'JMAX ',IJMAX, KRESP)
!
