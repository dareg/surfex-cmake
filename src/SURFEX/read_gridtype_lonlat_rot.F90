...
IF (LHOOK) CALL DR_HOOK('READ_GRIDTYPE_LONLAT_ROT',0,ZHOOK_HANDLE)
 ...
 CALL READ_SURF(HPROGRAM,'WEST',ZWEST,KRESP,HDIR=HDIR)
 CALL READ_SURF(HPROGRAM,'SOUTH',ZSOUTH,KRESP,HDIR=HDIR)
 CALL READ_SURF(HPROGRAM,'DLON',ZDLON,KRESP,HDIR=HDIR)
 CALL READ_SURF(HPROGRAM,'DLAT',ZDLAT,KRESP,HDIR=HDIR)
 CALL READ_SURF(HPROGRAM,'POLON',ZPOLON,KRESP,HDIR=HDIR)
 CALL READ_SURF(HPROGRAM,'POLAT',ZPOLAT,KRESP,HDIR=HDIR)
