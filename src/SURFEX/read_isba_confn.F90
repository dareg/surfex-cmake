...
!
 ...
 CALL TEST_NAM_VAR_SURF(ILUOUT,'CSNOWRES',CSNOWRES,'DEF','RIL','M98','RI2','M99')
 ...
 !
 CALL TEST_NAM_VAR_SURF(ILUOUT,'CSNOWMETAMO',CSNOWMETAMO,'B92','C13','F06','T07','F16')
 ! New options Cluzet et al 2016
 CALL TEST_NAM_VAR_SURF(ILUOUT,'CSNOWRAD',CSNOWRAD,'B92','B93','TAR','TA1','TA2','TA3','TA4')
 ! New options Cluzet et al 2016
 CALL TEST_NAM_VAR_SURF(ILUOUT,'CSNOWFALL',CSNOWFALL,'V12','S02','A76','P75') 
 CALL TEST_NAM_VAR_SURF(ILUOUT,'CSNOWCOND',CSNOWCOND,'Y81', 'I02','C11')
 CALL TEST_NAM_VAR_SURF(ILUOUT,'CSNOWHOLD',CSNOWHOLD,'B92', 'S02','O04','B02')
 CALL TEST_NAM_VAR_SURF(ILUOUT,'CSNOWCOMP',CSNOWCOMP,'B92', 'B93')
 !bber>
 ! 
 !* close namelist file
 !
