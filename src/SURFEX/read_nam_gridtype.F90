!     #########
      SUBROUTINE READ_NAM_GRIDTYPE(UG,U,HPROGRAM,HGRID,KGRID_PAR,PGRID_PAR,KL,HDIR)
!     ##########################################################
!!
!!    PURPOSE
!!    -------
...
!
  CASE ('CONF PROJ ','LONLAT REG','CARTESIAN ','GAUSS     ','IGN       ','LONLATVAL ','LONLAT ROT')
    ...
    IF (HGRID=='CONF PROJ ')&
      CALL READ_NAM_GRID_CONF_PROJ(UG,U,HPROGRAM,KGRID_PAR,KL,PGRID_PAR,YDIR)  
    IF (HGRID=='CARTESIAN ')&
      CALL READ_NAM_GRID_CARTESIAN(UG,U,HPROGRAM,KGRID_PAR,KL,PGRID_PAR,YDIR)  
    IF (HGRID=='LONLAT REG')&
      CALL READ_NAM_GRID_LONLAT_REG(UG,U,HPROGRAM,KGRID_PAR,KL,PGRID_PAR,YDIR)  
    IF (HGRID=='GAUSS     ')&
      CALL READ_NAM_GRID_GAUSS(UG,U,HPROGRAM,KGRID_PAR,KL,PGRID_PAR,YDIR)  
    IF (HGRID=='IGN       ')&
      CALL READ_NAM_GRID_IGN(UG,U,HPROGRAM,KGRID_PAR,KL,PGRID_PAR,YDIR)  
    IF (HGRID=='LONLATVAL ')&
      CALL READ_NAM_GRID_LONLATVAL(UG,U,HPROGRAM,KGRID_PAR,KL,PGRID_PAR,YDIR)      
    IF (HGRID=='LONLAT ROT')&
      CALL READ_NAM_GRID_LONLAT_ROT(UG,U,HPROGRAM,KGRID_PAR,KL,PGRID_PAR,YDIR)  
