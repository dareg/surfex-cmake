...
CALL DEFAULT_SEAFLUX(XTSTEP,XOUT_TSTEP,CSEA_ALB,CSEA_FLUX,LPWG,         &
                     ...
                     NTIME_COUPLING,XOCEAN_TSTEP,XCMO_COEF,XICHCE,CINTERPOL_SST,&
                     CINTERPOL_SSS)
!               
CALL DEFAULT_SEAICE(HPROGRAM, CINTERPOL_SIC, CINTERPOL_SIT,CONSTRAIN_CSV,  &
                    XFREEZING_SST,XSEAICE_TSTEP, XSIC_EFOLDING_TIME,       &
                    XSIT_EFOLDING_TIME, XCD_ICE_CST, XSI_FLX_DRV, LVOLATILE_SIC)
!
CALL DEFAULT_CH_DEP(CCH_DRY_DEP)
!
CALL DEFAULT_DIAG_SEAFLUX(N2M,LSURF_BUDGET,L2M_MIN_ZS,LHU2M_QSAT,LRAD_BUDGET,LCOEF,LSURF_VARS,&
