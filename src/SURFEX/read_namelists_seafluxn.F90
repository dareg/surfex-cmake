...
IF (LHOOK) CALL DR_HOOK('READ_NAMELISTS_SEAFLUX_N',0,ZHOOK_HANDLE)
 CALL DEFAULT_SEAFLUX(XTSTEP,XOUT_TSTEP,CSEA_ALB,CSEA_FLUX,LPWG,         &
                        ...
                        NTIME_COUPLING,XICHCE,CINTERPOL_SST,CINTERPOL_SSS)
 CALL DEFAULT_SEAICE(HPROGRAM, CSEAICE_SCHEME, CINTERPOL_SIC,               &
                     CINTERPOL_SIT, XFREEZING_SST,XSEAICE_TSTEP,            &
                     XSIC_EFOLDING_TIME, XSIT_EFOLDING_TIME, XCD_ICE_CST,   &
                     XSI_FLX_DRV)     
!               
