!     #########
      SUBROUTINE READ_PGD_FLAKE_n (DTCO, U, UG, FG, F, &
                                   HPROGRAM)
!     #########################################
!
...
CALL PACK_INIT(DTCO, U, UG,HPROGRAM,'WATER ',FG%CGRID,FG%XGRID_PAR,     &
               F%LCOVER,F%XCOVER,F%XZS,FG%XLAT,FG%XLON,FG%XMESH_SIZE)
!
!* FLake parameters
!
