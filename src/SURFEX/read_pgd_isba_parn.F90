...
!     #########
      SUBROUTINE READ_PGD_ISBA_PAR_n (DTCO, U, DTI, KDIM, IO, &
...
INTEGER           :: IENDT, IEND, ID1, ID2, ITIME0
!
LOGICAL :: GREAD_ALL, GFLAG
!
...
ENDIF
!
ALLOCATE(DTI%LDATA_VEG        (ITIME*NVEGTYPE))
ALLOCATE(DTI%LDATA_LAI        (ITIME*NVEGTYPE))
ALLOCATE(DTI%LDATA_Z0         (ITIME*NVEGTYPE))
ALLOCATE(DTI%LDATA_EMIS       (ITIME*NVEGTYPE))
ALLOCATE(DTI%LDATA_ALBNIR_VEG (ITIME*NVEGTYPE))
ALLOCATE(DTI%LDATA_ALBVIS_VEG (ITIME*NVEGTYPE))
ALLOCATE(DTI%LDATA_ALBUV_VEG  (ITIME*NVEGTYPE))
ALLOCATE(DTI%LDATA_ALBNIR_SOIL(ITIME*NVEGTYPE))
ALLOCATE(DTI%LDATA_ALBVIS_SOIL(ITIME*NVEGTYPE))
ALLOCATE(DTI%LDATA_ALBUV_SOIL (ITIME*NVEGTYPE))
ALLOCATE(DTI%LDATA_IRRIG      (ITIME*NVEGTYPE))
ALLOCATE(DTI%LDATA_WATSUP     (ITIME*NVEGTYPE))
DTI%LDATA_VEG        (:) = .FALSE.
DTI%LDATA_LAI        (:) = .FALSE.
DTI%LDATA_Z0         (:) = .FALSE.
...
ENDIF
!
ALLOCATE(DTI%LDATA_GNDLITTER(ITIME*NVEGTYPE))
ALLOCATE(DTI%LDATA_Z0LITTER (ITIME*NVEGTYPE))
ALLOCATE(DTI%LDATA_H_VEG    (ITIME*NVEGTYPE))
...
IF (.NOT.OLAND_USE) THEN
  ...
  !
  IF (.NOT.GFLAG .AND. ( ANY(DTI%LDATA_LAI) .OR. ANY(DTI%LDATA_VEG) .OR. &
  ...
  IF (DTI%LDATA_VEGTYPE) THEN
    ...
    IF (KDIM/=KSIZE) THEN
      CALL HOR_INTERPOL(DTCO, U, ILUOUT,ZFIELD,DTI%XPAR_VEGTYPE)
    ELSE
  ...
  IF (ANY(DTI%LDATA_VEG)) THEN
    ...
    ITIME0 = ITIME    
    DO JTIME=1,ITIME
      ID1 = (JTIME-1)*NVEGTYPE + 1
      ID2 = JTIME*NVEGTYPE
      IF (GFLAG .AND. ALL(.NOT.DTI%LDATA_VEG(ID1:ID2))) THEN
        ITIME0 = JTIME-1
        EXIT
      ENDIF
      WRITE(YRECFM,FMT='(A7,I2.2)') 'D_VEG_T',JTIME
      CALL READ_SURF_ISBA_PAR_n(DTCO, U, IO%NPATCH, HPROGRAM, YRECFM, ILUOUT, KSIZE, &
                                IVERSION, IBUGFIX, DTI%LDATA_VEG(ID1:ID2), DTI%XPAR_VEG(:,JTIME,:),IRESP,&
                                HCOMMENT=YCOMMENT,HDIR=YDIR)
    END DO
    CALL PUT_IN_TIME('VEG','NAT',ITIME0,ITIME,DTI%XPAR_VEG)
  ENDIF
!
  IF (ANY(DTI%LDATA_LAI)) THEN
    ...
    DO JTIME=1,ITIME
      ID1 = (JTIME-1)*NVEGTYPE + 1
      ID2 = JTIME*NVEGTYPE    
      IF (GFLAG .AND. ALL(.NOT.DTI%LDATA_LAI(ID1:ID2))) THEN
        ITIME0 = JTIME-1
        EXIT
      ENDIF
      WRITE(YRECFM,FMT='(A7,I2.2)') 'D_LAI_T',JTIME
      CALL READ_SURF_ISBA_PAR_n(DTCO, U, IO%NPATCH, HPROGRAM, YRECFM, ILUOUT, KSIZE, &
                                IVERSION, IBUGFIX, DTI%LDATA_LAI(ID1:ID2),DTI%XPAR_LAI(:,JTIME,:),IRESP,&
                                HCOMMENT=YCOMMENT,HDIR=YDIR)
    END DO
    CALL PUT_IN_TIME('LAI','NAT',ITIME0,ITIME,DTI%XPAR_LAI)
  ENDIF
!
  IF (ANY(DTI%LDATA_Z0)) THEN
    ...
    DO JTIME=1,ITIME
      ID1 = (JTIME-1)*NVEGTYPE + 1
      ID2 = JTIME*NVEGTYPE        
      IF (GFLAG .AND. ALL(.NOT.DTI%LDATA_Z0(ID1:ID2))) THEN
        ITIME0 = JTIME-1
        EXIT
      ENDIF
      WRITE(YRECFM,FMT='(A6,I2.2)') 'D_Z0_T',JTIME
      CALL READ_SURF_ISBA_PAR_n(DTCO, U, IO%NPATCH, HPROGRAM, YRECFM, ILUOUT, KSIZE, &
                                IVERSION, IBUGFIX, DTI%LDATA_Z0(ID1:ID2),DTI%XPAR_Z0(:,JTIME,:),IRESP,&
                                HCOMMENT=YCOMMENT,HDIR=YDIR)
    END DO
    CALL PUT_IN_TIME('Z0','NAT',ITIME0,ITIME,DTI%XPAR_Z0)
  ENDIF
!
  IF (ANY(DTI%LDATA_EMIS)) THEN
    ...
    DO JTIME=1,ITIME
      ...
      ID2 = JTIME*NVEGTYPE    
      IF (GFLAG) THEN
        IF (ALL(.NOT.DTI%LDATA_EMIS(ID1:ID2))) THEN
        ITIME0 = JTIME-1
        EXIT
      ENDIF
        WRITE(YRECFM,FMT='(A8,I2.2)') 'D_EMI_T',JTIME 
      ELSE
        WRITE(YRECFM,FMT='(A8,I2.2)') 'D_EMIS_T',JTIME             
      ENDIF    
      CALL READ_SURF_ISBA_PAR_n(DTCO, U, IO%NPATCH, HPROGRAM, YRECFM, ILUOUT, KSIZE, &
                                IVERSION, IBUGFIX, DTI%LDATA_EMIS(ID1:ID2),DTI%XPAR_EMIS(:,JTIME,:),IRESP,&
                                HCOMMENT=YCOMMENT,HDIR=YDIR)
    END DO
    CALL PUT_IN_TIME('EMIS','NAT',ITIME0,ITIME,DTI%XPAR_EMIS)
  ENDIF
!
  IF (ANY(DTI%LDATA_H_VEG)) THEN
    ...
    DO JTIME=1,ITIME
      ...
      ID2 = JTIME*NVEGTYPE    
      IF (GFLAG) THEN
        IF (ALL(.NOT.DTI%LDATA_H_VEG(ID1:ID2))) THEN
          ITIME0 = JTIME-1
          EXIT
        ENDIF
        WRITE(YRECFM,FMT='(A7,I2.2)') 'D_HVG_T',JTIME
      ELSE
        WRITE(YRECFM,FMT='(A9,I2.2)') 'D_H_VEG_T',JTIME
      ENDIF
      CALL READ_SURF_ISBA_PAR_n(DTCO, U, IO%NPATCH, HPROGRAM, YRECFM, ILUOUT, KSIZE, &
                                IVERSION, IBUGFIX, DTI%LDATA_H_VEG(ID1:ID2),DTI%XPAR_H_VEG(:,JTIME,:),IRESP,&
                                HCOMMENT=YCOMMENT,HDIR=YDIR)
    END DO
    CALL PUT_IN_TIME('H_VEG','NAT',ITIME0,ITIME,DTI%XPAR_H_VEG)
  ENDIF
!
  IF (ANY(DTI%LDATA_GNDLITTER)) THEN
    ...
    DO JTIME=1,ITIME
      ...
      ID2 = JTIME*NVEGTYPE   
      IF (GFLAG) THEN
        IF (ALL(.NOT.DTI%LDATA_GNDLITTER(ID1:ID2))) THEN
          ITIME0 = JTIME-1
          EXIT
        ENDIF
        WRITE(YRECFM,FMT='(A7,I2.2)') 'D_GLI_T',JTIME
      ELSE    
        WRITE(YRECFM,FMT='(A7,I2.2)') 'D_GNDLITTER',JTIME
      ENDIF
      CALL READ_SURF_ISBA_PAR_n(DTCO, U, IO%NPATCH, HPROGRAM, YRECFM, ILUOUT, KSIZE, &
                                IVERSION, IBUGFIX, DTI%LDATA_GNDLITTER(ID1:ID2),DTI%XPAR_GNDLITTER(:,JTIME,:),IRESP,&
                                HCOMMENT=YCOMMENT,HDIR=YDIR)
    END DO
    CALL PUT_IN_TIME('GNDLITTER','NAT',ITIME0,ITIME,DTI%XPAR_GNDLITTER)
  ENDIF
!
  IF (ANY(DTI%LDATA_Z0LITTER)) THEN
    ...
    DO JTIME=1,ITIME
      ...
      ID2 = JTIME*NVEGTYPE    
      IF (GFLAG) THEN
        IF (ALL(.NOT.DTI%LDATA_Z0LITTER(ID1:ID2))) THEN
          ITIME0 = JTIME-1
          EXIT
        ENDIF
        WRITE(YRECFM,FMT='(A7,I2.2)') 'D_Z0L_T',JTIME
      ELSE        
        WRITE(YRECFM,FMT='(A8,I2.2)') 'D_Z0LITTER_T',JTIME
      ENDIF
      CALL READ_SURF_ISBA_PAR_n(DTCO, U, IO%NPATCH, HPROGRAM, YRECFM, ILUOUT, KSIZE, &
                                IVERSION, IBUGFIX, DTI%LDATA_Z0LITTER(ID1:ID2),DTI%XPAR_Z0LITTER(:,JTIME,:),IRESP,&
                                HCOMMENT=YCOMMENT,HDIR=YDIR)
    END DO
    CALL PUT_IN_TIME('Z0LITTER','NAT',ITIME0,ITIME,DTI%XPAR_Z0LITTER)
  ENDIF
!
  IF (ANY(DTI%LDATA_ALBNIR_VEG)) THEN
    ...
    DO JTIME=1,ITIME
      ...
      ID2 = JTIME*NVEGTYPE    
      IF (GFLAG) THEN
        IF (ALL(.NOT.DTI%LDATA_ALBNIR_VEG(ID1:ID2))) THEN
          ITIME0 = JTIME-1
          EXIT
        ENDIF
        WRITE(YRECFM,FMT='(A7,I2.2)') 'D_ANV_T',JTIME
        CALL READ_SURF_ISBA_PAR_n(DTCO, U, IO%NPATCH, HPROGRAM, YRECFM, ILUOUT, KSIZE, &
                          IVERSION, IBUGFIX, DTI%LDATA_ALBNIR_VEG(ID1:ID2),DTI%XPAR_ALBNIR_VEG(:,JTIME,:),IRESP,&
                          HCOMMENT=YCOMMENT,HDIR=YDIR)
      ELSE
        IF (JTIME==1) THEN           
          YRECFM='D_ALBNIR_VEG'
          CALL READ_SURF_ISBA_PAR_n(DTCO, U, IO%NPATCH, HPROGRAM, YRECFM, ILUOUT, KSIZE, &
                              ...
                              HCOMMENT=YCOMMENT,HDIR=YDIR)
        ELSE
          DTI%XPAR_ALBNIR_VEG(:,JTIME,:) = DTI%XPAR_ALBNIR_VEG(:,1,:)
        ENDIF
      ENDIF
    ENDDO
    CALL PUT_IN_TIME('ALBNIR_VEG','NAT',ITIME0,ITIME,DTI%XPAR_ALBNIR_VEG)
  ENDIF
!
  IF (ANY(DTI%LDATA_ALBVIS_VEG)) THEN
    ...
    DO JTIME=1,ITIME
      ...
      ID2 = JTIME*NVEGTYPE    
      IF (GFLAG) THEN
        IF (ALL(.NOT.DTI%LDATA_ALBVIS_VEG(ID1:ID2))) THEN
          ITIME0 = JTIME-1
          EXIT
        ENDIF
        WRITE(YRECFM,FMT='(A7,I2.2)') 'D_AVV_T',JTIME
        CALL READ_SURF_ISBA_PAR_n(DTCO, U, IO%NPATCH, HPROGRAM, YRECFM, ILUOUT, KSIZE, &
                          IVERSION, IBUGFIX, DTI%LDATA_ALBVIS_VEG(ID1:ID2),DTI%XPAR_ALBVIS_VEG(:,JTIME,:),IRESP,&
                          HCOMMENT=YCOMMENT,HDIR=YDIR)
      ELSE
        IF (JTIME==1) THEN           
          YRECFM='D_ALBVIS_VEG'
          CALL READ_SURF_ISBA_PAR_n(DTCO, U, IO%NPATCH, HPROGRAM, YRECFM, ILUOUT, KSIZE, &
                              ...
                              HCOMMENT=YCOMMENT,HDIR=YDIR)
        ELSE
          DTI%XPAR_ALBVIS_VEG(:,JTIME,:) = DTI%XPAR_ALBVIS_VEG(:,1,:)
        ENDIF
      ENDIF
    ENDDO
    CALL PUT_IN_TIME('ALBVIS_VEG','NAT',ITIME0,ITIME,DTI%XPAR_ALBVIS_VEG)
  ENDIF
!
  IF (ANY(DTI%LDATA_ALBUV_VEG)) THEN
    ...
    DO JTIME=1,ITIME
      ...
      ID2 = JTIME*NVEGTYPE    
      IF (GFLAG) THEN
        IF (ALL(.NOT.DTI%LDATA_ALBUV_VEG(ID1:ID2))) THEN
          ITIME0 = JTIME-1
           EXIT
        ENDIF
        WRITE(YRECFM,FMT='(A7,I2.2)') 'D_AUV_T',JTIME
        CALL READ_SURF_ISBA_PAR_n(DTCO, U, IO%NPATCH, HPROGRAM, YRECFM, ILUOUT, KSIZE, &
                          IVERSION, IBUGFIX, DTI%LDATA_ALBUV_VEG(ID1:ID2),DTI%XPAR_ALBUV_VEG(:,JTIME,:),IRESP,&
                          HCOMMENT=YCOMMENT,HDIR=YDIR)
      ELSE
        IF (JTIME==1) THEN           
          YRECFM='D_ALBUV_VEG'
          CALL READ_SURF_ISBA_PAR_n(DTCO, U, IO%NPATCH, HPROGRAM, YRECFM, ILUOUT, KSIZE, &
                              ...
                              HCOMMENT=YCOMMENT,HDIR=YDIR)
        ELSE
          DTI%XPAR_ALBUV_VEG(:,JTIME,:) = DTI%XPAR_ALBUV_VEG(:,1,:)
        ENDIF
      ENDIF
    ENDDO
    CALL PUT_IN_TIME('ALBUV_VEG','NAT',ITIME0,ITIME,DTI%XPAR_ALBUV_VEG)
  ENDIF
!
  IF (ANY(DTI%LDATA_ALBNIR_SOIL)) THEN
    ...
    DO JTIME=1,ITIME
      ...
      ID2 = JTIME*NVEGTYPE    
      IF (GFLAG) THEN
        IF (ALL(.NOT.DTI%LDATA_ALBNIR_SOIL(ID1:ID2))) THEN
          ITIME0 = JTIME-1
          EXIT
        ENDIF
        WRITE(YRECFM,FMT='(A7,I2.2)') 'D_ANS_T',JTIME
        CALL READ_SURF_ISBA_PAR_n(DTCO, U, IO%NPATCH, HPROGRAM, YRECFM, ILUOUT, KSIZE, &
                          IVERSION, IBUGFIX, DTI%LDATA_ALBNIR_SOIL(ID1:ID2),DTI%XPAR_ALBNIR_SOIL(:,JTIME,:),IRESP,&
                          HCOMMENT=YCOMMENT,HDIR=YDIR)
      ELSE
        IF (JTIME==1) THEN           
          ...
          CALL READ_SURF_ISBA_PAR_n(DTCO, U, IO%NPATCH, HPROGRAM, YRECFM, ILUOUT, KSIZE, &
                              ...
                              HCOMMENT=YCOMMENT,HDIR=YDIR)
        ELSE
          DTI%XPAR_ALBNIR_SOIL(:,JTIME,:) = DTI%XPAR_ALBNIR_SOIL(:,1,:)
        ENDIF
      ENDIF
    ENDDO
    CALL PUT_IN_TIME('ALBNIR_SOIL','NAT',ITIME0,ITIME,DTI%XPAR_ALBNIR_SOIL)
  ENDIF  
!
  IF (ANY(DTI%LDATA_ALBVIS_SOIL)) THEN
    ...
    DO JTIME=1,ITIME
      ...
      ID2 = JTIME*NVEGTYPE    
      IF (GFLAG) THEN
        IF (ALL(.NOT.DTI%LDATA_ALBVIS_SOIL(ID1:ID2))) THEN
          ITIME0 = JTIME-1
          EXIT
        ENDIF
        WRITE(YRECFM,FMT='(A7,I2.2)') 'D_AVS_T',JTIME
        CALL READ_SURF_ISBA_PAR_n(DTCO, U, IO%NPATCH, HPROGRAM, YRECFM, ILUOUT, KSIZE, &
                          IVERSION, IBUGFIX, DTI%LDATA_ALBVIS_SOIL(ID1:ID2),DTI%XPAR_ALBVIS_SOIL(:,JTIME,:),IRESP,&
                          HCOMMENT=YCOMMENT,HDIR=YDIR)
      ELSE
        IF (JTIME==1) THEN           
          ...
          CALL READ_SURF_ISBA_PAR_n(DTCO, U, IO%NPATCH, HPROGRAM, YRECFM, ILUOUT, KSIZE, &
                              ...
                              HCOMMENT=YCOMMENT,HDIR=YDIR)
        ELSE
          DTI%XPAR_ALBVIS_SOIL(:,JTIME,:) = DTI%XPAR_ALBVIS_SOIL(:,1,:)
        ENDIF
      ENDIF
    ENDDO
    CALL PUT_IN_TIME('ALBVIS_SOIL','NAT',ITIME0,ITIME,DTI%XPAR_ALBVIS_SOIL)
  ENDIF   
!
  IF (ANY(DTI%LDATA_ALBUV_SOIL)) THEN
    ...
    DO JTIME=1,ITIME
      ...
      ID2 = JTIME*NVEGTYPE    
      IF (GFLAG) THEN       
        IF (ALL(.NOT.DTI%LDATA_ALBUV_SOIL(ID1:ID2))) THEN
          ITIME0 = JTIME-1
          EXIT
        ENDIF     
        WRITE(YRECFM,FMT='(A7,I2.2)') 'D_AUS_T',JTIME
        CALL READ_SURF_ISBA_PAR_n(DTCO, U, IO%NPATCH, HPROGRAM, YRECFM, ILUOUT, KSIZE, &
                          IVERSION, IBUGFIX, DTI%LDATA_ALBUV_SOIL(ID1:ID2),DTI%XPAR_ALBUV_SOIL(:,JTIME,:),IRESP,&
                          HCOMMENT=YCOMMENT,HDIR=YDIR)
      ELSE
        IF (JTIME==1) THEN           
          YRECFM='D_ALBUV_SOIL'
          CALL READ_SURF_ISBA_PAR_n(DTCO, U, IO%NPATCH, HPROGRAM, YRECFM, ILUOUT, KSIZE, &
                              ...
                              HCOMMENT=YCOMMENT,HDIR=YDIR)
        ELSE
          DTI%XPAR_ALBUV_SOIL(:,JTIME,:) = DTI%XPAR_ALBUV_SOIL(:,1,:)
        ENDIF
      ENDIF
    ENDDO
    CALL PUT_IN_TIME('ALBUV_SOIL','NAT',ITIME0,ITIME,DTI%XPAR_ALBUV_SOIL)
  ENDIF    
!
...
!
  IF (ANY(DTI%LDATA_GROUND_DEPTH)) THEN
    ...
    ENDIF       
    CALL READ_SURF_ISBA_PAR_n(DTCO, U, IO%NPATCH, HPROGRAM, YRECFM2, ILUOUT, KSIZE, &
...
!
  IF (ANY(DTI%LDATA_IRRIG)) THEN
    ...
    DO JTIME=1,ITIME
      ...
      ID2 = JTIME*NVEGTYPE   
      IF (GFLAG) THEN
        IF (ALL(.NOT.DTI%LDATA_IRRIG(ID1:ID2))) THEN
          ITIME0 = JTIME-1
          EXIT
        ENDIF            
        WRITE(YRECFM,FMT='(A9,I2.2)') 'D_IRR_T',JTIME        
      ELSE
        WRITE(YRECFM,FMT='(A9,I2.2)') 'D_IRRIG_T',JTIME            
      ENDIF         
      CALL READ_SURF_ISBA_PAR_n(DTCO, U, IO%NPATCH, HPROGRAM, YRECFM, ILUOUT, KSIZE, &
                                IVERSION, IBUGFIX, DTI%LDATA_IRRIG(ID1:ID2),DTI%XPAR_IRRIG(:,JTIME,:),IRESP,&
                                HCOMMENT=YCOMMENT,HDIR=YDIR)
    END DO
    CALL PUT_IN_TIME('IRRIG','NAT',ITIME0,ITIME,DTI%XPAR_IRRIG)
  ENDIF
!
  IF (ANY(DTI%LDATA_WATSUP)) THEN
    ...
    DO JTIME=1,ITIME
      ...
      ID2 = JTIME*NVEGTYPE    
      IF (GFLAG) THEN
        IF (ALL(.NOT.DTI%LDATA_WATSUP(ID1:ID2))) THEN
          ITIME0 = JTIME-1
          EXIT
        ENDIF
        WRITE(YRECFM,FMT='(A10,I2.2)') 'D_WAT_T',JTIME 
      ELSE
        WRITE(YRECFM,FMT='(A10,I2.2)') 'D_WATSUP_T',JTIME            
      ENDIF       
      CALL READ_SURF_ISBA_PAR_n(DTCO, U, IO%NPATCH, HPROGRAM, YRECFM, ILUOUT, KSIZE, &
                                IVERSION, IBUGFIX, DTI%LDATA_WATSUP(ID1:ID2),DTI%XPAR_WATSUP(:,JTIME,:),IRESP,&
                                HCOMMENT=YCOMMENT,HDIR=YDIR)
    END DO
    CALL PUT_IN_TIME('WATSUP','NAT',ITIME0,ITIME,DTI%XPAR_WATSUP)
  ENDIF
!
  IF (GFLAG) THEN
