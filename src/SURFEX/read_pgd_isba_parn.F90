...
!
  IF (DTI%LDATA_DG) THEN
    ALLOCATE(DTI%XPAR_DG        (IG%NDIM,IO%NGROUND_LAYER,NVEGTYPE))
...
!
  IF (DTI%LDATA_ROOTFRAC) THEN
    ALLOCATE(DTI%XPAR_ROOTFRAC  (IG%NDIM,IO%NGROUND_LAYER,NVEGTYPE))
...
!
  IF (DTI%LDATA_ROOTFRACGV) THEN
    ALLOCATE(DTI%XPAR_ROOTFRACGV  (IG%NDIM,IO%NGROUND_LAYER,NVEGTYPE))
