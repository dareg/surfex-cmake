...
!
write(100,*)'TEST10.-3'
write(100,*)OLAND_USE,GDIM,IENDT,IEND, NVEGTYPE , DTI%NTIME
write(100,*)'TEST10.-2'
write(100,*)ANY(DTI%LDATA_VEG)
write(100,*)'TEST10.-1'
IF (.NOT.OLAND_USE) THEN
  ...
  IF (IVERSION>=7) THEN
    ...
    !
    YRECFM='L_VEG'
write(100,*)'TEST10.0.-12'
write(100,*)ANY(DTI%LDATA_VEG)
write(100,*)HPROGRAM,YRECFM,IRESP,YCOMMENT
...
write(100,*)'TEST10.2'
    DO JT=1,ITIME
      ...
      ID2 = JT*NVEGTYPE
write(100,*)'TEST10.3'
write(100,*)GTIME(JT) , JT,ID1,ID2
      IF (GTIME(JT)) THEN
write(100,*)'TEST10.4'
write(100,*)HPROGRAM,YRECFM,ILUOUT,IVERSION,IBUGFIX,IO%NPATCH,KSIZE,DTI%LDATA_VEG(ID1:ID2),&
IRESP,YCOMMENT,YDIR
