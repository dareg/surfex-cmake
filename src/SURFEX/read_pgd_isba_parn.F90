...
!     #########
      SUBROUTINE READ_PGD_ISBA_PAR_n (DTCO, U, GCP, DTI, KDIM, IO, &
...
IF (.NOT.OLAND_USE) THEN
  ...
  IF (DTI%LDATA_VEGTYPE) THEN
    ...
    ELSE
      YRECFM='D_VEGTYPE'
    ENDIF
    CALL MAKE_CHOICE_ARRAY(HPROGRAM, NVEGTYPE, GDIM, YRECFM, ZFIELD(:,:),HDIR=YDIR)
