...
IF (.NOT.OLAND_USE) THEN
  ...
  !        
    ...
    IF (IBUGFIX>=2) THEN
      ...
      YCOMMENT=YRECFM
      CALL READ_SURF(HPROGRAM,YRECFM,LDATA_GROUND_DEPTH,IRESP,HCOMMENT=YCOMMENT)
      YRECFM='L_ROOT_DEPTH'
      YCOMMENT=YRECFM
...
!
  IF (LDATA_GROUND_DEPTH) THEN
    ...
    CALL READ_SURF_ISBA_PAR_n(HPROGRAM,YRECFM,ILUOUT,KSIZE,XPAR_GROUND_DEPTH(:,:),IRESP,IVERSION,&
                              HCOMMENT=YCOMMENT,HDIR=YDIR)
  ENDIF
!
