...
!
ALLOCATE(DTI%LDATA_VEG        (DTI%NTIME*NVEGTYPE))
ALLOCATE(DTI%LDATA_LAI        (DTI%NTIME*NVEGTYPE))
ALLOCATE(DTI%LDATA_Z0         (DTI%NTIME*NVEGTYPE))
ALLOCATE(DTI%LDATA_EMIS       (DTI%NTIME*NVEGTYPE))
ALLOCATE(DTI%LDATA_ALBNIR_VEG (DTI%NTIME*NVEGTYPE))
ALLOCATE(DTI%LDATA_ALBVIS_VEG (DTI%NTIME*NVEGTYPE))
ALLOCATE(DTI%LDATA_ALBUV_VEG  (DTI%NTIME*NVEGTYPE))
ALLOCATE(DTI%LDATA_ALBNIR_SOIL(DTI%NTIME*NVEGTYPE))
ALLOCATE(DTI%LDATA_ALBVIS_SOIL(DTI%NTIME*NVEGTYPE))
ALLOCATE(DTI%LDATA_ALBUV_SOIL (DTI%NTIME*NVEGTYPE))
ALLOCATE(DTI%LDATA_IRRIG      (DTI%NTIME*NVEGTYPE))
ALLOCATE(DTI%LDATA_WATSUP     (DTI%NTIME*NVEGTYPE))
DTI%LDATA_VEG        (:) = .FALSE.
DTI%LDATA_LAI        (:) = .FALSE.
DTI%LDATA_Z0         (:) = .FALSE.
...
ENDIF
!
ALLOCATE(DTI%LDATA_GNDLITTER(DTI%NTIME*NVEGTYPE))
ALLOCATE(DTI%LDATA_Z0LITTER (DTI%NTIME*NVEGTYPE))
ALLOCATE(DTI%LDATA_H_VEG    (DTI%NTIME*NVEGTYPE))
...
IF (.NOT.OLAND_USE) THEN
  ...
  !
  IF (GFLAG .OR. ( ANY(DTI%LDATA_LAI) .OR. ANY(DTI%LDATA_VEG) .OR. &
