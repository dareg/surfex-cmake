...
!
YRECFM='ISBA'
 CALL READ_SURF(HPROGRAM,YRECFM,I%CISBA,IRESP)
!
IF (IVERSION>=7) THEN
  !
  ...
  !
  YRECFM='PEDOTF'
  CALL READ_SURF(HPROGRAM,YRECFM,I%CPEDOTF,IRESP)
  !
ELSE
  I%CPEDOTF = 'CH78'
ENDIF
...
!
YRECFM='PHOTO'
 CALL READ_SURF(HPROGRAM,YRECFM,I%CPHOTO,IRESP)
!
...
IF (IVERSION>7 .OR. IVERSION==7 .AND. IBUGFIX>=2) THEN
  !
  YRECFM='TR_ML'
  CALL READ_SURF(HPROGRAM,YRECFM,I%LTR_ML,IRESP)
  !
ELSE 
  I%LTR_ML = .FALSE.
ENDIF
...
IF (IVERSION>7 .OR. IVERSION==7 .AND. IBUGFIX>=3) THEN
  !
  YRECFM='RM_PATCH'
  CALL READ_SURF(HPROGRAM,YRECFM,I%XRM_PATCH,IRESP)
  !
ELSE 
  I%XRM_PATCH = 0.0
ENDIF
...
!
YRECFM='GROUND_LAYER'
 CALL READ_SURF(HPROGRAM,YRECFM,I%NGROUND_LAYER,IRESP)
!
...
IF (IVERSION>=6) THEN
  YRECFM='NBIOMASS'
  CALL READ_SURF(HPROGRAM,YRECFM,I%NNBIOMASS,IRESP)
ELSE
...
!
YRECFM='PATCH_NUMBER'
 CALL READ_SURF(HPROGRAM,YRECFM,I%NPATCH,IRESP)
!
...
YRECFM='ZS'
 CALL READ_SURF(HPROGRAM,YRECFM,I%XZS(:),IRESP)
!
!
...
YRECFM='CLAY'
 CALL READ_SURF(HPROGRAM,YRECFM,I%XCLAY(:,1),IRESP)
...
YRECFM='SAND'
 CALL READ_SURF(HPROGRAM,YRECFM,I%XSAND(:,1),IRESP)
DO JLAYER=2,I%NGROUND_LAYER
...
IF (IVERSION>7 .OR. (IVERSION==7 .AND. IBUGFIX>=3)) THEN
   YRECFM='SOCP'
   CALL READ_SURF(HPROGRAM,YRECFM,I%LSOCP,IRESP)
ELSE
   I%LSOCP=.FALSE.
ENDIF
!
...
!
  YRECFM='SOC_TOP'
  CALL READ_SURF(HPROGRAM,YRECFM,I%XSOC(:,1),IRESP)
  YRECFM='SOC_SUB'
  CALL READ_SURF(HPROGRAM,YRECFM,I%XSOC(:,2),IRESP)
!
  DO JLAYER=2,I%NGROUND_LAYER
...
IF (IVERSION>7 .OR. (IVERSION==7 .AND. IBUGFIX>=3)) THEN
   YRECFM='PERMAFROST'
   CALL READ_SURF(HPROGRAM,YRECFM,I%LPERM,IRESP)
ELSE
   I%LPERM=.FALSE.
ENDIF
!
...
!
  YRECFM='PERM'
  CALL READ_SURF(HPROGRAM,YRECFM,I%XPERM(:),IRESP)
!
ELSE
!  
  ALLOCATE(I%XPERM (0))
...
IF (IVERSION>=8) THEN
   YRECFM='GWKEY'
   CALL READ_SURF(HPROGRAM,YRECFM,I%LGW,IRESP)
ELSE
   I%LGW=.FALSE.
ENDIF
!
...
!
  YRECFM='GWFRAC'
  CALL READ_SURF(HPROGRAM,YRECFM,I%XGW(:),IRESP)
!
ELSE
!  
  ALLOCATE(I%XGW (0))
...
IF (IVERSION>7 .OR. (IVERSION==7 .AND. IBUGFIX>=3)) THEN
   YRECFM='NO'
   CALL READ_SURF(HPROGRAM,YRECFM,I%LNOF,IRESP)
ELSE
   I%LNOF = .FALSE.
ENDIF
!
...
IF (CHI%LCH_NO_FLUX) THEN
  ...
  IF (I%LNOF) THEN
    ...
    YRECFM='PH'
    CALL READ_SURF(HPROGRAM,YRECFM,I%XPH(:),IRESP)
    !
    ALLOCATE(I%XFERT(IG%NDIM))
    YRECFM='FERT'
    CALL READ_SURF(HPROGRAM,YRECFM,I%XFERT(:),IRESP)
    !
  ELSE
...
YRECFM='AOSIP'
 CALL READ_SURF(HPROGRAM,YRECFM,I%XAOSIP,IRESP)
!
ALLOCATE(I%XAOSIM(IG%NDIM))
YRECFM='AOSIM'
 CALL READ_SURF(HPROGRAM,YRECFM,I%XAOSIM,IRESP)

ALLOCATE(I%XAOSJP(IG%NDIM))
YRECFM='AOSJP'
 CALL READ_SURF(HPROGRAM,YRECFM,I%XAOSJP,IRESP)
!
ALLOCATE(I%XAOSJM(IG%NDIM))
YRECFM='AOSJM'
 CALL READ_SURF(HPROGRAM,YRECFM,I%XAOSJM,IRESP)
!
ALLOCATE(I%XHO2IP(IG%NDIM))
YRECFM='HO2IP'
 CALL READ_SURF(HPROGRAM,YRECFM,I%XHO2IP,IRESP)
!
ALLOCATE(I%XHO2IM(IG%NDIM))
YRECFM='HO2IM'
 CALL READ_SURF(HPROGRAM,YRECFM,I%XHO2IM,IRESP)
!
ALLOCATE(I%XHO2JP(IG%NDIM))
YRECFM='HO2JP'
 CALL READ_SURF(HPROGRAM,YRECFM,I%XHO2JP,IRESP)
!
ALLOCATE(I%XHO2JM(IG%NDIM))
YRECFM='HO2JM'
 CALL READ_SURF(HPROGRAM,YRECFM,I%XHO2JM,IRESP)
!
!* orographic parameter to compute effective surface of energy exchanges
!
ALLOCATE(I%XSSO_SLOPE(IG%NDIM))
YRECFM='SSO_SLOPE'
 CALL READ_SURF(HPROGRAM,YRECFM,I%XSSO_SLOPE,IRESP)
!
!* orographic standard deviation for subgrid-scale orographic drag
!
ALLOCATE(I%XSSO_STDEV(IG%NDIM))
YRECFM='SSO_STDEV'
 CALL READ_SURF(HPROGRAM,YRECFM,I%XSSO_STDEV(:),IRESP)
!
!* orographic runoff coefficient
!
ALLOCATE(I%XRUNOFFB(IG%NDIM))
YRECFM='RUNOFFB'
 CALL READ_SURF(HPROGRAM,YRECFM,I%XRUNOFFB,IRESP)
!
...
ELSE
  YRECFM='WDRAIN'
  CALL READ_SURF(HPROGRAM,YRECFM,I%XWDRAIN,IRESP)
ENDIF
!
...
!
  YRECFM='CTI'
  CALL READ_SURF(HPROGRAM,YRECFM,I%LCTI,IRESP)        
!
...
!
  YRECFM='TI_MIN'
  CALL READ_SURF(HPROGRAM,YRECFM,I%XTI_MIN,IRESP)
!
  YRECFM='TI_MAX'
  CALL READ_SURF(HPROGRAM,YRECFM,I%XTI_MAX,IRESP)
!
  YRECFM='TI_MEAN'
  CALL READ_SURF(HPROGRAM,YRECFM,I%XTI_MEAN,IRESP)
!
  YRECFM='TI_STD'
  CALL READ_SURF(HPROGRAM,YRECFM,I%XTI_STD,IRESP)
!
  YRECFM='TI_SKEW'
  CALL READ_SURF(HPROGRAM,YRECFM,I%XTI_SKEW,IRESP)
!
ELSE
!
