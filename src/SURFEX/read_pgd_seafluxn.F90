!     #########
      SUBROUTINE READ_PGD_SEAFLUX_n (DTCO, DTS, SG, S, U, UG, &
                                     HPROGRAM)
!     #########################################
!
...
CALL PACK_INIT(DTCO,U,UG,HPROGRAM,'SEA   ',SG%CGRID,SG%XGRID_PAR,     &
               S%LCOVER,S%XCOVER,S%XZS,SG%XLAT,SG%XLON,SG%XMESH_SIZE )
!
!* orography
!
S%XZS(:) = 0.
