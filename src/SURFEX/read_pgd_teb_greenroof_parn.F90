!     #########
      SUBROUTINE READ_PGD_TEB_GREENROOF_PAR_n (DTGR, TGRO, TGRP, TG, &
                                               HPROGRAM)
!     ################################################
!
...
!
YRECFM='GR_NTIME'
 CALL READ_SURF(HPROGRAM,YRECFM,TGRO%NTIME_GR,IRESP)
!
YRECFM='GR_LAYER'
 CALL READ_SURF(HPROGRAM,YRECFM,TGRO%NLAYER_GR,IRESP)
!
! Read type of green roof
YRECFM='D_TYPE_GR'
 CALL READ_SURF(HPROGRAM,YRECFM,TGRO%CTYP_GR,IRESP)
!
...
DO JLAYER=1,TGRO%NLAYER_GR
  ...
  CALL READ_SURF(HPROGRAM,YRECFM,DTGR%XPAR_OM_GR(:,JLAYER),IRESP,HCOMMENT=YCOMMENT)
END DO
!
...
DO JLAYER=1,TGRO%NLAYER_GR
  ...
  CALL READ_SURF(HPROGRAM,YRECFM,DTGR%XPAR_SAND_GR(:,JLAYER),IRESP,HCOMMENT=YCOMMENT)
END DO
!
...
DO JLAYER=1,TGRO%NLAYER_GR
  ...
  CALL READ_SURF(HPROGRAM,YRECFM,DTGR%XPAR_CLAY_GR(:,JLAYER),IRESP,HCOMMENT=YCOMMENT)
END DO
!
! Read green roof LAI
...
DO JTIME=1,TGRO%NTIME_GR
  ...
  CALL READ_SURF(HPROGRAM,YRECFM,DTGR%XPAR_LAI_GR(:,JTIME),IRESP,HCOMMENT=YCOMMENT)
END DO
!
!
!-------------------------------------------------------------------------------
