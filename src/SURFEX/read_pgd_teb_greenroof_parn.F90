...
ALLOCATE(DTV%XPAR_ALBNIR_VEG (KDIM,1))
ALLOCATE(DTV%XPAR_ALBVIS_VEG (KDIM,1))
ALLOCATE(DTV%XPAR_ALBUV_VEG  (KDIM,1))
ALLOCATE(DTV%XPAR_ALBNIR_SOIL(KDIM,1))
ALLOCATE(DTV%XPAR_ALBVIS_SOIL(KDIM,1))
ALLOCATE(DTV%XPAR_ALBUV_SOIL (KDIM,1))
