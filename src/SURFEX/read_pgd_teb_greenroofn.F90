...
!
YRECFM='GR_ISBA'
 CALL READ_SURF(HPROGRAM,YRECFM,TGRO%CISBA_GR,IRESP)
!
YRECFM='GR_SCOND'
 CALL READ_SURF(HPROGRAM,YRECFM,TGRO%CSCOND_GR,IRESP)
!
...
YRECFM='GR_RUNOFFB' 
 CALL READ_SURF(HPROGRAM,YRECFM,TGRP%XRUNOFFB_GR,IRESP)
!
...
ELSE
  YRECFM='GR_WDRAIN'
  CALL READ_SURF(HPROGRAM,YRECFM,TGRP%XWDRAIN_GR,IRESP)
ENDIF
!
!-------------------------------------------------------------------------------
...
!
 CALL READ_PGD_TEB_GREENROOF_PAR_n(DTGR, TGRO, TGRP, TG, &
                                                       HPROGRAM)
!
