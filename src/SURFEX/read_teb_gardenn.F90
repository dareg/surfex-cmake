...
DO JLAYER=1,IWORK
  ...
  YRECFM=HPATCH//'TWN_TG'//ADJUSTL(YLVL(:LEN_TRIM(YLVL)))
...
DO JLAYER=1,NGROUND_LAYER
  WRITE(YLVL,'(I4)') JLAYER
  YRECFM=HPATCH//'TWN_WG'//ADJUSTL(YLVL(:LEN_TRIM(YLVL)))
  YRECFM=ADJUSTL(YRECFM)
  CALL READ_SURF(HPROGRAM,YRECFM,ZWORK(:),IRESP)
  XWG(:,JLAYER)=ZWORK
END DO
...
DO JLAYER=1,NGROUND_LAYER
  WRITE(YLVL,'(I4)') JLAYER
  YRECFM=HPATCH//'TWN_WGI'//ADJUSTL(YLVL(:LEN_TRIM(YLVL)))
  YRECFM=ADJUSTL(YRECFM)  
  CALL READ_SURF(HPROGRAM,YRECFM,ZWORK(:),IRESP)
  XWGI(:,JLAYER)=ZWORK
END DO
