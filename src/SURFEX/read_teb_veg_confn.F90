...
IF (IMI.NE.-1 .AND. LNAM_READ) THEN
 CALL INIT_NAM_TEB_VEGn(TGDO)
 CALL INIT_NAM_TEB_VEG_AGSn(TGDO)
 CALL INIT_NAM_CH_CONTROLn(CHT)
 CALL INIT_NAM_CH_TEB_VEGn(CHT)
 CALL INIT_NAM_SGH_TEB_VEGn(TGDO)        
ENDIF
...
!
IF (IMI.NE.-1) THEN
 CALL UPDATE_NAM_TEB_VEGn(TGDO)
 CALL UPDATE_NAM_TEB_VEG_AGSn(TGDO)
 CALL UPDATE_NAM_CH_TEB_VEGn(CHT)
 CALL UPDATE_NAM_CH_CONTROLn(CHT)
 CALL UPDATE_NAM_SGH_TEB_VEGn(TGDO)        
ENDIF
