...
DO JLAYER=1,TOP%NROOF_LAYER
 ...
 CALL READ_SURF(HPROGRAM,YRECFM,T%CUR%XT_ROOF(:,JLAYER),IRESP)
END DO
!
!* roof water content
!
...
YRECFM=ADJUSTL(YRECFM)
 CALL READ_SURF(HPROGRAM,YRECFM,T%CUR%XWS_ROOF(:),IRESP)
!
!* road temperatures
!
...
DO JLAYER=1,TOP%NROAD_LAYER
 ...
 CALL READ_SURF(HPROGRAM,YRECFM,T%CUR%XT_ROAD(:,JLAYER),IRESP)
END DO
!
!* road water content
!
...
YRECFM=ADJUSTL(YRECFM)
 CALL READ_SURF(HPROGRAM,YRECFM,T%CUR%XWS_ROAD(:),IRESP)
!
!* wall temperatures
!
...
DO JLAYER=1,TOP%NWALL_LAYER
  IF (TOP%CWALL_OPT=='UNIF' .OR. GOLD_NAME) THEN
    ...
    CALL READ_SURF(HPROGRAM,YRECFM,T%CUR%XT_WALL_A(:,JLAYER),IRESP)
    !
  ...
  ELSE
    ...
    YRECFM=ADJUSTL(YRECFM)
    CALL READ_SURF(HPROGRAM,YRECFM,T%CUR%XT_WALL_B(:,JLAYER),IRESP)
  END IF
END DO
!
...
YRECFM=ADJUSTL(YRECFM)
 CALL READ_SURF(HPROGRAM,YRECFM,B%CUR%XTI_BLD(:),IRESP)
...
IF (IVERSION>7 .OR. IVERSION==7 .AND. IBUGFIX>=3) THEN
   ...
   YRECFM=ADJUSTL(YRECFM)
   CALL READ_SURF(HPROGRAM,YRECFM,B%CUR%XT_WIN1(:),IRESP)
ELSE
...
IF (TOP%CBEM=='BEM' .AND. (IVERSION>7 .OR. IVERSION==7 .AND. IBUGFIX>=3)) THEN
   ...
   YRECFM=ADJUSTL(YRECFM)
   CALL READ_SURF(HPROGRAM,YRECFM,B%CUR%XQI_BLD(:),IRESP)
ELSE
...
IF (TOP%CBEM=='BEM') THEN
  ...
  YRECFM=ADJUSTL(YRECFM)
  CALL READ_SURF(HPROGRAM,YRECFM,B%CUR%XT_WIN2(:),IRESP)        
  !
  !* floor temperatures
  !
  ...
  DO JLAYER=1,BOP%NFLOOR_LAYER
    ...
    YRECFM=ADJUSTL(YRECFM)
    CALL READ_SURF(HPROGRAM,YRECFM,B%CUR%XT_FLOOR(:,JLAYER),IRESP)
  END DO
  !
  !* mass temperatures
  !
  ...
  DO JLAYER=1,BOP%NFLOOR_LAYER
    ...
    YRECFM=ADJUSTL(YRECFM)
    CALL READ_SURF(HPROGRAM,YRECFM,B%CUR%XT_MASS(:,JLAYER),IRESP)
  END DO
  !
ELSE 
...
YRECFM=ADJUSTL(YRECFM)
 CALL READ_SURF(HPROGRAM,YRECFM,T%CUR%XTI_ROAD(:),IRESP)
!
!
!* snow mantel
!
...
IF (GOLD_NAME) YRECFM='T_CANYON'
 CALL READ_SURF(HPROGRAM,YRECFM,T%CUR%XT_CANYON(:),IRESP)
!
...
IF (GOLD_NAME) YRECFM='Q_CANYON'
 CALL READ_SURF(HPROGRAM,YRECFM,T%CUR%XQ_CANYON(:),IRESP)
!
