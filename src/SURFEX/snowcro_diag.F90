...
SUBROUTINE SNOWCRO_DIAG(HSNOWMETAMO,&
                        ...
                        PSNOWLIQ,PDIRCOSZW,PSNOWIMP,PSNOWDEND,PSNOWSPHER,PSNOWSIZE,PSNOWSSA,PSNOWTYPEMEPRA,PSNOWRAM,&
  ...
  DO JJ=1,SIZE(PSNOWSWE,1)
    ...
    IF (PSNOWSWE(JJ,JST)>0) THEN
      ...
      DO JIMP=1,NIMPUR !Modif the cond
        PSNOWIMP_CONC(JJ,JST,JIMP)=PSNOWIMP(JJ,JST,JIMP)/(1000*ZSNOWSWE(JJ,JST)) 
      ENDDO 
