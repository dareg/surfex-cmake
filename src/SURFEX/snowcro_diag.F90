...
SUBROUTINE SNOWCRO_DIAG(HSNOWMETAMO,&
                        ...
                        PSNOWLIQ,PDIRCOSZW,PSNOWIMPV2,PSNOWDEND,PSNOWSPHER,PSNOWSIZE,PSNOWSSA,PSNOWTYPEMEPRA,PSNOWRAM,&
                        ...
                        PSNOWSWE_7DAYS,PSNOWRAM_SONDE,PSNOW_WETTHICKNESS,PSNOW_REFROZENTHICKNESS,PSNOWIMP_CONC)
...
REAL, DIMENSION(:,:,:), INTENT(IN) :: PSNOWIMPV2
...
DO JST=1,SIZE(PSNOWSWE,2)
  DO JJ=1,SIZE(PSNOWSWE,1)
    ...
    IF (PSNOWSWE(JJ,JST)>0) THEN
      ...
      DO JIMP=1,NIMPUR
        PSNOWIMP_CONC(JJ,JST,JIMP)=PSNOWIMPV2(JJ,JST,JIMP)/ZSNOWSWE(JJ,JST)
      ENDDO 
