!     #########
      SUBROUTINE SOILGRID1(PSOILGRID, PSOILDEPTH, PDG, KWG_LAYER  )
...
!               --------------
!
IF (LHOOK) CALL DR_HOOK('SOILGRID1',0,ZHOOK_HANDLE)
!
INI    = SIZE(PDG,1)
INL    = SIZE(PDG,2)
!
...
ENDIF
!
IF (LHOOK) CALL DR_HOOK('SOILGRID1',1,ZHOOK_HANDLE)
!
!-------------------------------------------------------------------------------
CONTAINS
!-------------------------------------------------------------------------------
...
! init
!
IF (LHOOK) CALL DR_HOOK('SOILGRID1:OPTIMSOILGRID',0,ZHOOK_HANDLE)
!
ZDG_WATER (:) = XUNDEF
!
!-------------------------------------------------------------------------------
...
ENDWHERE
!
IF (LHOOK) CALL DR_HOOK('SOILGRID1:OPTIMSOILGRID',1,ZHOOK_HANDLE)
!
END SUBROUTINE OPTIMSOILGRID
!
!-------------------------------------------------------------------------------
END SUBROUTINE SOILGRID1
