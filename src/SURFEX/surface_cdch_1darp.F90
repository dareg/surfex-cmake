...
ASSOCIATE(LCOEFKTKE=>AT%LCOEFKTKE, LCOEFK_F1=>AT%LCOEFK_F1, &
 & CGTURS=>AT%CGTURS, &
 & NUPTKE=>AT%NUPTKE, C3TKEFREE=>AT%C3TKEFREE, &
 & ETKE_OLAM=>AT%ETKE_OLAM, EFB_UR=>AT%EFB_UR, &
 & EFB_AZ0=>AT%EFB_AZ0, REFB_1=>AT%REFB_1, & 
 & REFB_2=>AT%REFB_2, REFB_3=>AT% REFB_3, &
 & RLOUIS_S0=>AT%RLOUIS_S0, PLOUIS_S0=>AT%PLOUIS_S0, &
 & RLOUIS_GU1=>AT%RLOUIS_GU1, RLOUIS_GU2=>AT%RLOUIS_GU2, &
 & PLOUIS_GU1=>AT%PLOUIS_GU1, PLOUIS_GU2=>AT%PLOUIS_GU2, &
 & RLOUIS_GS1=>AT%RLOUIS_GS1, RLOUIS_GS2=>AT%RLOUIS_GS2, &
 & RLOUIS_GS3=>AT%RLOUIS_GS3, RLOUIS_GS4=>AT%RLOUIS_GS4, &
 & PLOUIS_GS1=>AT%PLOUIS_GS1, PLOUIS_GS2=>AT%PLOUIS_GS2, &
 & PLOUIS_GS3=>AT%PLOUIS_GS3, PLOUIS_GS4=>AT%PLOUIS_GS4, &
 & RQNSE_S0=>AT%RQNSE_S0, RQNSE_GU1=>AT%RQNSE_GU1, &
 & RQNSE_GU2=>AT%RQNSE_GU2, RQNSE_GS1=>AT%RQNSE_GS1, &
 & RQNSE_GS2=>AT%RQNSE_GS2, RQNSE_GS3=>AT%RQNSE_GS3, &
 & RQNSE_GS4=>AT%RQNSE_GS4 )
