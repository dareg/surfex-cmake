...
IF (LHOOK) CALL DR_HOOK("SURFEX_ALLOC",0,ZHOOK_HANDLE)
  ...
  !
  !
  CALL DIAG_PATCH_INIT(YDSURFEX%GDM%VD%DP,NTEB_PATCH_MAX)  
  CALL DIAG_EVAP_ISBA_PATCH_INIT(YDSURFEX%GDM%VD%DEP,NTEB_PATCH_MAX)
  CALL DIAG_EVAP_ISBA_PATCH_INIT(YDSURFEX%GDM%VD%DEPC,NTEB_PATCH_MAX)
  CALL DIAG_MISC_ISBA_PATCH_INIT(YDSURFEX%GDM%VD%DMP,NTEB_PATCH_MAX)  
  !  
  ...
  !
  !
  CALL DIAG_PATCH_INIT(YDSURFEX%GRM%VD%DP,NTEB_PATCH_MAX)
  CALL DIAG_EVAP_ISBA_PATCH_INIT(YDSURFEX%GRM%VD%DEP,NTEB_PATCH_MAX)
  CALL DIAG_EVAP_ISBA_PATCH_INIT(YDSURFEX%GRM%VD%DEPC,NTEB_PATCH_MAX)
  CALL DIAG_MISC_ISBA_PATCH_INIT(YDSURFEX%GRM%VD%DMP,NTEB_PATCH_MAX)
  !
