...
!
GDDK   => GDM%VD%DP%AL(KTEB_P)
GDDEK  => GDM%VD%DEP%AL(KTEB_P)
GDDMK  => GDM%VD%DMP%AL(KTEB_P)
!
GRDK   => GRM%VD%DP%AL(KTEB_P)
GRDEK  => GRM%VD%DEP%AL(KTEB_P)
GRDMK  => GRM%VD%DMP%AL(KTEB_P)
!
ZDIR_SW(:) = 0.
ZSCA_SW(:) = 0.
!
