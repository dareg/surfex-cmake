!     #########
    SUBROUTINE TEB_GARDEN (TGD, TGDO, TGDPE, TGDP, TGR, TGRO, TGRPE, TGRP, TG, TIR, T, TOP, TVG, &
...
IF (OGARDEN) THEN
!
  CALL GARDEN(DTCO, DTI, DTGD, DTGR, IG, I, TGRO, &
              TGD, TGDO, TGDPE, TGDP, TG, TIR, T, TOP, TVG, &
...
!
  !
  CALL GREENROOF(DTCO, DTI, DTGD, DTGR, IG, I, &
