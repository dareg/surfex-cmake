...
PKDI%XP_SNOWDZ       => NULL()
PKDI%XP_SYTMASS      => NULL()

PKDI%XP_SNOWDEND     => NULL()
PKDI%XP_SNOWSPHER     => NULL()
PKDI%XP_SNOWSIZE     => NULL()
PKDI%XP_SNOWSSA     => NULL()
PKDI%XP_SNOWTYPEMEPRA     => NULL()
PKDI%XP_SNOWRAM     => NULL()
PKDI%XP_SNOWSHEAR     => NULL()
PKDI%XP_SNOWDEPTH_1DAYS     => NULL()
PKDI%XP_SNOWDEPTH_3DAYS     => NULL()
PKDI%XP_SNOWDEPTH_5DAYS     => NULL()
PKDI%XP_SNOWDEPTH_7DAYS     => NULL()
PKDI%XP_SNOWSWE_1DAYS     => NULL()
PKDI%XP_SNOWSWE_3DAYS     => NULL()
PKDI%XP_SNOWSWE_5DAYS     => NULL()
PKDI%XP_SNOWSWE_7DAYS     => NULL()
PKDI%XP_SNOWRAM_SONDE     => NULL()
PKDI%XP_SNOW_WETTHICKNESS     => NULL()
PKDI%XP_SNOW_REFROZENTHICKNESS     => NULL()
PKDI%XP_PRODCOUNT    => NULL()
PKDI%XP_SPEC_ALB     => NULL()
PKDI%XP_DIFF_RATIO     => NULL()
!
PKDI%XP_SNOWIMPUR     => NULL()
!
