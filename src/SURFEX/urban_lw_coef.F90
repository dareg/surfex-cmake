...
DO JJ=1,SIZE(T%XROAD)
  ...
  IF (PTS_SR(JJ) .EQ. XUNDEF) THEN
    ...
    PLW_S_TO_NR  (JJ) = 0.
  ELSE
    PLW_WA_TO_NR(JJ) = ZLW(T%XEMIS_WALL(JJ),T%TSNOW_ROAD%EMIS(JJ,1),ZF_R_W(JJ),T%XT_WALL_A(JJ,1),PTS_SR(JJ))
    PLW_WB_TO_NR(JJ) = ZLW(T%XEMIS_WALL(JJ),T%TSNOW_ROAD%EMIS(JJ,1),ZF_R_W(JJ),T%XT_WALL_B(JJ,1),PTS_SR(JJ))
    PLW_NR_TO_WA(JJ) = ZLW(T%TSNOW_ROAD%EMIS(JJ,1),T%XEMIS_WALL(JJ),ZF_W_NR(JJ),PTS_SR(JJ),T%XT_WALL_A(JJ,1))    
    PLW_NR_TO_WB(JJ) = ZLW(T%TSNOW_ROAD%EMIS(JJ,1),T%XEMIS_WALL(JJ),ZF_W_NR(JJ),PTS_SR(JJ),T%XT_WALL_B(JJ,1))    
    !
    PLW_WIN_TO_NR(JJ)= ZLW(ZEMIS_WIN(JJ),T%TSNOW_ROAD%EMIS(JJ,1),ZF_R_WIN(JJ),B%XT_WIN1(JJ),PTS_SR(JJ))
    PLW_NR_TO_WIN(JJ)= ZLW(T%TSNOW_ROAD%EMIS(JJ,1),ZEMIS_WIN(JJ),ZF_WIN_NR(JJ),PTS_SR(JJ),B%XT_WIN1(JJ))
    !
    PLW_S_TO_NR(JJ) = ZLW(1.,T%TSNOW_ROAD%EMIS(JJ,1),T%XSVF_ROAD(JJ),ZT_S(JJ),PTS_SR(JJ))
  ENDIF
  !
  ...
  !
ENDDO
!print*,'EMIS_WIN ',ZEMIS_WIN(32)
!print*,'EMIS_G ',PEMIS_G(32)
!print*,'F_WIN_G ',ZF_WIN_G(32)
!print*,'TS_G ',PTS_G(32)
!print*,'TS_WIN ',B%XT_WIN1(32)
!----------------------------
!-------------------------------------------------------------------------------
