...
REAL FUNCTION ZLW (PE1, PE2, PF, PT1, PT2)
REAL, INTENT (IN) :: PE1, PE2, PF, PT1, PT2

IF (PE1 == XUNDEF .OR. PE2 == XUNDEF .OR. PF == XUNDEF .OR. PT1 == XUNDEF .OR. PT2 == XUNDEF) THEN
  ZLW = 0.
ELSE
  ZLW = 4.*XSTEFAN*PE1*PE2*PF*((PT1+PT2)/2.)**3
ENDIF
