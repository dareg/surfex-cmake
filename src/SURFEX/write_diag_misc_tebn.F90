...
IF (TOP%LGARDEN) THEN
  ...
  !
  CALL WRITE_SURF(HSELECT,HPROGRAM,YRECFM,DMT%XRN_GARDEN(:),IRESP,HCOMMENT=YCOMMENT)
  !
  YRECFM='H_GD'
  YRECFM=ADJUSTL(YPATCH//YRECFM)
  YCOMMENT='GARDEN area sensible heat flux'//YRECFM//' (W/m2)'
  !
  CALL WRITE_SURF(HSELECT,HPROGRAM,YRECFM,DMT%XH_GARDEN(:),IRESP,HCOMMENT=YCOMMENT)
  !
  YRECFM='LE_GD'
  YRECFM=ADJUSTL(YPATCH//YRECFM)
  YCOMMENT='GARDEN area latent heat flux'//YRECFM//' (W/m2)'
  !
  CALL WRITE_SURF(HSELECT,HPROGRAM,YRECFM,DMT%XLE_GARDEN(:),IRESP,HCOMMENT=YCOMMENT)
  !
  YRECFM='GFLUX_GD'
  YRECFM=ADJUSTL(YPATCH//YRECFM)
  YCOMMENT='net GARDEN area conduction flux'//YRECFM//' (W/m2)'
  !
  CALL WRITE_SURF(HSELECT,HPROGRAM,YRECFM,DMT%XGFLUX_GARDEN(:),IRESP,HCOMMENT=YCOMMENT)
  !
  !
  YRECFM='RUNOFF_GD'
  YRECFM=ADJUSTL(YPATCH//YRECFM)
  ...
  !
  CALL WRITE_SURF(HSELECT,HPROGRAM,YRECFM,DMT%XRUNOFF_GARDEN(:),IRESP,HCOMMENT=YCOMMENT)
  !
  !
ENDIF
!
...
!
  ...
  !
    WHERE (T%XGREENROOF(:) == 0.)
      DMT%XRN_GREENROOF    (:) = XUNDEF   
      DMT%XH_GREENROOF     (:) = XUNDEF 
      DMT%XLE_GREENROOF    (:) = XUNDEF 
      DMT%XGFLUX_GREENROOF (:) = XUNDEF 
      DMT%XABS_SW_GREENROOF(:) = XUNDEF 
      DMT%XABS_LW_GREENROOF(:) = XUNDEF 
      DMT%XG_GREENROOF_ROOF(:) = XUNDEF 
      DMT%XRUNOFF_GREENROOF(:) = XUNDEF 
      DMT%XDRAIN_GREENROOF (:) = XUNDEF 
    END WHERE
    !
    YRECFM='RN_GR'
    YRECFM=ADJUSTL(YPATCH//YRECFM)
    YCOMMENT='net radiation for GREENROOFs'//' (W/m2)'
    CALL WRITE_SURF(HSELECT,HPROGRAM,YRECFM,DMT%XRN_GREENROOF(:),IRESP,HCOMMENT=YCOMMENT)
    !
    YRECFM='H_GR'
    YRECFM=ADJUSTL(YPATCH//YRECFM)
    YCOMMENT='sensible heat flux for GREENROOFs'//' (W/m2)'
    CALL WRITE_SURF(HSELECT,HPROGRAM,YRECFM,DMT%XH_GREENROOF(:),IRESP,HCOMMENT=YCOMMENT)
    !
    YRECFM='LE_GR'
    YRECFM=ADJUSTL(YPATCH//YRECFM)
    YCOMMENT='latent heat flux for GREENROOFs'//' (W/m2)'
    CALL WRITE_SURF(HSELECT,HPROGRAM,YRECFM,DMT%XLE_GREENROOF(:),IRESP,HCOMMENT=YCOMMENT)
    !
    YRECFM='GFLUX_GR'
    YRECFM=ADJUSTL(YPATCH//YRECFM)
    YCOMMENT='net conduction flux for GREENROOFs'//' (W/m2)'
    CALL WRITE_SURF(HSELECT,HPROGRAM,YRECFM,DMT%XGFLUX_GREENROOF(:),IRESP,HCOMMENT=YCOMMENT)
    !
    YRECFM='SWA_GR'
    YRECFM=ADJUSTL(YPATCH//YRECFM)
    ...
    CALL WRITE_SURF(HSELECT,HPROGRAM,YRECFM,DMT%XRUNOFF_GREENROOF(:),IRESP,HCOMMENT=YCOMMENT)
    !
    YRECFM='DRAIN_GR'
    YRECFM=ADJUSTL(YPATCH//YRECFM)
    YCOMMENT='GREENROOF total vertical drainage'//' (kg/m2/s)'
    CALL WRITE_SURF(HSELECT,HPROGRAM,YRECFM,DMT%XDRAIN_GREENROOF(:),IRESP,HCOMMENT=YCOMMENT)
  !
...
!
  ...
  IF (TOP%LGARDEN) THEN
    ...
    CALL WRITE_SURF(HSELECT,HPROGRAM,YRECFM,DMTC%XRUNOFF_GARDEN(:),IRESP,HCOMMENT=YCOMMENT)
    !
    YRECFM='DRAINC_GD'
    YRECFM=ADJUSTL(YPATCH//YRECFM)
    YCOMMENT='cumulated garden surface drainage'//' (kg/m2 garden)'
    CALL WRITE_SURF(HSELECT,HPROGRAM,YRECFM,DMTC%XDRAIN_GARDEN(:),IRESP,HCOMMENT=YCOMMENT)
    !
    YRECFM='IRRIGC_GD'
    YRECFM=ADJUSTL(YPATCH//YRECFM)
  ...
  IF (TOP%LGREENROOF) THEN
    !
    WHERE (T%XGREENROOF(:) == 0.)
      DMTC%XRUNOFF_GREENROOF (:) = XUNDEF   
      DMTC%XDRAIN_GREENROOF  (:) = XUNDEF 
    ...
    CALL WRITE_SURF(HSELECT,HPROGRAM,YRECFM,DMTC%XRUNOFF_GREENROOF(:),IRESP,HCOMMENT=YCOMMENT)
    !
    YRECFM='DRAINC_GR'
    YRECFM=ADJUSTL(YPATCH//YRECFM)
    YCOMMENT='GREENROOF cumulated total vertical drainage'//' (kg/m2 greenroof)'
    CALL WRITE_SURF(HSELECT,HPROGRAM,YRECFM,DMTC%XDRAIN_GREENROOF(:),IRESP,HCOMMENT=YCOMMENT)
    !
    !
    YRECFM='IRRIGC_GR'
    YRECFM=ADJUSTL(YPATCH//YRECFM)
