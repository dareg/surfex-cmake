...
USE MODD_TEB_GARDEN_PGD_EVOL_n,   ONLY : XLAI, XVEG, XZ0, XEMIS, XALBNIR, XALBVIS, XALBUV
USE MODD_TEB_GARDEN_PGD_n,        ONLY : XALBNIR_SOIL,XALBVIS_SOIL,XALBUV_SOIL,     &
                                         XRSMIN, XGAMMA, XRGL, XCV, XDG, XWRMAX_CF, &
                                         XVEGTYPE, XD_ICE  
!
