...
!
 CALL WRITE_SURF(HPROGRAM,YRECFM,TGDPE%XVEG(:),IRESP,HCOMMENT=YCOMMENT)
!
...
!
 CALL WRITE_SURF(HPROGRAM,YRECFM,TGDPE%XZ0(:),IRESP,HCOMMENT=YCOMMENT)
!
!-------------------------------------------------------------------------------
!
...
YCOMMENT='surface emissivity (-)'
 CALL WRITE_SURF(HPROGRAM,YRECFM,TGDPE%XEMIS(:),IRESP,HCOMMENT=YCOMMENT)
!
YRECFM='GD_WRMAX_CF'
...
!
   ...
   CALL WRITE_SURF(HPROGRAM,YRECFM,TGDPE%XALBNIR(:),IRESP,HCOMMENT=YCOMMENT)
!
!-------------------------------------------------------------------------------
!
   YRECFM='GD_ALBVIS_T'
   YCOMMENT='total visible albedo (-)'
   CALL WRITE_SURF(HPROGRAM,YRECFM,TGDPE%XALBVIS(:),IRESP,HCOMMENT=YCOMMENT)
!
!-------------------------------------------------------------------------------
!
   YRECFM='GD_ALBUV_T'
   YCOMMENT='total UV albedo (-)'
   CALL WRITE_SURF(HPROGRAM,YRECFM,TGDPE%XALBUV(:),IRESP,HCOMMENT=YCOMMENT)
!
END IF
!
!-------------------------------------------------------------------------------
