...
USE MODD_TEB_GARDEN_n,   ONLY : XLAI, XVEG, XZ0,XALBNIR_SOIL,XALBVIS_SOIL,XALBUV_SOIL,&
                                XRSMIN, XGAMMA, XRGL, XCV, XEMIS, XDG, XWRMAX_CF,     &
                                XVEGTYPE, XALBNIR, XALBVIS, XALBUV, XD_ICE  
!
...
DO JL=1,SIZE(XVEGTYPE,2)
  ...
  WRITE(YRECFM,FMT='(A13)') 'G_VEGTYPE_P'//YLVLV
