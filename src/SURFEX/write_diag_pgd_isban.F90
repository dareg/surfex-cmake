...
DO JP = 1,IO%NPATCH
  CALL  WRITE_FIELD_1D_PATCH(HSELECT,HPROGRAM,YRECFM,YCOMMENT,JP,&
              NP%AL(JP)%NR_P,NPE%AL(JP)%XVEG(:),ILU)
ENDDO  
!
...
DO JP = 1,IO%NPATCH
  CALL  WRITE_FIELD_1D_PATCH(HSELECT,HPROGRAM,YRECFM,YCOMMENT,JP,&
              NP%AL(JP)%NR_P,NPE%AL(JP)%XZ0(:),ILU)
ENDDO
!
...
DO JP = 1,IO%NPATCH
  CALL  WRITE_FIELD_1D_PATCH(HSELECT,HPROGRAM,YRECFM,YCOMMENT,JP,&
              NP%AL(JP)%NR_P,NPE%AL(JP)%XGNDLITTER(:),ILU)
ENDDO    
  !
  YRECFM='Z0LITTER'
...
DO JP = 1,IO%NPATCH
  CALL  WRITE_FIELD_1D_PATCH(HSELECT,HPROGRAM,YRECFM,YCOMMENT,JP,&
              NP%AL(JP)%NR_P,NPE%AL(JP)%XZ0LITTER(:),ILU)
ENDDO    
  !
ENDIF
!
...
DO JP = 1,IO%NPATCH
  CALL  WRITE_FIELD_1D_PATCH(HSELECT,HPROGRAM,YRECFM,YCOMMENT,JP,&
              NP%AL(JP)%NR_P,NP%AL(JP)%XDG(:,JL),ILU)
ENDDO    
END DO
!
!* Averaged Soil depth
...
IF(IO%CISBA=='DIF')THEN
  ...
  DO JP = 1,IO%NPATCH
    CALL  WRITE_FIELD_1D_PATCH(HSELECT,HPROGRAM,YRECFM,YCOMMENT,JP,&
                NP%AL(JP)%NR_P,NP%AL(JP)%XDROOT(:),ILU)
  ENDDO    
  !
  YRECFM='DG2_DIF'
  ...
  DO JP = 1,IO%NPATCH
    CALL  WRITE_FIELD_1D_PATCH(HSELECT,HPROGRAM,YRECFM,YCOMMENT,JP,&
              NP%AL(JP)%NR_P,NP%AL(JP)%XDG2(:),ILU)
  ENDDO    
  !  
  IF(IO%NPATCH>1)THEN
    YRECFM='DG2_DIF_ISBA'
  ...
  DO JP = 1,IO%NPATCH
    CALL  WRITE_FIELD_1D_PATCH(HSELECT,HPROGRAM,YRECFM,YCOMMENT,JP,&
                NP%AL(JP)%NR_P,NP%AL(JP)%XRUNOFFD(:),ILU)
  ENDDO    
  !
...
IF(IO%CHORT=='SGH'.AND.IO%CISBA/='DIF')THEN
  ...
  DO JP = 1,IO%NPATCH
    CALL  WRITE_FIELD_1D_PATCH(HSELECT,HPROGRAM,YRECFM,YCOMMENT,JP,&
                NP%AL(JP)%NR_P,NP%AL(JP)%XD_ICE(:),ILU)
  ENDDO    
ENDIF
!
!-------------------------------------------------------------------------------
...
!
  DO JL=1,SIZE(S%XVEGTYPE_PATCH,2)
    ...
    DO JP = 1,IO%NPATCH
      CALL  WRITE_FIELD_1D_PATCH(HSELECT,HPROGRAM,YRECFM,YCOMMENT,JP,&
                  NP%AL(JP)%NR_P,NP%AL(JP)%XVEGTYPE_PATCH(:,JL),ILU)
    ENDDO      
  END DO
!
ENDIF
...
DO JP = 1,IO%NPATCH
  CALL  WRITE_FIELD_1D_PATCH(HSELECT,HPROGRAM,YRECFM,YCOMMENT,JP,&
              NP%AL(JP)%NR_P,NPE%AL(JP)%XRSMIN(:),ILU)
ENDDO
!
YRECFM='GAMMA'
...
DO JP = 1,IO%NPATCH
  CALL  WRITE_FIELD_1D_PATCH(HSELECT,HPROGRAM,YRECFM,YCOMMENT,JP,&
              NP%AL(JP)%NR_P,NPE%AL(JP)%XGAMMA(:),ILU)
ENDDO
!
YRECFM='CV'
...
DO JP = 1,IO%NPATCH
  CALL  WRITE_FIELD_1D_PATCH(HSELECT,HPROGRAM,YRECFM,YCOMMENT,JP,&
              NP%AL(JP)%NR_P,NPE%AL(JP)%XCV(:),ILU)
ENDDO
!
YRECFM='RGL'
...
DO JP = 1,IO%NPATCH
  CALL  WRITE_FIELD_1D_PATCH(HSELECT,HPROGRAM,YRECFM,YCOMMENT,JP,&
              NP%AL(JP)%NR_P,NPE%AL(JP)%XRGL(:),ILU)
ENDDO
!
YRECFM='EMIS'
...
DO JP = 1,IO%NPATCH
  CALL  WRITE_FIELD_1D_PATCH(HSELECT,HPROGRAM,YRECFM,YCOMMENT,JP,&
              NP%AL(JP)%NR_P,NPE%AL(JP)%XEMIS(:),ILU)
ENDDO
!
YRECFM='WRMAX_CF'
...
DO JP = 1,IO%NPATCH
  CALL  WRITE_FIELD_1D_PATCH(HSELECT,HPROGRAM,YRECFM,YCOMMENT,JP,&
              NP%AL(JP)%NR_P,NPE%AL(JP)%XWRMAX_CF(:),ILU)
ENDDO
!
IF (ISIZE_LMEB_PATCH>0) THEN
  !
  ...
  DO JP = 1,IO%NPATCH
    CALL  WRITE_FIELD_1D_PATCH(HSELECT,HPROGRAM,YRECFM,YCOMMENT,JP,&
                NP%AL(JP)%NR_P,NPE%AL(JP)%XH_VEG(:),ILU)
  ENDDO
  !
ENDIF
!
...
!
  ...
  DO JP = 1,IO%NPATCH
    CALL  WRITE_FIELD_1D_PATCH(HSELECT,HPROGRAM,YRECFM,YCOMMENT,JP,&
               NP%AL(JP)%NR_P,NPE%AL(JP)%XALBNIR_SOIL(:),ILU)
  ENDDO
!
!-------------------------------------------------------------------------------
!
  ...
  DO JP = 1,IO%NPATCH
    CALL  WRITE_FIELD_1D_PATCH(HSELECT,HPROGRAM,YRECFM,YCOMMENT,JP,&
               NP%AL(JP)%NR_P,NPE%AL(JP)%XALBVIS_SOIL(:),ILU)
  ENDDO
!
!-------------------------------------------------------------------------------
!
  ...
  DO JP = 1,IO%NPATCH
    CALL  WRITE_FIELD_1D_PATCH(HSELECT,HPROGRAM,YRECFM,YCOMMENT,JP,&
                NP%AL(JP)%NR_P,NPE%AL(JP)%XALBUV_SOIL(:),ILU)
  ENDDO
!
!-------------------------------------------------------------------------------
!
...
!
  ...
  DO JP = 1,IO%NPATCH
    CALL  WRITE_FIELD_1D_PATCH(HSELECT,HPROGRAM,YRECFM,YCOMMENT,JP,&
                NP%AL(JP)%NR_P,NPE%AL(JP)%XALBNIR(:),ILU)
  ENDDO
!
!-------------------------------------------------------------------------------
!
  ...
  DO JP = 1,IO%NPATCH
    CALL  WRITE_FIELD_1D_PATCH(HSELECT,HPROGRAM,YRECFM,YCOMMENT,JP,&
                NP%AL(JP)%NR_P,NPE%AL(JP)%XALBVIS(:),ILU)
  ENDDO
!
!-------------------------------------------------------------------------------
!
  ...
  DO JP = 1,IO%NPATCH
    CALL  WRITE_FIELD_1D_PATCH(HSELECT,HPROGRAM,YRECFM,YCOMMENT,JP,&
                NP%AL(JP)%NR_P,NPE%AL(JP)%XALBUV(:),ILU)
  ENDDO
!
END IF
!
...
IF (CHI%CCH_DRY_DEP=='WES89' .AND. CHI%SVI%NBEQ>0) THEN
  ...
  DO JP = 1,IO%NPATCH
    CALL  WRITE_FIELD_1D_PATCH(HSELECT,HPROGRAM,YRECFM,YCOMMENT,JP,&
                NP%AL(JP)%NR_P,NCHI%AL(JP)%XSOILRC_SO2(:),ILU)
  ENDDO  
  !
  YRECFM='SOILRC_O3'
  ...
  DO JP = 1,IO%NPATCH
    CALL  WRITE_FIELD_1D_PATCH(HSELECT,HPROGRAM,YRECFM,YCOMMENT,JP,&
                NP%AL(JP)%NR_P,NCHI%AL(JP)%XSOILRC_O3(:),ILU)
  ENDDO   
END IF
!
!-------------------------------------------------------------------------------
...
!
  ...
  DO JP = 1,IO%NPATCH
    CALL  WRITE_TFIELD_1D_PATCH(HSELECT,HPROGRAM,YRECFM,YCOMMENT,JP,&
                NP%AL(JP)%NR_P,NPE%AL(JP)%TSEED(:),ILU)
  ENDDO
!
  YRECFM='TREAP'
...
!
  DO JP = 1,IO%NPATCH
    CALL  WRITE_TFIELD_1D_PATCH(HSELECT,HPROGRAM,YRECFM,YCOMMENT,JP,&
                NP%AL(JP)%NR_P,NPE%AL(JP)%TREAP(:),ILU)
  ENDDO
!
!-------------------------------------------------------------------------------
!
...
!
  DO JP = 1,IO%NPATCH
    CALL  WRITE_FIELD_1D_PATCH(HSELECT,HPROGRAM,YRECFM,YCOMMENT,JP,&
                NP%AL(JP)%NR_P,NPE%AL(JP)%XIRRIG(:),ILU)
  ENDDO
!
!-------------------------------------------------------------------------------
!
...
!
  DO JP = 1,IO%NPATCH
    CALL  WRITE_FIELD_1D_PATCH(HSELECT,HPROGRAM,YRECFM,YCOMMENT,JP,&
                NP%AL(JP)%NR_P,NPE%AL(JP)%XWATSUP(:),ILU)
  ENDDO
!
ENDIF
!
