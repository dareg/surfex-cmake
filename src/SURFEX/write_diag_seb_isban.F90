...
! Fluxes by patch  
    DGEI%XLEG(:,:)=DGEI%XLEGC(:,:)/XTSTEP_OUTPUT
    DGEI%XLEGI(:,:)=DGEI%XLEGIC(:,:)/XTSTEP_OUTPUT
    DGEI%XLEV(:,:)=DGEI%XLEVC(:,:)/XTSTEP_OUTPUT
    DGEI%XLES(:,:)=DGEI%XLESAC(:,:)/XTSTEP_OUTPUT
    DGEI%XLESL(:,:)=DGEI%XLESLC(:,:)/XTSTEP_OUTPUT
    DGEI%XSNDRIFT(:,:)=DGEI%XSNDRIFTC(:,:)/XTSTEP_OUTPUT
    DGEI%XLER(:,:)=DGEI%XLERC(:,:)/XTSTEP_OUTPUT
    DGEI%XLETR(:,:)=DGEI%XLETRC(:,:)/XTSTEP_OUTPUT
    DGEI%XEVAP(:,:)=DGEI%XEVAPC(:,:)/XTSTEP_OUTPUT
    DGEI%XSUBL(:,:)=DGEI%XSUBLC(:,:)/XTSTEP_OUTPUT
    DGEI%XDRAIN(:,:)=DGEI%XDRAINC(:,:)/XTSTEP_OUTPUT
    DGEI%XQSB(:,:)=DGEI%XQSBC(:,:)/XTSTEP_OUTPUT
    DGEI%XRUNOFF(:,:)=DGEI%XRUNOFFC(:,:)/XTSTEP_OUTPUT
    DGEI%XHORT(:,:)=DGEI%XHORTC(:,:)/XTSTEP_OUTPUT
    DGEI%XDRIP(:,:)=DGEI%XDRIPC(:,:)/XTSTEP_OUTPUT
    DGEI%XRRVEG(:,:)=DGEI%XRRVEGC(:,:)/XTSTEP_OUTPUT
    DGEI%XMELT(:,:)=DGEI%XMELTC(:,:)/XTSTEP_OUTPUT
    DGI%XRN(:,:)=DGEI%XRNC(:,:)/XTSTEP_OUTPUT
    DGI%XH(:,:)=DGEI%XHC(:,:)/XTSTEP_OUTPUT
    I%XLE(:,:)=DGEI%XLEC(:,:)/XTSTEP_OUTPUT
    DGI%XLEI(:,:)=DGEI%XLEIC(:,:)/XTSTEP_OUTPUT
    DGI%XGFLUX(:,:)=DGEI%XGFLUXC(:,:)/XTSTEP_OUTPUT
    IF (DGEI%LWATER_BUDGET) THEN
      DGEI%XDWG(:,:)=DGEI%XDWGC(:,:)/XTSTEP_OUTPUT
      DGEI%XDWGI(:,:)=DGEI%XDWGIC(:,:)/XTSTEP_OUTPUT
      DGEI%XDWR(:,:)=DGEI%XDWRC(:,:)/XTSTEP_OUTPUT
      DGEI%XDSWE(:,:)=DGEI%XDSWEC(:,:)/XTSTEP_OUTPUT
      DGEI%XWATBUD(:,:)=DGEI%XWATBUDC(:,:)/XTSTEP_OUTPUT
    END IF
    DGI%XSWD(:,:)=DGI%XSWDC(:,:)/XTSTEP_OUTPUT
    DGI%XSWU(:,:)=DGI%XSWUC(:,:)/XTSTEP_OUTPUT
    DGI%XLWD(:,:)=DGI%XLWDC(:,:)/XTSTEP_OUTPUT
    DGI%XLWU(:,:)=DGI%XLWUC(:,:)/XTSTEP_OUTPUT
! Averaged fluxes (over all patches)  
    DGEI%XAVG_LEG(:)=DGEI%XAVG_LEGC(:)/XTSTEP_OUTPUT
    DGEI%XAVG_LEGI(:)=DGEI%XAVG_LEGIC(:)/XTSTEP_OUTPUT
    DGEI%XAVG_LEV(:)=DGEI%XAVG_LEVC(:)/XTSTEP_OUTPUT
    DGEI%XAVG_LES(:)=DGEI%XAVG_LESAC(:)/XTSTEP_OUTPUT
    DGEI%XAVG_LESL(:)=DGEI%XAVG_LESLC(:)/XTSTEP_OUTPUT
    DGEI%XAVG_SNDRIFT(:)=DGEI%XAVG_SNDRIFTC(:)/XTSTEP_OUTPUT
    DGEI%XAVG_LER(:)=DGEI%XAVG_LERC(:)/XTSTEP_OUTPUT
    DGEI%XAVG_LETR(:)=DGEI%XAVG_LETRC(:)/XTSTEP_OUTPUT
    DGEI%XAVG_EVAP(:)=DGEI%XAVG_EVAPC(:)/XTSTEP_OUTPUT
    DGEI%XAVG_SUBL(:)=DGEI%XAVG_SUBLC(:)/XTSTEP_OUTPUT
    DGEI%XAVG_DRAIN(:)=DGEI%XAVG_DRAINC(:)/XTSTEP_OUTPUT
    DGEI%XAVG_QSB(:)=DGEI%XAVG_QSBC(:)/XTSTEP_OUTPUT
    DGEI%XAVG_RUNOFF(:)=DGEI%XAVG_RUNOFFC(:)/XTSTEP_OUTPUT
    DGEI%XAVG_HORT(:)=DGEI%XAVG_HORTC(:)/XTSTEP_OUTPUT
    DGEI%XAVG_DRIP(:)=DGEI%XAVG_DRIPC(:)/XTSTEP_OUTPUT
    DGEI%XAVG_RRVEG(:)=DGEI%XAVG_RRVEGC(:)/XTSTEP_OUTPUT
    DGEI%XAVG_MELT(:)=DGEI%XAVG_MELTC(:)/XTSTEP_OUTPUT
    DGI%XAVG_RN(:)=DGEI%XAVG_RNC(:)/XTSTEP_OUTPUT
    DGI%XAVG_H(:)=DGEI%XAVG_HC(:)/XTSTEP_OUTPUT
    DGI%XAVG_LE(:)=DGEI%XAVG_LEC(:)/XTSTEP_OUTPUT
    DGI%XAVG_LEI(:)=DGEI%XAVG_LEIC(:)/XTSTEP_OUTPUT
    DGI%XAVG_GFLUX(:)=DGEI%XAVG_GFLUXC(:)/XTSTEP_OUTPUT
    IF (DGEI%LWATER_BUDGET) THEN
      DGEI%XAVG_DWG(:)=DGEI%XAVG_DWGC(:)/XTSTEP_OUTPUT
      DGEI%XAVG_DWGI(:)=DGEI%XAVG_DWGIC(:)/XTSTEP_OUTPUT
      DGEI%XAVG_DWR(:)=DGEI%XAVG_DWRC(:)/XTSTEP_OUTPUT
      DGEI%XAVG_DSWE(:)=DGEI%XAVG_DSWEC(:)/XTSTEP_OUTPUT
      DGEI%XAVG_WATBUD(:)=DGEI%XAVG_WATBUDC(:)/XTSTEP_OUTPUT
    ENDIF
    DGI%XAVG_SWD(:)=DGI%XAVG_SWDC(:)/XTSTEP_OUTPUT
    DGI%XAVG_SWU(:)=DGI%XAVG_SWUC(:)/XTSTEP_OUTPUT
    DGI%XAVG_LWD(:)=DGI%XAVG_LWDC(:)/XTSTEP_OUTPUT
    DGI%XAVG_LWU(:)=DGI%XAVG_LWUC(:)/XTSTEP_OUTPUT      
  END IF
#endif
