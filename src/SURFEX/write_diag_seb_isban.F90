...
#endif
!
USE MODD_XIOS, ONLY : LXIOS, LALLOW_ADD_DIM, YGROUND_LAYER_DIM_NAME, &
...
IF (ISIZE_LMEB_PATCH>0) THEN
  ...
  DO JP=1,IO%NPATCH
    CALL WRITE_FIELD_1D_PATCH(DUO%CSELECT,HPROGRAM,YRECFM,YCOMMENT,JP,&
        NP%AL(JP)%NR_P,NDEA%AL(JP)%XLEV_CV(:),ISIZE)
  ENDDO
  !
  YRECFM='LES_CV'//TRIM(HTERM)
  YCOMMENT='X_Y_'//YRECFM//' (W/m2)'
  DO JP=1,IO%NPATCH
    CALL WRITE_FIELD_1D_PATCH(DUO%CSELECT,HPROGRAM,YRECFM,YCOMMENT,JP,&
        NP%AL(JP)%NR_P,NDEA%AL(JP)%XLES_CV(:),ISIZE)
  ENDDO
  !
  YRECFM='LETR_CV'//TRIM(HTERM)
  YCOMMENT='X_Y_'//YRECFM//' (W/m2)'
  DO JP=1,IO%NPATCH
    CALL WRITE_FIELD_1D_PATCH(DUO%CSELECT,HPROGRAM,YRECFM,YCOMMENT,JP,&
        NP%AL(JP)%NR_P,NDEA%AL(JP)%XLETR_CV(:),ISIZE)
  ENDDO
  !
  YRECFM='LER_CV'//TRIM(HTERM)
  YCOMMENT='X_Y_'//YRECFM//' (W/m2)'
  DO JP=1,IO%NPATCH
    CALL WRITE_FIELD_1D_PATCH(DUO%CSELECT,HPROGRAM,YRECFM,YCOMMENT,JP,&
        NP%AL(JP)%NR_P,NDEA%AL(JP)%XLER_CV(:),ISIZE)
  ENDDO
  !
  YRECFM='LE_CV'//TRIM(HTERM)
  YCOMMENT='X_Y_'//YRECFM//' (W/m2)'
  DO JP=1,IO%NPATCH
    CALL WRITE_FIELD_1D_PATCH(DUO%CSELECT,HPROGRAM,YRECFM,YCOMMENT,JP,&
        NP%AL(JP)%NR_P,NDEA%AL(JP)%XLE_CV(:),ISIZE)
  ENDDO
  !
  YRECFM='H_CV'//TRIM(HTERM)
  YCOMMENT='X_Y_'//YRECFM//' (W/m2)'
  DO JP=1,IO%NPATCH
    CALL WRITE_FIELD_1D_PATCH(DUO%CSELECT,HPROGRAM,YRECFM,YCOMMENT,JP,&
        NP%AL(JP)%NR_P,NDEA%AL(JP)%XH_CV(:),ISIZE)
  ENDDO  
  !
  YRECFM='MELT_CV'//TRIM(HTERM)
  YCOMMENT='X_Y_'//YRECFM//' (kg/m2/s)'
  DO JP=1,IO%NPATCH
    CALL WRITE_FIELD_1D_PATCH(DUO%CSELECT,HPROGRAM,YRECFM,YCOMMENT,JP,&
        NP%AL(JP)%NR_P,NDEA%AL(JP)%XMELT_CV(:),ISIZE)
  ENDDO
  !
  YRECFM='FRZ_CV'//TRIM(HTERM)
  YCOMMENT='X_Y_'//YRECFM//' (kg/m2/s)'
  DO JP=1,IO%NPATCH
    CALL WRITE_FIELD_1D_PATCH(DUO%CSELECT,HPROGRAM,YRECFM,YCOMMENT,JP,&
        NP%AL(JP)%NR_P,NDEA%AL(JP)%XFRZ_CV(:),ISIZE)
  ENDDO  
  !
  YRECFM='LE_GV'//TRIM(HTERM)
  YCOMMENT='X_Y_'//YRECFM//' (W/m2)'
  DO JP=1,IO%NPATCH
    CALL WRITE_FIELD_1D_PATCH(DUO%CSELECT,HPROGRAM,YRECFM,YCOMMENT,JP,&
        NP%AL(JP)%NR_P,NDEA%AL(JP)%XLE_GV(:),ISIZE)
  ENDDO  
  !
  YRECFM='H_GV'//TRIM(HTERM)
  YCOMMENT='X_Y_'//YRECFM//' (W/m2)'
  DO JP=1,IO%NPATCH
    CALL WRITE_FIELD_1D_PATCH(DUO%CSELECT,HPROGRAM,YRECFM,YCOMMENT,JP,&
        NP%AL(JP)%NR_P,NDEA%AL(JP)%XH_GV(:),ISIZE)
  ENDDO  
  !
  YRECFM='LE_GN'//TRIM(HTERM)
  YCOMMENT='X_Y_'//YRECFM//' (W/m2)'
  DO JP=1,IO%NPATCH
    CALL WRITE_FIELD_1D_PATCH(DUO%CSELECT,HPROGRAM,YRECFM,YCOMMENT,JP,&
        NP%AL(JP)%NR_P,NDEA%AL(JP)%XLE_GN(:),ISIZE)
  ENDDO 
  !
  YRECFM='H_GN'//TRIM(HTERM)
  YCOMMENT='X_Y_'//YRECFM//' (W/m2)'
  DO JP=1,IO%NPATCH
    CALL WRITE_FIELD_1D_PATCH(DUO%CSELECT,HPROGRAM,YRECFM,YCOMMENT,JP,&
        NP%AL(JP)%NR_P,NDEA%AL(JP)%XH_GN(:),ISIZE)
  ENDDO
  !
  YRECFM='SR_GN'//TRIM(HTERM)
  YCOMMENT='X_Y_'//YRECFM//' (kg/m2/s)'
  ...
  DO JP=1,IO%NPATCH
    CALL WRITE_FIELD_1D_PATCH(DUO%CSELECT,HPROGRAM,YRECFM,YCOMMENT,JP,&
        NP%AL(JP)%NR_P,NDEA%AL(JP)%XLE_CA(:),ISIZE)
  ENDDO
  !
  YRECFM='H_CA'//TRIM(HTERM)
  YCOMMENT='X_Y_'//YRECFM//' (W/m2)'
  DO JP=1,IO%NPATCH
    CALL WRITE_FIELD_1D_PATCH(DUO%CSELECT,HPROGRAM,YRECFM,YCOMMENT,JP,&
        NP%AL(JP)%NR_P,NDEA%AL(JP)%XH_CA(:),ISIZE)
  ENDDO  
  !
  YRECFM='SWNT_V'//TRIM(HTERM)
  YCOMMENT='X_Y_'//YRECFM//' (W/m2)'
