...
!RJ: extended ascii should be avoided in I/O
  ...
  CALL WRITE_SURF(DUO%CSELECT,HPROGRAM,YRECFM,DUT%XUTCI_IN(:),IRESP,HCOMMENT=YCOMMENT)
  !
  YRECFM='UTCI_OUTSUN'
!RJ: extended ascii should be avoided in I/O
...
!RJ: extended ascii should be avoided in I/O
  ...
  DO JSTRESS=1,NUTCI_STRESS
    ...
    CALL WRITE_SURF(DUO%CSELECT,HPROGRAM,YRECFM,DUT%XUTCIC_IN(:,JSTRESS),IRESP,HCOMMENT=YCOMMENT)
  END DO
  !
  DO JSTRESS=1,NUTCI_STRESS
