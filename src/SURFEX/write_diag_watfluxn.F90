!     #########
SUBROUTINE WRITE_DIAG_WATFLUX_n (BOP, BDD, CHE, CHI, CHS, CHN, CHU, CHT, DTCO, DTS, DTT, &
...
!        
   IF (DGW%XDIAG_TSTEP==XUNDEF .OR. ABS(NINT(W%TTIME%TIME/DGW%XDIAG_TSTEP)*DGW%XDIAG_TSTEP-W%TTIME%TIME)<1.E-3 ) THEN
      CALL WRITE_DIAG_SEB_WATFLUX_n(BOP, BDD, CHE, CHI, CHS, CHN, CHU, CHT, DTCO, DTS, DTT, &
                                            DTZ, DGEI, DGF, DGI, DGMI, DGMTO, DGO, DGS, DGSI, DGT, DGUT, &
                                            F, FSB, GB, IOB, ICP, I, O, S, SSB, UG, U, &
