!     #######################
      SUBROUTINE WRITE_ECOCLIMAP2_DATA(HPROGRAM)
!     #######################
!
USE MODI_WRITE_SURF
!
...
YCOMMENT='FLAG TO READ USER IRRIGATION DATA FOR ECOCLIMAP2'
 CALL WRITE_SURF(HPROGRAM,YRECFM,LDATA_IRRIG,IRESP,YCOMMENT)
!
YRECFM='LCLIM_LAI'
YCOMMENT='FLAG TO USE CLIMATOLOGICAL LAI'
 CALL WRITE_SURF(HPROGRAM,YRECFM,LCLIM_LAI,IRESP,YCOMMENT)
!
...
DO JCOVER=1,JPCOVER
  ...
  CALL WRITE_SURF(HPROGRAM,YRECFM,ZWORK,IRESP,YCOMMENT,'-',"Irrig_parameters")
END DO
