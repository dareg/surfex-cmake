...
!
  CALL GET_GRIDTYPE_CONF_PROJ(UG%XGRID_FULL_PAR,ZLAPO,ZLOPO,ZPRPK,ZBETA, &
...
!
  ...
  ALLOCATE(ZDY(ICOUNT))
!
  CALL GET_GRIDTYPE_CONF_PROJ(UG%XGRID_FULL_PAR,PDX=ZDX,PDY=ZDY)
!
  ALLOCATE(ZSINLA(18))
  ALLOCATE(INLOPA(8))
...
!
  CALL GET_GRIDTYPE_LONLAT_REG(UG%XGRID_FULL_PAR,ZLONMIN,ZLONMAX, &
...
!
  CALL GET_GRIDTYPE_GAUSS(UG%XGRID_FULL_PAR,KNLATI=INLATI,KL=IL)
!
...
!
  ALLOCATE(ZLAT_XY(IL))
!
  CALL GET_GRIDTYPE_GAUSS(UG%XGRID_FULL_PAR,PLAPO=ZLAPO,PLOPO=ZLOPO,          &
