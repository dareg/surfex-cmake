!     #########
      SUBROUTINE WRITE_INLAND_WATER_n (DTCO, DGU, IOB, U, CHW, W, WSB, CHF, DGMF, F, FSB, &
                                       HPROGRAM,HWRITE)
!     ####################################
!
...
IF (U%CWATER=='WATFLX') THEN
  CALL WRITE_WATFLUX_n(DTCO, DGU, IOB, U, CHW, W, WSB, &
                       HPROGRAM,HWRITE)
ELSE IF (U%CWATER=='FLAKE ') THEN
  CALL WRITE_FLAKE_n(DTCO, DGU, IOB, U, CHF, DGMF, F, FSB, &
                     HPROGRAM,HWRITE)
END IF
