...
IF (U%CWATER=='WATFLX') THEN
  CALL WRITE_WATFLUX_n(BOP, BDD, CHE, CHI, CHS, CHN, CHU, CHT, DTCO, DTS, DTT, &
                                   DTZ, DGEI, DGF, DGI, DGMI, DGMTO, DGO, DGS, DGSI, DGT, DGUT, &
                                   DGW, F, FSB, GB, IOB, ICP, I, O, S, SSB, UG, &
                                   U, SV, TCP, TGD, TGDO, TGR, TGRO, T, TOP, TVG, &
                       CHW, DGU, W, WSB, &
                       HPROGRAM,HWRITE)
ELSE IF (U%CWATER=='FLAKE ') THEN
  CALL WRITE_FLAKE_n(BOP, BDD, CHE, CHI, CHS, CHN, CHU, CHT, CHW, DTCO, DTS, &
                                 DTT, DTZ, DGEI, DGF, DGI, DGMI, DGMTO, DGO, DGS, DGSI, DGT, &
                                 DGUT, DGW, GB, IOB, ICP, I, O, S, SSB, UG, U, &
