...
!
 CALL WRITE_SURF(HPROGRAM,'SEA   ',U%CSEA   ,IRESP,YCOMMENT)
 CALL WRITE_SURF(HPROGRAM,'WATER ',U%CWATER ,IRESP,YCOMMENT)
 CALL WRITE_SURF(HPROGRAM,'NATURE',U%CNATURE,IRESP,YCOMMENT)
 CALL WRITE_SURF(HPROGRAM,'TOWN  ',U%CTOWN  ,IRESP,YCOMMENT)
!
 CALL WRITE_SURF(HPROGRAM,'DIM_FULL  ',U%NDIM_FULL,  IRESP,HCOMMENT=YCOMMENT)
 CALL WRITE_SURF(HPROGRAM,'DIM_SEA   ',U%NDIM_SEA,   IRESP,HCOMMENT=YCOMMENT)
 CALL WRITE_SURF(HPROGRAM,'DIM_NATURE',U%NDIM_NATURE,IRESP,HCOMMENT=YCOMMENT)
 CALL WRITE_SURF(HPROGRAM,'DIM_WATER ',U%NDIM_WATER, IRESP,HCOMMENT=YCOMMENT)
 CALL WRITE_SURF(HPROGRAM,'DIM_TOWN  ',U%NDIM_TOWN,  IRESP,HCOMMENT=YCOMMENT)
 CALL WRITE_SURF(HPROGRAM,'ECOCLIMAP ',U%LECOCLIMAP ,IRESP,YCOMMENT)
 CALL WRITE_SURF(HPROGRAM,'WATER_TO_NAT',U%LWATER_TO_NATURE,IRESP,YCOMMENT)
 CALL WRITE_SURF(HPROGRAM,'TOWN_TO_ROCK',U%LTOWN_TO_ROCK,IRESP,YCOMMENT)
 CALL WRITE_SURF(HPROGRAM,'GARDEN',U%LGARDEN,IRESP,YCOMMENT)
...
IF (CHU%LCH_EMIS) THEN
  ...
  CALL WRITE_SURF(HPROGRAM,'CH_EMIS_OPT',CHU%CCH_EMIS,IRESP,HCOMMENT=YCOMMENT)
END IF
!
IF (CHU%LCH_EMIS) THEN
