...
ELSE
  ...
  DO JCOVER=1,IL2
    ...
    !
     IF (HPROGRAM=='AROME ') THEN
#ifdef ARO        
      CALL WRITE_SURFX1_ARO(YREC,IL1,PFIELD(:,ICOVER),KRESP,YCOMMENT,YDIR)
#endif  
    ENDIF
    !   
    IF (HPROGRAM=='OFFLIN') THEN
#ifdef OL
      CALL WRITE_SURFN_OL(YREC,PFIELD(:,ICOVER),KRESP,YCOMMENT,YDIR)
#endif
    ENDIF
    !
    IF (HPROGRAM=='TEXTE ') THEN
#ifdef TXT
      CALL WRITE_SURFN_TXT(YREC,PFIELD(:,ICOVER),KRESP,YCOMMENT,YDIR)
#endif
    ENDIF
    !
    IF (HPROGRAM=='BINARY') THEN
    ...
    IF (HPROGRAM=='LFI   ') THEN
#ifdef LFI
      CALL WRITE_SURFN_LFI(YREC,PFIELD(:,ICOVER),KRESP,YCOMMENT,YDIR)
#endif
    ENDIF
    !    
    IF (HPROGRAM=='NC    ') THEN
#ifdef LFI
      CALL WRITE_SURFN_NC(YREC,PFIELD(:,ICOVER),KRESP,YCOMMENT,YDIR)
#endif
    ENDIF    
    !    
    IF (HPROGRAM=='ASCII ') THEN
#ifdef ASC
      CALL WRITE_SURFN_ASC(YREC,PFIELD(:,ICOVER),KRESP,YCOMMENT,YDIR)
#endif
    ENDIF
    !
    IF (HPROGRAM=='FA    ') THEN
#ifdef FA
      CALL WRITE_SURFN_FA(YREC,IL1,PFIELD(:,ICOVER),KRESP,YCOMMENT,YDIR)
#endif
    ENDIF
    !
  END DO
...
!  
  ...
  IF (HPROGRAM=='NC    ') THEN
#ifdef NC
    CALL WRITE_SURF0_NC(YREC,KFIELD,KRESP,HCOMMENT)
#endif
  ENDIF  
  !
!$OMP END SINGLE 
...
!$OMP SINGLE  
  ...
  IF (HPROGRAM=='NC   ') THEN
#ifdef NC
    CALL WRITE_SURF0_NC(YREC,YFIELD,KRESP,HCOMMENT)
#endif
  ENDIF  
  !
!$OMP END SINGLE 
...
!$OMP SINGLE
  ...
  IF (HPROGRAM=='NC    ') THEN
#ifdef NC
    CALL WRITE_SURF0_NC(YREC,OFIELD,KRESP,HCOMMENT)
#endif
  ENDIF  
  !
!$OMP END SINGLE 
...
IF (HPROGRAM=='NC    ') THEN
#ifdef NC
  CALL WRITE_SURFN_NC(YREC,OFIELD,KRESP,HCOMMENT,YDIR)
#endif
ENDIF
!
IF (HPROGRAM=='ASCII ') THEN
...
!$OMP SINGLE
  ...
  IF (HPROGRAM=='NC    ') THEN
#ifdef NC
    CALL WRITE_SURFT_NC(YREC,IYEAR,IMONTH,IDAY,ZTIME,KRESP,HCOMMENT)
#endif
  ENDIF  
  !
!$OMP END SINGLE 
