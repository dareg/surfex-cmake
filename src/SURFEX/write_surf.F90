...
IF (HPROGRAM=='AROME ') THEN
  CALL YRSURFEX_HOST%WRITE_SURFX0 (YREC,PFIELD,KRESP,HCOMMENT)
ENDIF
!
IF (NRANK==NPIO) THEN
  !
...
ELSE
  ...
  !
  IF (HPROGRAM=='AROME ') THEN
    CALL YRSURFEX_HOST%WRITE_SURFX1 (YREC,IL,PFIELD,KRESP,HCOMMENT,YDIR)
  ENDIF
  !
  IF (HPROGRAM=='OFFLIN') THEN
#ifdef SFX_OL
...
ELSE
  ...
  !
  IF (HPROGRAM=='AROME ') THEN
    CALL YRSURFEX_HOST%WRITE_SURFX2 (YREC,IL1,IL2,PFIELD,KRESP,HCOMMENT,YDIR)
  ENDIF
  !
  IF (HPROGRAM=='OFFLIN') THEN
#ifdef SFX_OL
...
!
IF (HPROGRAM=='AROME ') THEN
  CALL YRSURFEX_HOST%WRITE_SURFN0 (YREC,KFIELD,KRESP,HCOMMENT)
ENDIF
!
IF (NRANK==NPIO) THEN
  !
...
!
IF (HPROGRAM=='AROME ') THEN
  CALL YRSURFEX_HOST%WRITE_SURFN1 (YREC,IL,KFIELD,KRESP,HCOMMENT,YDIR)
ENDIF
!
IF (HPROGRAM=='OFFLIN') THEN
#ifdef SFX_OL
...
!
IF (HPROGRAM=='AROME ') THEN
  CALL YRSURFEX_HOST%WRITE_SURFC0 (YREC,YFIELD,KRESP,HCOMMENT)
ENDIF
!
IF (NRANK==NPIO) THEN
  !
...
!²
IF (HPROGRAM=='AROME ') THEN
  CALL YRSURFEX_HOST%WRITE_SURFL0 (YREC,OFIELD,KRESP,HCOMMENT)
ENDIF
!
IF (NRANK==NPIO) THEN
  !
...
!
IF (HPROGRAM=='AROME ') THEN
  CALL YRSURFEX_HOST%WRITE_SURFL1 (YREC,IL,OFIELD,KRESP,HCOMMENT,YDIR) 
ENDIF
!
IF (HPROGRAM=='OFFLIN') THEN
#ifdef SFX_OL
...
!
IF (HPROGRAM=='AROME ') THEN
  CALL YRSURFEX_HOST%WRITE_SURFT0 (YREC,IYEAR,IMONTH,IDAY,ZTIME,KRESP,HCOMMENT)
ENDIF
!
IF (NRANK==NPIO) THEN
  !
...
!
IF (HPROGRAM=='AROME ') THEN
  CALL YRSURFEX_HOST%WRITE_SURFT1 (YREC,IL1,IYEAR,IMONTH,IDAY,ZTIME,KRESP,HCOMMENT)
ENDIF
!
!IF (HPROGRAM=='OFFLIN') THEN
