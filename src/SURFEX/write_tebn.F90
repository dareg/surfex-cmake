...
!               ---------------------------
!
 CALL WRITESURF_TEB_CONF_n(TM%CHT, TM%TD%MTO, TM%TD%O, TM%TD%DUT, TM%T, TM%TOP,HPROGRAM)
!
DO JPATCH=1,TM%TOP%NTEB_PATCH
  CALL GOTO_WRAPPER_TEB_PATCH(JPATCH, B=TM%B, DMTC=TM%TD%DMTC, DMT=TM%TD%DMT, T=TM%T)
