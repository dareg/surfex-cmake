...
YCOMMENT='Total number of 2D emission files.'
 CALL WRITE_SURF(HPROGRAM,YRECFM,CHE%NEMIS_NBR,IRESP,HCOMMENT=YCOMMENT)
!
...
YCOMMENT = "Emission area" 
 CALL WRITE_SURF(HPROGRAM,YRECFM,CHE%CEMIS_AREA(IINDEX(1)),IRESP,HCOMMENT=YCOMMENT)
!
WRITE(YRECFM,'("EMISNBT",I3.3)') JSPEC
YCOMMENT = "Emission times number" 
 CALL WRITE_SURF(HPROGRAM,YRECFM,KSIZE,IRESP,HCOMMENT=YCOMMENT)

! Write emission times (ITIME) for species JSPEC
WRITE(YRECFM,'("EMISTIMES",I3.3)') JSPEC  
YCOMMENT = "Emission times in second"
 CALL WRITE_SURF(HPROGRAM,YRECFM,ITIME(:),IRESP,HCOMMENT=YCOMMENT,HDIR='-',HNAM_DIM="Temporal_emiss  ")
!
...
YCOMMENT = "Emission data (x,y,t),"//TRIM(CHE%CEMIS_COMMENT(IINDEX(1)))
 CALL WRITE_SURF(HPROGRAM,YRECFM,ZWORK2D(:,:),IRESP,HCOMMENT=YCOMMENT,HNAM_DIM="Temporal_emiss  ")
!
