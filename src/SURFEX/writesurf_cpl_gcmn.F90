...
!
   ...
   CALL WRITE_SURF(HPROGRAM,YRECFM,U%XRAIN(:),IRESP,HCOMMENT=YCOMMENT)
!
   YRECFM='SNOW_GCM'
   YCOMMENT='SNOWFALL FOR RESTART (kg/m2/s)'
   CALL WRITE_SURF(HPROGRAM,YRECFM,U%XSNOW(:),IRESP,HCOMMENT=YCOMMENT)
!
   YRECFM='Z0_GCM'
   YCOMMENT='Z0 FOR RESTART (m)'
   CALL WRITE_SURF(HPROGRAM,YRECFM,U%XZ0(:),IRESP,HCOMMENT=YCOMMENT)
!
   YRECFM='Z0H_GCM'
   YCOMMENT='Z0H FOR RESTART (m)'
   CALL WRITE_SURF(HPROGRAM,YRECFM,U%XZ0H(:),IRESP,HCOMMENT=YCOMMENT)
!
   YRECFM='QS_GCM'
   YCOMMENT='QS FOR RESTART (kg/kg)'
   CALL WRITE_SURF(HPROGRAM,YRECFM,U%XQSURF(:),IRESP,HCOMMENT=YCOMMENT)
!
ENDIF
!
