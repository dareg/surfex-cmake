...
DO JLAYER=1,IWORK
  ...
  CALL WRITE_SURF(HPROGRAM,YRECFM,I%XTG(:,JLAYER,:),IRESP,HCOMMENT=YCOMMENT)
END DO
!
...
DO JLAYER=1,I%NGROUND_LAYER
   ...
   CALL WRITE_SURF(HPROGRAM,YRECFM,I%XWG(:,JLAYER,:),IRESP,HCOMMENT=YCOMMENT)
END DO
!
...
DO JLAYER=1,IWORK
   ...
   CALL WRITE_SURF(HPROGRAM,YRECFM,I%XWGI(:,JLAYER,:),IRESP,HCOMMENT=YCOMMENT)  
END DO
!
...
YCOMMENT='X_Y_WR (kg/m2)'
 CALL WRITE_SURF(HPROGRAM,YRECFM,I%XWR(:,:),IRESP,HCOMMENT=YCOMMENT)
!
!* Glacier ice storage
!
YRECFM = 'GLACIER'
YCOMMENT='LGLACIER key for external prep'
CALL WRITE_SURF(HPROGRAM,YRECFM,I%LGLACIER,IRESP,HCOMMENT=YCOMMENT)
!
IF(I%LGLACIER)THEN
  YRECFM='ICE_STO'
  YCOMMENT='X_Y_ICE_STO (kg/m2)'
  CALL WRITE_SURF(HPROGRAM,YRECFM,I%XICE_STO(:,:),IRESP,HCOMMENT=YCOMMENT)
ENDIF
!
!* Leaf Area Index
!
...
!
  ...
  CALL WRITE_SURF(HPROGRAM,YRECFM,I%LSOC,IRESP,HCOMMENT=YCOMMENT)
!
ELSE
!
  YRECFM = 'TEMPARP'
  YCOMMENT='LTEMP_ARP key for external prep'
  CALL WRITE_SURF(HPROGRAM,YRECFM,I%LTEMP_ARP,IRESP,HCOMMENT=YCOMMENT)
!
  IF(I%LTEMP_ARP)THEN
    YRECFM = 'NTEMPLARP'
    YCOMMENT='NTEMPLAYER_ARP for external prep'
    CALL WRITE_SURF(HPROGRAM,YRECFM,I%NTEMPLAYER_ARP,IRESP,HCOMMENT=YCOMMENT)
  ENDIF
!
ENDIF
!
...
!
  ...
  CALL WRITE_SURF(HPROGRAM,YRECFM,I%XWRVN(:,:),IRESP,HCOMMENT=YCOMMENT)
!
!* canopy vegetation temperature
!
  YRECFM='TV'
  YCOMMENT='X_Y_TV (K)'
  CALL WRITE_SURF(HPROGRAM,YRECFM,I%XTV(:,:),IRESP,HCOMMENT=YCOMMENT)
!
!* vegetation canopy air temperature
!
  YRECFM='TC'
  YCOMMENT='X_Y_TC (K)'
  CALL WRITE_SURF(HPROGRAM,YRECFM,I%XTC(:,:),IRESP,HCOMMENT=YCOMMENT)
!
!* vegetation canopy air specific humidity
!
  YRECFM='QC'
  YCOMMENT='X_Y_QC (kg/kg)'
  CALL WRITE_SURF(HPROGRAM,YRECFM,I%XQC(:,:),IRESP,HCOMMENT=YCOMMENT)
!
ENDIF
!
!-------------------------------------------------------------------------------
...
CALL WRITE_SURF(HPROGRAM,YRECFM,I%XPATCH(:,:),IRESP,HCOMMENT=YCOMMENT)
!
...
YCOMMENT='X_Y_RESA (s/m)'
 CALL WRITE_SURF(HPROGRAM,YRECFM,I%XRESA(:,:),IRESP,HCOMMENT=YCOMMENT)
!
!* Land use variables
!
IF(OLAND_USE)THEN
!
  DO JLAYER=1,I%NGROUND_LAYER
    ...
    CALL WRITE_SURF(HPROGRAM,YRECFM,I%XDG(:,JLAYER,:),IRESP,HCOMMENT=YCOMMENT)
  END DO
!
ENDIF
!
...
IF (I%CPHOTO/='NON') THEN
  ...
  CALL WRITE_SURF(HPROGRAM,YRECFM,I%XAN(:,:),IRESP,HCOMMENT=YCOMMENT)
!
  YRECFM='ANDAY'
  YCOMMENT='X_Y_ANDAY (kgCO2/m2/day)'
  CALL WRITE_SURF(HPROGRAM,YRECFM,I%XANDAY(:,:),IRESP,HCOMMENT=YCOMMENT)
!
  YRECFM='ANFM'
  YCOMMENT='X_Y_ANFM (kgCO2/kgair m/s)'
  CALL WRITE_SURF(HPROGRAM,YRECFM,I%XANFM(:,:),IRESP,HCOMMENT=YCOMMENT)
!
  YRECFM='LE_AGS'
  YCOMMENT='X_Y_LE_AGS (W/m2)'
  CALL WRITE_SURF(HPROGRAM,YRECFM,I%XLE(:,:),IRESP,HCOMMENT=YCOMMENT)
END IF
!
!
IF (I%CPHOTO=='NIT' .OR. I%CPHOTO=='NCB') THEN
  ...
  DO JNBIOMASS=1,I%NNBIOMASS
    ...
    CALL WRITE_SURF(HPROGRAM,YRECFM,I%XBIOMASS(:,JNBIOMASS,:),IRESP,HCOMMENT=YCOMMENT)
  END DO
  !
  !
  DO JNBIOMASS=2,I%NNBIOMASS
    ...
    CALL WRITE_SURF(HPROGRAM,YRECFM,I%XRESP_BIOMASS(:,JNBIOMASS,:),IRESP,HCOMMENT=YCOMMENT)
  END DO
  !
END IF
!
...
YRECFM = 'RESPSL'
YCOMMENT=YRECFM
 CALL WRITE_SURF(HPROGRAM,YRECFM,I%CRESPSL,IRESP,HCOMMENT=YCOMMENT)
!
YRECFM='NLITTER'
YCOMMENT=YRECFM
 CALL WRITE_SURF(HPROGRAM,YRECFM,I%NNLITTER,IRESP,HCOMMENT=YCOMMENT)
!
YRECFM='NLITTLEVS'
YCOMMENT=YRECFM
 CALL WRITE_SURF(HPROGRAM,YRECFM,I%NNLITTLEVS,IRESP,HCOMMENT=YCOMMENT)
!
YRECFM='NSOILCARB'
YCOMMENT=YRECFM
 CALL WRITE_SURF(HPROGRAM,YRECFM,I%NNSOILCARB,IRESP,HCOMMENT=YCOMMENT)
!
IF(I%LSPINUPCARBS.OR.I%LSPINUPCARBW)THEN
  YRECFM='NBYEARSOLD'
  YCOMMENT='yrs'
  CALL WRITE_SURF(HPROGRAM,YRECFM,I%NNBYEARSOLD,IRESP,HCOMMENT=YCOMMENT)
ENDIF
!
IF (I%CRESPSL=='CNT') THEN
  ...
  DO JNLITTER=1,I%NNLITTER
    DO JNLITTLEVS=1,I%NNLITTLEVS
      ...
      CALL WRITE_SURF(HPROGRAM,YRECFM,I%XLITTER(:,JNLITTER,JNLITTLEVS,:),IRESP,HCOMMENT=YCOMMENT)
    END DO
  END DO
  ...
  DO JNSOILCARB=1,I%NNSOILCARB
    ...
    CALL WRITE_SURF(HPROGRAM,YRECFM,I%XSOILCARB(:,JNSOILCARB,:),IRESP,HCOMMENT=YCOMMENT)
  END DO
!
  DO JNLITTLEVS=1,I%NNLITTLEVS
    ...
    CALL WRITE_SURF(HPROGRAM,YRECFM,I%XLIGNIN_STRUC(:,JNLITTLEVS,:),IRESP,HCOMMENT=YCOMMENT)
  END DO
!
ENDIF
!
...
IF (CHI%NDSTEQ > 0)THEN
  DO JSV = 1,NDSTMDE ! for all dust modes
    ...
    CALL WRITE_SURF(HPROGRAM,YRECFM,DST%XSFDSTM(:,JSV,:),IRESP,HCOMMENT=YCOMMENT)
  END DO
ENDIF
!
!-------------------------------------------------------------------------------
...
YRECFM='DTCUR'
YCOMMENT='s'
 CALL WRITE_SURF(HPROGRAM,YRECFM,I%TTIME,IRESP,HCOMMENT=YCOMMENT)
