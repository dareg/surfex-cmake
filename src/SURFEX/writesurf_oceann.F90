...
YCOMMENT='flag to use OCEAN model'
 CALL WRITE_SURF(HPROGRAM,YRECFM,O%LMERCATOR,IRESP,HCOMMENT=YCOMMENT)
!
...
YCOMMENT='Relaxation time of ocean model (s)'
 CALL WRITE_SURF(HPROGRAM,YRECFM,OR%XTAU_REL,IRESP,HCOMMENT=YCOMMENT)
!
YRECFM='LREL_CUR_OC'
YCOMMENT='FLAG FOR RELAXATION ON CURRENT'
 CALL WRITE_SURF(HPROGRAM,YRECFM,OR%LREL_CUR,IRESP,HCOMMENT=YCOMMENT)
!
YRECFM='LREL_TS_OC'
YCOMMENT='FLAG FOR RELAXATION ON T,S'
 CALL WRITE_SURF(HPROGRAM,YRECFM,OR%LREL_TS,IRESP,HCOMMENT=YCOMMENT)
!
YRECFM='LFLX_NULL_OC'
YCOMMENT='FLAG FOR ZERO FLUX '
 CALL WRITE_SURF(HPROGRAM,YRECFM,OR%LFLUX_NULL,IRESP,HCOMMENT=YCOMMENT)

YRECFM='LFLX_CORR_OC'
YCOMMENT='FLAG FOR FLUX CORRECTION '
 CALL WRITE_SURF(HPROGRAM,YRECFM,OR%LFLX_CORR,IRESP,HCOMMENT=YCOMMENT)

YRECFM='CORR_FLX_OC'
YCOMMENT='FLUX CORRECTION COEFF (W/M2/K)'
 CALL WRITE_SURF(HPROGRAM,YRECFM,OR%XQCORR,IRESP,HCOMMENT=YCOMMENT)
!
YRECFM='LDIAPYC_OC'
YCOMMENT='FLAG FOR DIAPYCNAL MIXING '
 CALL WRITE_SURF(HPROGRAM,YRECFM,OR%LDIAPYCNAL,IRESP,HCOMMENT=YCOMMENT)
!
!-------------------------------------------------------------------------------
!
!*       3.     Prognostic fields:
...
YRECFM='SSS'
YCOMMENT='SSS'
 CALL WRITE_SURF(HPROGRAM,YRECFM,O%XSEAS(:,NOCKMIN),IRESP,HCOMMENT=YCOMMENT)
!-------------------------------------------------------------------------------
!Sea Surface Salinity
!
YRECFM='SEA_HMO'
YCOMMENT='X_Y_'
 CALL WRITE_SURF(HPROGRAM,YRECFM,O%XSEAHMO(:),IRESP,HCOMMENT=YCOMMENT)
!-------------------------------------------------------------------------------
