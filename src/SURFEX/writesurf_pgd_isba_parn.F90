...
YRECFM='L_VEGGV'
YCOMMENT=YRECFM
CALL WRITE_SURF(HPROGRAM,YRECFM,LDATA_VEGGV,IRESP,HCOMMENT=YCOMMENT)
IF (LDATA_VEGGV) THEN
  DO JTIME=1,36
    WRITE(YRECFM,FMT='(A7,I2.2)') 'D_VEGGV',JTIME
    YCOMMENT='X_Y_D_VEGGV'
    CALL WRITE_SURF(HPROGRAM,YRECFM,XPAR_VEGGV(:,JTIME,:),IRESP,HCOMMENT=YCOMMENT)
  END DO
ENDIF
!
YRECFM='L_Z0'
