...
IF (.NOT. ASSOCIATED(DTV%LPAR_STRESS)) THEN
  WRITE(0,*) "WARNING: DTV%LPAR_STRESS not associated, assuming D_STRESS_V size"
  ALLOCATE(ZWORK(SIZE(DTV%LDATA_F2I,1))) ! RJ: "borrow" dim size from other array
ELSE
