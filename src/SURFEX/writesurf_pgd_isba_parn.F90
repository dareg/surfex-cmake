...
USE MODD_DATA_ISBA_n,    ONLY : NTIME, XPAR_VEG, XPAR_LAI,XPAR_RSMIN,XPAR_GAMMA,XPAR_WRMAX_CF, &
                                ...
                                XPAR_ROOT_DEPTHGV, XPAR_ROOT_EXTINCTIONGV, &
...
YRECFM='L_LAIGV'
YCOMMENT=YRECFM
CALL WRITE_SURF(HPROGRAM,YRECFM,LDATA_LAIGV,IRESP,HCOMMENT=YCOMMENT)
IF (LDATA_LAIGV) THEN
  DO JTIME=1,36
    WRITE(YRECFM,FMT='(A9,I2.2)') 'D_LAIGV_T',JTIME
    YCOMMENT='X_Y_D_LAIGV'
    CALL WRITE_SURF(HPROGRAM,YRECFM,XPAR_LAIGV(:,JTIME,:),IRESP,HCOMMENT=YCOMMENT)
  END DO
ENDIF
!
YRECFM='L_H_VEG'
YCOMMENT=YRECFM
CALL WRITE_SURF(HPROGRAM,YRECFM,LDATA_H_VEG,IRESP,HCOMMENT=YCOMMENT)
IF (LDATA_H_VEG) THEN
  DO JTIME=1,36
    WRITE(YRECFM,FMT='(A9,I2.2)') 'D_H_VEG_T',JTIME
    YCOMMENT='X_Y_D_H_VEG'
    CALL WRITE_SURF(HPROGRAM,YRECFM,XPAR_H_VEG(:,JTIME,:),IRESP,HCOMMENT=YCOMMENT)
  END DO
ENDIF
!
YRECFM='L_GNDLITTER'
YCOMMENT=YRECFM
CALL WRITE_SURF(HPROGRAM,YRECFM,LDATA_GNDLITTER,IRESP,HCOMMENT=YCOMMENT)
IF (LDATA_GNDLITTER) THEN
  DO JTIME=1,36
    WRITE(YRECFM,FMT='(A7,I2.2)') 'D_GNDLITTER',JTIME
    YCOMMENT='X_Y_D_GNDLITTER'
    CALL WRITE_SURF(HPROGRAM,YRECFM,XPAR_GNDLITTER(:,JTIME,:),IRESP,HCOMMENT=YCOMMENT)
  END DO
ENDIF
!
YRECFM='L_Z0'
...
YRECFM='L_Z0LITTER'
YCOMMENT=YRECFM
CALL WRITE_SURF(HPROGRAM,YRECFM,LDATA_Z0LITTER,IRESP,HCOMMENT=YCOMMENT)
IF (LDATA_Z0LITTER) THEN
  DO JTIME=1,36
    WRITE(YRECFM,FMT='(A8,I2.2)') 'D_Z0LITTER_T',JTIME
    YCOMMENT='X_Y_D_Z0LITTER'
    CALL WRITE_SURF(HPROGRAM,YRECFM,XPAR_Z0LITTER(:,JTIME,:),IRESP,HCOMMENT=YCOMMENT)
  END DO
ENDIF
!
YRECFM='L_EMIS'
...
YRECFM='L_RSMINGV'
YCOMMENT=YRECFM
CALL WRITE_SURF(HPROGRAM,YRECFM,LDATA_RSMINGV,IRESP,HCOMMENT=YCOMMENT)
IF (LDATA_RSMINGV) THEN
  YRECFM='D_RSMINGV'
  YCOMMENT='X_Y_D_RSMINGV'
  CALL WRITE_SURF(HPROGRAM,YRECFM,XPAR_RSMINGV(:,:),IRESP,HCOMMENT=YCOMMENT)
ENDIF
!
YRECFM='L_GAMMA'
YCOMMENT=YRECFM
...
YRECFM='L_GAMMAGV'
YCOMMENT=YRECFM
CALL WRITE_SURF(HPROGRAM,YRECFM,LDATA_GAMMAGV,IRESP,HCOMMENT=YCOMMENT)
IF (LDATA_GAMMAGV) THEN
  YRECFM='D_GAMMAGV'
  YCOMMENT='X_Y_D_GAMMAGV'
  CALL WRITE_SURF(HPROGRAM,YRECFM,XPAR_GAMMAGV(:,:),IRESP,HCOMMENT=YCOMMENT)
ENDIF
!
YRECFM='L_WRMAX_CF'
YCOMMENT=YRECFM
...
YRECFM='L_WRMAX_CFGV'
YCOMMENT=YRECFM
CALL WRITE_SURF(HPROGRAM,YRECFM,LDATA_WRMAX_CFGV,IRESP,HCOMMENT=YCOMMENT)
IF (LDATA_WRMAX_CFGV) THEN
  YRECFM='D_WRMAX_CFGV'
  YCOMMENT='X_Y_D_WRMAX_CFGV'
  CALL WRITE_SURF(HPROGRAM,YRECFM,XPAR_WRMAX_CFGV(:,:),IRESP,HCOMMENT=YCOMMENT)
ENDIF
!
YRECFM='L_RGL'
YCOMMENT=YRECFM
...
YRECFM='L_RGLGV'
YCOMMENT=YRECFM
CALL WRITE_SURF(HPROGRAM,YRECFM,LDATA_RGLGV,IRESP,HCOMMENT=YCOMMENT)
IF (LDATA_RGLGV) THEN
  YRECFM='D_RGLGV'
  YCOMMENT='X_Y_D_RGLGV'
  CALL WRITE_SURF(HPROGRAM,YRECFM,XPAR_RGLGV(:,:),IRESP,HCOMMENT=YCOMMENT)
ENDIF
!
YRECFM='L_ZF_TALLVEG'
YCOMMENT=YRECFM
CALL WRITE_SURF(HPROGRAM,YRECFM,LDATA_ZF_TALLVEG,IRESP,HCOMMENT=YCOMMENT)
IF (LDATA_ZF_TALLVEG) THEN
  YRECFM='D_ZF_TALLVEG'
  YCOMMENT='X_Y_D_ZF_TALLVEG'
  CALL WRITE_SURF(HPROGRAM,YRECFM,XPAR_ZF_TALLVEG(:,:),IRESP,HCOMMENT=YCOMMENT)
ENDIF
!
YRECFM='L_CV'
YCOMMENT=YRECFM
...
!
YRECFM='L_RTFRACGV'
CALL WRITE_SURF(HPROGRAM,YRECFM,LDATA_ROOTFRACGV,IRESP,HCOMMENT=YCOMMENT)
IF (LDATA_ROOTFRACGV) THEN
  ...
  DO JLAYER=1,SIZE(XPAR_ROOTFRACGV,2)
    ...
    DO JPATCH=1,SIZE(XPAR_ROOTFRACGV,3)
      ZWORK(:,JPATCH) = XPAR_ROOTFRACGV(:,JLAYER,JPATCH)
    END DO
    CALL WRITE_SURF(HPROGRAM,YRECFM,ZWORK,IRESP,HCOMMENT=YCOMMENT)
  END DO
  DEALLOCATE(ZWORK)
...
YRECFM='L_RT_DEPTHGV'
YCOMMENT=YRECFM
CALL WRITE_SURF(HPROGRAM,YRECFM,LDATA_ROOT_DEPTHGV,IRESP,HCOMMENT=YCOMMENT)
IF (LDATA_ROOT_DEPTHGV) THEN
  YRECFM='D_RT_DEPTHGV'
  YCOMMENT='X_Y_'//YRECFM
  CALL WRITE_SURF(HPROGRAM,YRECFM,XPAR_ROOT_DEPTHGV(:,:),IRESP,HCOMMENT=YCOMMENT)
ENDIF
!
YRECFM='L_ROOT_EXT'
YCOMMENT=YRECFM
...
YRECFM='L_RT_EXTGV'
YCOMMENT=YRECFM
CALL WRITE_SURF(HPROGRAM,YRECFM,LDATA_ROOT_EXTINCTIONGV,IRESP,HCOMMENT=YCOMMENT)
IF (LDATA_ROOT_EXTINCTIONGV) THEN
  YRECFM='D_RT_EXTGV'
  YCOMMENT='X_Y_'//YRECFM
  CALL WRITE_SURF(HPROGRAM,YRECFM,XPAR_ROOT_EXTINCTIONGV(:,:),IRESP,HCOMMENT=YCOMMENT)
ENDIF
!
YRECFM='L_ROOT_LIN'
YCOMMENT=YRECFM
