!     #########
      SUBROUTINE WRITESURF_PGD_ISBA_n (HSELECT, HNATURE, DTI, DTZ, IG, ISS, IO, IP, PVEGTYPE, HPROGRAM)
!     ################################################
!
...
YRECFM='COVER_LIST'
YCOMMENT='(LOGICAL LIST)'
 CALL WRITE_SURF(HSELECT, HPROGRAM,YRECFM,IP%LCOVER(:),IRESP,HCOMMENT=YCOMMENT,HDIR='-')
!
#ifdef SFX_OL
IF (LWR_VEGTYPE) THEN
  YRECFM='VEGTYPE'
  YCOMMENT='(X_Y_VEGTYPE)'
  CALL WRITE_SURF(HSELECT, HPROGRAM,YRECFM,PVEGTYPE,IRESP,HCOMMENT=YCOMMENT)
ENDIF
#endif
!
!* orography
...
YRECFM='ZS'
YCOMMENT='ZS'
 CALL WRITE_SURF(HSELECT, HPROGRAM,YRECFM,IP%XZS(:),IRESP,HCOMMENT=YCOMMENT)
!
!* latitude, longitude
!
 CALL WRITE_GRID(HSELECT, HPROGRAM,IG%CGRID,IG%XGRID_PAR,IG%XLAT,IG%XLON,IG%XMESH_SIZE,IRESP,ISS%XZ0EFFJPDIR)
!
!
!* clay fraction
!
...
YRECFM='CLAY'
YCOMMENT='X_Y_CLAY'
 CALL WRITE_SURF(HSELECT, HPROGRAM,YRECFM,IP%XCLAY(:,1),IRESP,HCOMMENT=YCOMMENT)
!
!* sand fraction
!
YRECFM='SAND'
YCOMMENT='X_Y_SAND'
 CALL WRITE_SURF(HSELECT, HPROGRAM,YRECFM,IP%XSAND(:,1),IRESP,HCOMMENT=YCOMMENT)
!
!* soil organic carbon
!
YRECFM='SOCP'
...
IF(IO%LSOCP)THEN
  ...
  YCOMMENT='X_Y_SOC'
  YRECFM='SOC_TOP'
  CALL WRITE_SURF(HSELECT, HPROGRAM,YRECFM,IP%XSOC(:,1),IRESP,HCOMMENT=YCOMMENT)
  YRECFM='SOC_SUB'
  CALL WRITE_SURF(HSELECT, HPROGRAM,YRECFM,IP%XSOC(:,2),IRESP,HCOMMENT=YCOMMENT)
  !
ENDIF
!
...
IF(IO%LPERM)THEN
  YCOMMENT='X_Y_PERM'
  YRECFM='PERM'
  CALL WRITE_SURF(HSELECT, HPROGRAM,YRECFM,IP%XPERM(:),IRESP,HCOMMENT=YCOMMENT)
ENDIF
!
...
YRECFM='GWKEY'
YCOMMENT=''
 CALL WRITE_SURF(HSELECT, HPROGRAM,YRECFM,IO%LGW,IRESP,HCOMMENT=YCOMMENT)
!
IF(IO%LGW)THEN
  YCOMMENT='X_Y_GWFRAC'
  YRECFM='GWFRAC'
  CALL WRITE_SURF(HSELECT, HPROGRAM,YRECFM,IP%XGW(:),IRESP,HCOMMENT=YCOMMENT)
ENDIF
!
!SOILNOX
!
...
IF (IO%LNOF) THEN
  ...
  YRECFM='PH'
  YCOMMENT='X_Y_PH'
  CALL WRITE_SURF(HSELECT, HPROGRAM,YRECFM,IP%XPH(:),IRESP,HCOMMENT=YCOMMENT)
  !
  YRECFM='FERT'
  YCOMMENT='X_Y_FERT'
  CALL WRITE_SURF(HSELECT, HPROGRAM,YRECFM,IP%XFERT(:),IRESP,HCOMMENT=YCOMMENT)
  !
ENDIF
!
...
YCOMMENT='X_Y_RUNOFFB'
 CALL WRITE_SURF(HSELECT, HPROGRAM,YRECFM,IP%XRUNOFFB,IRESP,HCOMMENT=YCOMMENT)
!
!* subgrid drainage coefficient
!
YRECFM='WDRAIN'
YCOMMENT='X_Y_WDRAIN'
 CALL WRITE_SURF(HSELECT, HPROGRAM,YRECFM,IP%XWDRAIN,IRESP,HCOMMENT=YCOMMENT)
!
...
YRECFM='TI_MIN'
YCOMMENT='X_Y_TI_MIN'
 CALL WRITE_SURF(HSELECT, HPROGRAM,YRECFM,IP%XTI_MIN,IRESP,HCOMMENT=YCOMMENT)
!
YRECFM='TI_MAX'
YCOMMENT='X_Y_TI_MAX'
 CALL WRITE_SURF(HSELECT, HPROGRAM,YRECFM,IP%XTI_MAX,IRESP,HCOMMENT=YCOMMENT)
!
YRECFM='TI_MEAN'
YCOMMENT='X_Y_TI_MEAN'
 CALL WRITE_SURF(HSELECT, HPROGRAM,YRECFM,IP%XTI_MEAN,IRESP,HCOMMENT=YCOMMENT)
!
YRECFM='TI_STD'
YCOMMENT='X_Y_TI_STD'
 CALL WRITE_SURF(HSELECT, HPROGRAM,YRECFM,IP%XTI_STD,IRESP,HCOMMENT=YCOMMENT)
!
YRECFM='TI_SKEW'
YCOMMENT='X_Y_TI_SKEW'
 CALL WRITE_SURF(HSELECT, HPROGRAM,YRECFM,IP%XTI_SKEW,IRESP,HCOMMENT=YCOMMENT)
!
ENDIF
!
!-------------------------------------------------------------------------------
 CALL WRITESURF_PGD_ISBA_PAR_n(HSELECT, DTI, HPROGRAM)
