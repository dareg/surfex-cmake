!     #########
      SUBROUTINE WRITESURF_PGD_ISBA_n (HSELECT, HNATURE, DTI, DTZ, G, ISS, IO, S, K, HPROGRAM)
!     ################################################
!
...
!* latitude, longitude
!
 CALL WRITE_GRID(HSELECT, HPROGRAM,G%CGRID,G%XGRID_PAR,G%XLAT,G%XLON,G%XMESH_SIZE,IRESP,ISS%XZ0EFFJPDIR)
!
!
!* clay fraction
!
...
IF(IO%LGW)THEN
  YCOMMENT='X_Y_GWFRAC'
  YRECFM='GWFRAC'
  CALL WRITE_SURF(HSELECT, HPROGRAM,YRECFM,S%XGW(:),IRESP,HCOMMENT=YCOMMENT)
ENDIF
!
!SOILNOX
!
