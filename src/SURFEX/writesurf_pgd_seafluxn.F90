!     #########
      SUBROUTINE WRITESURF_PGD_SEAFLUX_n (HSELECT, DTS, SG, S, HPROGRAM)
!     ###################################################
!
...
!* latitude, longitude
!
 CALL WRITE_GRID(HSELECT, HPROGRAM,SG%CGRID,SG%XGRID_PAR,SG%XLAT,SG%XLON,SG%XMESH_SIZE,IRESP)
!
!* sst
!
YRECFM='SST_DATA'
