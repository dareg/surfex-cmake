...
YCOMMENT='FLAG FOR SPECIFIED GARDEN IRRIGATION PARAMETERS'
 CALL WRITE_SURF(HPROGRAM,YRECFM,TIR%LPAR_GD_IRRIG,IRESP,HCOMMENT=YCOMMENT)
!
...
!
  ...
  CALL WRITE_SURF(HPROGRAM,YRECFM,TIR%XGD_START_MONTH(:),IRESP,HCOMMENT=YCOMMENT)
!
  YRECFM='D_GD_EM_IRR'
  YCOMMENT='End   Month for Gardens Irrigation'
  CALL WRITE_SURF(HPROGRAM,YRECFM,TIR%XGD_END_MONTH  (:),IRESP,HCOMMENT=YCOMMENT)
!
  YRECFM='D_GD_SH_IRR'
  YCOMMENT='Start Hour  for Gardens Irrigation'
  CALL WRITE_SURF(HPROGRAM,YRECFM,TIR%XGD_START_HOUR (:),IRESP,HCOMMENT=YCOMMENT)
!
  YRECFM='D_GD_EH_IRR'
  YCOMMENT='End   Hour  for Gardens Irrigation'
  CALL WRITE_SURF(HPROGRAM,YRECFM,TIR%XGD_END_HOUR   (:),IRESP,HCOMMENT=YCOMMENT)
!
  YRECFM='D_GD_IRRIG'
  YCOMMENT='24h mean Irrigation rate for Gardens Irrigation'
  CALL WRITE_SURF(HPROGRAM,YRECFM,TIR%XGD_24H_IRRIG  (:),IRESP,HCOMMENT=YCOMMENT)
!
ENDIF
!
...
YCOMMENT='FLAG FOR SPECIFIED GREENROOFS IRRIGATION PARAMETERS'
 CALL WRITE_SURF(HPROGRAM,YRECFM,TIR%LPAR_GR_IRRIG,IRESP,HCOMMENT=YCOMMENT)
!
! Parameters describing irrigation
...
!
  ...
  CALL WRITE_SURF(HPROGRAM,YRECFM,TIR%XGR_START_MONTH(:),IRESP,HCOMMENT=YCOMMENT)
!
  YRECFM='D_GR_EM_IRR'
  YCOMMENT='End   Month for Greenroofs Irrigation'
  CALL WRITE_SURF(HPROGRAM,YRECFM,TIR%XGR_END_MONTH  (:),IRESP,HCOMMENT=YCOMMENT)
!
  YRECFM='D_GR_SH_IRR'
  YCOMMENT='Start Hour  for Greenroofs Irrigation'
  CALL WRITE_SURF(HPROGRAM,YRECFM,TIR%XGR_START_HOUR (:),IRESP,HCOMMENT=YCOMMENT)
!
  YRECFM='D_GR_EH_IRR'
  YCOMMENT='End   Hour  for Greenroofs Irrigation'
  CALL WRITE_SURF(HPROGRAM,YRECFM,TIR%XGR_END_HOUR   (:),IRESP,HCOMMENT=YCOMMENT)
!
  YRECFM='D_GR_IRRIG'
  YCOMMENT='24h mean Irrigation rate for Greenroofs Irrigation'
  CALL WRITE_SURF(HPROGRAM,YRECFM,TIR%XGR_24H_IRRIG  (:),IRESP,HCOMMENT=YCOMMENT)
!
ENDIF
!
...
YCOMMENT='FLAG FOR SPECIFIED ROAD IRRIGATION PARAMETERS'
 CALL WRITE_SURF(HPROGRAM,YRECFM,TIR%LPAR_RD_IRRIG,IRESP,HCOMMENT=YCOMMENT)
!
...
!
  ...
  CALL WRITE_SURF(HPROGRAM,YRECFM,TIR%XRD_START_MONTH(:),IRESP,HCOMMENT=YCOMMENT)
!
  YRECFM='D_RD_EM_IRR'
  YCOMMENT='End   Month for Roads Irrigation'
  CALL WRITE_SURF(HPROGRAM,YRECFM,TIR%XRD_END_MONTH  (:),IRESP,HCOMMENT=YCOMMENT)
!
  YRECFM='D_RD_SH_IRR'
  YCOMMENT='Start Hour  for Roads Irrigation'
  CALL WRITE_SURF(HPROGRAM,YRECFM,TIR%XRD_START_HOUR (:),IRESP,HCOMMENT=YCOMMENT)
!
  YRECFM='D_RD_EH_IRR'
  YCOMMENT='End   Hour  for Roads Irrigation'
  CALL WRITE_SURF(HPROGRAM,YRECFM,TIR%XRD_END_HOUR   (:),IRESP,HCOMMENT=YCOMMENT)
!
  YRECFM='D_RD_IRRIG'
  YCOMMENT='24h mean Irrigation rate for Roads Irrigation'
  CALL WRITE_SURF(HPROGRAM,YRECFM,TIR%XRD_24H_IRRIG  (:),IRESP,HCOMMENT=YCOMMENT)
!
ENDIF
!
