!     #########
      SUBROUTINE WRITESURF_PGD_TEB_PAR_n (BDD, DTB, DTGD, DTGR, DTT, DGU, U, TGDO, TGDP, TGRO, TGRP, TIR, TOP, &
                                          HPROGRAM)
!     ################################################
!
...
YCOMMENT='FLAG FOR SPECIFIED GARDEN PARAMETERS'
 CALL WRITE_SURF(DGU, U, &
                 HPROGRAM,YRECFM,TGDO%LPAR,IRESP,HCOMMENT=YCOMMENT)
!
IF (TOP%LGARDEN .AND. TGDO%LPAR) THEN
!
  YRECFM='GD_NTIME'
  YCOMMENT=YRECFM
  CALL WRITE_SURF(DGU, U, &
...
ENDIF
!
IF (TOP%LGREENROOF .AND. TGRO%LPAR) THEN
!
! Type of green roof
  YRECFM='D_TYPE_GR'
  YCOMMENT='X_Y_TYPE_GR'
  CALL WRITE_SURF(DGU, U, &
                 HPROGRAM,YRECFM,TGRO%CTYP_COV,IRESP,HCOMMENT=YCOMMENT)
!
