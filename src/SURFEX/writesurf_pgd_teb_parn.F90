...
IF (LDATA_HC_ROOF) THEN
  ...
  CALL WRITE_SURF(HPROGRAM,'PAR_ROOF_LAYER',NPAR_ROOF_LAYER,IRESP,YCOMMENT)
END IF
!
YRECFM='L_HC_ROOF'
YCOMMENT=YRECFM
...
IF (LDATA_HC_ROAD) THEN
  ...
  CALL WRITE_SURF(HPROGRAM,'PAR_ROAD_LAYER',NPAR_ROAD_LAYER,IRESP,YCOMMENT)
END IF
!
YRECFM='L_HC_ROAD'
YCOMMENT=YRECFM
...
IF (LDATA_HC_WALL) THEN
  ...
  CALL WRITE_SURF(HPROGRAM,'PAR_WALL_LAYER',NPAR_WALL_LAYER,IRESP,YCOMMENT)
END IF
!
YRECFM='L_HC_WALL'
YCOMMENT=YRECFM
...
IF (CBEM .EQ. 'BEM') THEN
  ...
  IF (LDATA_HC_FLOOR) THEN
    ...
    CALL WRITE_SURF(HPROGRAM,'PAR_FLOOR_LAYER',NPAR_FLOOR_LAYER,IRESP,YCOMMENT)
  END IF
  !
  YRECFM='L_HC_FLOOR'
  YCOMMENT=YRECFM
