!     #########
      SUBROUTINE WRITESURF_PGD_TEB_n (HSELECT, TOP, BOP, TG, BDD, DTB, DTT, &
                                      GDO, GDP, GDDT, GDIR, GRO, GRP, GRDT, &
                                      HPROGRAM)
!     ###############################################
!
...
YRECFM='GD_PEDOTF'
YCOMMENT=YRECFM
 CALL WRITE_SURF(HSELECT, HPROGRAM,YRECFM,GDO%CPEDOTF,IRESP,HCOMMENT=YCOMMENT)
!
! * type of photosynthesis
!
YRECFM='GD_PHOTO'
YCOMMENT=YRECFM
 CALL WRITE_SURF(HSELECT, HPROGRAM,YRECFM,GDO%CPHOTO,IRESP,HCOMMENT=YCOMMENT)
!
!* new radiative transfert
!
YRECFM='GD_TR_ML'
YCOMMENT=YRECFM
 CALL WRITE_SURF(HSELECT, HPROGRAM,YRECFM,GDO%LTR_ML,IRESP,HCOMMENT=YCOMMENT)
!
! * ISBA fields specific to urban gardens
!
 CALL WRITESURF_PGD_TEB_VEG_n(HSELECT, GDDT%NTIME, GDO, GDP, HPROGRAM)
!
! * ISBA fields specific to urban greenroofs
!
IF (TOP%LGREENROOF) CALL WRITESURF_PGD_TEB_GREENROOF_n(HSELECT, GRDT%NTIME, GRO, GRP, HPROGRAM)
!
ENDIF
!
!------------------------------------------------------------------------------
...
!* latitude, longitude
!
 CALL WRITE_GRID(HSELECT,  HPROGRAM,TG%CGRID,TG%XGRID_PAR,TG%XLAT,TG%XLON,TG%XMESH_SIZE,IRESP)
!
!-------------------------------------------------------------------------------
 CALL WRITESURF_PGD_TEB_PAR_n(BDD, DTB, GDDT, GRDT, DTT, HSELECT, GDO, &
                              GRO, GRP, GDIR, TOP, HPROGRAM)
!
