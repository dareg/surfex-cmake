!     #########
      SUBROUTINE WRITESURF_PGD_TEB_n (DGU, IOB, U, TM, GDM, GRM, &
                                      HPROGRAM)
!     ###############################################
!
...
!
IF (TM%TOP%LGREENROOF) CALL WRITESURF_PGD_TEB_GREENROOF_n(DGU, IOB, U, &
                                                       GRM%TGRO, GRM%TGRP, &
                                                       HPROGRAM)
!
ENDIF
...
!
!-------------------------------------------------------------------------------
 CALL WRITESURF_PGD_TEB_PAR_n(TM%BDD, TM%DTB, GDM%DTGD, GRM%DTGR, TM%DTT, DGU, IOB, U, GDM%TGDO, &
