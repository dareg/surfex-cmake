...
!
 CALL WRITESURF_PGD_TEB_VEG_n(HSELECT, GDM%DTI%NTIME, GDM%O, GDM%K, HPROGRAM)
!
! * ISBA fields specific to urban greenroofs
!
IF (TOP%LGREENROOF) CALL WRITESURF_PGD_TEB_GREENROOF_n(HSELECT, GRM%DTI%NTIME, GRM%O, GRM%K, HPROGRAM)
!
ENDIF
!
!------------------------------------------------------------------------------
...
!
!-------------------------------------------------------------------------------
 CALL WRITESURF_PGD_TEB_PAR_n(BDD, DTB, GDM%DTI, GRM%DTI, DTT, HSELECT, GDM%O, &
