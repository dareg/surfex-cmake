...
YRECFM   = 'ND_TSZ0_TIME'
YCOMMENT = '(-)'
 CALL WRITE_SURF(HPROGRAM,YRECFM,DTZ%NTIME,IRESP,HCOMMENT=YCOMMENT)
!
YRECFM   = 'D_DTS'
YCOMMENT = 'X_Y_DATA_DTS'
 CALL WRITE_SURF(HPROGRAM,YRECFM,DTZ%XDATA_DTS(:),IRESP,HCOMMENT=YCOMMENT,HDIR='-',HNAM_DIM="Nforc_tsz0      ")
!
YRECFM   = 'D_DHUGRD'
YCOMMENT = 'X_Y_DATA_DHUGRD'
 CALL WRITE_SURF(HPROGRAM,YRECFM,DTZ%XDATA_DHUGRD(:),IRESP,HCOMMENT=YCOMMENT,HDIR='-',HNAM_DIM="Nforc_tsz0      ")
!
