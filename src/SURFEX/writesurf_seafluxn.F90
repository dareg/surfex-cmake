...
!
  DO JMTH=1,INMTH
     ...
     CALL WRITE_SURF(HPROGRAM,YRECFM,S%XSST_MTH(:,JMTH),IRESP,HCOMMENT=YCOMMENT)
  ENDDO
!
ENDIF
!
YRECFM='SST'
YCOMMENT='SST'
CALL WRITE_SURF(HPROGRAM,YRECFM,S%XSST(:),IRESP,HCOMMENT=YCOMMENT)  
!
!-------------------------------------------------------------------------------
!
...
YRECFM='Z0SEA'
YCOMMENT='Z0SEA (m)'
CALL WRITE_SURF(HPROGRAM,YRECFM,S%XZ0(:),IRESP,HCOMMENT=YCOMMENT)
!
!
...
IF(S%LINTERPOL_SSS)THEN
   ...
   DO JMTH=1,INMTH
      ...
      CALL WRITE_SURF(HPROGRAM,YRECFM,S%XSSS_MTH(:,JMTH),IRESP,HCOMMENT=YCOMMENT)
   ENDDO
!
ENDIF
!
...
CALL WRITE_SURF(HPROGRAM,YRECFM,S%XSSS(:),IRESP,HCOMMENT=YCOMMENT)  
!
!
...
!
  ...
  CALL WRITE_SURF(HPROGRAM,YRECFM,S%XDIR_ALB(:),IRESP,HCOMMENT=YCOMMENT)
!
  YRECFM='OSA_SCA'
  YCOMMENT='diffuse ocean surface albedo (-)'
  CALL WRITE_SURF(HPROGRAM,YRECFM,S%XSCA_ALB(:),IRESP,HCOMMENT=YCOMMENT)
!
ENDIF
!
!-------------------------------------------------------------------------------
...
YRECFM='DTCUR'
YCOMMENT='s'
 CALL WRITE_SURF(HPROGRAM,YRECFM,S%TTIME,IRESP,HCOMMENT=YCOMMENT)
