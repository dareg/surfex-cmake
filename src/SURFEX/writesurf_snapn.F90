...
! Writes the temporal profiles of all snaps
  ...
  CALL WRITE_SURF(HPROGRAM,YRECFM,XSNAP_MONTHLY(:,:,JSPEC),IRESP,YCOMMENT,&
        HDIR='-',HNAM_DIM="Nemis_snap      ")
  YRECFM = "E_"//TRIM(CEMIS_NAME(JSPEC))//"_D"
  CALL WRITE_SURF(HPROGRAM,YRECFM,XSNAP_DAILY(:,:,JSPEC),IRESP,YCOMMENT,&
        HDIR='-',HNAM_DIM="Nemis_snap        ")
  YRECFM = "E_"//TRIM(CEMIS_NAME(JSPEC))//"_H"
  CALL WRITE_SURF(HPROGRAM,YRECFM,XSNAP_HOURLY(:,:,JSPEC),IRESP,YCOMMENT,&
        HDIR='-',HNAM_DIM="Nemis_snap       ")
