!     #########
      SUBROUTINE WRITESURF_TEB_GREENROOF_n (HSELECT, IO, PEK, HPROGRAM,HPATCH)
!     #####################################
!
...
ENDDO
YRECFM='GR'
 CALL WRITESURF_GR_SNOW(HSELECT, HPROGRAM, YRECFM, HPATCH, SIZE(PEK%XTG,1), IMASK_P, 0, PEK%TSNOW)
