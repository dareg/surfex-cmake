...
DO JLAYER=1,TOP%NROOF_LAYER
 ...
 CALL WRITE_SURF(HPROGRAM,YRECFM,T%CUR%XT_ROOF(:,JLAYER),IRESP,HCOMMENT=YCOMMENT)
END DO
...
YCOMMENT='WS_ROOF (kg/m2)'
 CALL WRITE_SURF(HPROGRAM,YRECFM,T%CUR%XWS_ROOF(:),IRESP,HCOMMENT=YCOMMENT)
!
!* road temperatures
!
...
DO JLAYER=1,TOP%NROAD_LAYER
  ...
  CALL WRITE_SURF(HPROGRAM,YRECFM,T%CUR%XT_ROAD(:,JLAYER),IRESP,HCOMMENT=YCOMMENT)
END DO
!
!* road water content
!
...
YCOMMENT='WS_ROAD (kg/m2)'
 CALL WRITE_SURF(HPROGRAM,YRECFM,T%CUR%XWS_ROAD(:),IRESP,HCOMMENT=YCOMMENT)
!
!* wall temperatures
!
...
DO JLAYER=1,TOP%NWALL_LAYER
 IF (TOP%CWALL_OPT=='UNIF') THEN
  ...
  CALL WRITE_SURF(HPROGRAM,YRECFM,T%CUR%XT_WALL_A(:,JLAYER),IRESP,HCOMMENT=YCOMMENT)
 ELSE
  !* Wall A
  ...
  ENDIF
  WRITE(YCOMMENT,'(A,I1.1,A4)') TRIM(YSTRING), JLAYER,' (K)'
  CALL WRITE_SURF(HPROGRAM,YRECFM,T%CUR%XT_WALL_B(:,JLAYER),IRESP,HCOMMENT=YCOMMENT)
 END IF
END DO
!
...
YRECFM=ADJUSTL(YRECFM)
YCOMMENT='TI_BLD (K)'
 CALL WRITE_SURF(HPROGRAM,YRECFM,B%CUR%XTI_BLD(:),IRESP,HCOMMENT=YCOMMENT)
!
!
...
YRECFM=ADJUSTL(YRECFM)
YCOMMENT='T_WIN1 (K)'
 CALL WRITE_SURF(HPROGRAM,YRECFM,B%CUR%XT_WIN1(:),IRESP,HCOMMENT=YCOMMENT)
!
...
YCOMMENT='QI_BLD (kg/kg)'
 CALL WRITE_SURF(HPROGRAM,YRECFM,B%CUR%XQI_BLD(:),IRESP,HCOMMENT=YCOMMENT)
!
  !
  ...
  YRECFM=ADJUSTL(YRECFM)
  YCOMMENT='T_WIN2 (K)'
  CALL WRITE_SURF(HPROGRAM,YRECFM,B%CUR%XT_WIN2(:),IRESP,HCOMMENT=YCOMMENT)
  !
  !* floor temperatures
  !
  DO JLAYER=1,BOP%NFLOOR_LAYER
    ...
    YRECFM=ADJUSTL(YRECFM)
    CALL WRITE_SURF(HPROGRAM,YRECFM,B%CUR%XT_FLOOR(:,JLAYER),IRESP,HCOMMENT=YCOMMENT)
  END DO
  !
  ...
  DO JLAYER=1,BOP%NFLOOR_LAYER
    ...
    YRECFM=ADJUSTL(YRECFM)
    CALL WRITE_SURF(HPROGRAM,YRECFM,B%CUR%XT_MASS(:,JLAYER),IRESP,HCOMMENT=YCOMMENT)
  END DO        
  !
ENDIF
!
...
YRECFM=ADJUSTL(YRECFM)
YCOMMENT='TI_ROAD (K)'
 CALL WRITE_SURF(HPROGRAM,YRECFM,T%CUR%XTI_ROAD(:),IRESP,HCOMMENT=YCOMMENT)
!
!* snow mantel
!
YRECFM='RF'
...
YRECFM=ADJUSTL(YRECFM)
YCOMMENT='T_CANYON (K)'
 CALL WRITE_SURF(HPROGRAM,YRECFM,T%CUR%XT_CANYON(:),IRESP,HCOMMENT=YCOMMENT)
!
...
YCOMMENT='Q_CANYON (kg/kg)'
 CALL WRITE_SURF(HPROGRAM,YRECFM,T%CUR%XQ_CANYON(:),IRESP,HCOMMENT=YCOMMENT)
!
!
