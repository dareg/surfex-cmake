!     #########
      SUBROUTINE WRITESURF_TEB_n (DGU, IOB, U, TM, GDM, GRM, &
...
!
! Gardens
IF (TM%TOP%LGARDEN) CALL WRITESURF_TEB_GARDEN_n(DGU, IOB, U, GDM, &
                                             HPROGRAM,YPATCH)
!
! Grenn roofs
IF (TM%TOP%LGREENROOF) CALL WRITESURF_TEB_GREENROOF_n(DGU, IOB, U, GDM%TVG, GRM, &
                                                   HPROGRAM,YPATCH)
!
