...
!
 ...
 CALL READ_SURF(HINIFILETYPE,'PATCH_NUMBER',I%NPATCH,IRESP)
 CALL READ_SURF(HINIFILETYPE,'GROUND_LAYER',I%NGROUND_LAYER,IRESP)
 CALL READ_SURF(HINIFILETYPE,'ISBA',I%CISBA,IRESP)
IF (IVERSION >= 7) THEN
  CALL READ_SURF(HINIFILETYPE,'PEDOTF',I%CPEDOTF,IRESP)
ELSE
  I%CPEDOTF = 'CH78'
ENDIF
 CALL READ_SURF(HINIFILETYPE,'PHOTO',I%CPHOTO,IRESP)
!
IF (IVERSION>7 .OR. IVERSION==7 .AND. IBUGFIX>=2) THEN
  !
  CALL READ_SURF(HINIFILETYPE,'TR_ML',I%LTR_ML,IRESP)
  !
ELSE 
  I%LTR_ML = .FALSE.
ENDIF
...
IF(I%CISBA=='DIF') THEN
  ...
  I%XSOILGRID=XUNDEF
  IF (IVERSION>7 .OR. IVERSION==7 .AND. IBUGFIX>=2) THEN
    CALL READ_SURF(HINIFILETYPE,'SOILGRID',I%XSOILGRID,IRESP,HDIR='-')
  ELSE
...
!
IF (IVERSION>=6) THEN
  CALL READ_SURF(HPROGRAM,'NBIOMASS',I%NNBIOMASS,IRESP)
ELSE
